...
For more information, see [Create accrual schemes](create-accrual-schemes.md) and [Create ledger accrual transactions](create-ledger-accrual-transactions.md).
