...
A **customer invoice for a sales order** is a bill that is related to a sale, and that an organization gives to a customer. This type of customer invoice is created based on a sales order, which includes order lines and item numbers. Item numbers are specified and posted in the ledger. Subledger journal entries aren't available for a customer invoice for a sales order. For more information, see [Create sales order invoices](create-sales-order-invoices.md).
...
[Create a free text invoice](create-free-text-invoice.md)

[Create a free text template](create-free-text-invoice-template.md)

[Assign a free text invoice tempate to a customer](assign-free-text-invoice-template-customer.md)

[Generate and post recurring free text invoices](post-recurring-free-text-invoices.md)
