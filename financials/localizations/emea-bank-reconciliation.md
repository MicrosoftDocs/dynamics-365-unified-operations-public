...
-   Advanced bank reconciliation European file formats. For more information, see [Advanced bank reconciliation overview](..cash-bank-management/advanced-bank-reconciliation-overview).
