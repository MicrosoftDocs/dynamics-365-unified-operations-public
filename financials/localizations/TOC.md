...
### [ISR declaration report](latin-america\isr-declaration-report.md)			
### [DIOT declaration statement](latin-america\diot-declaration-statement.md)			
### [Electronic invoices (CFDI)](latin-america\electronic-invoices-mexico.md)			
### [Electronic ledger accounting statements](latin-america\electronic-ledger-accounting-statements-mexico.md)			
### [Adjustment inflation declaration report](latin-america\adjustment-inflation-declaration-report.md)			
# Europe			
## [Registration IDs](europe\registration-ids.md)
## [EU Entry certificates](europe\entry-certificates.md)		
## [EU Sales list reporting](europe\eu-sales-list.md)
## [SEPA Direct debit overview]()			
### [Set up SEPA direct debit mandate](europe\set-up-sepa-direct-debit-mandate.md)						
...
## [Petty cash](financials\europe\eeu-petty-cash.md)			
## [Import or manually create postal codes](europe\import-create-postal-codes-manually.md)			
## [OIOUBL standards for electronic invoicing](europe\oioubl-standards-electronic-invoicing.md)			
## [Post the pre-acquisition of a fixed asset](europe\eeur-pre-acquisition-acquisition-fixed-asset.md)			
## [Set up signers for print forms](europe\eeu-set-up-signers-for-printing-forms.md)			
...
## [Advance holders](europe\advance-holders.md)			
### [Advance holder transactions](europe\advance-holders-transactions.md)			
## [Amount printing forms](europe\eeu-amount-printing-forms.md)			
## Austria			
...
### [Public sector accounting](europe\public-sector-accounting-france.md)			
...
### [Italian sales tax books](financials\europe\fiscal-books-for-italy.md)			
...
### [Latvia fixed assets location fields change](europe\lva-fixed-assets-location-fields-change.md)			
### [Tax on natural resources report](financials\europe\tax-on-natural-resources-in-latvia.md)			
### [Fixed assets location change tracking](financials\europe\lva-fixed-assets-location-fields-change.md)			
			
## Lithuania			
### [Fixed asset repair statement](europe\ltu-fixed-asset-repair-statement.md)			
			
## Netherlands			
			
## Norway			
### [Nets import format](europe\nor-nets-import-format.md)			
			
## Poland			
### [Fixed assets disposal](financials\europe\pol-fixed-asset-disposal-functionality-extension-for-poland.md)			
### [Fixed asset disposal functionality extension](europe\pol-fixed-asset-disposal-functionality-extension.md)			
### [Fixed assets depreciation](europe\pol-fixed-assets-depreciation.md)		
### [Line discount calculation from the unit price](europe\pol-line-discount-calculation-from-unit-price.md)			
### [Turnover balances statement](europe\turnover-balances-statement.md)			
### [Duplicate sales invoice numbering](europe\pol-sales-invoice-duplicates-numbering.md)			
### [Correction notes](europe\pol-correction-notes.md)			
			
## Spain			
### [Spanish bill of exchange options](europe\esp-spanish-bill-of-exchange-options.md)			
  ### [Spanish promissory note options](europe\esp-spanish-promissory-note-options.md)			
  ### [Special entries and opening sheets](europe\opening-sheets-spain.md)			
  ### [Sales and purchase cycles](europe\esp-sales-purchase-cycle.md)			
  ### [Fixed asset group revaluation](europe\esp-fixed-asset-group-revaluation.md)			
  ### [Fiscal data invoice account](europe\esp-fiscal-data-invoice-account.md)			
  ### [One time customers](europe\esp-no-one-time-customer-for-project-contracts.md)			
  ### [Cash discount is applied in the invoice parameter](europe\cash-discount-applied-invoice.md)			
			
			
## Sweden			
### [Import payment formats for Sweden](europe\sweden-payment-formats-import.md)			
			
## Switzerland			
### [Swiss ESR customer payments import](europe\che-esr-customer-payments-import.md)			
			
## United Kingdom			
### [Construction Industry Scheme](europe\construction-industry-scheme.md)			
...
# South America			
## Brazil			
### [Brazilian taxes](latin-america\bra-about-calculation-of-taxes.md)			
### [Journals generated during the electronic payment return process](latin-america\bra-examples-journals-generated-during-the-electronic-payment-return-process.md)			
### [NF-e process overview](latin-america\bra-about-the-nf-e-process.md)
### [Parameters for legal entities in Brazil](latin-america\brazilian-legal-entity-parameters.md)			
### [Purchase complementary fiscal documents](latin-america\bra-about-purchase-complementary-fiscal-documents.md)			
### [Referenced fiscal documents](latin-america\referenced-fiscal-documents.md)			
### [Sales complementary fiscal documents](latin-america\bra-about-sales-complementary-fiscal-documents.md)			
### [Service electronic fiscal document](latin-america\service-electronic-fiscal-document.md)			
### [Tax attributes](latin-america\bra-tax-attributes.md)			
### [Tax payments in Brazil](latin-america\tax-payments.md)			
### [Fiscal books](latin-america\bra-about-fiscal-books.md)			
### [Fiscal document text placeholders](latin-america\bra-about-fiscal-document-text-placeholders.md)			
### [Fiscal documents and fiscal document framework](latin-america\bra-about-fiscal-documents-and-the-fiscal-document-framework.md)			
### [ICMS tax fiscal documents](latin-america\bra-about-icms-tax-fiscal-documents.md)			
### [Import and verify NF-e XML documents and DANFE files](latin-america\bra-import-and-verify-nf-e-xml-documents-and-danfe-that-you-receive-in-emails.md)			
### [Import fiscal documents](latin-america\bra-about-import-fiscal-documents.md)			
