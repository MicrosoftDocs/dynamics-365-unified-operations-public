...
# ms.tgt_pltfrm: 
ms.custom: 55651
ms.assetid: abca3195-9b10-4ddb-952c-6323627609e1
ms.region: Global
# ms.industry: 
ms.author: sericks
...
For information about the requirements for development on local virtual machines (VMs), see [VM running on-premises](https://docs.microsoft.com/en-us/dynamics365/operations/dev-itpro/dev-tools/access-microsoft-dynamics-ax-7-instances-2#vm-running-on-premises).

See also
--------

[Get an evaluation copy of Dynamics 365 for Operations](https://docs.microsoft.com/en-us/dynamics365/operations/dev-itpro/dev-tools/get-an-evaluation-copy)
