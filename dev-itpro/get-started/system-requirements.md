...
-   To capture images that are generated from Task Recorder and include them in Microsoft Word documents, you must have a Chrome extension installed. <!---For instructions about how to install the extension, see [Screenshot Extension setup](/dynamics365/unified-operations/dev-itpro/user-interface/task-recorder).-->
...
[Get an evaluation copy of Dynamics 365 for Operations](/dynamics365/unified-operations/dev-itpro/dev-tools/get-evaluation-copy)
