...
-   To capture images that are generated from Task Recorder and include them in Microsoft Word documents, you must have a Chrome extension installed. For instructions about how to install the extension, see [Screenshot Extension setup](user-interface/task-recorder.md#screenshot-extension-setup).
...
-   To run the Microsoft Excel and Word add-ins, you must have Microsoft Office 2016 for Windows or Mac installed. For more details about version requirements, see [Office integration troubleshooting](office-integration/office-integration-troubleshooting.md).
...
[Get an evaluation copy of Dynamics 365 for Operations](dev-tools/get-evaluation-copy.md)
