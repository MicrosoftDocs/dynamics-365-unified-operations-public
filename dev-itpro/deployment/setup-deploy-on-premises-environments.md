...
the [Enterprise Agreements](https://www.microsoft.com/en-us/Licensing/licensing-programs/enterprise.aspx) channel and set up an on-premises project in LCS. Deployments can be initiated only through LCS. For more information about how to set up on-premises projects in LCS, see [Hyperlink to LCS documentation].
...
For more information, see System requirements[Hyperlink] and Sizing guidelines[Hyperlink].

### Hardware layout

Plan your infrastructure and Service Fabric cluster, based on the recommended sizing in Sizing guidelines [hyperlink to sizing doc]. For more information about how to plan the Service Fabric cluster, see [Plan and prepare your Service Fabric standalone cluster deployment](https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-cluster-standalone-deployment-preparation).
...
1. Plan your domain name and Domain Name System (DNS) zones.
2. Plan and acquire your certificates.
3. Create DNS zones, and add A records.
4. Set up certificates.
5. Register the tenant so that it can connect to LCS.
6. Create user accounts.
7. Set up the Service Fabric cluster.
8. Configure AD FS.
9. Configure SQL Server.
10. Configure Azure File storage.
11. Set up and configure databases.
12. Configure SSRS.
13. Deploy a local agent.
...
### Plan your users or service accounts
...
> [!NOTE]
> You might have to restart your computer after you install the components.
...
3. Click **Tasks** \> **New Share** to create a new share.
...
1. Repeat steps 2 through 3 of the previous procedure to create a new share for the local deployment agent.
2. Grant **Full-Control** permissions to the gMSA user for the local deployment agent (contoso\\svc-LocalAgent\$).
