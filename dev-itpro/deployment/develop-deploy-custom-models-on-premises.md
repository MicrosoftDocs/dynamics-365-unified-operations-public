...
For more information about how to configure a local development VHD, see [Access instances](./dev-itpro/dev-tools/access-instances.md#vm-that-is-running-onpremises).
