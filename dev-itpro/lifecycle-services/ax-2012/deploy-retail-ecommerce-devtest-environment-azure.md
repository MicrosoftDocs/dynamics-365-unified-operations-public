...
title: Deploy a Retail e-commerce dev/test environment on Azure (AX 2012) | Microsoft Docs
...
# ms.tgt_pltfrm: 
ms.custom: 13241
ms.assetid: f6b85fa5-2d1f-4c9f-a605-6028c040075e
ms.region: Global
# ms.industry: 
ms.author: aamiral
...
| Import data into Dynamics AX.                                                                                                                                   | If you want sample data installed in your Dynamics AX  environment, use the Test Data Transfer tool to install the sample data. For instructions, see [Test Data Transfer Tool (beta) for Microsoft Dynamics AX 2012 R3](https://docs.microsoft.com/en-us/dynamics365/operations/dev-itpro/lifecycle-services/ax-2012/test-data-transfer-tool-beta-for-microsoft-dynamics-ax-2012). |
