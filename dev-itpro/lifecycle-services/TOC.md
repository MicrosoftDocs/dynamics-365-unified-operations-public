...
### [Test Data Transfer Tool (beta)](ax-2012\test-data-transfer-tool-beta-2012.md)
### [Install the Test Data Transfer Tool (beta) for Dynamics AX](ax-2012\install-test-data-transfer-tool-beta.md)
### [Import demo data for AX 2012 R3 by using the Test Data Transfer Tool](ax-2012\import-demo-data-ax-2012-r3-test-data-transfer-tool.md)
### [Run the Test Data Transfer Tool (beta) for Dynamics AX](ax-2012\run-test-data-transfer-tool-beta.md)
