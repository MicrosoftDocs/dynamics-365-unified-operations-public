...
# [Configure the code upgrade service in Lifecycle Services ](configure-execute-code-upgrade.md)
...
# [Issue search in Lifecycle Services](issue-search-lcs.md)
...
## [Develop and release an LCS solution](lcs-solutions-app-source.md)
...
## [Back up an LCS solution database](database-backup-lcs-solutions.md)
