...
| Area                           | Entity                                 | Action to take                                            |  
|--------------------------------|----------------------------------------|-----------------------------------------------------------
| System setup                   | Operating unit                         | Unmap Manager personnel number unless you have imported workers |
|                                | User information                       | Apply a filter where the ID is not equal to Admin. Unmap Person name and use the User to person relationship entity to map system users to directory users. |
...
| Accounts receivable            | Customer details                       | Unmap Employee responsible number unless workers have been imported. Unmap Collections contact person (CollectionsContactPersonID) unless workers and their contact information has been imported. Unmap site (SiteID) and warehouse (WarehouseID) unless they have already been imported |
