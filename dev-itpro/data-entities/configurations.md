...
Default templates are delivered with each new release in the product. These templates are automatically loaded when you first install your instance of Dynamics 365 for Finance and Operations. [fix when decided]
