...
title: Dynamics 365 for Finance and Operations mobile app home page
...
# Dynamics 365 for Finance and Operations mobile app home page

[!include[banner](../includes/banner.md)]


This topic describes the Microsoft Dynamics 365 for Finance and Operations mobile app and provides links to resources that can help you implement it in your organization.

Overview
--------

The Microsoft Dynamics 365 for Finance and Operations mobile app enables your organization to make its business processes available on mobile devices. After your IT admin enables the mobile workspaces feature for your organization, users can sign in to the app and immediately begin to run business processes from their mobile devices. The Dynamics 365 for Finance and Operations mobile app includes the following features that can help increase productivity:
...
-   IT admins or developers easily design mobile workspaces by using the point-and-click workspace designer that is included with the Dynamics 365 for Finance and Operations web client.
...
-   On the dashboard, you can see a list of **workspaces** that are published in your Dynamics 365 for Finance and Operations environment.
-   In each workspace, you can see a list of **pages** that are available for that workspace.
-   On a page, you can view data that is collected from one or more pages in Dynamics 365 for Finance and Operations.
...
The following illustration shows the process for implementing the Dynamics 365 for Finance and Operations mobile app in your organization. 

![Mobile apps implementation process](./media/mobile-implementation-process_4.png)

The following table includes links to resources that can help you implement the Dynamics 365 for Finance and Operations mobile app in your organization. The numbers in the first column correspond to the numbered steps in the previous illustration.
