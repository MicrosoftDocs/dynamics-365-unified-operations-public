...
| [flexSize](../interfaces/view-model-control-image-iimage-iimagedesign.md#flexsize) |flexSize: "medium" &#124; "xx-small" &#124; "x-small" &#124; "small" &#124; "large" &#124; "x-large" &#124; "xx-large" (optional)  <br>|This property is an alias for the CSS property "flex".<br>  Inherited from [Design](../interfaces/view-model-ipage-idesign.md).[flexSize](../interfaces/view-model-ipage-idesign.md#flexsize) <br> |
| [fontSize](../interfaces/view-model-control-image-iimage-iimagedesign.md#fontsize) |fontSize: string (optional)  <br>|A number written as a string. E.g. "3".<br>  Inherited from [Design](../interfaces/view-model-ipage-idesign.md).[fontSize](../interfaces/view-model-ipage-idesign.md#fontsize) <br> |
