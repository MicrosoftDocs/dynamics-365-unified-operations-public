...
| Create calculation models with Copilot (preview) | Describe the calculation model that you want to create, and Copilot generates the model for you. To use this feature, turn it on in **Application settings**, and then open it from the **Models** page. | [Create calculation models with Copilot (preview)](/industry/sustainability/sustainability-manager-copilot-calculation-models) |
...
| **Visualize data in a view** | Visualizes the data in your view as an interactive chart to help you understand trends, patterns, and relationships easily. The chart is based on the visible columns and can be personalized to support deeper exploration. | [Visualize data in a view with Copilot (preview)](/industry/sustainability/microsoft-sustainability-manager/visualize-data-in-copilot) |
| **Row summary** | Provides you quick, concise, AI‑generated summaries of selected records so you can understand key details without opening each item. It highlights important fields and recent updates, helping you review information faster and act with context. | [Use row summaries in model-driven apps](/industry/sustainability/microsoft-sustainability-manager/record-summaries) |
| **Timeline highlights** | Creates an AI-generated, bulleted list that appears at the top of the timeline. These highlights summarize key activities—such as user interactions, reported issues, and steps taken—so you can understand the record's status at a glance. | [Use timeline highlights powered by generative AI](/industry/sustainability/microsoft-sustainability-manager/add-activities#use-timeline-highlights-powered-by-generative-ai) |
