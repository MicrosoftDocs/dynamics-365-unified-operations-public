...
| Vendor               | Specify the vendor that the garnishment is paid to. Typically, this vendor is a state agency and is listed on the garnishment order. If you don't already have a vendor record for the agency, you must create it. For more information, see [Create a vendor account (Task guide)](http://ax.help.dynamics.com/en/wiki/create-a-vendor-account/).          |
