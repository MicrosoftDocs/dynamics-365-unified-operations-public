...
|Information about the declaration's receiver|<p>The following information about the authorities is presented:</p><p>- Identification number</p><p>- Name</p><p>- Legal address</p><p>- Email address</p><p>- Fax number</p><p>- Web address (URL)</p>|
|Information about the declaration's sender|<p>The following information about the company is presented:</p><p>- Value-added tax (VAT) code</p><p>- Legal address</p><p>- Phone number</p><p>- Email address</p><p>- Fax number</p><p>- URL</p>|
|Information about the contact person|<p>The following information about the person who is submitting the declaration is presented:</p><p>- Name</p><p>- Phone number</p><p>- Fax number</p><p>- Email address</p>|
...
|Function code|<p>For an original Intrastat declaration, "O" is printed.</p><p>For a correction Intrastat declaration, "M" is printed.</p>|
|Report direction|<p>For arrivals, "A" is printed.</p><p>For dispatches, "D" is printed.</p>|
...
1. Go to **Organization administration** > **Organizations** > **Legal entities**.
1. In the grid, select your company.
1. On the **Tax registration** FastTab, in the **Tax registration number** field, enter the VAT ID of your company.
...
1. For each tax-exempt number, create a record that includes the following information:
   1. In the **Country/region** field, select the tax registration of the counterparty.
   1. In the **Tax exempt number** field, enter the tax-exempt number of the counterparty.
   1. In the **Company name** field, enter the name of the counterparty.
1. Go to **Accounts receivable** > **Customers** > **All customers**.
1. In the grid, select a customer.
...
1. On the **Foreign trade** FastTab, in the **Intrastat** section, in the **Commodity** field, select the commodity code. The name of the commodity will be printed in the **Description of goods** field in the Intrastat declaration.
1. In the **Statistics procedure** field, select the statistical sign if it's required. The values that are available for selection depend on the commodity code that you selected.
...
1. On the **State/province** tab, select **New**.
1. In the **Country/region** field, select **LTU**.
1. In the **State** field, enter the **VL**.
1. In the **Intrastat code** field, enter **LT-VL**.
1. On the **City** tab, select **New**.
1. In the **Country/region** field, select **LTU**.
1. In the **City** field, enter **Vilnius**.
1. In the **State** field, select **VL**.
1. On the **ZIP/postal code** tab, select **New**.
1. In the **Country/region** field, select **LTU**.
1. In the **State** field, select **VL**.
1. In the **City** field, select **Vilnius**.
1. In the **ZIP/postal code** field, enter **LT-00001**.
1. Go to **Organization administration** > **Organization** > **Legal entities**.
1. In the grid, select the **DEMF** legal entity.
1. On the **Addresses** FastTab, select **Edit**.
1. In the **Country/region** field, select **LTU**.
1. In the **ZIP/postal code** field, select **LT-00001**.
1. In the **Street** field, enter **Ukmerges Street 120**.
1. In the **City** field, select **Vilnius**.
1. In the **State** field, select **VL**.
1. Select **OK**.
### Set up contact information
...
1. In the **Contact number/address** field, enter http://eu.contoso.com.
1. Select the **Primary** option.
### Set up VAT IDs
#### *Set up the VAT ID of your company*
1. Go to **Organization administration** > **Organizations** > **Legal entities**.
...
1. Assign the new transport method to a mode of delivery. In this way, you set up the default values that are used for the transport method when the corresponding mode of delivery is selected.
...
1. In the **Internet address** field, enter http://eu.authority.com.
### Set up foreign trade parameters
...
1. On the **Line details** FastTab, on the **Foreign trade** tab, verify that the fields are set to the following values:
   1. **Transaction code:** 11
   1. **Transport:** 3
   1. **Commodity:** 100 200 30
   1. **Country/region of origin:** LTU
1. On the Action Pane, select **Save**.
...
Description automatically generated](Aspose.Words.5c4f158a-5715-4a64-8ff7-20cbaf8e8203.001.png)

1. Select the transaction line, and then select the **General** tab to view more details.

![A screenshot of a computer

Description automatically generated with medium confidence](Aspose.Words.5c4f158a-5715-4a64-8ff7-20cbaf8e8203.002.png)
...
|Completion date and time|<p>2022-02-01</p><p>03:31:48</p>|
...
Description automatically generated](Aspose.Words.5c4f158a-5715-4a64-8ff7-20cbaf8e8203.003.png)
...
1. On the **Line details** FastTab, on the **Foreign trade** tab, verify that the fields are set to the following values:
   ...
   1. **Transport:** 3
   1. **Commodity:** 100 200 30
   1. **Country/region of origin:** DEU
...
1. In the **Invoice dates** section, in the **Invoice date** field, select the current date. This date will be used for Intrastat transfer.
...
Description automatically generated](Aspose.Words.5c4f158a-5715-4a64-8ff7-20cbaf8e8203.004.png)

1. Review the information on the **General** tab for the purchase order.

![Graphical user interface, text, application

Description automatically generated](Aspose.Words.5c4f158a-5715-4a64-8ff7-20cbaf8e8203.005.png)
...
Description automatically generated with low confidence](Aspose.Words.5c4f158a-5715-4a64-8ff7-20cbaf8e8203.006.png)
