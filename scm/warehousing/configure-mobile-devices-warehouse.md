...
[Set up a mobile device menu item for completing work of type Purchase order (Task guide)](http://ax.help.dynamics.com/en/wiki/set-up-a-mobile-device-menu-item-for-completing-work-of-type-purchase-order/)

[Set up a mobile device menu item to register received items (Task guide)](http://ax.help.dynamics.com/en/wiki/set-up-a-mobile-device-menu-item-to-register-received-items/)
