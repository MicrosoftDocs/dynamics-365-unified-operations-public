...
## Operations
An operation is a step in the production process. In Dynamics 365 for Finance and Operations, each operation has an ID and a simple description. The following tables shows typical examples of operations from a machine shop.
