...
2. When you change a worker position, this also might change which benefits the worker is eligible for. Go to [Define and manage a benefits program](../../../../human-resources/hr-benefits-manage-benefit-program.md) and complete these tasks:
