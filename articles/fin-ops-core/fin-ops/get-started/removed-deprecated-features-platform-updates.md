...
| &nbsp;  | &nbsp; |
|------------|--------------------|
| **Reason for deprecation/removal** | Improve platform security and remove dependency on deprecated and out of maintenance nugets : <br> [WindowsAzure.Storage (v9.3.3)](https://www.nuget.org/packages/WindowsAzure.Storage/) (Along with Microsoft.WindowsAzure.StorageClient.dll 6.0.6002.18488 and Microsoft.WindowsAzure.Storage.dll 9.3.2.0)<br> <br>  [Microsoft.Azure.Storage.Common (v11.xx)](https://www.nuget.org/packages/Microsoft.Azure.Storage.Common) <br> [Microsoft.Azure.Storage.Blob](https://www.nuget.org/packages/Microsoft.Azure.Storage.Blob) (Microsoft.Azure.Storage.Blob.dll 11.2.3 and Microsoft.Azure.Storage.Common.dll 11.2.3) |
