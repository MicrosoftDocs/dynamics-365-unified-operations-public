...
The `learn.microsoft.com` site ([learn.microsoft.com/dynamics365](/dynamics365/)) is the default source for product documentation for the previously listed apps. This site offers the following features:
...
You can find content on `learn.microsoft.com` by using any search engine. For the best results, we recommend that you use a site search, such as **site:learn.microsoft.com dynamics 365 "search term"**.

## Get notified about changes through an RSS feed

To subscribe to an RSS feed of all updates made to the content on `learn.microsoft.com` across the finance and operations apps, use the following link:
...
For more information, see the [Microsoft Docs contributor guide](/contribute).
...
| Site | Description |
|------|-------------|
| [Dynamics 365 documentation](/dynamics365/) | This site hosts or links to all product documentation for Dynamics 365. |
| [Microsoft Training](/training/) | This site is the free Microsoft eLearning site. |
