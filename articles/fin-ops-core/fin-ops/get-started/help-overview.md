...
The ([Microsoft Dynamics 365 documentation](/dynamics365/)) on Microsoft Docs is the default source for product documentation for the previously listed apps. This site offers the following features:
