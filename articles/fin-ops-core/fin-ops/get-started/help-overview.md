...
The docs.microsoft.com site ([docs.microsoft.com/dynamics365/](../../index.md)) is the primary source of product documentation for the applications listed above. The site offers the following features:
