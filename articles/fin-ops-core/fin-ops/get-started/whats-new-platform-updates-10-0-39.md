...
| System Administration | Application users must be present in your Microsoft Entra ID tenant. | Admins can use the new Invalid Users form to determine and [fix invalid users](https://learn.microsoft.com/dynamics365/fin-ops-core/fin-ops/sysadmin/invalid-users) in the application. | Default |
