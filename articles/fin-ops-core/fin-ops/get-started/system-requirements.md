...
> **Update 10.0.21 and later**: Users on old versions of Microsoft Edge and Google Chrome (version 83 or lower) will see prompts to update their browser to the latest version.  
