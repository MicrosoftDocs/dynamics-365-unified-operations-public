...
To support this new behavior, a new column for the row status has been added to the right of the marking column when the grid is in edit mode. This column indicates one of the following statuses:
