...
title: What's new or changed in Dynamics 365 Finance version 8.1.3 (January 2019)
description: This article describes features that are either new or changed in Dynamics 365 Finance version 8.1.3. This version will be released in January 2019.
author: tonyafehr
ms.date: 10/15/2019
ms.topic: article
ms.prod: 
...
---
# What's new or changed in Dynamics 365 Finance version 8.1.3 (January 2019)

[!include [banner](../includes/banner.md)]

This article describes features that are either new or changed in Microsoft Dynamics 365 Finance version 8.1.3. This version will be released in January 2019 and has a build number of 8.1.227.
...
Microsoft Dynamics 365 Finance version 8.1.3 includes Platform update 23. To learn more about Platform update 23, see [What's new or changed in Dynamics 365 Finance platform update 23 (January 2019)](whats-new-platform-update-23.md).
