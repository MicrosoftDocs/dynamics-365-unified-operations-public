...
- **Visibility** – We will send notifications through admin center and other available channels, Lifecycle Services (LCS) for upcoming proactive quality updates. In addition, support teams and incident leads will have visibility into where quality updates have been proactively deployed.
 > [!NOTE]
 > Microsoft Communications team is investigating an ongoing degradation of the email tooling which is preventing the delivery of notification emails and admin center notifications. Please continue to monitor the Microsoft 365 Message Center for on boarding and notification related messages.
