...
- Quality updates will not be applied to prod environments if there is an impending service update scheduled within a week from when the quality update is scheduled to happen.
