...
> [!NOTE]
> - LCS has several [Sovereign and local cloud deployment options](../../dev-itpro/deployment/deployment-options-geo.md) instances. Movement of production between different LCS instances is not supported. 
