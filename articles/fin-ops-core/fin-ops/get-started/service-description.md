...
- Customers that have operations in China should review [Azure China Playbook](https://docs.microsoft.com/en-us/azure/china/) and [Finance and Operations operated by 21Vianet in China](../../dev-itpro/deployment/china-local-deployment.md).
...
### [Success by Design](https://docs.microsoft.com/en-us/dynamics365/fasttrack/success-by-design-overview)
