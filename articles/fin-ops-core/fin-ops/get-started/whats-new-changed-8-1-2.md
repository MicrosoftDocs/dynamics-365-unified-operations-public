...
title: What's new or changed in Dynamics 365 Finance version 8.1.2 (December 2018)
description: This article describes features that are either new or changed in Dynamics 365 Finance version 8.1.2. This version was released in December 2018.
author: tonyafehr
ms.date: 10/15/2019
ms.topic: article
ms.prod: 
...
---
# What's new or changed in Dynamics 365 Finance version 8.1.2 (December 2018)

[!include [banner](../includes/banner.md)]


This article describes features that are either new or changed in Microsoft Dynamics 365 Finance version 8.1.2. This version was released in December 2018 and has a build number of 8.1.195.
...
Microsoft Dynamics 365 Finance version 8.1.2 includes Platform update 22. To learn more about Platform update 22, see [What's new or changed in Dynamics 365 Finance platform update 22 (December 2018)](whats-new-platform-update-22.md).
