...
|---|---|---|---|
| Copilot in finance and operations apps | Follow-up questions in the Copilot sidecar |[Enable follow-up questions in the Copilot sidecar](../../dev-itpro/copilot/enable-copliot-generative-help.md#follow-ups) | Feature Management:<br>*(Preview) AI-generated follow-up questions for the Copilot sidecar in finance and operations apps* |
