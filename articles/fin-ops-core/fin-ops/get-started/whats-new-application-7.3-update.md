...
To learn more about the new features and changes in all of the latest product releases, see [What's new or changed](../../fin-and-ops/get-started/whats-new-changed.md) and [What's new or changed in Dynamics 365 for Retail](/../../../retail/get-started/whats-new.md).
