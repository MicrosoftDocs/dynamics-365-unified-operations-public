...
3. Click the toolbar button of the format to apply. For example, to indent a row, select the row, and then click **Increase indent** ![Increase indent.](../../dev-itpro/analytics/media/indent.gif "Increase Indent") on the toolbar.
