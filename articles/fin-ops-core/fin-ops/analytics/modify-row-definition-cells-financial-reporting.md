...
5. In the **From** field, enter the starting dimension, or click ![Browse.](../../dev-itpro/analytics/media/browse.gif "Browse") to search for available dimensions. To enter a range of dimensions, enter the ending dimension in the **To** field.
...
| Item                | Description |
|---------------------|-------------|
| Individual or range | In the **From** field, enter the name of an account, or click the **Browse** button ![Browse.](../../dev-itpro/analytics/media/browse.gif "Browse") to browse for the account. To select a range, enter or browse for a value in the **To** field. |
