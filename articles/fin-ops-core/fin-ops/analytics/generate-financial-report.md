...
1. Select override company, detail, and date settings from each of the reports that will be included in the group.
...
1. Under **Settings**, select an individual report or a report group to schedule. Only reports or report groups for the company or building block selection that you are currently logged on to are available.
...
1. Select the report schedule to delete, and then select **Delete** or click **Delete**.
...
1. When the issues are resolved, select **OK** to close the dialog box.
