...
description: Learn about how the components, or building blocks, of report definitions are used in financial reporting, including an outline on the building blocks of a report.
author: aprilolson
ms.author: aolson
ms.topic: article
ms.date: 10/27/2022
