...
>3. **HR migration projects**. Projects which are migrating from Dynamics 365 Human Resources standalone application to finance and operations infrastructure should follow the process described in this link [Human Resources migration go-live readiness review](https://learn.microsoft.com/dynamics365/human-resources/hr-migration-admin-go-live-readiness-review).
