...
description: Learn about Copilot capabilities in finance and operations apps and explains how to use them, including an outline on responisble use of AI.
author: cabeln
ms.author: cabeln
ms.topic: overview
ms.date: 11/09/2023
