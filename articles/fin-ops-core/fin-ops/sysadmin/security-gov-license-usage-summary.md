...
>[!Note]
> In the above screenshot, **Supply Chain Management Premium** shows **Priority is 100** and **Finance Premium** shows **Priority is 90**. This is because Priority reflects the global SKU order, not the best match for the Accountant role. 
>
