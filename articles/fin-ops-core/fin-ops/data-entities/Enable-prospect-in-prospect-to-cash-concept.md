...
The following sections provides common scenarioes enabled by **Enable prospects in Sales quotation lifecycle with Dynamics 365 Sales**.
...
Result: The new prospect is created using the number sequence setup for the prospect entity in Microsoft Dynamics 365 Supply Chain Management. A new account of type Prospect is created in Microsoft Dynamics 365 Sales with same account number as in Microsoft Dynamics 365 Supply Chain Management.
...
1. In Microsoft Dynamics 365 Sales, navigate to Customers > Accounts. Create New account type Prospect. A new prospect is created with the account number selected by the user. Create a new contact for the prospect.
...
3. In Microsoft Dynamics 365 Sales navigate to Customers>Accounts. Select the account type prospect. Change the type to Customer. Select the appropriate Customer group.
...
2. Add an address of role delivery to the prospect. Add an address of role invoice. Create a new contact for the prospect.
Result: A contact for the prospect is not created in Microsoft Dynamics 365 Sales as the prospect is in itself a contact. This is intentional.
*** Henrikan: Test at contacts kun synkroniseres dersom contacten er knyttet til en type account (organization) og ikke type contact (type person) *** 

    > [!NOTE]
    > Depending on whether the dual write GAB solution is deployed, either both the delivery and invoice addresses or only the delivery address are created in Microsoft Dynamics 365 Sales for the contact with the Is Prospect value set to Yes. 
        > 
...
Result:A customer account of type person is created in Microsoft Dynamics 365 Supply Chain Management from the prospect. Customer account number is the same as prospect irrespective of customer number sequence setup in Microsoft Dynamics 365 Supply Chain Management. It is intentional that it cannot be changed in the converting process. Customer group is defaulted into the process from the setup in Sales and Marketing parameters for prospects. The prospect in Microsoft Dynamics 365 Supply Chain Management is retired and the type is changed from Prospect to Customer. Addresses and contacts in Dynamics 365 Supply Chain Management are related to the new customer account created in Microsoft Dynamics 365 Supply Chain Management. The contact in Dynamics 365 Sales is changed from _Is Prospect_ value Yes to No, and _Is Customer_ value No to Yes.

 > [!NOTE]
    > It is intentional that the customer account associated contact in Microsoft Dynamics 365 Supply Chain Management is not synchronized to the contact in Microsoft Dynamics 365 Sales with _Is Customer_ value equal Yes. There are no changes to the delivery and invoice addresses in Microsoft Dynamics 365 Sales.  
>

### Scenario 4:  Prospect lifecycle managed from Microsoft Dynamics 365 Sales - Prospect of type person
The following steps show what happens when you manage prospect lifecycle from Microsoft Dynamics 365 Sales.
1. In Microsoft Dynamics 365 Sales, navigate to Customers > Contacts. Create new contact with _Is Prospect _set to Yes. 
...
Result:The business relation type for the prospect in Microsoft Dynamics 365 Supply Chain Management is changed from Prospect to Customer. A customer account is created with the same account number as the contact Last Name, irrespective of the number sequence for customer accounts in Microsoft Dynamics 365 Supply Chain Management. 
