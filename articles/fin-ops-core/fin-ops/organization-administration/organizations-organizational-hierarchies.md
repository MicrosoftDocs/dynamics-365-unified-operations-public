...
Organizational Hierarchies can be selected as a Tree type option in Financial Reporting. Financial reporting will select the current effective hierarch as noted by hierarchy.  See [Reporting tree definitions in Financial Reports](financial-reporting-tree-definitions.md)
