...
| Use Exchange email server                                              | Uses the Exchange Online server associated with the tenant. On-premises Exchange servers are not supported at this time for the **Exchange** mail provider. |
