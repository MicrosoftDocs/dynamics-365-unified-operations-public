...
Organizational hierarchies represent the relationships between the organizations that make up a business. Therefore, the most important consideration when you model organizations is the structure of your business. Define organization structures based on feedback from executives and senior managers from functional areas, such as finance and accounting, human resources, operations, purchasing, and sales and marketing.

When you plan hierarchies, consider the relationship between the organizational hierarchy and financial dimensions. You can set up multiple organizational hierarchies to represent different views of your business. By using financial dimensions, you can create reports based on these views. Work with your partner to create hierarchies that address both organizational and statutory reporting needs.
...
Some functionality works differently depending on whether the organization is a legal entity or an operating unit. Carefully consider the functionality described in the following section as you make your decision.

### Master data

#### If you model the organization as a legal entity
...
#### If you model the organization as an operating unit
...
Set module parameters, such as Accounts receivable, Accounts payable, and Cash and bank management, per legal entity. Because the module setup for legal entities is separate, each subsidiary can comply with local statutory requirements and business practices. For example, a professional services legal entity and a manufacturing legal entity can have different module parameters even though they report to the same parent company.
...
An operating unit can't have its own ledger information. If your internal organizations don't require unique ledgers, model them as operating units. Set up ledger information for the parent legal entity in the hierarchy. You can create income statements for operating units within a legal entity or for the parent legal entity.

### Fiscal calendars

#### If you model the organization as a legal entity

Each legal entity has its own fiscal calendar. If your internal organizations use different fiscal years and fiscal calendars, model the organizations as legal entities.

#### If you model the organization as an operating unit

Operating units must share a fiscal calendar. If your internal organizations can use the same fiscal years and fiscal calendars, model the organizations as operating units.

### Consolidation

#### If you model the organization as a legal entity

You must consolidate the financial results for regional offices into a single, consolidated company to prepare financial statements.
...
Set up centralized payments so you can pay invoices for all child legal entities to or from a single parent legal entity.

#### If you model the organization as an operating unit

You don't need centralized payments because you record all invoices in a single legal entity.

### Intercompany transactions

#### If you model the organization as a legal entity

You can apply intercompany sales orders, purchase orders, payments, or receipts to one another. You don't need to use journal vouchers. You can view intercompany transactions at the subledger level, such as Accounts receivable and Accounts payable. The following examples illustrate how the system handles intercompany transactions.
...
Model the organizations as legal entities if laws and accounting practices differ among the countries or regions where your organizations are located. Each legal entity has its own year-end procedures.

#### If you model the organization as an operating unit

Model the organizations as operating units if laws and accounting practices are the same among the countries or regions where your organizations are located. All operating units must use the same year-end closing procedure.

### Number sequences

#### If you model the organization as a legal entity

Set up number sequences for some references per legal entity. Share some number sequences.
...
This capability was introduced in Dynamics 365 Finance version 10.0.44. Starting with Dynamics 365 Finance version 10.0.47, the feature is enabled by default.

To enable the feature manually, follow these steps:

1. Go to **Feature management**.
1. Enable the **Multi-company purpose** feature.

The feature activates a hierarchical parent-child legal entity selection experience, replacing the previous flat multiselection company picker. This enhancement provides a more scalable and structured approach for cross-company operations and improves usability for organizations managing complex legal entity structures.

You can search, sort, and select multiple legal entities in:
