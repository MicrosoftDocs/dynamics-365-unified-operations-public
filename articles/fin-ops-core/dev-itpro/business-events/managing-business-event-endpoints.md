...
:::image type="content" source="/workspaces/Dynamics-365-Operations/articles/fin-ops-core/dev-itpro/business-events/media/Businessevents_AzureAppIdSecret.png" alt-text="Screenshot of the business event endpoint configuration page showing the Secret Expiry Date field for managing application secrets.":::
...
:::image type="content" source="/workspaces/Dynamics-365-Operations/articles/fin-ops-core/dev-itpro/business-events/media/Businessevents_ErrorInfoWarning.png" alt-text="Screenshot of a banner alert on the business event endpoint configuration page displaying a notification about upcoming secret expirations.":::
