...
:::image type="content" source="../media/businessevents_FinOpsConnector.png" alt-text="Screenshot of the When a Business Event occurs trigger.":::
...
To use the finance and operations apps business events in the **When an action is performed** trigger of the Dataverse connector, enable the Microsoft Power Platform integration for the finance and operations apps environment. This integration connects the finance and operations apps environment to the Dataverse environment. For more information about how to enable the Microsoft Power Platform integration for finance and operations apps environments, see [Enabling the Microsoft Power Platform integration](../power-platform/enable-power-platform-integration.md). 
...
:::image type="content" source="../media/businessevents_DataverseConnector.png" alt-text="Screenshot of the When an action is performed trigger in the Microsoft Dataverse connector.":::
...
:::image type="content" source="../media/businessevents_DataEventConnector.png" alt-text="Screenshot of the When a row is added, modified or deleted trigger in the Microsoft Dataverse connector.":::
