...
To activate a data event, select a configured endpoint. For information about how to configure endpoints business events and data events, see [Managing business event endpoints](managing-business-event-endpoints.md).
