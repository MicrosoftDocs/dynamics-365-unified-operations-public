...
> [!TIP]
> **Change tracking** is essential for enabling incremental data export and for triggering data events in finance and operations apps.  
>  
> Without change tracking enabled on a data entity, only full data exports are possible, and data events might not fire as expected.
