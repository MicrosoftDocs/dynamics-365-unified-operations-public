...
:::image type="content" source="../../../supply-chain/sales-marketing/media/FSOnHandOW.png" alt-text="Screenshot of synchronization of business processes between Supply Chain Management and Field Service.":::
...
1. Select the used Connection set.
1. On the **Integration key** tab, ensure that the following keys are added to msdynce_externalproductinventories:
...
:::image type="content" source="../../../supply-chain/sales-marketing/media/FSinventoryLevel1.png" alt-text="Screenshot of template mapping in Data integration.":::
