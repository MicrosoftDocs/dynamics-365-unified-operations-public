...
:::image type="content" source="../../../supply-chain/sales-marketing/media/FSTransAdjOW.png" alt-text="Screenshot of synchronization of business processes between Supply Chain Management and Field Service.":::
...
:::image type="content" source="../../../supply-chain/sales-marketing/media/FSAdj1.png" alt-text="Screenshot of template mapping in Data integration, Inventory adjustment (Field Service to Supply Chain Management): Inventory adjustment.":::

### Inventory transfer (Field Service to Supply Chain Management): Inventory transfer

:::image type="content" source="../../../supply-chain/sales-marketing/media/FSTrans1.png" alt-text="Screenshot of template mapping in Data integration, Inventory transfer (Field Service to Supply Chain Management): Inventory transfer.":::
