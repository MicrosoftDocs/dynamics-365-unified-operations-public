...
:::image type="content" source="../../../supply-chain/sales-marketing/media/FSWarehouseOW.png" alt-text="Screenshot of synchronization of business processes between Supply Chain Management and Field Service.":::
...
1. Select the **Connection Set** tab.
1. Select the connection set used for work order synchronization.
1. Select the **Integration key** tab.
1. Find msdyn_warehouses and confirm that the key **msdyn_name (name)** is added. If it is not shown, add it by clicking **Add key** and then click **Save** at the top of the page.
...
:::image type="content" source="../../../supply-chain/sales-marketing/media/Warehouse1.png" alt-text="Screenshot of template mapping in Data integration.":::
