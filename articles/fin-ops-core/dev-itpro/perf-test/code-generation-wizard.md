...
1. Right-click the name of the table, and then, on the **Add-ins** menu, select **Generate ATL Entity**.
1. Select the fields that you want to include in the `AtlEntity` class, and then select **Add**.
1. Rename the entity and the fields as needed.
1. Select **Generate** to create the class.
...
1. Right-click the name of the table, and then, on the **Add-ins** menu, select **Generate ATL Query**.
1. Select the fields and relations that you want to include in the `AtlQuery` class, and then select **Add**.
1. Rename the query, the fields, and the relations as needed.
1. Select **Generate** to create the class.
...
1. In Visual Studio, open the table in the designer window.
1. Right-click the name of the table, and then, on the **Add-ins** menu, select **Generate ATL Specification**.
1. Select the fields that you want to include in the `AtlSpec` class, and then select **Add**.
1. Rename the specification and the fields as needed.
1. Select **Generate** to create the class.
