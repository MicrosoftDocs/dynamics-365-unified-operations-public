...
:::image type="content" source="media/derived-test-case.png" alt-text="Screenshot of example of derived test case.":::
...
:::image type="content" source="media/derived-1.png" alt-text="Screenshot of example of derived test case that is automatically created.":::

When you run a derived test case, it uses the recording of its parent test case and its own copy of the Excel parameters file. This setup allows you to run the same test with different parameters without the need to maintain more than one recording.
