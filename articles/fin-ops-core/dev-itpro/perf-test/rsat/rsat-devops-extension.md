...
9. Optional: Enter text in the **Comments** field. You can include Azure DevOps variables. The text will be recorded in the test run summary and test case results for later reference.
