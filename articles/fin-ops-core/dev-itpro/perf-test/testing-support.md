...
:::image type="content" source="./media/1_support.png" alt-text="Screenshot of options for testing in Visual Studio.":::
...
:::image type="content" source="./media/2_support.png" alt-text="Screenshot of an example of a test appearing in Test Explorer.":::
...
:::image type="content" source="./media/3_support.png" alt-text="Screenshot of an example of right-clicking to run or debug selected tests.":::
...
:::image type="content" source="./media/4_support.png" alt-text="Screenshot of an example of test cases displayed in Test Explorer.":::
...
:::image type="content" source="./media/5_support.png" alt-text="Screenshot of an example of the Import Task Recording dialog box.":::
