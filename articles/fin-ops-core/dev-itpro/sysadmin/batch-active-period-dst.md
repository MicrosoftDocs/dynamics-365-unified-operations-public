...
> [!NOTE]
> This feature is one-way. You can't turn it off after you turn it on.

When you turn on this feature, the following changes occur:
...
- The start and end times of existing active periods are adjusted according to the UTC time zone. Although the active periods continue to start and end at the same times that they previously started and ended, the times that are shown might change if the user's preferred time zone isn't UTC.
- Active periods follow the DST adjustments of the time zones that they're associated with.
