...
## To view the report
The [License codes and configuration keys report](https://mbs.microsoft.com/customersource/northamerica/AX/downloads/reports/axtechrefrep) lists each configuration key that is available. The report also indicates the license code and menu items associated with each configuration key. For more information, see [Find information about standard data entities](../dev-itpro/data-entities/data-entities-report.md).
