...
### You cannot generate a User Delegated SAS (UDS) URL using WindowsAzure.Storage v9.3.3?
...
1. You cannot generate a SAS URL using `GetSharedAccessSignature()` regardless of the library you use with managed identity.
