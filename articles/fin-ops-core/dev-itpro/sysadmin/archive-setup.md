...
- *(Preview) Archive data to Dataverse managed data lake and purge* – This feature provides the framework for purging data from the various history tables of Supply Chain Management and moving it to your Dataverse managed data lake, thereby improving system performance and lowering operating costs while keeping your historical records available as read-only data when you need them.
- *(Preview) Purge archived inventory transactions* – Copies data from the inventory transactions history table of Supply Chain Management to your Dataverse managed data lake and then purges the inventory transactions history table. This move helps improve system performance and lower operating costs while keeping your historical records available as read-only data when you need them.
