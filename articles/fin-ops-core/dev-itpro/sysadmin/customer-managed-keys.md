...
| Dynamics 365 Commerce | <p>Dynamics 365 Commerce environments support CMKs for all environment-specific resources except the content management system in e-commerce and recommendations. CMK support for the content management system in e-commerce and recommendations are expected to be enabled in the future. CMK will also not be enforced for [Commerce Scale Units](../deployment/initialize-retail-channels.md) that are not located in the same geo as the environment.</p>|
