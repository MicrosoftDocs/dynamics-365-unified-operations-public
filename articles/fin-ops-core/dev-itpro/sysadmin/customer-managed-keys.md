...
| Dynamics 365 Commerce | <p>Dynamics 365 Commerce environments support CMKs for all environment-specific resources except the content management system in e-commerce and recommendations. CMK support for the content management system in e-commerce and recommendations are expected to be enabled in the future.</p><p>CMK cannot be applied to [Commerce Scale Units](../deployment/initialize-retail-channels.md) that are located in a geo different from the environment.</p>|
