...
1. Go to **System administration** > **Inquiries** > **Batch jobs**.
   ...
   :::image type="content" source="./media/batch-popup.png" alt-text="Screenshot of the Switch to enhanced form button.":::

1. Select **Switch to enhanced form**.

To switch back to the unenhanced form, select **Switch to legacy form** on the Action Pane of the enhanced form.

:::image type="content" source="./media/enhanced-form.png" alt-text="Screenshot of the Switch to legacy form button.":::
