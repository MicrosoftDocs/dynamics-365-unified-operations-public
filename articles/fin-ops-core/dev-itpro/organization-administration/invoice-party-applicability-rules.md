...
Learn more about **Establishments** and how they're defined in [Establishments](../../fin-ops/organization-administration/organizations-organizational-hierarchies.md#establishments).
...
Learn about how the ship‑from address is captured and validated on vendor invoices in [**Vendor ship‑from address support on invoices**](../../../finance/accounts-payable/vendor-ship-from-address.md).
