...
1. Expand the new query, right-click the **Data Sources** node, and then select **New Data Source**. A data source group appears under the **Data Sources** node.
1. Right-click the new data source group, and then select **Properties**.
1. On the **Properties** sheet, set the **Table** property to the main table for the document type that you're defining a workflow for.
1. In the Application Object Tree (AOT), right-click the new query, and then select **Save**.
