...
5. Click on the **Query name** and select **All throttling events** for all Odata and custom services activities.
6. Click on the **Query name** and select **Requests throttled** for all Odata and custom services requests throttled.
