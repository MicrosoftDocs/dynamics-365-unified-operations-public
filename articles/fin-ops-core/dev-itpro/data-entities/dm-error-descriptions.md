...
|DMF043	|Package execution failed. This is when the error pattern doesn't match a known error code.	|Check the execution details for the particular execution ID for the specific error message. Depending on the problem, you may need to contact support.|
