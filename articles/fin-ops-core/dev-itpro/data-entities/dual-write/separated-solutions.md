...
For more information on the mappings that are available in the solutions, see [Integration with Dataverse tables](/dynamics365/human-resources/hr-dataverse-integration.md#template-mappings).
