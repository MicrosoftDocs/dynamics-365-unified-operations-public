...
A business ecosystem that consists of finance and operations apps and Dataverse continues to have an organization hierarchy. This organization hierarchy is built on finance and operations apps, but it's exposed in Dataverse for informational and extensibility purposes. The following illustration shows the organization hierarchy information that is exposed in Dataverse as a one-way data flow from finance and operations apps to Dataverse.

:::image type="content" source="media/dual-write-data-flow.png" alt-text="Screenshot of architecture image.":::
...
Dataverse gets internal organization information from two tables: **Operating unit** and **Legal entities**.
