...
-----------------------|--------------------------------|---
[All products](includes/mapping-tables.md#138) | msdyn_globalproducts | The all products table contains all the products available in Finance and Operations apps, both the released products and the non-released products.
[CDS released distinct products](includes/mapping-tables.md#213) | Product | The **Product** table contains the columns that define the product. It includes individual products (products with subtype product) and the product variants. The following table shows the mappings.
[Colors](includes/mapping-tables.md#170) | msdyn\_productcolors
[Configurations](includes/mapping-tables.md#171) | msdyn\_productconfigurations
[Default order settings](includes/mapping-tables.md#172) | msdyn_productdefaultordersettings |
[Product categories](includes/mapping-tables.md#166) | msdyn_productcategories | Each of the product categories and information about its structure and characteristics are contained in the product category table.
[Product category assignments](includes/mapping-tables.md#167) | msdyn_productcategoryassignments | To assign a product to a category the product category assignments table can be used.
[Product category hierarchies](includes/mapping-tables.md#168) | msdyn_productcategoryhierarchies | You use product hierarchies to categorize or group products. The category hierarchies are available in Dataverse using the Product category hierarchy table.
[Product category hierarchy roles](includes/mapping-tables.md#169) | msdyn_productcategoryhierarchyroles | Product hierarchies can be used for different roles in D365 Finance and Operations. They specify which category is used in each role the product category role table is used.
[Product default order settings V2](includes/mapping-tables.md#175) | msdyn_productspecificdefaultordersettings |
[Product dimension groups](includes/mapping-tables.md#173) | msdyn\_productdimensiongroups | The product dimension group defined which product dimensions define the product.
[Product master colors](includes/mapping-tables.md#187) | msdyn_sharedproductcolors | The **Shared product color** table indicates the colors that a specific product master can have. This concept is migrated to Dataverse to keep data consistent.
[Product master configurations](includes/mapping-tables.md#188) | msdyn_sharedproductconfigurations | The **Shared product configuration** table indicates the configurations that a specific product master can have. This concept is migrated to Dataverse to keep data consistent.
[Product master sizes](includes/mapping-tables.md#190) | msdyn_sharedproductsizes | The **Shared product size** table indicates the sizes that a specific product master can have. This concept is migrated to Dataverse to keep data consistent.
[Product master styles](includes/mapping-tables.md#191) | msdyn_sharedproductstyles | The **Shared product style** table indicates the styles that a specific product master can have. This concept is migrated to Dataverse to keep data consistent.
[Product Number Identified Barcode](includes/mapping-tables.md#164) | msdyn\_productbarcodes | Product bar codes are used to uniquely identify products.
[Product specific unit conversions](includes/mapping-tables.md#176) | msdyn_productspecificunitofmeasureconversions |
[Released products V2](includes/mapping-tables.md#189) | msdyn\_sharedproductdetails | The **msdyn\_sharedproductdetails** table contains the columns from Finance and Operations apps that define the product, and that contain the product's financial and management information.
[Sizes](includes/mapping-tables.md#174) | msdyn\_productsizes
[Storage dimension groups](includes/mapping-tables.md#177) | msdyn_productstoragedimensiongroups | The product storage dimension group represents the method used to define the placement the product in the warehouse.
[Styles](includes/mapping-tables.md#178) | msdyn\_productsytles
[Tracking dimension groups](includes/mapping-tables.md#179) | msdyn_producttrackingdimensiongroups | The product tracking dimension group represents the method used to track the product in inventory.
[Units](includes/mapping-tables.md#219) | uoms
[Unit conversions](includes/mapping-tables.md#199) | msdyn_ unitofmeasureconversions
...
---|---
[CDS released distinct products](includes/mapping-tables.md#213) | Product |
[Released products V2](includes/mapping-tables.md#189) | msdyn_sharedproductdetails |
[All products](includes/mapping-tables.md#138) | msdyn_globalproducts |
...
Finance and operations apps | Customer engagement apps |
---|---
[Product master colors](includes/mapping-tables.md#187) | msdyn_sharedproductcolors |
[Product master configurations](includes/mapping-tables.md#188) | msdyn_sharedproductconfigurations |
[Product master sizes](includes/mapping-tables.md#190) | msdyn_sharedproductsizes |
[Product master styles](includes/mapping-tables.md#191) | msdyn_sharedproductstyles |
[Product Number Identified Barcode](includes/mapping-tables.md#164) | msdyn\_productbarcodes |
...
Finance and operations apps | Customer engagement apps |
---|---
[Product dimension groups](includes/mapping-tables.md#173) | msdyn\_productdimensiongroups |
[Storage dimension groups](includes/mapping-tables.md#177) | msdyn_productstoragedimensiongroups |
[Tracking dimension groups](includes/mapping-tables.md#179) | msdyn_producttrackingdimensiongroups |

## Product hierarchies

Finance and operations apps | Customer engagement apps |
---|---
[Product category assignments](includes/mapping-tables.md#167) | msdyn_productcategoryassignments |
[Product category hierarchies](includes/mapping-tables.md#168) | msdyn_productcategoryhierarchies |
[Product category hierarchy roles](includes/mapping-tables.md#169) | msdyn_productcategoryhierarchyroles |
