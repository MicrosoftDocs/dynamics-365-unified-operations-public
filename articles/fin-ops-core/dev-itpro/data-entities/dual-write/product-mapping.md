...
[DV released distinct products](mapping-reference.md#242) | Product |  The **DV released distinct products** table is a simpler version of **CDS released distinct products** table. It contains only variant specific information, and relies on Dataverse plugins to set relevant product master information from **msdyn\_sharedproductdetails** to **Product**. Available in solution Dynamics 365 Supply Chain Extended v2.3.4.294
[DV released products](mapping-reference.md#243) | msdyn\_sharedproductdetails | The **DV released products** table is a simpler version of **Released products V2** table. It contains product master relevat information, and relies on Dataverse plugins to update relevant products from **msdyn\_sharedproductdetails** to **Product**. Available in solution Dynamics 365 Supply Chain Extended v2.3.4.294.
