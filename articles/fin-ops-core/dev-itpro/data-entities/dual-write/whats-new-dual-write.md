...
## June 2023 release
The June release of Dual-write GAB solution 3.5.1.91 contains the following bug fixes.

| Feature | Description | Status |
|---|---|---|
| Bug fix | CRM workflow perf fix to add additional check on update call|	General availability|
| Bug fix | Updates to the account entity during create by the CreateVendorsinVendorsTable workflow are causing performance issues.	|General availability|
