...
| Bug fix | Fixes issues where dual-write fails because of a mismatch between the plugin and the destination environments. | General availability |
| Bug fix | Support to ensure that unused plugins are deleted. | General availability |
