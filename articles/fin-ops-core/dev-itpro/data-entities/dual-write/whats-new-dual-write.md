...
| Unit conversions | 	When unit conversions occur in a Finance and Operations app at the quote line and order line, the model-driven app in Dynamics 365 honors the unit conversions and reflects the respective changes to unit and price in model-driven app quote detail and order detail. | General availability |
...
| No address duplication | Don’t duplicate an address in a Finance and Operations app when there's a create or update action on a model-driven app quote or order.  | General availability |
...
| Create sellable contracts | Allow creation of a sellable contact using the **Quick Create: Contact** form in model-driven apps. | General availability |
