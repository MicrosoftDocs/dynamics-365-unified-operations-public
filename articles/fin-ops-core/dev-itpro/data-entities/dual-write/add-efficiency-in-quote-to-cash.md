...
- The **Origin** tells which system originally created a quotation. Possible values are *Supply Chain Management* and *Dynamics 365 Sales*. <!-- KFM: Set on creation and always read-only? -->
...
## Example of an integrated sales quotation workflow
 ...
 <!-- KFM: These seems like just a more detailed version of the first scenario above. How is it different? Highlight this in the intro. -->
