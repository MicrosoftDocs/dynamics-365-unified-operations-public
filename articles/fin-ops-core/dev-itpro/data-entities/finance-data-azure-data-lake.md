...
| 401        | The table you added is not supported or missing in the database. | The table you added may be a special table such as an extended or a super type/ sub-type table which is not currently supported by the service. If this is the case, you can add the base table and create corresponding super type tables as views. For an example, in order to add DirPerson table, which is a super type table with this issue, you may add the DirPartyTable which is the underlying base table. <br> <br> It is also possible that a table once added  is no longer available in the database and the system can't continue updating data in the lake. The table may have been removed because of a software or database update. Contact your database administrator or a developer. If this table was developed by your partner or ISV, contact the developer.                 |
...
| 410        | Failed to find Application ID to access the Data lake. Application ID provided is incorrect or can't be found      | Application ID provided in the key vault can't be found in Azure active directory. Validate the Application ID provided in the key vault by following the documentation steps here:[Configure export to Azure Data Lake - Finance &Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#createapplication). You need to contact the systems administrator or the LCS administrator who configured the system |
| 411        | Failed to access data lake with given Application ID and Application secret | Application ID (app-id) and Application secret  (app-secret) provided can't be
used to access the storage account. Verify the Application ID and Application secret are valid by following documentation steps below: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \|MicrosoftDocs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#createapplication) <br><br> Next validate that the application has required access to the storage account [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \|MicrosoftDocs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#grantaccess)
You need to contact the systems administrator or the LCS administrator who configured the system |
| 413        | Failed to access the storage account using the storage name provided in the key vault | Storage account provided in the Key vault can't be found or is invalid. Validate that correct storage account name is entered into the key vault by using steps here: [Configure export to Azure Data Lake - Finance & Operations \Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#addsecrets) <br><br> Verify that you have provided the correct secret name for the storage account by using steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \|Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#addsecrets) |
| 430        | Failed to access the key vault or the key vault secrets | Service can't access the key vault or the secrets in the key vault.  Verify that your Azure subscription is not expired <br> <br> Verify that you have created the service principal by following steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#createServicePrincipal) <br> <br> Verify that the Key vault contains all the required secrets using the steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#addsecrets) <br> <br> Verify that you have provided the correct Key vault URI in the configuration steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#installaddin) |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
