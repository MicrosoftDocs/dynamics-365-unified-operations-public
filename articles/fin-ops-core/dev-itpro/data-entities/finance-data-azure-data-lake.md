...
---------------------------------------------------------
| 400  | The table you added does not contain a RecID field | Tables that do not contain a RecID field can't be added to the Data lake at this point in time. If this issue is coming from a table in Finance and Operations, contact Microsoft support. If this table was developed by your partner or ISV, contact the developer |
| 401  | Tbe table you added is missing in the database | The table you added is no longer available in the Finance and Operations database. The file may have been removed since it was added due to a software or database update. You should contact a DBA or a developer |
...
| 500  | Error encoutered in Data Feeds service | This is a system error. Deactivate and Activate the table. If the issue persists, you may contact Microsoft support |
| 501  | Error encountered in Data lake writer service | This is a system error. Deactivate and Activate the table. If the issue persists, you may contact Microsoft support |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
