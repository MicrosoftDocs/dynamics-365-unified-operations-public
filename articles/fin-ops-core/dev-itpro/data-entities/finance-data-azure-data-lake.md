...
| 410        | Failed to find Application ID to access the Data lake. Application ID provided is incorrect or can't be found      | Application ID provided in the key vault can't be found in Azure active directory. Validate the Application ID provided in the key vault by following the documentation steps here:[Configure export to Azure Data Lake - Finance &Operations](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#createapplication). You need to contact the systems administrator or the LCS administrator who configured the system |
