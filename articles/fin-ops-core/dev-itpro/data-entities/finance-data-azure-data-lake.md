...
| 410        | Failed to find Application ID to access the Data lake. Application ID provided is incorrect or can't be found      | Application ID provided in the key vault can't be found in Azure active directory. Validate the Application ID provided in the key vault by following the documentation steps [here](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#createapplication). You need to contact the systems administrator or the LCS administrator who configured the system |
...
used to access the storage account. Verify the Application ID and Application secret are valid by following documentation steps [here](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#createapplication) <br> Next validate that the application has required access to the storage account [Configure export to Azure Data Lake](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#grantaccess). You need to contact the systems administrator or the LCS administrator who configured the system |
| 413        | Failed to access the storage account using the storage name provided in the key vault | Storage account provided in the Key vault can't be found or is invalid. Validate that correct storage account name is entered into the key vault by using steps here: [Configure export to Azure Data Lake](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#addsecrets) <br> Verify that you have provided the correct secret name for the storage account by using steps here: [Configure export to Azure Data Lake](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#addsecrets) |
| 430        | Failed to access the key vault or the key vault secrets | Service can't access the key vault or the secrets in the key vault.  Verify that your Azure subscription is not expired <br> <br> Verify that you have created the service principal by following steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#createServicePrincipal) <br> <br> Verify that the Key vault contains all the required secrets using the steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#addsecrets) <br> Verify that you have provided the correct Key vault URI in the configuration steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#installaddin) |
| 428        | Failed to locate the Azure Tenant ID for the environment | Verify that you have provided the correct Azure tenant ID using the steps here: [Configure export to Azure Data Lake - Finance & Operations \| Dynamics 365 \|Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/configure-export-data-lake#installaddin)  |
| 426        | Failed to Failed to access the environment | Ensure that the environment is available and not in a deleted or inactive state  |
|------------|-----------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
