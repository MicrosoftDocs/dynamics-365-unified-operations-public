...
| Error code | Issue                                                                  | What you can do next                                                                                                                                                                                                                                                                                                                                                                     |
|------------|-----------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
Due to the error, the system has paused data export – data that exists in the lake won’t be updated until the error is resolved. You may Deactivate and Activate the table to see if the issue is resolved. Note that deactivating and activating the table may cause the system to re-initialize the data in the lake by taking a full copy. If the issue persists, you may contact Microsoft support with the Table name and the error code that you are seeing in the UI.

**Error status codes 8xx and 9xx indicates a change to the table or database structure since it was added**

| Error code | Issue                                                                                 | What you can do next                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|------------|---------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 800        | There is a change in the data table schema                                            | System found a change in the table structure when adding changed data to the lake. This is typically the result of a software update or a database modification in Finance and Operations. For an example, when a new field is added to a table, or a field is modified or removed, the data being updated in the lake may not be of the same format as existing data. Due to the error, the system has paused data export – data that exists in the lake won’t be updated until the error is resolved. You may Deactivate and Activate the table to see if the issue is resolved. Note that deactivating and activating the table may cause the system to re-initialize the data in the lake by taking a full copy. If this is a large table, initialize process may take some time. In the future, system may automatically update data in the lake to reflect table structure changes. |
| 801        | There is an issue with change Data Capture feature in Finance and Operations database | Export to Data lake feature uses Change Data Capture feature in Finance and Operations. Change data can’t be exported since the Change Data Capture feature is disabled in Finance and Operations database. This may be the result of a database maintenance operation in Finance and Operations. You may Deactivate and Activate the table to see if the issue is resolved. Note that deactivating and activating the table may cause the system to re-initialize the data in the lake by taking a full copy. If this is a large table, initialize process may take some time. In the future, system may automatically react to these issues. If the issue persists, contact Microsoft support.                                                                                                                                                                                          |
| 802        | There is an issue with Change Data capture feature for the table                      | Export to Data lake feature uses Change Data Capture feature in Finance and Operations. Change data can’t be exported since the Change Data Capture feature is disabled in for this table in Finance and Operations database. This may be the result of a database maintenance operation in Finance and Operations. You may Deactivate and Activate the table to see if the issue is resolved. Note that deactivating and activating the table may cause the system to re-initialize the data in the lake by taking a full copy. If this is a large table, initialize process may take some time. In the future, system may automatically react to these issues. If the issue persists, contact Microsoft support.                                                                                                                                                                        |
