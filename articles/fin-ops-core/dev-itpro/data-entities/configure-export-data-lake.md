...
3.  If this is the first time you are installing Add-ins in this environment, you may need to enable **Power platform integration**  for this environment. This is a one time operation to be performed by the LCS administrator. See the documentation here: [Add-ins overview - Finance & 
    Operations \| Dynamics 365 \| Microsoft Docs](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/power-platform/add-ins-overview). Also see the trouble-shooting section of the document for common issues.
4.  Select **Install a new add-in**, and in the dialog box, select **Export to Data lake** in the list. If **Export to data lake** isn't listed, the feature might not be available for your environment at this time.
