...
2. Select **+ New registration** at the top of the menu, and enter the following information:
    ...
    - Choose **Accounts in this Organizational directory only** unless your storage account and your Dynamics environment are in different Azure active directory domains
...
7. Select **Certificates & secrets** menu on the left navigation, and select **+ New client secret**.
