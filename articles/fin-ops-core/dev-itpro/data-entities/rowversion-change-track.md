...
| The count of data sources in a data entity must be below the threshold. | You will receive a warning when the data source count exceededs 5, and an error when it exceeded by 10. This limit helps improve performance. | Change tracking can't be enabled because the F&O entity %1 contains more than %2 data sources. |
