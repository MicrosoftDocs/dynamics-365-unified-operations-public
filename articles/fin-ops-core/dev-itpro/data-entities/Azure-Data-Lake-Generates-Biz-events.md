...
| Metadata changed (not yet implemented)  | Table metadata changed                           | TableName: string                    |
| Deactivated (not yet implemented)       | Table has been deactivated                       | TableName: string                    |
| Activated (not yet implemented)         | Table has been activated                         | TableName: string                    |
| Error  (not yet implemented)            | Service has paused due to an error               | TableName: string, StatusCode: int    |
