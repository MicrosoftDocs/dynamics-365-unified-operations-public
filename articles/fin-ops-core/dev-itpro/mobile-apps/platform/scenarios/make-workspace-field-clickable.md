...
:::image type="content" source="media/workspace-api/FieldAsURLOriginal.png" alt-text="Screenshot of the Customer details page before the changes are made.":::
...
1. Upload the updated business logic file by using the mobile app designer.
1. Update the workspace metadata in the mobile client.

The fields now appear as links.

:::image type="content" source="media/workspace-api/FieldAsURLFinal.png" alt-text="Screenshot of the Customer details page after the changes.":::
