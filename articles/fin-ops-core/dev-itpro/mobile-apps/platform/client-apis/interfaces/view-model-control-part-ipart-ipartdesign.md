...
description: Learn about the Part design object type, including the alignItems, alignSelf, allowScroll, background, bindings, border, color, and other properties.
author: jasongre
ms.author: jasongre
ms.topic: how-to
ms.date: 12/31/2024
...
[ContainerControlDesign](view-model-control-container-icontainercontrol-icontainercontroldesign.md) <br>&nbsp;&nbsp;&nbsp;└─ PartDesign <br>

## Index

### Properties

* [alignItems](view-model-control-part-ipart-ipartdesign.md#alignitems)
* [alignSelf](view-model-control-part-ipart-ipartdesign.md#alignself)
* [allowScroll](view-model-control-part-ipart-ipartdesign.md#allowscroll)
* [background](view-model-control-part-ipart-ipartdesign.md#background)
* [bindings](view-model-control-part-ipart-ipartdesign.md#bindings)
* [border](view-model-control-part-ipart-ipartdesign.md#border)
* [color](view-model-control-part-ipart-ipartdesign.md#color)
* [design](view-model-control-part-ipart-ipartdesign.md#design)
* [flexFlow](view-model-control-part-ipart-ipartdesign.md#flexflow)
* [flexSize](view-model-control-part-ipart-ipartdesign.md#flexsize)
* [fontSize](view-model-control-part-ipart-ipartdesign.md#fontsize)
* [fontWeight](view-model-control-part-ipart-ipartdesign.md#fontweight)
* [itemBorder](view-model-control-part-ipart-ipartdesign.md#itemborder)
* [items](view-model-control-part-ipart-ipartdesign.md#items)
* [justifyItems](view-model-control-part-ipart-ipartdesign.md#justifyitems)
* [label](view-model-control-part-ipart-ipartdesign.md#label)
* [labelPosition](view-model-control-part-ipart-ipartdesign.md#labelposition)
* [name](view-model-control-part-ipart-ipartdesign.md#name)
* [padding](view-model-control-part-ipart-ipartdesign.md#padding)
* [target](view-model-control-part-ipart-ipartdesign.md#target)
* [type](view-model-control-part-ipart-ipartdesign.md#type)
