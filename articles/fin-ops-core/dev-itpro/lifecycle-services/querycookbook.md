...
| Get throttle config | Yes | No longer applicable.</br><br>**Reason**</br><ul></br><li>Throttling at RG level is no longer applicable for elastic pool.</li></br></ul></br>**Details**</br><ul></br><li>This report is no longer applicable.</li></br></ul> |
...
| Drop index | Yes | No longer applicable. </br><br>**Reason**</br><ul></br><li>Not included in DAMS because of the periodic nature of Finance and Operations workloads.</li></br></ul></br>**Details**</br><ul></br><li>The system will automatically tune as required.</li></br></ul> |
