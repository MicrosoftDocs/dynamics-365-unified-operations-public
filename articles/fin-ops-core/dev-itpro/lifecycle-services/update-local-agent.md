...
| 2.7.2               | This version includes a fix for deploying older application versions. | October 2021 | 30th of June 2023 |
| 2.7.1               | This version introduces a new deployment option and fixes a bug with a deployment option. | October 2021 | 30th of June 2023 |
| 2.7.0               | Enables deploying or updating to 10.0.21 and later versions. Additionally, this version enables deploying on environments with Microsoft SQL Server 2019 and some bug fixes. | August 2021 | 30th of June 2023 |
...
| 1.0.0               | This version enables the [Reconfigure feature](../../dev-itpro/lifecycle-services/reconfigure-environment.md) for failed deployments. | October 2017 | 31st of January 2023 |
| Null                | This initial version deploys Platform update 8. | July 2017 | 31st of January 2023 |
