...
>[!IMPORTANT] Prospect projects is available only in Global LCS (https://lcs.dynamics.com). The preview license is not available in Local LCS. [Go here for more information about LCS in local geographies](../deployment/deployment-options-geo.md).
