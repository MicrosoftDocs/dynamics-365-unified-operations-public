---
title: What's new or changed in Lifecycle Services
description: Access links to the release plans, major announcements, and more for Microsoft Dynamics Lifecycle Services. 
author: laneswenka
ms.author: laswenka
ms.topic: whats-new
ms.date: 03/06/2026
...
Microsoft Dynamics Lifecycle Services provides a cloud-based collaborative workspace that customers and their partners can use to manage projects from pre-sales through implementation and operations. Lifecycle Services provides checklists and tools to help you manage your project, based on the phase of the project and the industry that you're working in. It also provides a dashboard, so that you have a single location where you can obtain up-to-date project information.

To get started with Lifecycle Services, see the [Lifecycle Services user guide](lcs-user-guide.md).

> [!IMPORTANT]
> Lifecycle Services features and service changes will no longer be announced via blog posts. Descriptions of Lifecycle Services features are provided in the [release plans](/dynamics365/release-plans/). 

The following sections list the features that are included in Lifecycle Services releases.
## June 2020 - wave 1
| Area | Feature |Status |
|------|---------|-------|
...
## Lifecycle Services releases before November 2019

For information about Lifecycle Services releases that occurred before November 2019, see the blog posts that the Lifecycle Services team published on the [Dynamics 365 blog](https://cloudblogs.microsoft.com/dynamics365/author/lifecycle-services-team/).
