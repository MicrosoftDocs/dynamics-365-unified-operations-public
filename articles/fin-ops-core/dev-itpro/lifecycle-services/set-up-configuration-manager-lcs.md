...
- A running version of AX 2012 R3 that you configured for your business. For more information about how to install AX 2012 R3, see [Install Microsoft Dynamics AX 2012](/dynamicsax-2012/appuser-itpro/install-microsoft-dynamics-ax-2012).
...
Complete the following procedure in the environment that you want to export a configuration from.

1.  Select **Data import export framework** &gt; **Setup** &gt; **Source data formats**.
1.  Select **New**, and name the source AX.
1.  Verify that the type is **AX.**
1.  Repeat this procedure in the environment that you want to import the configuration to.
...
1. Select **Data import export framework** &gt; **Setup** &gt; **Source data formats**.
1. Select **New**, and name the source CSV.
1. Verify that the type is **File**.
1. On the **General** tab, set the following values.
   ...
   | <strong>Multiple value separators</strong> |       ;        |

   :::image type="content" source="./media/dixfconfigurationmanager.png" alt-text="Screenshot of DIXF settings for Configuration manager.":::
...
1.  Select **Start** &gt; **Microsoft Dynamics AX Lifecycle Services Diagnostic Service Discovery**.
1.  In the **Environment Discovery** window, enter a name for the environment, and the fully qualified name of the Microsoft SQL Server instance and database. Then select Discover environment.
1.  After discovery is completed, enter the values in the **Configuration management (Beta)** section, select **Save**, and then select **Upload environment**.
    ...
    :::image type="content" source="./media/systemdiagnosticconfigurationmanagerdiscoverysettings.png" alt-text="Screenshot of System diagnostic discovery for Config manager.":::

1.  Repeat this procedure in the environment that you intend to import a configuration to.
