...
The following set of topics provide information that is related to service updates for Microsoft Dynamics 365 Finance version 8.1 (October 2018) and later. This is applicable for cloud releases only.
