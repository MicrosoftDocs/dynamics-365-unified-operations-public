...
Additionally, a notification email will be sent five days in advance, and a notification will appear in Lifecycle Services just before an update, as shown in the following illustration.

:::image type="content" source="./media/Notification-bar.png" alt-text="Screenshot of the Upcoming updates notification in Lifecycle Services.":::

## Update

After notifications have been sent, Microsoft will apply the update (**auto update**) during the designated maintenance window. After this operation is completed, a notification email will be sent to indicate the status of the update. Customers will also be able to **self-update** by using the standard update experience in Lifecycle Services. For more information, see [Apply updates to cloud environments](../deployment/apply-deployable-package-system.md). 
...
Customers will also be able to **self-update** by using the standard update experience in Lifecycle Services, as shown in the following illustration.

:::image type="content" source="./media/Self-Update-Execute.jpg" alt-text="Screenshot of the Apply updates command on the Maintain menu in Lifecycle Services.":::
...
:::image type="content" source="./media/TestAutomation.png" alt-text="Screenshot of the Regression Suite Automation Tool.":::
