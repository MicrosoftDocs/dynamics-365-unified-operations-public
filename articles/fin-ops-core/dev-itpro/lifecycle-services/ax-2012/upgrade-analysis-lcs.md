...
For in-place upgrades, you must upload a model store that you have exported as a zip file. Before you begin, follow the steps in the [Before you begin](/dynamicsax-2012/appuser-itpro/scenario-perform-in-place-upgrade-to-ax-2012-r2-or-ax-2012-r3#Prerequisites) section of the [Scenario: Perform in-place upgrade to AX 2012 R2 or AX 2012 R3](/dynamicsax-2012/appuser-itpro/scenario-perform-in-place-upgrade-to-ax-2012-r2-or-ax-2012-r3) topic.

### Export and zip your model store

1.  Use Microsoft Windows PowerShell or the AxUtil command-line utility to export the model store from the system that you plan to upgrade. For details, see [How to: Export and Import a Model Store](/dynamicsax-2012/developer/how-to-export-and-import-a-model-store).
...
[Upgrading to a new version of Microsoft Dynamics AX](/dynamicsax-2012/developer/upgrading-to-a-new-version-of-microsoft-dynamics-ax)

[Scenario: Perform in-place upgrade to AX 2012 R2 or AX 2012 R3](/dynamicsax-2012/appuser-itpro/scenario-perform-in-place-upgrade-to-ax-2012-r2-or-ax-2012-r3)
