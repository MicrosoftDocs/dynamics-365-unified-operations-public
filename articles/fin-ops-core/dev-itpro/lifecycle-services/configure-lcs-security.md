...
> [!IMPORTANT]
> Manage all users within your company at the organization level. You help ensure that users can access the benefits that are available to your organization.
...
1. Add your users to the appropriate projects in Lifecycle Services.

### Invite a user to a Lifecycle Services project

1. Sign in to [Lifecycle Services](https://lcs.dynamics.com/).
1. Select the project to add the user to.
1. Select **Project users** on the hamburger menu or the **Project users** tile. On the **Project users** page, select the plus sign (**+**).
1. Enter the user's email address, select the correct security role, and then select **Invite**.

> [!NOTE]
> For implementation projects, you can select the implementation role for the invited user. If you set **Allow FastTrack to contact** to **Yes**, then Microsoft FastTrack team might reach out to you based on your implementation role and the stages of the implementation project.

## Configuring project security

Invite users from inside or outside your organization to join your project. The following table describes the roles that are available for users.
...
If you have an implementation project, you can specify project user's implementation roles. For more information, see [Roles in a Dynamics 365 implementation](/training/modules/get-started-implementation-project/01-2-roles).
