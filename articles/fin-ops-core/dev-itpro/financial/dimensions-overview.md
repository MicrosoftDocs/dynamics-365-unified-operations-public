...
After installation, the only value present on Microsoft Excel templates is the MainAccount. This dimension is the only one that all customers have. To add dimensions to Microsoft Excel templates, complete the following steps:
