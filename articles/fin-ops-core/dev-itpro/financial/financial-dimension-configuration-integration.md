...
This article describes the financial dimension configuration. Two important areas require setup: 
...
>[!NOTE]
>To see the changes in the financial reports, you need to reset the Data Mart. 
...
Let's look at some examples that show how the dimension formats work. Use the ledger dimension format for these examples.
...
For the first row of the import file, because you define only three segments, the Customer segment is blank or uses a dash: **Main account == 605140** **Department == 001** **Cost Center == 02** **Customer == blank**. 
