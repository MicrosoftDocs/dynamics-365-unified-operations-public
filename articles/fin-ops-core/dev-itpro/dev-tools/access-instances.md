...
This is only possible if you lower a user's security role in the project to *Project team member role* and it is not possible to hide it for the *Environment manager*, or *Project owner* roles.
