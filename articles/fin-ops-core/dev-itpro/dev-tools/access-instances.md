...
1. Go to your LCS project navigation menu, and select **Cloud-hosted environments**
2. Highlight the environment you wish to remove and click **Deallocate**.  This will power the machine down in your Azure subscription.
3. After the deallocation is successful, the environment will be in Deallocated state.  You may now use the **Delete** button to start the deletion process.
