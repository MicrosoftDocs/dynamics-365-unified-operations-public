...
> - For cloud-hosted environments older than 6 months, it is advisable to review the supported software list on the [Microsoft Dynamics 365 Finance + Operations supported software](../deployment/onprem-compatibility.md) page.
