...
:::image type="content" source="./media/messaging_messagebartypes.jpg" alt-text="Screenshot of message bars.":::
...
:::image type="content" source="./media/messaging_boxapi.jpg" alt-text="Screenshot of an example error message.":::
...
:::image type="content" source="./media/messaging_boxapi.jpg" alt-text="Screenshot of an example of the Box API.":::
...
:::image type="content" source="./media/messaging_messagedetailsmessagebar.jpg" alt-text="Screenshot of an example of an info type message bar.":::

If the collection contains one or more calls to **warning()**, the message bar is of the **warning** type.

:::image type="content" source="./media/messaging_messagedetailswarningmessagebar.jpg" alt-text="Screenshot of an example of a warning type message bar.":::

If the collection contains one or more calls to **error()**, the message bar is of the **error** type.

:::image type="content" source="./media/messaging_messagedetailserrormessagebar.jpg" alt-text="Screenshot of an example of an error type message bar.":::
