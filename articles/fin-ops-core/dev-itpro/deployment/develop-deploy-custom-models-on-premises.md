...
1. Upload the deployable package to your project in Microsoft Dynamics Lifecycle Services.
...
You can use an on-premises Lifecycle Services project to deploy build and development environments on Microsoft Azure by using your own Azure subscription. Alternatively, you can download a virtual hard disk (VHD) for local development.

To deploy a development or build environment in your Azure subscription, or to download a development VHD, open the **Cloud-hosted environments** page in Lifecycle Services.
...
When your deployable package is ready, follow these steps to upload it to your Lifecycle Services project's Asset library.
...
1. In your Lifecycle Services project, select **Configure** to deploy your environment.
