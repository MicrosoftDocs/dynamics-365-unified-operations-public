...
3. On the **Distribution schedule** page, run job **1070** (**Channel configuration job**) and **1110** (**Global configuration**) by selecting **Run now** for each job. (For asynchronous processing, select **Create batch job** instead of **Run now**.) After the jobs are completed, your channels have been migrated to the new CSU.
