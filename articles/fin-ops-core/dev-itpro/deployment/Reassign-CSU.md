...
> [!IMPORTANT]
> Migrating channels to a different CSU is not supported if your environment uses a Commerce Globalization solution. Migration may cause data corruption and regulatory compliance issues. Contact Microsoft Support before you attempt to migrate.
