...
Having localized Lifecycle Services in a local datacenter means that some features aren't available, such as the Global Lifecycle. If you are interested in local deployment to a specific region, reach out to your Microsoft contact to understand the process and limitations.
