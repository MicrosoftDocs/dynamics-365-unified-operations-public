...
- If you've deployed reports and customized them in Power BI, you can use [Resolve Issues with Power BI](/dynamics365/fin-ops-core//analytics/entity-store-maintenance) to republish your reports post-migration. Note that customizations cannot be automatically restored after republishing and must be redone manually.
