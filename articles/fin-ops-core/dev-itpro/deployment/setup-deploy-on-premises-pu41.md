...
| AOS       | SNAC – ODBC driver 17.5.x | [ODBC driver 17.5.2](/sql/connect/odbc/windows/release-notes-odbc-sql-server-windows) |
...
| AOS       | SQL Server Management Studio 17.9.1 | [SSMS 17.9.1](/sql/ssms/release-notes-ssms) |
...
| BI        | SQL Server Management Studio 17.9.1 | [SSMS 17.9.1](/sql/ssms/release-notes-ssms) |
...
2. Download the following Microsoft Windows Installers (MSIs) into a file share that is accessible by all VMs.
    ...
    | SNAC – ODBC driver 17.5.x | [ODBC Driver 17.5.2](/sql/connect/odbc/windows/release-notes-odbc-sql-server-windows) | msodbcsql\_17.msi |
    | SQL Server Management Studio 17.9.1 | [SSMS 17.9.1](/sql/ssms/release-notes-ssms) | SSMS-Setup-\*.exe |
