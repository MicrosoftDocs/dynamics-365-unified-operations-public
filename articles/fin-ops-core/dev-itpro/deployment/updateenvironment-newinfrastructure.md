...
5. Select **Apply**.
    ...
    The status in the upper-right corner of the environment details page changes from **Queued** to **Servicing** and then **Post-servicing** and when package application is completed, the status changes to **Deployed**.
