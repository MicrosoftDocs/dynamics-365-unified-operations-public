...
Microsoft created a configuration file for Logstash "logstash-dyn365finops.conf" available in the [LCS Shared Asset Library, under the Model asset type in zipped file "LBD Diagnostic configurations"](https://lcs.dynamics.com/V2/SharedAssetLibrary). Download, extract and put it in C:\\ELK\\Logstash\\6.2.4\\config. This file performs useful transformations on diagnostics.
