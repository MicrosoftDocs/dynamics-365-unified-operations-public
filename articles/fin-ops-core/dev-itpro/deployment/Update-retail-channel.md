...
1. If the latest Quality Update is not yet available in the Service Update, wait up to three business days and try again. If the issue persists, you may want to file a support request.
...
> [!NOTE]
> Auto-update for CSU is being gradually rolled out to all Commerce customers. If you are a Lifecycle Services project owner or environment administrator, you'll recieve an email notification when CSU auto-update is rolled out to your Lifecycle Services project.

When CSU is auto-updated by Microsoft, it takes place in the following sequence.

:::image type="content" source="./media/CSU-auto-update-timeline.png" alt-text="Screenshot of the CSU auto-update sequence timeline.":::
