...
Client plugins involve invoking client code in the finance and operations client. See [Create client plugins](copilot-client-plugins.md) for more information on creating client plugins for Copilot in finance and operations.
