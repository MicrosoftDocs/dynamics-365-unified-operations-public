...
| All finance and operations apps | Follow-up questions in the Copilot sidecar | [Enable generative help and guidance with Copilot](enable-copliot-generative-help.md). |
