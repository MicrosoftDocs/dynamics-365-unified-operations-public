...
> [!Note]
> If a virtual entity already exists in Dataverse and if a solution is being imported which now references new fields in the virtual entity which does not exist in Dataverse, a manual refresh must be performed on the virtual entity to get the latest metadata from Finance and Operations.
