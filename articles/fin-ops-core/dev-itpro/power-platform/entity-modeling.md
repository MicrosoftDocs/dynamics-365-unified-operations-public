...
Fields of data type *real* and *long* in Finance and Operations are modelled as data type *decimal* in Common Data Service. Due to the mismatch in precision and scale between the two data types, the following behavior must be considered.
