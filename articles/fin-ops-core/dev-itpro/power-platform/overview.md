...
Core HR entities can also be virtualized like F&O entities. For more information, see [Core HR VE](https://docs.microsoft.com/en-us/dynamics365/human-resources/hr-admin-integration-common-data-service-virtual-entities).
