...
To understand the core concepts of Power Platform Integration and a detailed list of supported scenarios, visit [Environment lifecycle operations - Core concepts](./environment-lifecycle-core-concepts.md).
