...
> [!IMPORTANT]
> This functionality requires Platform update 36 for Finance and Operations while, service update 189 is needed for Common Data Service. The release information for Common Data Service is published on the [latest version availability page](https://docs.microsoft.com/business-applications-release-notes/dynamics/released-versions/dynamics-365ce#all-version-availability).
