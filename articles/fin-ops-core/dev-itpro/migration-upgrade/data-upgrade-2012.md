...
> [!Note]
> Developer environments hosted by Microsoft have limited drive space.  For most AX 2012 customers, it is recommended to host your own developer environment via [Cloud-hosted enviormments](../dev-tools/access-instances.md) where you can increase the drive space to your own specifications.  
