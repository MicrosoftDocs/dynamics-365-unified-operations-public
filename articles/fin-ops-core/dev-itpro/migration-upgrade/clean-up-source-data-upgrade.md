...
In Microsoft Dynamics AX 2012, cleanup routines are available in various modules. The following provides an overview of the routines that are currently available, to assist you in data cleanup prior to the upgrade. The information is organized by module.
...
| Inventory management \> Periodic tasks \> Clean up \> Inventory journals cleanup | <p>This cleanup routine is used to delete posted inventory journals.</p><p>Main Article: [Link](/dynamicsax-2012/appuser-itpro/delete-posted-inventory-journals)</p> |
