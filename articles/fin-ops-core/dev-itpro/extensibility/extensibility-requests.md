...
:::image type="content" source="media/extensibility-work-items.jpg" alt-text="Screenshot of extensibility support requests.":::
...
:::image type="content" source="media/extensibility-options.png" alt-text="Screenshot of maintain extensibility support options.":::
...
:::image type="content" source="media/create-extensibility-request.png" alt-text="Screenshot of create extensibility support request.":::
