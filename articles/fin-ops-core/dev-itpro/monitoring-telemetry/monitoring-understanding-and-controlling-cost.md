...
- **[Workspace-based resources](/azure/azure-monitor/best-practices-cost)** – Use workspace-based Application Insights resources to take advantage of cost-saving features such as Basic Logs and commitment tiers.
...
By implementing the strategies described in this article and adhering to best practices, you can effectively control telemetry costs in [!INCLUDE[finops-product-name-short](includes/finops-product-name-short.md)] and maintain comprehensive monitoring capabilities.
