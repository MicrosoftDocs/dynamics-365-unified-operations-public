...
description: This article explains how to extend the list of ER destinations that store documents that are generated by Electronic reporting (ER) formats.
author: NickSelin
ms.date: 03/29/2021
ms.topic: article
ms.prod: 
