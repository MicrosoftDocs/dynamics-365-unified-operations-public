...
- You can use the reporting units that are defined in your financial data system to add reporting units to the reporting tree definition. Organizational hierarchies can also be selected as an option in tree types. For more information, see [Organizations and organizational hierarchies overview](../../fin-ops/organization-administration/organizations-organizational-heirarchies.md#organizational-heirarchies). 
