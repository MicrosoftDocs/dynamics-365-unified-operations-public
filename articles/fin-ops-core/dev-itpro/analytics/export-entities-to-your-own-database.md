...
> [!NOTE]
> Your BYOD database must be accessible to F&O and hence, if you encounter errors about F&O not able to access BYOD, you must ensure firewall rules in your BYOD are configured appropriately.
