...
> The use of performance tier of SQL Azure is recommended. More details on the tiers is explained in [SQL Azure tiers](https://docs.microsoft.com/en-us/azure/azure-sql/database/service-tiers-dtu).
