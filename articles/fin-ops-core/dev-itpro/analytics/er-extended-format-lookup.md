...
Usually, you must specify what ER format to use in a certain business process. To do that, select a single ER format in a lookup field configured as part of business process-specific parameters. Use the appropriate API of the ER framework to implement these lookup fields. For more information, see [ER framework API - code to display a format mapping lookup](er-apis-app73.md#code-to-display-a-format-mapping-lookup).
...
:::image type="content" source="./media/ER-ExtLookup-Lookup1.gif" alt-text="Screenshot of Foreign trade parameters page showing empty Report format mapping field." lightbox="./media/ER-ExtLookup-Lookup1.gif":::
...
:::image type="content" source="./media/ER-ExtLookup-Lookup2.png" alt-text="Screenshot of Foreign trade parameters page showing Report format mapping field with options." lightbox="./media/ER-ExtLookup-Lookup2.png":::
...
:::image type="content" source="./media/ER-ExtLookup-Lookup3.png" alt-text="Screenshot of Foreign trade parameters page showing Import from Global repository FastTab." lightbox="./media/ER-ExtLookup-Lookup3.png":::
...
:::image type="content" source="./media/ER-ExtLookup-FormatImport.png" alt-text="Screenshot of Foreign trade parameters page showing Processing operation note." lightbox="./media/ER-ExtLookup-FormatImport.png":::
...
:::image type="content" source="./media/ER-ExtLookup-RepoSignUp.png" alt-text="Screenshot of Foreign trade parameters page showing link to sign up for RCS." lightbox="./media/ER-ExtLookup-RepoSignUp.png":::

By default, the **Import from Global repository** FastTab presents the list of ER formats from the temporary storage that is automatically created based on the GR content for performance improvements. This happens when the **Import from Global repository** FastTab is opened the first time, which might take several seconds.
...
:::image type="content" source="./media/ER-ExtLookup-FeatureMngt.png" alt-text="Screenshot of Feature management page." lightbox="./media/ER-ExtLookup-FeatureMngt.png":::
...
The following screenshot shows how to grant this privilege to users who are assigned to the **Accountant** role. This role allows users to configure foreign trade parameters and set up references to the ER formats in the **File format mapping** and **Report format mapping** fields on the **Foreign trade parameters** page.

:::image type="content" source="./media/ER-ExtLookup-SecuritySetting.png" alt-text="Screenshot of Security configuration page." lightbox="./media/ER-ExtLookup-SecuritySetting.png":::
