...
1. On the **Configurations** page, in the configuration tree in the left pane, expand **Intrastat model**, and select **Intrastat report**. Litware, Inc. will use version 1.9 of this ER format configuration as the base for the custom version.
1. Select **Create configuration** to open the drop-down dialog box. You can use this dialog box to create a new configuration for a custom payment format.
1. In the **New** field group, select **Derive from Name: Intrastat report, Microsoft**.
1. In the **Name** field, enter **Intrastat report Litware**.
1. Select **Create configuration** to create the new format.
...
1. In the configuration tree in the left pane, select **Intrastat report Litware**.
1. Set the **Run Draft** option to **Yes** and then select **Save**.

    :::image type="content" source="./media/er-paginate-excel-reports-derived-format-configuration.png" alt-text="Screenshot of the Run Draft option on the Configurations page.":::
...
1. On the **Foreign trade parameters** page, on the **Electronic reporting** FastTab, in the **File format mapping** field, select **Intrastat report Litware**.
1. In the **Report format mapping** field, select **Intrastat report Litware**.
1. Select **Save**.
...
1. Verify that the template contains named ranges to create report header, report details, and report footer sections in generated documents.

    :::image type="content" source="./media/er-paginate-excel-reports-template1.gif" alt-text="Screenshot of the layout of Excel template 1 in the desktop application.":::
...
1. Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.
1. On the **Configurations** page, in the configuration tree in the left pane, expand **Intrastat model** \> **Intrastat report**, and select the **Intrastat report Litware** configuration.
1. Select **Designer**.
1. On the **Format designer** page, on the Action Pane, select **Show details**.
1. Make sure that the **Intrastat: Excel** root format component is selected, and then, on the Action Pane, on the **Import** tab, in the **Import** group, select **Update from Excel**.
1. In the **Update from Excel** dialog box, select **Update template**.
1. In the **Open** dialog box, browse to and select the **ERIntrastatReportDemo1.xlsx** file that you downloaded earlier, and then select **Open**.
1. Select **OK**.
1. Select **Save**.

:::image type="content" source="./media/er-paginate-excel-reports-format1.png" alt-text="Screenshot of the format structure in the ER format designer after the new Excel template is added.":::
...
1. Expand **Intrastat** \> **Report lines**, and select the **Commodity code** component.
1. Select **Edit formula**.
1. Change the binding formula from `@.CommodityCode` to `CONCATENATE(@.CommodityCode, " ", @.ProductName)`.
1. Select **Save**.

:::image type="content" source="./media/er-paginate-excel-reports-format1a.png" alt-text="Screenshot of the configured binding for showing the item description in the ER format designer.":::
...
:::image type="content" source="./media/er-paginate-excel-reports-transactions1.gif" alt-text="Screenshot of transactions on the Intrastat page.":::

Then use the custom ER format to generate the control report of the Intrastat declaration.

1. Go to **Tax** \> **Declarations** \> **Foreign trade** \> **Intrastat**.
1. On the **Intrastat** page, on the Action Pane, select **Output** \> **Report**.
1. In the **Intrastat Report** dialog box, follow these steps to run the report:

    1. Set the **From date** and **To date** fields to include specific Intrastat transactions to the report.
    1. Set the **Generate file** option to **No**.
    1. Set the **Generate report** option to **Yes**.
    1. Select **OK**.

1. Download and save the document that is generated.
1. Open the document in Excel, and review it.

    :::image type="content" source="./media/er-paginate-excel-reports-document1.png" alt-text="Screenshot of the generated Excel document in the desktop application.":::
...
1. Compare this template with the **ERIntrastatReportDemo1.xlsx** template, and verify that it contains several new Excel names to create and fill in page-specific sections in generated documents:
    ...
    :::image type="content" source="./media/er-paginate-excel-reports-template2a.gif" alt-text="Screenshot of the layout of Excel template 2 in the desktop application.":::
    ...
    :::image type="content" source="./media/er-paginate-excel-reports-template2b.gif" alt-text="Screenshot of the CommodityCode cell configured to wrap cell text.":::
...
1. On the **Format designer** page, expand **Intrastat**.
1. Name the [Range](er-fillable-excel.md#range-component) format components that have been added to the editable ER format to sync the structure with the structure of the applied Excel template:

    1. Select the **Range** component that is associated with the Excel name **ReportPageHeader**.
    1. On the **Format** tab, in the **Name** field, enter **Report page header**.
    1. Select the **Range** component that is associated with the Excel name **ReportPageFooter**.
    1. On the **Format** tab, in the **Name** field, enter **Report page footer**.

1. Select **Save**.

:::image type="content" source="./media/er-paginate-excel-reports-format2.png" alt-text="Screenshot of the format structure in the ER format designer after the Excel template is replaced.":::
...
1. Select **Add**.
1. In the **Add** dialog box, select the [Page](er-fillable-excel.md#page-component) component in the **Excel** group of components.
1. In the **Component properties** dialog box, in the **Name** field, enter **Report page**. Then select **OK**.
1. To use the **Report page header** component as a page header on every generated page, follow these steps:

    1. Select the **Report page header** component, and then select **Cut**.
    1. Select the **Report page** component, and then select **Paste**.
    1. Expand **Report page**.
    1. To force the **Page** component to [consider](er-fillable-excel.md#page-component-structure) this range a page header, select **Report page header**, and then, on the **Format** tab, in the **Replication direction** field, select **No replication**.

1. To paginate a generated document so that the content on report lines is considered, follow these steps:

    1. Select the **Report lines** component, and then select **Cut**.
    1. Select the **Report page** component, and then select **Paste**.

1. To include the report footer after report lines but before the final page footer, follow these steps:

    1. Select the **Report footer** component, and then select **Cut**.
    1. Select the **Report page** component, and then select **Paste**.

1. To use the **Report page footer** component as a page footer on every generated page, follow these steps:

    1. Select the **Report page footer** component, and then select **Cut**.
    1. Select the **Report page** component, and then select **Paste**.
    1. To force the **Page** component to [consider](er-fillable-excel.md#page-component-structure) this range a page footer, select **Report page footer**, and then, on the **Format** tab, in the **Replication direction** field, select **No replication**.

:::image type="content" source="./media/er-paginate-excel-reports-format3.png" alt-text="Screenshot of the format structure in the ER format designer after document pagination is implemented.":::
...
1. On the **Format designer** page, select the **Mapping** tab.
1. Select **Add root**, and then follow these steps:

    1. In the **Add data source** dialog box, in the **General** section, select **Empty container**.
    1. In the **'Empty container' data source properties** dialog box, in the **Name** field, enter **Total**.
    1. Select **OK**.

1. Select the **Total** data source, select **Add**, and then follow these steps:

    1. In the **Add data source** dialog box, in the **General** section, select **Empty container**.
    1. In the **'Empty container' data source properties** dialog box, in the **Name** field, enter **Page**.
    1. Select **OK**.

1. Select **Add** again, and then follow these steps:

    1. In the **Add data source** dialog box, in the **General** section, select **Empty container**.
    1. In the **'Empty container' data source properties** dialog box, in the **Name** field, enter **Running**.
    1. Select **OK**.

1. Select the **Total.Page** data source, select **Add**, and then follow these steps:

    1. In the **Add data source** dialog box, in the **Functions** section, select **Data collection**.
    1. In the **'Data collection' data source properties** dialog box, in the **Name** field, enter **Amount**.
    1. In the **Item type** field, select **Real**.
    1. Set the **Collect all values** option to **Yes**.
    1. Select **OK**.

1. Select **Add** again, and then follow these steps:

    1. In the **Add data source** dialog box, in the **Functions** section, select **Data collection**.
    1. In the **'Data collection' data source properties** dialog box, in the **Name** field, enter **Weight**.
    1. In the **Item type** field, select **Real**.
    1. Set the **Collect all values** option to **Yes**.
    1. Select **OK**.

1. Select the **Total.Running** data source, select **Add**, and then follow these steps:

    1. In the **Add data source** dialog box, in the **Functions** section, select **Data collection**.
    1. In the **'Data collection' data source properties** dialog box, in the **Name** field, enter **Amount**.
    1. In the **Item type** field, select **Real**.
    1. Set the **Collect all values** field to **Yes**.
    1. Select **OK**.
...
1. Select **Add** again, and then follow these steps:
    ...
    1. In the **Add data source** dialog box, in the **Functions** section, select **Data collection**.
    1. In the **'Data collection' data source properties** dialog box, in the **Name** field, enter **Lines**.
...
1. On the **Format designer** page, select the **Mapping** tab.
1. Select the **Total.Running** data source, select **Add**.
1. In the **Add data source** dialog box, in the **Functions** section, select **Data collection**.
1. In the **'Data collection' data source properties** dialog box, in the **Name** field, enter **Lines2**.
1. In the **Item type** field, select **Integer**.
1. Set the **Collect all values** option to **Yes**.
1. Select **OK**.
1. Select **Save**.

:::image type="content" source="./media/er-paginate-excel-reports-format4.png" alt-text="Screenshot of the added data sources in the ER format designer.":::
...
1. Select **Edit formula**.
1. Change the binding formula from `NUMBERVALUE(NUMBERFORMAT(@.InvoiceValue, "F"&TEXT(model.Parameters.IntrastatAmountDecimals)), ".", "")` to `Total.Page.Amount.Collect(NUMBERVALUE(NUMBERFORMAT(@.InvoiceValue, "F"&TEXT(model.Parameters.IntrastatAmountDecimals)), ".", ""))`.
...
1. Select the nested **Weight** component.
1. Select **Edit formula**.
1. Change the binding formula from `@.'$RoundedWeight'` to `Total.Page.Weight.Collect(@.'$RoundedWeight')`.
...
:::image type="content" source="./media/er-paginate-excel-reports-format5.png" alt-text="Screenshot of the configured bindings for collecting total values in the ER format designer.":::
...
1. On the **Format designer** page, in the format tree, expand the **Report page footer** component, select the nested **Range** component that refers to the Excel **ReportPageFooter\_PageAmount** cell, and then follow these steps:
    ...
    1. Select **Bind**.
    1. Select **Edit formula**.
    1. Update the formula to `Total.Page.Amount.Sum(false)`.
...
1. In the format tree, select the nested **Range** component that refers to the Excel **ReportPageFooter\_PageWeight** cell, and then follow these steps:

    1. In the data sources tree in the right pane, select the **Total.Page.Weight.Sum()** item.
    1. Select **Bind**.
    1. Select **Edit formula**.
    1. Update the formula to `Total.Page.Weight.Sum(false)`.
...
1. On the **Format designer** page, in the format tree, expand the **Report page footer** component, select the nested **Range** component that refers to the Excel **ReportPageFooter\_RunningTotalAmount** cell, and then follow these steps:
    ...
    1. Select **Bind**.
    1. Select **Edit formula**.
    1. Update the formula to `Total.Running.Amount.Sum(false)+Total.Running.Amount.Collect(Total.Page.Amount.Sum(true))`.
...
1. In the format tree, select the nested **Range** component that refers to the Excel **ReportPageFooter\_RunningTotalWeight** cell, and then follow these steps:

    1. In the data sources tree in the right pane, select **Total.Running.Weight.Collect()** item.
    1. Select **Bind**.
    1. Select **Edit formula**.
    1. Update the formula to `Total.Running.Weight.Sum(false)+Total.Running.Weight.Collect(Total.Page.Weight.Sum(true))`.
...
1. Select **Edit formula**.
1. Add the formula `Total.Running.Lines.Collect(COUNT(Total.Page.Amount.Result))`.
...
1. Select **Edit formula**.
1. Add the formula `COUNT(Total.Page.Amount.Result)-Total.Running.Lines.Sum(false)`.
...
:::image type="content" source="./media/er-paginate-excel-reports-format6.png" alt-text="Screenshot of the configured bindings for filling in the page footer counter in the ER format designer.":::
...
1. On the **Format designer** page, in the format tree, expand the **Report page** component, select the nested **Report page header** component, and then follow these steps:
    ...
    1. On the **Formula designer** page, in the **Formula** field, enter the following expression:
...
1. In the format tree, select the nested **Report page footer** component, and then follow these steps:
...
1. Make sure that you have 24 transactions on the **Intrastat** page. Repeat the steps in the [Generate an Intrastat declaration control report](#generate-intrastat-control-report) section of this article to generate and review the control report.
    ...
    :::image type="content" source="./media/er-paginate-excel-reports-document2.gif" alt-text="Screenshot of the generated Excel document in desktop application.":::

1. Update two transactions on the **Intrastat** page by changing the **Item number** code from **D00006** to **L0010**. Notice that the product name of the new item, **Active stereo speaker pair**, is longer than the product name of the original item, **Standard speaker**. This situation forces text wrapping in the corresponding cell of the generated document. Document pagination, and page-related summing and counting, must now be updated. Repeat the steps in the [Generate an Intrastat declaration control report](#generate-intrastat-control-report) section to generate and review the control report.
    ...
    :::image type="content" source="./media/er-paginate-excel-reports-document3.gif" alt-text="Screenshot of the updated generated Excel document in the desktop application.":::
