...
> [!NOTE]
> Starting from version 10.0.21 **Office-like UI experience for Business document management** feature became mandatory, i.e., <ins>[**turned on**](#UIturnedOn)</ins> by default without possibility of turning it off. Starting from version 10.0.32 the feature has been eliminated.
