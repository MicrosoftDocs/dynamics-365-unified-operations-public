...
To turn on this feature for all legal entities follow these steps:
...
To create a new provider, on the **Configuration provider** dialog, follow these steps:
...
To activate a provider, on the **Configuration provider** dialog, follow these steps:
...
To upload a template from the Global repository, follow these steps:
