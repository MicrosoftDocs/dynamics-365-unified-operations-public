...
## Prerequisites
The **Warehouse performance** Power BI content only shows data for the dates defined on the **Date dimensions** page (**Organization administration** \> **Setup** \> **Calendars** \> **Date dimensions**). For more information, see [How to: Create a Date Dimension for a Cube](https://learn.microsoft.com/en-us/dynamicsax-2012/appuser-itpro/how-to-create-a-date-dimension-for-a-cube).
