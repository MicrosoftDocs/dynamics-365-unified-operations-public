...
## Prerequisites
The **Warehouse performance** Power BI content will only show data for the dates defined in the **Date dimensions** form (**Organization administration** \> **Setup** \> **Calendars** \> **Date dimensions**). See details in the [How to: Create a Date Dimension for a Cube](https://learn.microsoft.com/en-us/dynamicsax-2012/appuser-itpro/how-to-create-a-date-dimension-for-a-cube) page.
