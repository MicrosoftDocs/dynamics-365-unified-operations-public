...
- Create a [custom (derived)](general-electronic-reporting.md#building-a-format-by-selecting-another-format-as-a-base-customization) version of a standard ER format configuration that is provided by Microsoft.
