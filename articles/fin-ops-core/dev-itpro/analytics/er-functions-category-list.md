...
| [ListJoin](er-functions-list-listjoin.md)                 | This function returns a *Record list* value representing a new joined list that is created from the specified arguments.|
