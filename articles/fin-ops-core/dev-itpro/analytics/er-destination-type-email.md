...
The message body of your email is composed in TEXT or HTML depending on the email client. You can use any layout, styling, and branding that HTML and inline Cascading Style Sheets (CSS) allow. 
...
> [!NOTE]
> Use proper encoding to implement a carriage return depending on body formatting. For more information, see the definition of the [String](er-formula-supported-data-types-primitive.md#string) data type.
