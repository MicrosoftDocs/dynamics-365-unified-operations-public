...
description: Learn how to validate Electronic reporting (ER) configuration versions.
author: liza-golub
ms.author: egolub
ms.topic: how-to
ms.date: 07/17/2026
...
Those sections explain the types of components that ER provides inspections for and how you can reconfigure ER components to help prevent issues.
...
:::image type="content" source="./media/er-components-inspections-11e.png" alt-text="Screenshot of running the editable format on the Format designer page.":::
