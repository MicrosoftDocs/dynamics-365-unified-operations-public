...
## What's next?
Going forward, new cloud deployments come bundled with the Power BI Embedded service. Other documentation describing the Developer ALM process is made available to help partners and ISVs create new solutions that take advantage of the Power BI Embedded service integration options that are available.
