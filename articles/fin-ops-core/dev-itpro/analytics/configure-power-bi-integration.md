...
| You can't access the application.                           | You probably didn't select all the check boxes under **Step 8  in the Regitration proces** during the registration process. Start Power BI, and re-run the registration process. |
