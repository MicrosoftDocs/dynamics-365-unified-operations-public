...
| Sorry, something went wrong. The authentication process was not successful. Please contact your system administrator  | This may occur in cases where service keys have expired. Recommend performing the **Registration process above starting with Steps #3.** Once complete, make sure to update PowerBI.com settings in the Dynamics 365 F&O application form **AX client > System administration > Set up > PowerBI.com integration** |
