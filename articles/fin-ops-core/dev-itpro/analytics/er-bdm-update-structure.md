...
:::image type="content" source="./media/er-bdm-update-structure1.gif" alt-text="Screenshot of using the Business document management workspace to start editing a business document template.":::
...
1. In the editable template, select the rectangle above the template title. This rectangle is a picture that's named **rptHeaderCompLogo**.
...
1. In the template structure in Finance, the **rptHeaderCompLogo** item appears as a child item of **Report \> Invoice \> rptHeader \> rptHeaderPart1**.
...
1. Follow one of these steps to delete the selected picture from the editable template:
    ...
    > [!NOTE]
    > The **rptHeaderCompLogo** item currently remains in the template structure in Finance, even though the picture is no longer included in the Excel template.

1. Select **Update structure** to sync the structure of the editable template in Excel and Finance.
1. In the **Template structure** pane, expand **Report \> Invoice \> rptHeader \> rptHeaderPart1**.
1. Notice that the **rptHeaderCompLogo** item is no longer in the template structure in Finance.
...
1. Select **Update structure** to sync the structure of the editable template in Excel and Finance.
1. In the **Template structure** pane, expand **Report \> Invoice \> rptHeader \> rptHeaderPart1**.
1. Notice that the new picture is now included as an item in the template structure in Finance.
