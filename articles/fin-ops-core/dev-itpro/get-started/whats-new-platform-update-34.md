...
This topic lists the platform updates for version 10.0.10 of Finance and Operations apps. This version has a build number of 7.0.5600 and is available on the following schedule:
