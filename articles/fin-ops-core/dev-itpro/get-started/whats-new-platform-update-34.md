...
- [Updates to Saved views](https://docs.microsoft.com/en-us/dynamics365-release-plan/2020wave1/finance-operations-crossapp-capabilities/user-productivity--saved-views--phase-2) - In this update, in addition to bug fixes, task recorder support was added for saved views. To ensure users are able to fully utilize recordings, recordings should be created using published views or the Standard view for every form encountered during the recording. For more information, see [Task recorder resources](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/user-interface/task-recorder).
- [Continued stabilization of the new grid control](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/finance-operations-crossapp-capabilities/user-productivity--new-grid-control--phase-2) 
