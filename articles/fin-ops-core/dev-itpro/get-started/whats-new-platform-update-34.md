...
This topic lists the platform updates for version 10.0.10 of Finance and Operations apps. (These platform updates were formally referred to as *Platform update 34*.) This version has a build number of 7.0.5600 and is available on the following schedule:
