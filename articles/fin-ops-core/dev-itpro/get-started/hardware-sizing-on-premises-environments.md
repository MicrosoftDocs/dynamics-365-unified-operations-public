...
ms.topic: article
ms.date: 06/02/2021
ms.topic: articlems.reviewer: johnmichalak
...
Starting with version 10.0.17, it is possible to configure more SSRS nodes to achieve high availability. For more information, see [Configure high availability for SQL Server Reporting Services (SSRS) nodes](../deployment/onprem-ssrsha.md).
