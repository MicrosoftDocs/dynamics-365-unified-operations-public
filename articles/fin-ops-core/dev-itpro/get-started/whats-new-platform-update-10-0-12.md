...
- Customer and vendor master data can be enabled using Feature Management. For more information, see [Customer and vendor master data sharing](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/sysadmin/cross-company-data-sharing#customer-and-vendor-master-data-sharing).
- Product name and brand, i.e. Dynamics 365 Finance, Dynamics 365 Supply Chain Management or Dynamics 365 Commerce, is displayed in the navigation bar and reflects the base license associated with the current user 
