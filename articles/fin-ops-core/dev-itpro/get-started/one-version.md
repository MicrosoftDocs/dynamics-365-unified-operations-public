...
For more information about One Version service updates, see [One Version service updates overview](../lifecycle-services/oneversion-overview.md).
...
For information about how to pause an update, see [Pause service updates through Lifecycle Services (LCS)](../lifecycle-services/pause-service-updates.md).
...
| Version       | Description |
|---------------|-------------|
| 8.1 and later | All customers on version 8.1 and later will be scheduled for automatic monthly updates. These updates will be combined application and platform updates. You are required to be on an update that is no more than three updates behind the current update. For information about how to pause an update, see [Pause service updates](../lifecycle-services/pause-service-updates.md). |
...
For more information about deprecation guidelines, and deprecated methods and metadata elements, see [Deprecation of methods and metadata elements](../migration-upgrade/deprecation-deletion-apis.md).
...
Deprecated features will be documented for each release. For more information, see [Removed or Deprecated features](../migration-upgrade/deprecated-features.md).

## Preparing for One Version

### How can I log an extensibility request?

Extensibility requests can be logged in LCS. Details are available in the [Extensibility requests](../extensibility/extensibility-requests.md) article. Note the following timelines for logging and using the available extensions.
