...
| **Product areas affected**         | Visual Studio development tools |
| **Deployment option**              | All |
| **Status**                         | Virtual machines deployed on version 10.0.13 (PU37) or later contain Visual Studio 2017. Version 10.0.16 (PU40) is the final release with support for Visual Studio 2015. Virtual machines with only Visual Studio 2015 will not be able to update to 10.0.17 (PU41). |
