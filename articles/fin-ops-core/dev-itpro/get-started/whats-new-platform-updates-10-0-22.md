...
| Power Platform integration | New scenarios are enabled in the Power Platform integration, including setup for the integration, automated setup for dual-write and virtual entities, streamlined user setup, Finance and Operations business events and data events in Dataverse, improved development tools, and an enhanced add-in experience. | [New scenarios enabled with Power Platform convergence](/dynamics365-release-plan/2021wave2/finance-operations/finance-operations-crossapp-capabilities/new-scenarios-enabled-power-platform-convergence) | Default |
