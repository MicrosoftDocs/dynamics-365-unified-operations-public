...
| Client features | Visual updates to the Hierarchy viewer control  | [HierarchyViewer control](../user-interface/hierarchy-viewer-control.md) | Because the feature is related to accessabitliy, it is enabled for everyone. |
