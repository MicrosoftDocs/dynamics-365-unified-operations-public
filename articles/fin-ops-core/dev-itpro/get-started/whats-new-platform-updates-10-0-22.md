...
| Client features | Visual updates to the Hierarchy viewer control  | [HierarchyViewer control](../user-interface/hierarchy-viewer-control.md) | Feature is enabled for everyone |
