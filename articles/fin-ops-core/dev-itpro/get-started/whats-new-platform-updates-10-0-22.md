...
| Power BI |  The Power BI embedded and Power BI.com integration has been upgraded as part of the 10.0.22 release to be compatible with the lastest Power BI Desktop releases. With this change users are now able to use the latest version of Power BI desktop when editing workspace reports. This is an infrastructure change and will happen automatically when an environment is upgraded to release 10.0.22.    | [Configure PowerBI.com integration](../analytics/configure-power-bi-integration.md)<br><br>[Create analytical reports by using Power BI Desktop](../analytics/author-distribute-power-bi-reports.md) | Default |
