...
| Client  | <p>**Allow users to select and change tile sizes**</p><p>This feature allows users to change the size of tiles in workspace to one of four available sizes. Users adding new tiles to a workspace can select the desired tile size in the configuration dialog.</p><p>Note this feature is not available for the preview release.</p> | [Personalize the user experience](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/fin-ops/get-started/personalize-user-experience)  | [Feature management](../../fin-ops/get-started/feature-management/feature-management-overview.md)  |  
