...
This article provides an overview of the components of the Help system for solutions with Dynamics 365 Finance, Dynamics 365 Supply Chain Management, Dynamics 365 Commerce, or Dynamics 365 Human Resources. The article also explains how to connect these components.

## Help architecture

Finance and operations apps include conceptual overviews and other articles that are published to the [Microsoft Learn](/dynamics365/) site. You can access this content from the in-product **Help** pane. The following illustration shows the parts of the Help system.
...
1. Set the display order of the BPM libraries. The display order defines the order in which task recordings from the libraries appear in the **Help** pane.

After you complete these steps, you can open the **Help** pane and select the **Task guides** tab. You see the task guides that apply to the page that you're currently on in finance and operations apps. If no task guides are found, you can enter keywords to refine your search.
...
> [!NOTE]
> Although many task guides are translated, the client doesn't currently show the translated task guide names. Additionally, in the May 2016 library, translations are available only for the task guides that were released in February 2016. Microsoft releases an updated library that includes more translations.
>
> - If a task guide is translated, when you open that task guide all the text of the task guide appears in your selected language.
> - If a task guide isn't yet translated, when you open it, only some of the text (the text of the controls) appears in your selected language.
...
Microsoft provides a toolkit to help you deploy and connect custom Help to the **Help** pane. Learn more at [Custom Help overview](../help/custom-help-overview.md).
