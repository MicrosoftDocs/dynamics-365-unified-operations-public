---
title: Version 10.0.32 PQU release 3 build information
description: Learn about the version 10.0.32 proactive quality update (PQU) release 3 build, including a table that provides titles for various update IDs. 
author: rashmansur
ms.author: rashmim
ms.topic: article
ms.date: 06/01/2023
...
| 810889 | [Issue in Lifecycle Service](https://fix.lcs.dynamics.com/Issue/Details?kb=0&bugId=810889) | IN - Posting invoice proposals of partial sales orders through project getting multiple errors | 5/7/2023 | 10.0.1515.108 |
| 807412 | [Issue in Lifecycle Service](https://fix.lcs.dynamics.com/Issue/Details?kb=0&bugId=807412) | ODATA calls to SubBillBillingScheduleTables endpoint result in schedule number always incrementing by 2 | 5/5/2023 | 10.0.1515.105 |
| 810547 | [Issue in Lifecycle Service](https://fix.lcs.dynamics.com/Issue/Details?kb=0&bugId=810547) | [Dual Write + ECM] Can't create an engineering product master when Dual Write is enabled | 5/4/2023 | 10.0.1515.105 |
| 805487 | [Issue in Lifecycle Service](https://fix.lcs.dynamics.com/Issue/Details?kb=0&bugId=805487) | Xml file format isn't supporting other extensions except .xml | 5/3/2023 | 7.0.6801.79 |
| 807107 | [Issue in Lifecycle Service](https://fix.lcs.dynamics.com/Issue/Details?kb=0&bugId=807107) | Users aren't able to submit vendor bank account to workflow when custom vendor bank account workflow solution is applied on an environment | 5/1/2023 | 10.0.1515.103 |
| 807019 | [Issue in Lifecycle Service](https://fix.lcs.dynamics.com/Issue/Details?kb=0&bugId=807019) | Add staging list to shipping container batch doesn't validate transfer quantity correctly. | 4/30/2023 | 10.0.1515.103 |
...
| 803853 | [Issue in Lifecycle Service](https://fix.lcs.dynamics.com/Issue/Details?kb=0&bugId=803853) | Norway: User isn't able to run VAT Declaration Excel (NO) -report in batch | 4/18/2023 | 10.0.1515.91 |
