...
|---|---|---|---|
| Data management | Allow Row version change tracking for tables and data entities | See [Allow Row version change tracking for tables and data entities](../rowversion-change-track.md). | Default |
