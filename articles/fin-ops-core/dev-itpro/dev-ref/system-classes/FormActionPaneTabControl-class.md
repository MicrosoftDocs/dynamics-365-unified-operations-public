---
title: FormActionPaneTabControl class
description: This topic describes the FormActionPaneTabControl class.
author: robinarh
manager: tonyafehr
ms.date: 06/25/2020
ms.topic: article
...
| public str name(\[str value\])                                                                                      | Gets or sets the name used in code to identify a form, report, table, query, or another application object.                    |
...
Gets or sets the name used in code to identify a form, report, table, query, or another application object.
