...
3.	**Find the feature**: Navigate to the **Feature management** workspace. If **Saved views** does not appear in the list, select the **Check for updates** button.   

4.	**Enable the feature**: Find the **Saved views** feature in the list of features, and click the **Enable now** button on the details pane.
