...
The Release notes contain information about the first wave of platform extensibility enhancements for the April 2019 release, which are coming with Platform update 24. There are nine enhancements detailed, with one of the highlights being a new onClicking event for form button controls.
