...
title: What's new or changed in Dynamics 365 for Finance and Operations version 10.0.1 ()
...
---
# What's new or changed in Dynamics 365 for Finance and Operations version 10.0.1 ()

[!include [banner](../includes/banner.md)]

[!include [banner](../includes/preview-banner.md)]

This topic describes features that are either new or changed in Microsoft Dynamics 365 for Finance and Operations version 10.0.1. This version will be released in [date] and has a build number of [build #] .
...
Microsoft Dynamics 365 for Finance and Operations version 10.0.1 includes Platform update [#]. To learn more about Platform update [#], see [What's new or changed in Dynamics 365 for Finance and Operations platform update]().
