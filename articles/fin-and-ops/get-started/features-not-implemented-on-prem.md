...
| Data integrations | The ability to import and export data in data management via package APIs are not available for on-premises deployments of Finance and Operations for all versions but 7.2 with Platform update 12, build 7.0.4709.41184. | 
