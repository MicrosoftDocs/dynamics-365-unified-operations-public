...
| Recurring integrations | The ability to import and export data in data management via package APIs are currently available for on-premises deployments for 7.2 based on PU12 build 7.0.4709.41184. | 
