...
| Recurring integrations | The ability to import and export data in data management via integration APIs are not currently available for on-premises deployments. | 
...
|Retail| Please see below for currently available retail capabilities in on-premises deployments. For more information about availability, see [Dynamics 365 for Retail On-Premises – Enabling Flexible Deployment Options](https://community.dynamics.com/enterprise/b/365forretail/archive/2017/12/15/dynamics-365-for-retail-on-premises-enabling-flexible-deployment-options). ![Retail on-prem capabilities](.././media/RetailLBD.PNG) |
