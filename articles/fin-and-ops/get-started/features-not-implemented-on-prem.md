...
| Microsoft Office integration                                             | SharePoint on-premises support is not yet available. SharePoint online is also not yet supported (due to an authentication issue).<br>Skype for Business on-premises support is not yet available. Skype for Business online is supported.  |
