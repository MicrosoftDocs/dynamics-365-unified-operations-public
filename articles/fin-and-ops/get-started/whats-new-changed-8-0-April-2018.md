...
department). For more information, see [Requests for quotation (RFQs)] (request-quotations.md).
...
that has a replenishment template. For more information about immediate replenishment, see [Immediate replenishment](immediate-replenishment.md).
