...
As part of this change, the workspace tiles on the dashboard now have a new visual style. See [Creating icons for workspace tiles](../../dev-itpro/userinterface/create-icons-workspace-tiles.md) for updated guidance on creating images for workspace tiles that are visually aligned to out-of-the-box workspace tiles.
