...
Data management honors configuration key settings on data entities, tables and fields. Due to the hierarchial nature of the structure amongst these artifacts, data management will allow a child in the hierarchy to be used if the configuration key on itself and its parent is enabled. If a parent's configuration key is disabled, none of the children will be made available for use in imports and exports. For a detailed explaination of this behavior, see [Data entities and configuration keys](https://docs.microsoft.com/en-us/dynamics365/unified-operations/dev-itpro/data-entities/config-key-entities?toc=/fin-and-ops/toc.json)
