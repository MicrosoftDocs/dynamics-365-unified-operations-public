...
2. Verify the email batch process is running:
    1. Navigate to the **System administration** > **Periodic tasks** > **Email processing** > **Batch**.
...
3. Verify workflow notification system email templates
    ...
    2. Verify that the 'Sender email' is set and valid
4. Verify workflow notification organtization email templates
    1. Navigate to **Organization administration** > **Setup** > **Email templates** (for organization-specific template)
    2. Verify that the 'Sender email' is set and valid
5. Verify that the user can receive email notifications
    1. Navigate to **Settings** > **User options
    2. Navigate to the **Account** tab
        1. Set email provider ID (i.e. SMTP)
...
6. Verify that the workflow will send an email notification
    1. For each workflow that should have a notification, open the workflow definition in the Workflow Designer 
        1. Basic settings
