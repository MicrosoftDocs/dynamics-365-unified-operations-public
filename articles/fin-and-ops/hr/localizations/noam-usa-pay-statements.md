...
> [!NOTE]
> If a worker payment occurs outside the systemhttps://github.com/MicrosoftDocs/Dynamics-365-Operations/edit/oct-finops-admin/articles/fin-and-ops/imp-lifecycle/architecture-overview.md#L62, see "Record payments made outside Payroll" in [Pay statements and the payment generation process FAQ](noam-usa-pay-statements-payment-generation-process.md).
