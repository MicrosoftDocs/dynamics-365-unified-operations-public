...
2.  When you change a worker position, this also might change which benefits the worker is eligible for. Go to [Define and manage a benefit program](../../talent/manage-benefit-program) and complete these tasks:
...
1.  Go to [Define and manage a benefit program](../../talent/manage-benefit-program) and complete the following:
    -   Create an eligibility event.
    -   Process eligibility for benefits.
    -   Enroll workers in benefits.
