...
##### [Create a new product lifecycle state (Task guide)](../supply-chain/pim/tasks/new-product-lifecycle-state.md)
##### [Create a default product lifecycle state (Task guide)](../supply-chain/pim/tasks/default-product-lifecycle-state.md)
##### [Assign a product lifecycle state to a released product master (Task guide)](../supply-chain/pim/tasks/product-lifecycle-state-released-product-master.md)
##### [Assign a product lifecycle state to a released product (Task guide)](../supply-chain/pim/tasks/product-lifecycle-state-released-product.md)
##### [Find obsolete product variants (Task guide)](../supply-chain/pim/tasks/obsolete-product-variants.md)
##### [Exclude products from Master planning (Task guide)](../supply-chain/pim/tasks/exclude-products-master-planning.md)
