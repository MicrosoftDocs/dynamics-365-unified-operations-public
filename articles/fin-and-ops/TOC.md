...
### [Cost management Power BI content pack](../dev-itpro/analytics/cost-management-content-pack.md?toc=/fin-and-ops/toc.json)
...
##### [Manage vendor debit and credit for GST](../financials/localizations/tasks/my-00004-manage-vendor-debit-note-credit-note-gst.md)
...
##### [Cancel a customer fiscal document](../financials/localizations/latam-bra-cancel-customer-fiscal-documents.md)
...
### [Information access and reporting](../dev-itpro/analytics/information-access-reporting.md?toc=/fin-and-ops/toc.json)
### [Power BI content](../dev-itpro/analytics/power-bi-home-page.md?toc=/fin-and-ops/toc.json)
#### [Actual vs budget](../dev-itpro/analytics/ledger-budgets-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Benefits](../dev-itpro/analytics/benefits-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Cash overview](../financials/cash-bank-management/Cash-Overview-Power-BI-content.md)
#### [CFO overview](../dev-itpro/analytics/CFO-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Compensation](../dev-itpro/analytics/compensation-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Compensation and benefits](../dev-itpro/analytics/compensation-and-benefits-analysis-power-bi-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Cost accounting analysis](../dev-itpro/analytics/cost-accounting-analysis-content-pack.md?toc=/fin-and-ops/toc.json)
##### [Security for the Cost accounting analysis](../dev-itpro/analytics/setup-security-cost-accounting-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Cost management](../dev-itpro/analytics/cost-management-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Credit and collections management](../financials/accounts-receivable/credit-collections-power-bi.md)
#### [Employee competencies and development](../dev-itpro/analytics/employee-competencies-and-development-analysis-power-bi-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Employee development](../dev-itpro/analytics/employee-development-PBI.md?toc=/fin-and-ops/toc.json) 
#### [Financial performance](../dev-itpro/analytics/financial-performance-power-bi-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Financial insights](../dev-itpro/analytics/financial-insights.md?toc=/fin-and-ops/toc.json)
#### [Fixed asset management](../financials/fixed-assets/Fixed-asset-management-workspace.md)
#### [Learning](../dev-itpro/analytics/learning-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Organizational training](../dev-itpro/analytics/organizational-training-analysis-power-bi-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Practice manager](../dev-itpro/analytics/practice-manager-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Production performance](../dev-itpro/analytics/production-performance-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Purchase spend analysis](../dev-itpro/analytics/purchase-content-pack-for-power-bi.md?toc=/fin-and-ops/toc.json)
#### [Recruiting](../dev-itpro/analytics/recruiting-analysis-power-bi-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Retail channel performance ](../dev-itpro/analytics/retail-channel-performance-dashboard-power-bi-data.md?toc=/fin-and-ops/toc.json)
#### [Sales and profitability performance](../dev-itpro/analytics/sales-profitability-performance-content-pack.md?toc=/fin-and-ops/toc.json)
#### [Vendor payments](../financials/accounts-payable/Vendor-payments-workspace.md)
#### [Warehouse performance](../dev-itpro/analytics/warehouse-power-bi-content.md?toc=/fin-and-ops/toc.json)
#### [Workforce metrics](../dev-itpro/analytics/workforce-analysis-power-bi-content-pack.md?toc=/fin-and-ops/toc.json)
...
#### [List of SQL Server Reporting Services reports](../dev-itpro/analytics/SSRS-report.md?toc=/fin-and-ops/toc.json)
#### [Create reporting solutions](../dev-itpro/analytics/create-nextgen-reporting-solutions.md?toc=/fin-and-ops/toc.json)
#### [Install report design templates](../dev-itpro/analytics/install-modern-report-design-templates.md?toc=/fin-and-ops/toc.json)
#### [Customize App Suite reports using extensions](../dev-itpro/analytics/customize-app-suite-reports-with-extensions.md?toc=/fin-and-ops/toc.json)
#### [Expand Application Suite report data sets](../dev-itpro/analytics/expand-app-suite-report-data-sets.md?toc=/fin-and-ops/toc.json)
#### [Extend report menu items](../dev-itpro/analytics/extend-report-menu-items.md?toc=/fin-and-ops/toc.json)
#### [Custom design business docs](../dev-itpro/analytics/custom-designs-business-docs.md?toc=/fin-and-ops/toc.json)


### [Electronic reporting](../dev-itpro/analytics/general-electronic-reporting.md?toc=/fin-and-ops/toc.json)
#### [Configure the Electronic reporting framework](../dev-itpro/analytics/electronic-reporting-er-configure-parameters.md?toc=/fin-and-ops/toc.json)
#### [Create a configuration](../dev-itpro/analytics/electronic-reporting-configuration.md?toc=/fin-and-ops/toc.json)
##### [Create a configuration provider and mark it as active for electronic reporting](../dev-itpro/analytics/tasks/er-configuration-provider-mark-it-active-2016-11.md?toc=/fin-and-ops/toc.json)
##### [Design a domain-specific data model for electronic reporting](../dev-itpro/analytics/tasks/er-design-domain-specific-data-model-2016-11.md?toc=/fin-and-ops/toc.json)
##### [Define model mapping and select data sources for electronic reporting](../dev-itpro/analytics/tasks/er-define-model-mapping-select-data-sources-2016-11.md?toc=/fin-and-ops/toc.json)
##### [Map a data model to selected data sources for electronic reporting](../dev-itpro/analytics/tasks/er-map-data-model-selected-data-sources-2016-11.md?toc=/fin-and-ops/toc.json)
##### [Create a format configuration for electronic reporting](../dev-itpro/analytics/tasks/er-format-configuration-2016-11.md?toc=/fin-and-ops/toc.json)
##### [Map components of the created format to data model elements for electronic reporting](../dev-itpro/analytics/tasks/er-map-components-data-model-elements--2016-11.md?toc=/fin-and-ops/toc.json)
##### [Generate electronic documents for payments using a format configuration for electronic reporting](../dev-itpro/analytics/tasks/er-electronic-payments.md?toc=/fin-and-ops/toc.json)
##### [Upgrade your format by adopting of new base version of that format for electronic reporting](../dev-itpro/analytics/tasks/er-upgrade-format.md?toc=/fin-and-ops/toc.json)
#### [Formula designer in Electronic reporting](../dev-itpro/analytics/general-electronic-reporting-formula-designer.md?toc=/fin-and-ops/toc.json)
#### [Set up Electronic reporting with Power BI](../dev-itpro/analytics/general-electronic-reporting-report-configuration-get-data-powerbi.md?toc=/fin-and-ops/toc.json)
#### [Destinations](../dev-itpro/analytics/electronic-reporting-destinations.md?toc=/fin-and-ops/toc.json)
##### [Configure destinations for electronic reporting](../dev-itpro/analytics/tasks/er-destinations-2016-11.md?toc=/fin-and-ops/toc.json)
#### [Design a configuration for generating reports in Microsoft Word format for electronic reporting](../dev-itpro/analytics/tasks/er-design-configuration-word-2016-11.md?toc=/fin-and-ops/toc.json)
#### [Design a configuration for generating reports in OpenXML format for electronic reporting](../dev-itpro/analytics/tasks/er-design-reports-openxml-2016-11.md?toc=/fin-and-ops/toc.json)
#### [Modify an Electronic reporting format by reapplying a Microsoft Excel template](../dev-itpro/analytics/modify-electronic-reporting-format-reapply-excel-template.md?toc=/fin-and-ops/toc.json)
#### [Select data model definition while creating format for electronic reporting](../dev-itpro/analytics/tasks/er-select-data-model-definition-creating-er-format-july-2017.md?toc=/fin-and-ops/toc.json)
#### [Define the dependency of configurations from other components for electronic reporting](../dev-itpro/analytics/tasks/er-define-dependency-er-configurations-from-other-components-july-2017.md?toc=/fin-and-ops/toc.json)
##### [Design data model to use financial dimensions as a data source](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md?toc=/fin-and-ops/toc.json)
##### [Map models to use financial dimensions as a data source](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-2.md?toc=/fin-and-ops/toc.json)
##### [Design a report to use financial dimensions as a data source](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-3.md?toc=/fin-and-ops/toc.json)
##### [Run a report that uses financial dimensions as a data source](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-4.md?toc=/fin-and-ops/toc.json)
##### [Create format for counting and summing](../dev-itpro/analytics/tasks/er-format-counting-summing-1.md?toc=/fin-and-ops/toc.json)
##### [Configure computations to do counting and summing](../dev-itpro/analytics/tasks/er-format-counting-summing-2.md?toc=/fin-and-ops/toc.json)
##### [Use computations to make the output for counting and summing](../dev-itpro/analytics/tasks/er-format-counting-summing-3.md?toc=/fin-and-ops/toc.json)
##### [Run the format to do counting and summing](../dev-itpro/analytics/tasks/er-format-counting-summing-4.md?toc=/fin-and-ops/toc.json)
##### [Design a format to use horizontally-expandable ranges to dynamically add columns in Excel reports](../dev-itpro/analytics/tasks/er-horizontal-1.md?toc=/fin-and-ops/toc.json)
##### [Run a format that uses horizontally-expandable ranges to dynamically add columns in Excel reports](../dev-itpro/analytics/tasks/er-horizontal-2.md?toc=/fin-and-ops/toc.json)
##### [Prepare data model to use Document Management files in format outputs](../dev-itpro/analytics/tasks/er-document-management-files-1.md?toc=/fin-and-ops/toc.json)
##### [Extend data model to use Document Management files in format outputs](../dev-itpro/analytics/tasks/er-document-management-files-2.md?toc=/fin-and-ops/toc.json)
##### [Create format to use Document Management files in format outputs](../dev-itpro/analytics/tasks/er-document-management-files-3.md?toc=/fin-and-ops/toc.json)
##### [Run format to use Document Management files in format outputs](../dev-itpro/analytics/tasks/er-document-management-files-4.md?toc=/fin-and-ops/toc.json)
##### [Modify and run format to use Document Management files in format outputs](../dev-itpro/analytics/tasks/er-document-management-files-5.md?toc=/fin-and-ops/toc.json)
##### [Design configurations to generate reports in Microsoft Office formats with embedded images](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md?toc=/fin-and-ops/toc.json)
##### [Review configurations to make reports in Microsoft Office formats with embedded images](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-2-review-configurations.md?toc=/fin-and-ops/toc.json)
##### [Generate reports in Microsoft Office formats with embedded images](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-3-generate-reports.md?toc=/fin-and-ops/toc.json)
#### [Generate electronic documents and update application data using the Electronic reporting tool](../dev-itpro/analytics/generate-electronic-documents-update-application-data.md?toc=/fin-and-ops/toc.json)
##### [Import configurations to generate documents with application data](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-1-import-configurations.md?toc=/fin-and-ops/toc.json)
##### [Design configurations to generate documents with application data](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-2-generate-documents.md?toc=/fin-and-ops/toc.json)
##### [Modify model and mapping to generate documents with application data](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-3-modify-model-mapping.md?toc=/fin-and-ops/toc.json)
##### [Modify format to generate documents with application data](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-4-modify-format.md?toc=/fin-and-ops/toc.json)
##### [Generate documents with application data](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-5-generate-documents-application-data-update.md?toc=/fin-and-ops/toc.json)
#### [Generate reports by adding content as raw XML](../dev-itpro/analytics/er-generate-reports-raw-xml.md?toc=/fin-and-ops/toc.json)
#### [Trace generated report results and compare them with baseline values](../dev-itpro/analytics/er-trace-reports-compare-baseline.md?toc=/fin-and-ops/toc.json)
#### [Cross-company data sources in Electronic reporting](../dev-itpro/analytics/er-cross-company-data-sources.md?toc=/fin-and-ops/toc.json)
#### [Embed images and shapes in business documents that are generated by using the Electronic reporting tool](../dev-itpro/analytics/electronic-reporting-embed-images-shapes.md?toc=/fin-and-ops/toc.json)
#### [Manage the configuration lifecycle](../dev-itpro/analytics/general-electronic-reporting-manage-configuration-lifecycle.md?toc=/fin-and-ops/toc.json)
##### [Upload a configuration into Lifecycle Services for electronic reporting](../dev-itpro/analytics/tasks/er-upload-configuration-into-lifecycle-services.md?toc=/fin-and-ops/toc.json)
##### [Import a configuration from Lifecycle Services for electronic reporting](../dev-itpro/analytics/tasks/er-import-configuration-lifecycle-services.md?toc=/fin-and-ops/toc.json)
##### [Download configurations from Lifecycle Services](../dev-itpro/analytics/download-electronic-reporting-configuration-lcs.md?toc=/fin-and-ops/toc.json)
##### [Import Electronic reporting configurations](../dev-itpro/analytics/electronic-reporting-import-ger-configurations.md?toc=/fin-and-ops/toc.json)
#### [Manage model mapping configurations for electronic reporting](../dev-itpro/analytics/tasks/er-manage-model-mapping-configurations-july-2017.md?toc=/fin-and-ops/toc.json)
##### [Create required configurations to import data from an external file for electronic reporting](../dev-itpro/analytics/tasks/er-required-configurations-import-data.md?toc=/fin-and-ops/toc.json)
##### [Configure data import from SharePoint](../dev-itpro/analytics/er-configure-data-import-sharepoint.md?toc=/fin-and-ops/toc.json)
#### [Parse incoming documents in Microsoft Excel](../dev-itpro/analytics/parse-incoming-documents-excel.md?toc=/fin-and-ops/toc.json)
#### [Parse incoming documents to update application data](../dev-itpro/analytics/parse-incoming-electronic-documents.md?toc=/fin-and-ops/toc.json)
#### [Parse incoming documents in CSV format](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md?toc=/fin-and-ops/toc.json)
#### [Split generated files based on file size and content quantity](../dev-itpro/analytics/er-split-files.md?toc=/fin-and-ops/toc.json)
##### [Extend Electronic reporting functions](../dev-itpro/analytics/general-electronic-reporting-formulas-list-extension.md?toc=/fin-and-ops/toc.json)
##### [Electronic reporting framework API changes for Application update 7.3](../dev-itpro/analytics/er-apis-app73.md?toc=/fin-and-ops/toc.json)


### Embedded analytical solutions
#### [Embedded Power BI in workspaces](../dev-itpro/analytics/embed-power-bi-workspaces.md?toc=/fin-and-ops/toc.json)
...
#### [Pin Power BI reports to workspaces](../dev-itpro/analytics/pin-power-bi-reports.md?toc=/fin-and-ops/toc.json)

### Tools for creating and extending solutions
#### [Analytics, aggregate measurements, and KPI modeling](../dev-itpro/analytics/analytics.md?toc=/fin-and-ops/toc.json)
#### [Author analytical reports by using Power BI Desktop](../dev-itpro/analytics/author-distribute-power-bi-reports.md?toc=/fin-and-ops/toc.json)
#### [Modeling and aggregate data](../dev-itpro/analytics/model-aggregate-data.md?toc=/fin-and-ops/toc.json)
#### [Add financial dimensions to aggregate measurements](../dev-itpro/analytics/add-financial-dimensions-aggregate-measurements.md?toc=/fin-and-ops/toc.json)
#### [Add analytics to workspaces by using Power BI Embedded](../dev-itpro/analytics/add-analytics-tab-workspaces.md?toc=/fin-and-ops/toc.json)
#### [Help secure analytical workspaces and reports by using Power BI Embedded](../dev-itpro/analytics/secure-analytical-workspaces.md?toc=/fin-and-ops/toc.json)
...
#### [Set up an item arrival overview profile](../supply-chain/inventory/tasks/set-up-item-arrival-overview-profile.md)

### [Quality management](../supply-chain/inventory/enable-quality-management.md)
#### [Quality management processes](../supply-chain/inventory/quality-management-processes.md)
...
#### [Create and maintain inventory blocking](../supply-chain/inventory/tasks/create-maintain-inventory-blocking.md)
...
#### [Create a new warehouse layout](../supply-chain/inventory/tasks/create-new-warehouse-layout.md)
#### [Maintain bar code types](../supply-chain/inventory/tasks/maintain-barcode-types.md)
#### [Check the availability of stock](../supply-chain/inventory/tasks/check-availability-stock.md)
#### [Initialize stock levels in the warehouse](../supply-chain/inventory/tasks/initialize-stock-levels-warehouse.md)
#### [Transfer physical inventory within the warehouse](../supply-chain/inventory/tasks/transfer-physical-inventory-within-warehouse.md)
#### [Adjust stock levels in the warehouse (basic warehousing)](../supply-chain/inventory/tasks/adjust-stock-levels-warehouse-basic-warehousing.md)
#### [Inventory tag counting](../supply-chain/inventory/inventory-tag-counting.md)
#### [Count inventory in a warehouse](../supply-chain/inventory/tasks/count-inventory-warehouse.md)
#### [Define inventory counting processes](../supply-chain/inventory/tasks/define-inventory-counting-processes.md)
...
#### [Define coverage rules for items](../supply-chain/master-planning/tasks/define-coverage-rules-items.md)
#### [Generate a constrained plan](../supply-chain/master-planning/tasks/constrained-plan.md)
#### [Create a material plan for co-products](../supply-chain/master-planning/tasks/create-material-plan-co-products.md)
#### [Maintain planned orders](../supply-chain/master-planning/maintain-planned-orders.md)
#### [Safety stock fulfillment for items](../supply-chain/master-planning/safety-stock-replenishment.md)
#### [Delays](../supply-chain/master-planning/delays.md)
#### [Use tracing for explosion](../supply-chain/master-planning/trace-explosion.md)
#### [Action messages](../supply-chain/master-planning/action-messages.md)
#### [Monitor a master planning run](../supply-chain/master-planning/tasks/monitor-master-planning-run.md)
#### [Create a schedule for a site](../supply-chain/master-planning/tasks/create-schedule-site.md)
#### [Create a plan for a site](../supply-chain/master-planning/tasks/create-plan-site.md)
#### [Master plans and multisite functionality](../supply-chain/master-planning/master-plan-multisite-functionality.md)
##### [Master planning for site coverage, mandatory warehouse](../supply-chain/master-planning/master-plan-site-coverage-warehouse-mandatory.md)
##### [Master planning for site coverage, warehouse not mandatory](../supply-chain/master-planning/master-plan-site-coverage-warehouse-not-mandatory.md)
##### [Master planning for site and warehouse coverage, warehouse mandatory](../supply-chain/master-planning/master-plan-site-warehouse-coverage-warehouse-mandatory.md)
##### [Master planning for site and warehouse coverage, warehouse not mandatory](../supply-chain/master-planning/master-plan-site-warehouse-coverage-warehouse-not-mandatory.md)
...
#### [Create an intercompany plan](../supply-chain/master-planning/tasks/create-intercompany-plan.md)
#### [View outbound planned intercompany demand](../supply-chain/master-planning/tasks/view-outbound-planned-intercompany-demand.md)
#### [Collaborate with internal supply chain customers](../supply-chain/master-planning/tasks/collaborate-internal-supply-chain-customers.md)
### [Demand forecasting](../supply-chain/master-planning/introduction-demand-forecasting.md)
#### [Demand forecasting setup](../supply-chain/master-planning/demand-forecasting-setup.md)
...
#### [Remove outliers from historical transaction data when calculating a demand forecast](../supply-chain/master-planning/remove-historical-outliers-calculating-demand-forecast.md)
#### [Reduction keys](../supply-chain/master-planning/reduction-keys.md)
#### [Create a baseline forecast](../supply-chain/master-planning/tasks/create-baseline-forecast.md)
#### [Modify a demand forecast manually](../supply-chain/master-planning/tasks/modify-demand-forecast-manually.md)


## [Mobile app](../dev-itpro/mobile-apps/Mobile-app-home-page.md?toc=/fin-and-ops/toc.json)
### [Mobile workspaces](../dev-itpro/mobile-apps/mobile-workspaces-released.md?toc=/fin-and-ops/toc.json)
#### [Company directory](../dev-itpro/mobile-apps/company-directory-mobile-workspace.md?toc=/fin-and-ops/toc.json)
...
#### [Invoice approvals](../dev-itpro/mobile-apps/invoice-approval-mobile-workspace.md?toc=/fin-and-ops/toc.json)
#### [My team](../dev-itpro/mobile-apps/manager-self-service-mobile-workspace.md?toc=/fin-and-ops/toc.json)
...
### [Publish a mobile workspace](../dev-itpro/mobile-apps/publish-mobile-workspace.md?toc=/fin-and-ops/toc.json)


## [Office integration](../dev-itpro/office-integration/office-integration.md?toc=/fin-and-ops/toc.json)
### [Office integration tutorial](../dev-itpro/office-integration/office-integration-tutorial.md?toc=/fin-and-ops/toc.json)
### [Use the Excel add-in](../dev-itpro/office-integration/use-excel-add-in.md?toc=/fin-and-ops/toc.json)
### [Create Open in Excel experiences](../dev-itpro/office-integration/office-integration-edit-excel.md?toc=/fin-and-ops/toc.json)
...
#### [Import vendor catalogs](../supply-chain/procurement/vendor-catalogs-import.md)
...
#### [Create a record template](../dev-itpro/data-entities/tasks/create-record-template-facilitate-data-entry.md?toc=/fin-and-ops/toc.json)
#### [Use a record template to create a new record](../dev-itpro/data-entities/tasks/use-record-template-new-record.md?toc=/fin-and-ops/toc.json)
...
##### [BOM calculations](../supply-chain/cost-management/bom-calculations.md)
##### [Manage unit of measure](../supply-chain/pim/tasks/manage-unit-measure.md)
...
##### [Create an operations resource](../supply-chain/production-control/tasks/create-operations-resource.md)
##### [Resource capabilities](../supply-chain/production-control/resource-capabilities.md)
##### [Define resource capabilities](../supply-chain/production-control/tasks/define-resource-capabilities.md)
...
##### [Create working time scheduling properties](../supply-chain/production-control/tasks/create-working-time-scheduling-properties.md)
##### [Create working time templates](../supply-chain/production-control/tasks/create-working-time-templates.md)
...
##### [Add an existing activity to a production flow version](../supply-chain/production-control/tasks/add-existing-activity-production-flow-version.md)
##### [Deactivate a production flow version](../supply-chain/production-control/tasks/deactivate-production-flow-version.md)
##### [Define an expiry date for a production flow version](../supply-chain/production-control/tasks/define-expiry-date-production-flow-version.md)
##### [Define production flow models](../supply-chain/production-control/tasks/define-production-flow-models.md)
...
##### [Schedule a production order with operations and job scheduling](../supply-chain/production-control/tasks/schedule-production-order-operations-job-scheduling.md)
#### Operate production jobs
##### [Manage production order lifecycle](../supply-chain/production-control/create-production-orders.md)
###### [Create a production order](../supply-chain/production-control/tasks/create-production-order.md)
###### [Estimate a production order](../supply-chain/production-control/tasks/estimate-production-order.md)
###### [Schedule a production order](../supply-chain/production-control/tasks/schedule-production-order.md)
###### [Release a production order](../supply-chain/production-control/tasks/release-production-order.md)
###### [Start a production order](../supply-chain/production-control/tasks/start-production-order.md)
###### [Report a production order as finished](../supply-chain/production-control/tasks/report-production-order-finished.md)
###### [End a production order](../supply-chain/production-control/tasks/end-production-order.md)
...
##### [Report as finished to a plate-controlled location](../supply-chain/production-control/tasks/report-finished-non-license-plate-controlled-location-2016-11.md)
##### [Report progress on a mobile job device](../supply-chain/production-control/tasks/report-progress-mobile-job-device.md)
##### [Use the safety stock journal to update minimum coverage](../supply-chain/production-control/tasks/use-safety-stock-journal-update-minimum-coverage.md)
...
##### [Production feedback](../supply-chain/production-control/production-feedback.md)
##### [Create a production flow version](../supply-chain/production-control/tasks/create-production-flow-version.md)
...
##### [Validate a production flow and version](../supply-chain/production-control/tasks/validate-production-flow-version.md)
##### [Activate a production flow version](../supply-chain/production-control/tasks/activate-production-flow-version.md)
##### [Create activity relation: Successor](../supply-chain/production-control/tasks/create-activity-relation-successor.md)
##### [Add a predecessor to a production flow activity](../supply-chain/production-control/tasks/add-predecessor-production-flow-activity.md)
##### [Create a value stream](../supply-chain/production-control/tasks/create-value-stream.md)
...
##### [Transfer materials with kanban jobs](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
...
##### [Copy a formula](../supply-chain/production-control/tasks/copy-formula.md)
##### [Create a formula by copying from an existing formula](../supply-chain/production-control/tasks/create-formula-copying-existing-formula.md)
##### [Copy co-products from an existing formula version](../supply-chain/production-control/tasks/copy-co-products-existing-formula-version.md)
##### [Create a formula by copying from an existing formula](../supply-chain/production-control/tasks/create-formula-copying-existing-formula.md)
##### [Production parameters in Manufacturing execution](../supply-chain/production-control/production-parameters-manufacturing-execution.md)
##### [Production setup requirements](../supply-chain/production-control/production-set-up-requirements.md)
#### Schedule production operations
...
##### [Batch order lifecycle from create to start](../supply-chain/production-control/tasks/batch-order-lifecycle-start.md)
##### [Sequence production jobs for process manufacturing](../supply-chain/production-control/tasks/sequence-production-jobs-process-manufacturing.md)
##### [Material substitution in manufacturing](../supply-chain/production-control/substitute-items-bom-lines.md)
##### [Registration for manufacturing execution](../supply-chain/production-control/registration-manufacturing-execution.md)
##### [Production feedback](../supply-chain/production-control/production-feedback.md)
##### [Time and attendance registration](../supply-chain/production-control/time-attendance-registrations.md) 
...
#### [Create a hierarchy of product classification](../supply-chain/pim/tasks/create-hierarchy-product-classification.md)
#### [Classify a product using category hierarchies](../supply-chain/pim/tasks/classify-product-category-hierarchies.md)
#### [Product number nomenclature](../supply-chain/pim/product-variant-identification-nomenclature.md)
#### [Create a product number nomenclature for predefined product variants](../supply-chain/pim/tasks/create-product-number-nomenclature-predefined-variants-2016-11.md)
#### [Create a product number nomenclature for configured product variants](../supply-chain/pim/tasks/create-product-number-nomenclature-product-variants_2016_11.md)
#### [Create a new product](../supply-chain/pim/tasks/create-new-product.md)
#### [Create a product master](../supply-chain/pim/tasks/create-product-master.md)
#### [Create predefined product variants](../supply-chain/pim/tasks/create-predefined-product-variants.md)
#### [Create a released product for a single company](../supply-chain/pim/tasks/create-released-product-single-company.md)
#### [Product lifecycle state](../supply-chain/pim/product-lifecycle.md)
##### [Create a new product lifecycle state](../supply-chain/pim/tasks/new-product-lifecycle-state.md)
##### [Create a default product lifecycle state](../supply-chain/pim/tasks/default-product-lifecycle-state.md)
##### [Assign a product lifecycle state to a released product master](../supply-chain/pim/tasks/product-lifecycle-state-released-product-master.md)
##### [Assign a product lifecycle state to a released product](../supply-chain/pim/tasks/product-lifecycle-state-released-product.md)
##### [Find obsolete product variants](../supply-chain/pim/tasks/obsolete-product-variants.md)
##### [Exclude products from Master planning](../supply-chain/pim/tasks/exclude-products-master-planning.md)
#### [Create a bar code for a product](../supply-chain/pim/tasks/create-bar-code-product.md)
#### [Enter the GTIN code for a product](../supply-chain/pim/tasks/enter-gtin-code-product.md)
#### [Create batch attributes for a product](../supply-chain/pim/tasks/create-batch-attributes-product.md)
#### [Add an image to a product](../supply-chain/pim/tasks/add-image-product.md)
...
#### [Add variant products to purchase orders using variant weights](../supply-chain/pim/tasks/add-variant-products-purchase-order-variant-weights.md)
#### [Create a sales order for a configurable product](../supply-chain/pim/tasks/create-sales-order-configurable-product.md)
#### [Create sales price selection criteria](../supply-chain/pim/tasks/create-sales-price-selection-criteria.md)
#### [Set up attribute-based pricing for configurable products](../supply-chain/pim/tasks/set-up-attribute-based-pricing-configurable-products.md)
#### [BOM calculations](../supply-chain/cost-management/bom-calculations.md)
...
##### [Create a dimension-based product master](../supply-chain/pim/tasks/create-dimension-based-product-master.md)
##### [Release a dimension-based product master](../supply-chain/pim/tasks/release-dimension-based-product-master.md)
##### [Complete basic setup of a released product master](../supply-chain/pim/tasks/complete-basic-setup-released-product-master.md)
##### [Define configuration groups](../supply-chain/pim/tasks/define-configuration-groups.md)
##### [Create a bill of materials for a dimension-based product master](../supply-chain/pim/tasks/create-bill-materials-dimension-based-product-master.md)
##### [Define configuration routes](../supply-chain/pim/tasks/define-configuration-route.md)
##### [Create configuration rules](../supply-chain/pim/tasks/create-configuration-rules.md)
##### [Create dimension-based configurations](../supply-chain/pim/tasks/create-dimension-based-configurations.md)
...
##### [Create product model components](../supply-chain/pim/tasks/create-product-model-components.md)
##### [Create a product configuration model](../supply-chain/pim/tasks/create-product-configuration-model.md)
##### [Add an expression constraint to a product configuration model](../supply-chain/pim/tasks/add-expression-constraint-product-configuration-model.md)
##### [Add a calculation to a product configuration model](../supply-chain/pim/tasks/add-calculation-product-configuration-model.md)
##### [Maintain BOM for a product configuration model](../supply-chain/pim/tasks/maintain-bom-product-configuration-model.md)
##### [Maintain a route for a product model](../supply-chain/pim/tasks/maintain-route-product-model.md)
##### [Approve a product configuration model](../supply-chain/pim/tasks/approve-product-configuration-model.md)
##### [Transfer data for product models](../supply-chain/pim/tasks/transfer-data-product-models.md)
