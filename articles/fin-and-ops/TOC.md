...
#### [Build a product configuration model](../supply-chain/pim/build-product-configuration-model.md)
...
##### [Dimension-based configuration](../supply-chain/pim/dimension-based-product-configuration.md)
...
##### [Set up a configuration model](../supply-chain/pim/set-up-maintain-product-configuration-model.md)
