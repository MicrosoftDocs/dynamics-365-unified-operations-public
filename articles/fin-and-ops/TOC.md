...
##### [Create a default new product lifecycle state (Task guide)](../supply-chain/pim/tasks/default-product-lifecycle-state.md)
...
##### [Find obsolete product variants and assign a product lifecycle state (Task guide)](../supply-chain/pim/tasks/obsolete-product-variants.md)
##### [Create a product lifecycle state to exclude products from Master planning (Task guide)](../supply-chain/pim/tasks/exclude-products-master-planning.md)
