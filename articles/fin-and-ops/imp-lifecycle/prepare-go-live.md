...
| 2 |            Complete and send check list            |                                               After UAT complete                                               |         Partner/Customer          |                                                     Follow the instructions provided in the section FastTrack Go-live assessment later in this topic.                                                    |
...
| 4 |         Release for production deployment          |                                     Upon successfully completed assessment                                     |        FastTrack Architect        |                                 If the production deployment request has already been submitted, deployment will start. However, we request that you only submit the Production reques after the assessment has successfully completed.                                   |
...
|   |                   Copy database                    |                                     Five hours lead time and two hours downtime                                     | Dynamic Service Engineering (DSE) | Generally, the database copy is completed in less than one hour. We still recommend to provide a downtime window of two hours in case a rollback is required for any reason.                                                                                                                                                               |
