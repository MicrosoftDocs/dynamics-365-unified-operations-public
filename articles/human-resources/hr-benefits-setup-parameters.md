...
1. In the **Benefits management** tab, specify values for the following fields:
   ...
   | **Default pay frequency** | The default pay frequency to use when you add new workers. |
