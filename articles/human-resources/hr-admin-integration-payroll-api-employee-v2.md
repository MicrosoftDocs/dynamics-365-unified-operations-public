...
title: Employee V2
description: This topic provides details and an example query for the employee V2 entity in Dynamics 365 Human Resources.
author: marcelbf
ms.date: 09/20/2021
ms.topic: article
ms.prod: 
...
This topic describes the employee V2 entity for Dynamics 365 Human Resources.

Physical name: mshr_hcmemployeev2entity.

### Description

This entity provides extended information about the employee.
