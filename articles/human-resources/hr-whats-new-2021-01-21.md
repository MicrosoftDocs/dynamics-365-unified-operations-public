...
| 543641 | Zip code not populating on electronic reporting  | Fixed an internal bug on zip code not appearing in ACA Electronic reports for Advanced Benefits when coverage code is M through Q|
...
| 533079 | ## Navigation error " Form was called incorrectly" when we try to look at deductions. | Fixed error ocuring when in Deductions form for Benefits Managed when viewed "As of date"|
