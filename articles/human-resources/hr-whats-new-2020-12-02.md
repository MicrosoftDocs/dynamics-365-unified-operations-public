...
| 437112 | Misleading error message text during employee position assignment |Updated the error message when hiring a worker and attempting to assign a the worker to a postition that isn't active.  Updated message 'The specified position is not active as of the employment start date. Please check the duration of this position.' |
