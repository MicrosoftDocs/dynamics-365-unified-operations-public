...
| 589617 | On the **Time off** page, the Available to buy and Available to sell balances are empty when access is restriced to a specific company. | This issue is now fixed. The **Time off** page will display the correct Available to buy and Available to Sell balances when the user is restricted to a specific company. |
