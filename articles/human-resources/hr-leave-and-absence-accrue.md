...
1. Under **Manage leave**, select **Accrue leave and absence plans**.
1. The **Accrue leave and absence plans** dialog box appears. In **Accrue as of**, select **Today's date** or select **Custom date** and enter a custom date.
1. If you want to run accruals for all companies, select **All companies**. If you want to process accruals for a single leave plan, select **No** for **All plans**, and then select a **Leave plan**. If you select all companies, you can't select an individual leave plan.
1. If you want to run the accrual process in the background, select **Run in the background** and complete the following tasks:
    ...
    1. Select **OK**. The accrual process runs with the parameters you set.

## Accrue leave and absence for an employee

1. On the employee's record, select **Leave**.
1. Select **Accrue leave and absence**.
1. The **Accrue leave and absence plans** dialog box appears. In **Accrue as of**, select **Today's date** or select **Custom date** and enter a custom date.
1. If you want to run accruals for all companies, select **All companies**. If you want to process accruals for a single leave plan, select **No** for **All plans**, and then select a **Leave plan**. If you select all companies, you can't select an individual leave plan.
1. If you want to run the accrual process in the background, select **Run in the background** and complete the following tasks:
...
1. On the **Leave and absence** page, select the **Links** tab.
1. Under **Manage leave**, select **Delete leave and absence plan accruals**.
1. In the **Delete leave and absence plan accruals** dialog box, select the **Leave plan**.
1. If applicable, choose **Delete balance adjustments**.
1. Enter or select a **Leave accrual date**. This date has to be either today or in the future.
1. Select **OK**. The accrual process deletes accruals with the parameters you set.

## Delete leave and absence accruals for a single employee

1. On the employee's record, select **Leave**.
1. Select **Delete leave and absence plan accruals**.
1. In **Delete leave and absence plan accruals**, select **Leave plan**.
1. If applicable, choose **Delete balance adjustments**.
1. Enter or select a **Leave accrual date**. This date must be either today or in the future.
1. Select **OK**. The accrual process deletes accruals with the parameters you set.

## Review leave accrual and deletion processes

**Leave accrual audit** displays each time you run or delete an accrual for one or all employees. The date and person who performed the action also display.

1. On the **Leave and absence** page, select the **Links** tab.
1. Under **Manage leave**, select **Delete leave accrual audit**.

## Leave accrual rounding

When an employee is either enrolled or unenrolled, leave accrual rounding is prorated. Previously, rounding was only allowed when a leave plan was set to prorate, and an employee was enrolled/unenrolled during mid-period. Leave accruals will now round regardless of enrollment/unenrollment at mid-period or at the start of a period.
...
1. On the employee's record, select **Leave**.
1. Select **View time off**, and then select the **Balances** tab.
