...
1. On the **General** tab, enter values for the following fields:
   ...
   | **Master** | Specifies whether the plan is the master plan within the bundle it's assigned to. |
...
1. On the **Configuration** tab, enter values for the following fields, depending on the type of plan you're creating:
   ...
   | Long term disability<br><br>ADD (Basic life, Voluntary life) | Incremental amount | The incremental amount of insurance coverage for the plan. For example, if the incremental amount is 1,000, an employee can’t have $200,500 of insurance, they need to round up to $201,000 or down to $200,000. |
...
1. On the **Setup** tab, enter values for the following fields:
   ...
   | Field | Description |
   | --- | --- |
   | **Allow/continue enrollment** | Specifies whether employees can enroll in the plan if they meet eligibility requirements.</br></br>If you set this value to **No**, the plan isn’t available to employees when you process eligibility. |
   ...
   | **Currency** (Benefit administrator) | The currency that you use to pay the benefits administrator. |
   | **Expense account** (Benefit administrator) | The general ledger account that you use as the expense account for the costs associated with the administration of the plan. |

1. On the **Filters** tab, filter as necessary. You can filter by the following fields:
...
1. On the **Eligibility rules** tab, specify values for the following fields:
...
1. In the **Benefits management** workspace, under **Plans**, select **Benefit plans**.
1. On the **Benefits** tab in the navigation bar, select **Enrolled workers**.
...
You can add workers to a plan as exceptions to the eligibility rules. Each worker you add is eligible for the benefits plan.

1. In the **Benefits management** workspace, under **Plans**, select **Benefit plans**.
1. On the **Benefits** tab in the navigation bar, select **Eligibility rule override**.
...
1. In the **Benefits management** workspace, under **Plans**, select **Benefit plans**.
1. Select the **Periods** tab in the navigation bar.

## View plan description

Enter a description of the plan to help employees with their benefits selections. The plan description you enter here displays in Employee self service when hovering on the plan in the coverage options list.

1. In the **Benefits management** workspace, under **Plans**, select **Benefit plans**.
1. On the **Benefits** tab in the navigation bar, select **Plan description**.

## View flex credit programs

1. In the **Benefits management** workspace, under **Plans**, select **Benefit plans**.
1. On the **Benefits** tab in the navigation bar, select **Flex credit programs**.
