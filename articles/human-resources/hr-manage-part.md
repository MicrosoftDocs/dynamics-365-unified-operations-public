...
- **Option 1:** Use this option for mass assignment of more than one participant at a time.

    1. On the **Course details** page, on the **Participants** tab, find and select participants. Use the **Filter by** or **Group by** functionality to easily find participants.
    1. After you select the participants, select **Assign participants**.
...
- **Option 2:** Use this option to assign one participant at a time. For mass assignment, use option 1.

    1. On the Action Pane, on the **Course** tab, in the **Related information** group, select **Course participants**.
    1. Select a course participant, and then select **New** to add a participant.
...
To view the **Learning** tab in **Manager self service**, open the **Human resources parameters** page. On the **Learning** tab, in the **View direct reports** assigned course, select **Direct reports only** or **Extended reports**. If you select **Extended reports**, direct reports are included.

This feature gives managers visibility into learning, including all courses that are assigned, overdue, and due soon. Managers can assign courses by selecting **Assign courses**. This information helps managers track courses for direct reports or extended reports, and progress through them, to ensure that workers stay on track and complete assigned courses in a timely manner.
