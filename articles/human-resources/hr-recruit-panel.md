...
The status of the application changes to **Rejected**.

## Reopen applications

If you reconsider a candidate's application after rejecting it, you can reopen the application.
...
The application status changes to **In progress**.

## Set applicants to Ready to hire

When a recruiter wants to hire a candidate, they set the applicant to **Ready to hire**. The system transfers the applicant's information to Dynamics 365 Human Resources, and the system administrator can create the worker (employee) record.
