...
After you duplicate a security role and sign in as that new role, you can't see addresses that are marked as private.

**Resolution**

To resolve the issue, follow these steps for the duplicated security role.

1. Go to **Organization administration \> Global address book \> Global address book parameters**.
1. On the **Private location security** tab, move the new security role from the **Available roles** list to the **Selected roles** list.
3. Select **Save**.
