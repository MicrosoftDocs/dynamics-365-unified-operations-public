...
2. On the **Next Scheduled Review**, click the ellipsis.
3. Select **New review** to create a new review.
4. In the **Review type** field, enter or select a value.
5. In the **Performance period** field, enter or select a value.
6. In the **Start date** field, enter a date.
7. In the **End date** field, enter a date.
8. Select **OK**. You can also create a review from a template. This is the best way to create a review because each section contains the information that you need to start a review.  
9. You can show or hide tabs such as the attachments tab:
...
10. Select **Add goal to review** to add a goal. Select **OK** when finished.
11. Select **Add competency** to open the drop dialog.
12. In the **Title** field, type a value.
13. In the **Description** field, enter `Increase customer skills by working with the support team`.
14. Select **OK**.
15. Select **Collapse all**.
16. Select **Expand all**.
17. Select **Add comment**.
18. Select **Post**.
19. Select the **Measurements** tab.
20. Select **Add measurement** to open the dialog menu.
21. In the **Measurement** field, enter or select a value.
...
31. Select the **Sign offs** tab. If the review uses workflow, then the signoffs only appear after the workflow is complete. If no workflow is used, then both the worker and the manager are listed here. The **Required** checkbox for **Sign offs** is selected based on the settings of the review type.  
