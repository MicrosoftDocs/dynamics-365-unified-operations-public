...
| Minor UX updates for creating new Benefits plan - (419941) | NA | [Creating Benefits Plans] (https://docs.microsoft.com/en-us/dynamics365/human-resources/hr-benefits-plans-setup) |
...
| (505989) | Life events processing:  Change of eligibility not processed correctly due to date used | Fixed issue where change in eligibility processing was dependant on the position start date and not just the current position. |
