...
- **Completed answer sessions** – View details about the questionnaires that respondents complete, and generate reports to summarize answers and any points that were earned.
...
After respondents complete a questionnaire, you can view the results of the completed answer sessions. An answer session is one user’s response to a questionnaire. You can view details about completed answer sessions on the **Answers** page. The answer sessions that appear on the **Answers** page are filtered in various ways, depending on how you open the page:
...
Use questionnaire statistics to analyze the results of a completed questionnaire, based on calculations that you define. To define calculations, complete the following tasks:

- Select criteria to calculate and display the statistics.
  - Show statistics by questionnaire, questions, question rows, or results groups.
  - Select the type of chart that you want to use when you view results.
...
The system saves the settings that you define and can use them to periodically recalculate results.
