...
This article lists the system requirements for Microsoft Dynamics 365 Human Resources. It also outlines the countries and regions where Human Resources is available, and provides information about languages and localization for Human Resources data.

## Supported web browsers

Users can access Microsoft Dynamics 365 Human Resources by using any of the following web browsers that run on the specified operating systems: 
...
* To enable Task Recorder to capture screenshots and include them in Microsoft Word documents that are generated, you must install a prerelease Chrome extension
...
> [!WARNING]
> Don't compute bandwidth requirements from a client location by multiplying the number of users by the minimum bandwidth requirements. The concurrent usage of a given location is difficult to calculate. For customers who are concerned about bandwidth requirements, use a trial version of Human Resources.

## Supported Microsoft Office applications

* To run the Microsoft Excel and Word add-ins, you must have Microsoft Office 2016 for Windows or Mac installed. For more information about version requirements, see [Office integration troubleshooting](../fin-ops-core/dev-itpro/office-integration/office-integration-troubleshooting.md "Office integration troubleshooting").
...
You can download a PDF file of the countries, regions, and languages that Human Resources supports at [International availability of Microsoft Dynamics 365](/dynamics365/get-started/availability). 
