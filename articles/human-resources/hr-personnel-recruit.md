...
If your organization has multiple locations, you can add them so requesters can select a location where the new recruit will be working. The location is included in the job posting.
