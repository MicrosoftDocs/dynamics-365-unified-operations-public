...
| --- | --- | --- |
| ## Localizability: Create a new label for "Jobs" in Personnel Management - (574380) In personnel management -> Organizations -> Jobs | | |
| ## Level is not shown when creating a fixed compensation plan for an employee - (559312) | | |
