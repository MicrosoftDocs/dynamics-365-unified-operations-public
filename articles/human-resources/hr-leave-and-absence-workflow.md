...
To create a leave and absence request workflow, follow these steps:

1. On the **Leave and absence** page, select the **Links** tab.
1. Under **Setup**, select **Human resource workflows**.
1. Select **New**, and then select **Leave and absence request**.
...
Use the following data elements to create conditional or automatic approvals in workflows for leave and absence requests:
...
- **Denied** – A manager or an absence manager denied the leave request.
- **Approved** – A manager or an absence manager approved the leave request.
...
Use the following workflow statuses for leave requests:

- **In review** – You submitted the leave request. When a leave request is in review, the workflow is triggered for the next steps.
