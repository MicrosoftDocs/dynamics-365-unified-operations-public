...
Yes, you can delete personnel actions that have a status of **Draft**, **Error**, **Failed**, or **Canceled**.  You can delete **Completed** personnel actions if you have set **Allow deleting completed worker actions** to **Yes** on the **Human resources shared parameters** page.
