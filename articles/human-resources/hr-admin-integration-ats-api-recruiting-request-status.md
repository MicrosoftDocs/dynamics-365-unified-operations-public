...
description: This article describes the Recruiting request status option set for Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
# optional metadata
...
This article describes the Recruiting request status option set for Dynamics 365 Human Resources.
