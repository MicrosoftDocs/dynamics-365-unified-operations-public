...
title: Employee V2 entity
description: This article provides details and an example query for the Hcm Employee V2 entity in Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 02/20/2026
ms.topic: article
...
This article describes the Hcm Employee V2 entity (PayIntV2HcmEmployeeV2Entity) for Dynamics 365 Human Resources.
...
| Employeedetailseffective | mserp_employeedetailseffective | Date time offset | Read-only |
...
| Relocationreimbursement | mserp_relocationreimbursement | Real | Read-only |
| Terminationreasoncodeid | mserp_terminationreasoncodeid | String | Read-only |
...
| Employmentnoticeworkerunit | mserp_employmentnoticeworkerunit | Enum | Read-only |
...
| Startdate | mserp_startdate | Date time offset | Read-only |
...
| Employmentdetailseffective | mserp_employmentdetailseffective | Date time offset | Read-only |
...
| Employmentnoticeemployerunit | mserp_employmentnoticeemployerunit | Enum | Read-only |
| Employeedetailsexpiration | mserp_employeedetailsexpiration | Date time offset | Read-only |
| Employmentnoticeemployerquantity | mserp_employmentnoticeemployerquantity | Enum | Read-only |
...
| Terminationdate | mserp_terminationdate | Date time offset | Read-only |
...
| Calendardataareaid | mserp_calendardataareaid | String | Read-only |
| Pensionenrollment | mserp_pensionenrollment | Date time offset | Read-only |
| Pensionstart | mserp_pensionstart | Date time offset | Read-only |
| Employmentdetailsexpiration | mserp_employmentdetailsexpiration | Date time offset | Read-only |
...
| Employmentlegalentityid | mserp_employmentlegalentityid | String | Read-only |
...
| Employmentnoticeworkerquantity | mserp_employmentnoticeworkerquantity | Enum | Read-only |
...
## Example query for PayIntV2HcmEmployeeV2Entity

Entity name: mserp_payintv2hcmemployeev2entities

**Request**

```HTTP
GET [Organization URI]/api/data/v9.1/mserp_payintv2hcmemployeev2entities
```
...
{  
    ...
    "mserp_startdate": "2010-02-01T08:00:00Z",
    ...
    "mserp_relocationreimbursement": 0,
    ...
    "mserp_probationperiod": null,
    "mserp_nationalitycountryregion": "",
    "mserp_primarycontactemaildescription": "Work",
    "mserp_employmentenddate": "2154-12-31T23:59:59Z",
    "mserp_employeedetailseffective": null,
    "mserp_employmentdetailseffective": "2012-09-11T20:30:58Z",
    "mserp_officelocationid": "000000034",
    "mserp_employeedetailsexpiration": null,
    "mserp_pensionenrollment": null,
    ...
    "mserp_employmentdetailsexpiration": "2154-12-31T23:59:59Z",
    "mserp_dimensiondisplayvalue": "--026",
    "mserp_lastnameprefix": "",
    "mserp_addresslocationroles": "Home",
    "mserp_employmentnoticeemployerquantity": 0,
    "mserp_addressbooks": "",
    "mserp_primarycontactemail": "jodi@contoso.com",
    "mserp_phoneticlastname": "",
    "mserp_addressnamedescription": "Home address",
    "mserp_employmentnoticeworkerunit": 200000000,
    ...
    "mserp_employmentlegalentityid": "USMF",
    ...
    "mserp_employmentnoticeemployerunit": 200000000,
    "mserp_primarycontactphoneismobile": 200000000,
    "mserp_professionaltitle": "",
    "mserp_employmentnoticeworkerquantity": 0,
