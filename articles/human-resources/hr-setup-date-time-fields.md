...
In the example above, the start time is a point in time, not a particular date. By changing the time zone of the logged in user from GMT +12:00 to GMT UTC, the same record shows 04/30/2025 12:00:00 instead of 05/01/2025 12:00:00.

In the example below, employee 000724's employment becomes active at the same time regardless of time zone. The employee is active on 04/30/2025 in the GMT time zone, which is the same as 05/01/2025 in GMT+12:00 time zone. Both refer to the same point in time and not a particular date.
...
## Examples of the same record displayed in different product areas
