...
| In application support                                 | Select the **?** icon in the menu and select Support (Core HR) Report a problem (Attract, Onboard).  Issues will be reported in the Active Issues tab in LCS. **Note** if you purchased the stand-alon version of Onboard Report a problem issues will be sent to Microsft.   |
