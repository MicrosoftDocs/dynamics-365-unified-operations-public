...
When generating the 1095-C form enter in the appropriate tax year and indicate if social security numbers should be masked.   If you are printing 1095-C forms for more than 500 employees you will receive more than one pdf file and it is recommended that the Maximum file size in the Document management parameters window be increased to 150mb. 
