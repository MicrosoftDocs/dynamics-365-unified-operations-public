...
*Note: When the default template is used, the integration keys will be
...
*Or data transfer has null values for fields which are mandatory in Finance and
Operations*

*Verify the data that is in CDS, meets the requirements of Finance and
Operations.*
...
*Step1: Capture Task index from data integrator. (In this case it is 9.)*

![](media/1801a3b66b1ac2b5f344737d0f59cee0.png)

*Step 2: Track time of execution of project*

![](media/7a18e2f06607a94711e34c81ad754203.png)

*Step 3: In Finance and Operations, identify index - 1. In this case, the
