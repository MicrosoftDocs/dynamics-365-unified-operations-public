...
description: Learn how the new Planning Optimization planning engine is now replacing the legacy built-in planning engine and when the deprecated engine will be removed.
author: t-benebo
ms.author: benebotg
ms.topic: overview
ms.date: 11/11/2022
