...
-   If you enable **Forecast model selection on Demand forecast details** from Feature management you will be able to select the forecast models to be included, for the historical forecast, on the Demand forecast details page.
