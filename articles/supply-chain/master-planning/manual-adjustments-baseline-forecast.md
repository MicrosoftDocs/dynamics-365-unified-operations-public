...
-   If you enable *Forecast model selection on Demand forecast details* in [Feature management](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md), you will be able to select the forecast models to be included, for the historical forecast, on the **Demand forecast details** page. (As of Supply Chain Management version 10.0.21, this feature is turned on by default. As of Supply Chain Management 10.0.25, this feature is mandatory and can't be turned off.)
