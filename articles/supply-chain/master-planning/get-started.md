...
Connection status	   | Description	                                                                                  | Possible to use Planning Optimization 
---------------------------|------------------------------------------------------------------------------------------------------|---------------------------------------
Connected	           | Connection is established between Planning Optimization service and Finance and Operations.    | Yes                                   
Enabling connection	 | A request to enable the connection to Planning Optimization service is currently in progress.  | No                                    
Disconnected	       | There is no connection to Planning Optimization service. Connection can be enabled from LCS as described earlier on this page. | No    
Disabling connection | A request to disable the connection to Planning Optimization service is currently in progress. | No                                    
...
**No** - The "classic X++" planning engine is used for master planning.

**Note:** If existing planning batch jobs created for the "classic X++" planning engine are triggered when Use Planning Optimization is set to Yes these will fail, as the "classic X++" planning engine is disabled.
