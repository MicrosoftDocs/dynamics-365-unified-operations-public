...
If you set negative days to zero and use only the dynamic negative days time fence&mdash;which will now be `6 + 0 – 4 = 2`&mdash;you will again end up in the same situation as in case A. For a graphical view, refer to situation 2, case A.
