...
Additional requirements apply based on which version you are currently running, as described in the following subsections.

### In Supply Chain Management versions 10.0.38 or 10.0.39
...
### In Supply Chain Management version 10.0.40 or later
...
1. Use the company picker to select the legal entity (company) where you want to calculate requested shipment dates.
1. Go to **Procurement and sourcing** \> **Setup** \> **Procurement and sourcing parameters**.
1. Open the **Delivery** tab.
1. Set **Supplier requested and confirmed shipment dates** to *Yes* to make the feature available to the selected legal entity. Set to *No* to hide the feature for the selected legal entity.
