...
The main purpose of installing the Planning Optimization add-in is to connect the service to the environment. Therefore, you must install the add-in separately on each environment where you will use Planning Optimization, regardless of any code moved between the environments.
