...
| Extension of ETDs | Changes to the precission of EDTs is not supported on Planning Optimization. Therefore, if for example product quantity precision is changed from 2 decimals (default) to 4, 2 decimals will be used by Planning Optimization. |
