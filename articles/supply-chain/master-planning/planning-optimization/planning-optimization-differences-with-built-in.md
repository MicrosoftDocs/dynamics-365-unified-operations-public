...
| Negative days | Planning Optimization always uses Dynamic negative days, regardless of the setting of **Use dynamic negative days** on the **Master planning parameters**. The Use dynamic negative days setting on the Master planning parameters page has no effect on this behavior. For more information on negative days see [Delay tolerane](https://learn.microsoft.com/en-us/dynamics365/supply-chain/master-planning/planning-optimization/delay-tolerance). |
