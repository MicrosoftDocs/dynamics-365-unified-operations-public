...
| Planned orders in the past | Planning Optimization never plans orders in the past, regardless of the **requested date**. It will keep its **Requested date **in the past but its **Required date** will be set to _Today_, as it is the earliest planned orders can be for. |
