...
> [!IMPORTANT]
> Before the feature that is described in this section can be used with Planning Optimization, the [*Auto-firming for Planning Optimization* feature](#enable-features) must be turned on for your system, as described at the beginning of this article. Auto-firming can always be used with the built-in master planning engine.
