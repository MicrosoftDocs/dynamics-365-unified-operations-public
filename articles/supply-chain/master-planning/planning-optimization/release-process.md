...
|---|---|---|
| <p>[Bills of material with constant scrap or variable scrap defined](../scrap-calculations.md)</p><p>Demand with specific BOM or route requirements defined <p> Calculated delays: Add the calculated delay to the requirement date settings on master plans </p> | No feature management required | January 10-15, 2023 |
...
| <p> [Master planning for products with limited shelf life](https://learn.microsoft.com/en-us/dynamics365/supply-chain/master-planning/planning-optimization/shelf-life) </p> General performance, quality, and stability improvements | No feature management required | August 29 - September 3, 2022 |
