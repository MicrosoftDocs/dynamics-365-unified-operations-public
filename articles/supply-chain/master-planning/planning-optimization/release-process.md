...
|---|---|---|
| <p>[Bills of material with constant scrap or variable scrap defined](../scrap-calculations.md)</p><p>Demand with specific BOM or route requirements defined</p> | No feature management required | January 10-15, 2023 |
