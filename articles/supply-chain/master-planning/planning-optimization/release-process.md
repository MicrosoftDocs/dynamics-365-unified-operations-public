...
|---|---|---|
| <p>BOM lines with rounding or multiple setup.</p><p>BOM/formula lines with negative quantity.</p><p>General performance, quality and stability improvements.</p> | No feature management required | May 22–31, 2023 |
