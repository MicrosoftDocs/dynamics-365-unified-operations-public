...
| Production | Sales line reservation using explosion: *\#* | This scenario is not yet supported. When using CTP for Planning Optimization the sales line reservation is not automatically performed during explosion.  | Future wave |
