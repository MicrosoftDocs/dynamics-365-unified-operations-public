...
| Batch disposition codes | Non-nettable batch disposition masters: *\#* | This feature is now supported. | Supported  [Use batch disposition codes to mark batches as available or unavailable](../../inventory/batch-disposition-codes.md) |
