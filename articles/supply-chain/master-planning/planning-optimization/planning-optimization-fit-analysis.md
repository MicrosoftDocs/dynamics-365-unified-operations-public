...
| Base calendars | Calendars using base calendar: _\#_ | This feature is pending. Currently, the base calendar is ignored when Planning Optimization is enabled. Evaluate if the base calendar is needed for your business processes or if direct setup in calendars is sufficient. | April 2021 | 
...
| Forecast | Forecast models with sub models: _\#_ | This feature is pending. Currently, forecasts that use sub-models aren't supported when Planning Optimization is enabled. They will be ignored, regardless of this setting. | April 2021 |
...
| Production | Resources scheduled with finite capacity: _\#_ | This feature is pending. Currently, resources that are scheduled with finite capacity are ignored when Planning Optimization is enabled. Scheduling is done based on the default lead time from the product. | Infinite: April 2021, Finite: October 2021 |
