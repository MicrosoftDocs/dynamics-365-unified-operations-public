...
| Planning items | Planning Items: *\#* | This is now supported for all versions of Supply Chain Management. | Supported |
...
| Kanban | Item coverage records with planned order type kanban: *\#* | This feature is now supported. To use it, enable the (Preview) Lean manufacturing for Planning Optimization feature in Feature management. As of Supply Chain Management version 10.0.46, this feature will be generally available. | Supported |
| Kanban | Items with default order type kanban: *\#* | This feature is now supported. To use it, enable the (Preview) Lean manufacturing for Planning Optimization feature in Feature management. As of Supply Chain Management version 10.0.46, this feature will be generally available. | Supported |
