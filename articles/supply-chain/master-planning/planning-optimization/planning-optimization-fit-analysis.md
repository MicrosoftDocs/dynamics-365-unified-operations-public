...
| Freeze time fence | Coverage groups with freeze time fence set: *\#* | This feature is now supported, please enable its feature on feature management. | Supported |
...
| Freeze time fence | Master plans with freeze time fence set: *\#* | This feature is now supported, please enable its feature in feature management | Supported |
...
| Production | BOM/formula lines with item substitution (plan groups): *\#* | This feature is now supported, please enable its feature in feature management. | Supported |
