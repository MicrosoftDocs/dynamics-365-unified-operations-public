...
|---|---|---|---|
| Asset management | Change the asset type of an existing asset | *Coming soon* | Feature management:<br>*(Preview) Change types on assets and functional locations*  |
| Asset management | Change the functional location type of an existing functional location | *Coming soon* | Feature management:<br>*(Preview) Change types on assets and functional locations*  |
...
| Master planning | Demand planning app | Coming soon | Feature management:<br>*(Preview) Demand Planning* |
