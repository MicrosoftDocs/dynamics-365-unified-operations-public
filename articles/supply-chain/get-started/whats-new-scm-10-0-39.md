...
|<p>**Module:** Inventory and warehouse management</p><p>**Enhancement name:** Inventory transaction details page's performance improvement</p><p>**Feature management name:** *(None)*</p> | Improves the performance of the **Inventory transactions details** page. Users can now set default filters, so that the page shows only frequently checked inventory transactions. In addition, the page shows only inventory-related fields. To access the **Inventory transaction details** page, go to **Inventory management** \> **Inquiries and reports** \> **Transactions**. |
