...
|<p>**Module:** Warehouse management</p><p>**Feature management name:** *Inventory transaction details page's performance improvement.*</p> | <p>Improves the performance of the **Inventory transactions details** page. Users can now set default filters, so that the page shows only frequently checked inventory transactions. In addition, the page shows only inventory-related fields.</p><p>To access the **Inventory transaction details** page, go to **Inventory management** \> **Inquiries and reports** \> **Transactions**.</p><p>**Important:** This feature changes the form used to create the **Inventory transaction details** page, which might break some customizations. Learn more in [Inventory transaction details](../inventory/inventory-transactions-details.md).</p> |
