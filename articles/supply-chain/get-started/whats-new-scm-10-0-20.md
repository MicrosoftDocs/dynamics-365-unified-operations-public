...
| Procurement and sourcing | (Preview) Enable resetting procurement related workflows | This feature allows you to reset following workflows to draft status: Purchase Order, Vendor Change, and Purchase Requisitions. |
