...
| Inventory&nbsp;and&nbsp;logistics | [Warehouse app promoted fields](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/warehouse-management-mobile-app-step-instructions) | [Customize step titles and instructions for the Warehouse Management mobile app](../warehousing/mobile-app-titles-instructions.md) | Feature management (*Warehouse app promoted fields*) |
...
| Sales and marketing | Clean up sales-order update history | This feature lets you clean up temporary historical records related to sales-order updates. It adds a new button called **Clean up sales update history** to the Action Pane of the detail and list pages for sales orders. | <!-- KFM: Is this actually older? (Not in What's New before). -->
