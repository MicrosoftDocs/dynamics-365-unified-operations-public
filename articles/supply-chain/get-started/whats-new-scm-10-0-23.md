...
| Master planning | Azure Machine Learning Service for demand forecasting | This feature allows Azure Machine Learning Service to generate demand forecasts based on historical data. For more information, see [Demand forecasting setup](../master-planning/demand-forecasting-setup.md) |
