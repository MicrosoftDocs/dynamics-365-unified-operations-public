...
| <p>**Module:** Product information management</p><p>**Feature management name:** *(Preview) Rename item number*</p> | This feature was released as a preview and was never made generally available for use in production environments. It was [removed from the product](removed-deprecated-features-scm-updates.md) in version 10.0.44 and shouldn't be used with any version of Supply Chain Management. |
