...
This article lists features that are either new or changed in Microsoft Dynamics 365 Supply Chain Management preview version 10.0.37. This version has a build number of 10.0.1695 and is available on the following schedule:
...
| Warehouse management | Automatically update documents when receiving purchase orders | [Warehouse handling of inbound loads for purchase and inbound shipment orders](../warehousing/inbound-load-handling.md) | Enabled by default |
...
<!-- KFM: Continue in FM after *Cross-company data sharing for products* -->
