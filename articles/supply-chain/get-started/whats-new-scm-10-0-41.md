...
| <p>**Module:** Warehouse management</p><p>**Enhancement:** *Unannounced returns in Warehouse management only mode*</p><p>**Feature management name:** *Warehouse management only mode*</p> | <p>Introduces the capability to receive unannounced returns when using Warehouse management only mode.</p><p>For more information, see [Configure unannounced returns in Warehouse management only mode](../warehousing/wms-only-mode-unannounced-returns-setup.md). </p> |
