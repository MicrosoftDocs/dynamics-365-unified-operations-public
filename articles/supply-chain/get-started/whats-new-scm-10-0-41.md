...
|---|---|---|---|
| Copilot and AI innovation | Follow-up questions in the Copilot sidecar | [Responsible AI FAQ for Follow-up questions in the Copilot sidecar (preview)](../../fin-ops-core/fin-ops/copilot/faq-copilot-suggested-questions.md) | Feature Management:<br>*(Preview) Follow-up questions in the Copilot sidecar*  |
...
| Inventory and logistics | Link transfer order lines with sales order lines <!--KFM: Won't be on release plan --> | [Link transfer order lines with sales order lines](../inventory/pair-transfer-and-sales-lines.md) | Feature management:<br>*(Preview) Pair transfer order lines with sales order lines* |
