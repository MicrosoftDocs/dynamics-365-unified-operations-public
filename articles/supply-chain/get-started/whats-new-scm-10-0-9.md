...
This topic lists features that are either new or changed in Microsoft Dynamics 365 Supply Chain Management 10.0.9. This version <!-- has a build number of XXXX and -->is available as follows:
