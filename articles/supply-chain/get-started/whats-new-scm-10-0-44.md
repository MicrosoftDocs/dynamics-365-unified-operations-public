...
| **Module:** Product information management<br><br>**Feature management name:** *(Preview) Enable foreign trade parameters for all countries* | Adds foreign trade parameters for all previously unsupported countries/regions, including Hong Kong SAR, China, Thailand, Japan, Korea, Malaysia, Russia, and Türkiye. The new settings are available on **Foreign trade** FastTab for released products. |
