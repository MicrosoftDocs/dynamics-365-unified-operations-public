...
| **Module:** Procurement and sourcing<br><br>**Feature management name:** *Copy Prices include sales tax setting from vendor* | Adds the option to copy the vendor's **Prices include sales tax** setting when creating a purchase order from a purchase requisition. If you turn this option off, the **Prices include sales tax** setting isn't copied and is disabled by default when creating a purchase order from a purchase requisition. This feature is already mandatory. |
