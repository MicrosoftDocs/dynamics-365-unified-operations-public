...
Microsoft Dynamics 365 Supply Chain Management 10.0.27 includes platform updates. Learn more in [Platform updates for version 10.0.27 of finance and operations apps (July 2022)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-27.md).

### Bug fixes

For information about the bug fixes included in each of the updates that are part of 10.0.27, sign in to Microsoft Dynamics Lifecycle Services and view the [KB article](https://fix.lcs.dynamics.com/Issue/Details?bugId=673271).
