...
description: Learn about features that are either new or changed in Microsoft Dynamics 365 Supply Chain Management 10.0.29 with a table that outlines feature areas. 
author: kamaybac
ms.author: kamaybac
...
Microsoft Dynamics 365 Supply Chain Management 10.0.29 includes platform updates. Learn more in [Platform updates for version 10.0.29 of Finance and Operations apps (October 2022)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-29.md).

### Bug fixes

For information about the bug fixes included in each of the updates that are part of version 10.0.29, sign in to Microsoft Dynamics Lifecycle Services and view the [KB article](https://fix.lcs.dynamics.com/Issue/Details?bugId=726559).
