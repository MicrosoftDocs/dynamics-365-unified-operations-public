...
| **Module:** Inventory and warehouse management<br><br>**Enhancement:** *Allow inventory transactions consolidation without inventory closing*<br><br>**Feature management name:** *(None)* | Allows the system to consolidate inventory transactions on unclosed inventory for items that use the *Standard cost* or *Moving average* inventory model.<br><br>Learn more in [Consolidate inventory transactions](../inventory/inventory-transaction-consolidation.md). |
