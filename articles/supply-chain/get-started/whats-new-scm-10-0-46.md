...
| Omnichannel commerce | [Enable custom price attributes for POS and e-commerce](/dynamics365/release-plan/2025wave2/enterprise-resource-planning/dynamics365-commerce/enable-custom-price-attributes-pos-e-commerce) | [Add custom pricing attributes for Dynamics 365 Commerce Point of Sale](../unified-pricing-management/upm-support-custom-attributes.md) and [Example custom request handler code](../unified-pricing-management/upm-custom-request-handler-example.md) | Enabled by default. |
