...
|---|---|
| **Module:** Asset management<br><br>**Feature management name:** *Remarks can be associated with each change in lifecycle states* | Allows for remarks to be captured on changes in lifecycle states. Learn more in [Introduction to assets](../asset-management/objects/introduction-to-objects.md) and [Introduction to work orders](../asset-management/work-orders/introduction-to-work-orders.md) |
...
| **Module:** Production control<br><br>**Feature management name:** *(Preview) Record test results from the production floor execution interface* | Allows workers to record test results on quality orders directly from the production floor execution interface. |
