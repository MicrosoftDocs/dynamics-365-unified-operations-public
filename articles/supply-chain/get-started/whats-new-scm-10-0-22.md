...
| Distributed hybrid topology | *(No feature management required)* | This release expands the outbound load planning capabilities of the warehouse management workload for cloud and edge scale units. For details, see [Warehouse management workloads for cloud and edge scale units](../cloud-edge/cloud-edge-workload-warehousing.md) |
