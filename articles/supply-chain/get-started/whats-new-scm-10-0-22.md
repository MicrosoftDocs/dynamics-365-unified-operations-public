...
description: This topic describes features that are either new or changed in Dynamics 365 Supply Chain Management 10.0.22. 
author: kamaybac
ms.date: 08/09/2021
ms.topic: article
...
| Distributed hybrid topology | *(No feature management required.)* | This release expands the outbound load planning capabilities of the warehouse management workload for cloud and edge scale units.<br><br>For more information, see [Warehouse management workloads for cloud and edge scale units](../cloud-edge/cloud-edge-workload-warehousing.md) |
| Engineering change management | Variant generation for engineering products | This feature enables you to generate several variants for an engineering product based on its color, size, style, or configuration dimensions.<br><br>For more information, see [Generate variants for engineering products](../engineering-change-management/engineering-variants.md) |
| Inventory and warehouse management | Inventory Visibility integration with reservation offset | This feature can only be enabled after feature Inventory Visibility Integration is enabled. It provides the functionality to offset reservations made on Inventory Visibility.<br><br>For more information, see [Inventory Visibility reservations](../inventory/inventory-visibility-reservations.md) |
