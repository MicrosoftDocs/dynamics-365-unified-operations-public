...
| Manufacturing | [Material consumption and reservations in the production floor execution interface](#) |  | Feature management (*(Preview) Register material consumption on the production floor execution interface (WMS-enabled)*) |
| Manufacturing | [Register material consumption on scale units](#) |  | Feature management (*Register material consumption on the mobile app on a scale unit*)  |
