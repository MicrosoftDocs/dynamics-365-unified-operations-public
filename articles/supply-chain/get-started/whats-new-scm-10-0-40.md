...
| Copilot and AI innovation | [Generate context-aware insights for warehouse workers](/dynamics365/release-plan/2024wave1/finance-supply-chain/dynamics365-supply-chain-management/generate-context-aware-insights-warehouse-workers) | [AI summaries with Copilot](copilot-summaries-overview.md) | Feature management:<br>*Context-aware worker summary screen in WMA*<br><br>Requires Warehouse Management mobile app version 2.3.2.0 or later. |
| Copilot and AI innovation | AI summaries with Copilot | [AI summaries with Copilot](copilot-summaries-overview.md) | Feature management:<ul><li>Product summary when hovering on item</li><li>Product details summary</li><li>Purchase order summary</li><li>Sales order summary</li><li>Vendor summary</li></ul> |
