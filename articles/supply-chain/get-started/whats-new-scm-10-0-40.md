...
| <p>**Module:** Procurement and sourcing</p><p>**Feature management name:** *(Preview) Ubiquitous Buying*</p> | Enables an API for the Ubiquitous Buying eProcurement Dataverse application, to simplify purchase requisition creation for nonexpert buyers. |
