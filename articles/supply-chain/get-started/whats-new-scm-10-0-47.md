...
This article lists features that are either new or changed in Microsoft Dynamics 365 Supply Chain Management version 10.0.47. This version  has a build number of 10.0.2527 and is available on the following schedule:
...
| --- | --- | --- | --- |
| Production Control | [Automate production reporting with electronic sensors](/dynamics365/release-plan/2025wave2/enterprise-resource-planning/dynamics365-supply-chain-management/automate-production-reporting-electronic-sensors) | [Production auto report scenario (preview)](../sensor-data-intelligence/sdi-scenario-production-auto-report.md) |  Feature management:<br>*(Preview) Sensor Data Intelligence - Auto report progress* |
...
| Sales and marketing | [Manage pricing rules using a generic base currency](/dynamics365/release-plan/2025wave2/enterprise-resource-planning/dynamics365-supply-chain-management/manage-pricing-rules-using-generic-base-currency) | [Manage pricing rules using a generic base currency](../unified-pricing-management/upm-generic-base-currency.md) | Enabled by default |
...
| Sales and marketing | [Simulate prices based on sales order line attributes](/dynamics365/release-plan/2025wave2/enterprise-resource-planning/dynamics365-supply-chain-management/simulate-prices-based-sales-order-line-attributes) | [Simulate prices based on sales order line attributes](../unified-pricing-management/upm-simulate-prices-line-attributes.md) | Enabled by default |
...
| **Module:** Transportation management<br><br>**Enhancement:** *Performance-optimized pro number generation*<br><br>**Feature management name:** *(None)* | If your high-volume processes (such as release to warehouse) run slowly when you're using pro numbers, the new *Performance optimized* pro number generation option can help improve throughput.<br><br>Learn more in [Transportation management number sequence](../transportation/transportation-management-number-sequence.md). |
