...
- [Power Pages documentation](/power-pages/introduction.md)
- [Dynamics 365 templates](power-pages/templates/dynamics-365-apps/overview#supply-chain-management-customer-site.md)
...
- [About Power Pages lifecycle](/power-pages/admin/lifecycle.md)
- [Upgrade a Power Pages site](/power-pages/admin/upgrade-site.md)
- [Migrate website configuration](power-pages/admin/migrate-site-configuration.md)
