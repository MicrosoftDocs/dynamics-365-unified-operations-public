...
1. Save the configuration.
    ...
    > [!IMPORTANT]
    > To save the configuration, you must have either the *Administrator* or *Commerce Payment Administrator* role in Microsoft Power Platform.
...
1. To check the latest status, select **Check status** to reload the current payment link status. This page also has a **Cancel** button to cancel the payment link. The payment link can only be canceled if the customer hasn't yet used the link for payment.
