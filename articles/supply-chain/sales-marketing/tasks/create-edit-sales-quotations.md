...
1. Select **New**.
1. In the **Account type** field, select 'Prospect'.
1. In the **Prospect** field, enter or select a value.
1. Expand the **General** section. Because you chose to create a quotation from the Sales and Marketing area, the type is automatically set to *Sales quotation*. To create a quotation for a project, you must access it from the **Project management and accounting** module.
1. Select **OK**. The fields and actions on the quotation lines are very similar to the ones on the sales order lines. Like sales orders, quotations can be created for a specific item or, when item number isn't known or doesn't exist at the time of quotation creation, quotations can be created for a sales category.
1. In the **Item** field, enter or select a value.
1. In the **Site** field, type a value.
1. In the **Quantity** field, enter a number. If there are valid trade agreements for the item selected on the line, the applicable price and discounts will be automatically copied to the quotation line. Make sure that the Unit price field contains a value and you can also enter discount values if you want to.
1. Select **Save**.
1. On the Action Pane, select **Sales quotation**.
1. Select **Totals**.
1. Select **OK**.
1. Select the sales quotation line.
1. On the Action Pane, select **Quotation**.
1. Select **Price simulation**.
...
1. Select **OK**. The report might take a minute to generate. Don't close the page until it finishes.

## Update a sales quotation

1. Go to **Sales and marketing > Sales quotations > All quotations**.
1. On the Action Pane, select **Follow up**.
1. Select **Convert to customer**.
1. In the **Customer account** field, type a value.
1. Select **Check**. Make sure you see a message that the account number you typed in is free to use.
1. Select **OK**. The system has now created a new customer account for the prospect on the quotation.
1. Close the page.
1. On the Action Pane, select **Follow up**.
1. Select **Confirm**.
