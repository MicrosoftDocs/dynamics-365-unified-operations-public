...
1. In the **Navigation pane** located in the upper left corncern, go to **Modules > Sales and marketing > Sales orders > All sales orders**.
...
7. In the **Color** field, select the drop-down button to open the lookup.
