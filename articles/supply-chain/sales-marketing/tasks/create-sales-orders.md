...
2. Select **Totals**.
    ...
    The **Totals** dialog displays details about the entire order. This includes the subtotal amount, which is a sum of all line net amounts adjusted for eventual line discounts, the total invoice amount, which is a subtotal amount adjusted for eventual order-level discount, charges, and sales tax, the customer credit limit situation, and more. The invoice amount is the amount that will appear on the customer's invoice document.  

3. Select **OK**.

> [!TIP]
> For examples of how sales totals and discounts are calculated when prices include sales tax compared to when prices don't include sales tax (including how related values are shown on the **Totals** dialog) see [Calculating sales totals when prices include sales tax](../sales-tax-calculation.md).
