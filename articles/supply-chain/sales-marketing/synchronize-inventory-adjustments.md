...
1.  Data integration -> Connection sets
2.  Select the used Connection set
3.  On the tab Integration key ensure that the following keys are added to msdynce_externalproductinventories:
      msdynce_productnumber (Product Number)  &  msdynce_warehouseid (Warehouse Id)
