...
If several companies can deliver the same item, you can freely choose whom to buy from, and updates are processed even if one sales order becomes several purchase orders. In case of demand explosion of a bill of materials (BOM) version in original sales order, which creates a demand for each BOM line item at a specific site and, possibly, at a specific warehouse. Neither product bundle items nor BOM explosions are supported for intercompany sales orders and intercompany purchase orders.
