...
Assign a disposition code an item is received or during the physical inspection of a returned item. Use disposition codes to describe the condition of the item. You can also use disposition codes to indicate whether additional action is required for the transaction. For example, create disposition codes for the following actions:
