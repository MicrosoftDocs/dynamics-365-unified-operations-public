...
You can cancel only sales orders and return orders that are in a *Created* state. For more information, see [Cancel a return order](cancel-return-order.md).
...
## Is there a way to calculate commissions on invoices that are already posted?
