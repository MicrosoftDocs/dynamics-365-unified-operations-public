...
## Prerequisites for the role-based access feature
...
- The feature that's named *Role-based access control for work order lifecycle stages* must be turned on in [Feature management](../../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md). As of Supply Chain Management version 10.0.45, this feature is turned on by default. As of Supply Chain Management version 10.0.47, this feature is mandatory and can't be turned off.
