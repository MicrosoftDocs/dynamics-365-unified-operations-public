...
You can also create maintenance worker groups and associate maintenance workers with them. This functionality is useful when you do simple work order scheduling, and you want to schedule a group of maintenance workers on a work order. You can use maintenance workers and maintenance worker groups to set up preferred maintenance workers and responsible maintenance workers. For more information about these two types of workers, see [Set up preferred maintenance workers](../work-order-scheduling/set-up-preferred-workers.md) and [Responsible maintenance workers](../setup-for-requests/responsible-workers.md).
