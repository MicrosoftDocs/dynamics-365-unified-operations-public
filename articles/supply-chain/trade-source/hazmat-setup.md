...
| **Print&nbsp;field** | Defines the field you wish to include in the shipping text. Not all fields on the material will be available to print here, just the common ones used in the various regulations for defining shipping text. You should define the first print field as sequence zero (0) to be the field separator. You only need one reference to the field separator that will be used between the fields.<p>The following values are available for **Print** field:</p><ul></li><li>**Field separator** - This represents the field separator to use for the text. There only needs to be one field separator in the sequence. Usually you should put this at sequence 0. The system will look for a field separator and use the first one in the list. The text value used in the string will come from the **Print after** field. </li><li>**Identification** - Places the [identification code](#identification) in the print text. </li><li>**Class** - Places the [class code](#classes) in the print text. </li><li>**Division** - Places the [division code](#divisions) in the print text. </li><li>**Packing group** - Places the [packing group code](#packing-group) in the print text. </li><li>**Tunnel code** - Places the [tunnel code](#tunnel) in the print text. </li><li>**Proper shipping name** - Places the [proper shipping name](hazmat-items.md#hazmat-description) in the print text.</li><li>**Technical name** - Places the [technical name](#technical-name) in the print text. </li><li>**Transport category** - Places the [transport category code](#transport-category) in the print text. </li><li>**Stowage** - Places the [stowage code](#stowage) in the print text.</li><li>**Fixed text** - Enter custom text to be added to the print text. </li><li>**Label code** - Places the [label code](#label) in the print text. </li><li>**Aircraft packing** - Used to print the [aircraft packing instructions](#packing-instruction) in the print text. </li><li>**Limited quantity** - Checks whether the item is marked as [limited quantity](hazmat-items.md#material-management) and, if so, places a predefined note about this in the print text. </li><li>**Packing description** - Places the [packing description](#packing-description) in the print text.</li></ul> |
| **Print&nbsp;before** | When the print field is selected, this character will be inserted before the print field. |
| **Print&nbsp;after** | When the print field is selected, this character will be inserted after the print field. |
| **Print with previous** | Sometimes a print field is optional or included with another print field. Select this option to avoid printing the field separator. |
| **Fixed text** | If you define the print field as fixed text, then enter the fixed text to be printed. The fixed text will also be used if the item is marked as limited quantity. Enter the text to print if you select limited quantity in the print field. |
| **Include in print** | After you select a print field, you can determine if the code or description prints by selecting the option in the include in print field. You can choose between printing the code, description or both the code and description. |
