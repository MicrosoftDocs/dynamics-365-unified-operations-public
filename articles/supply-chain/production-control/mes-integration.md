...
The **Manufacturing execution systems integration** page works the same way as the **Message processor messages** page and represents very similar functionality (and even displays MES messages in addition to other types of messages). See [Message processor messages](../admin/message-processor.md) for details about how to use either of these pages to review messages, find and fix failed messages, and more.
