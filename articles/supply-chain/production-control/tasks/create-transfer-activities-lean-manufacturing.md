...
description: Learn how to create a transfer activity for lean manufacturing, including step-by-step processes for finding production flow versions and creating new activities.
