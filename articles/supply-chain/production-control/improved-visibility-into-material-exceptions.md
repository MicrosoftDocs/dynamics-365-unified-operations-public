...
When the tile is selected, the **All production waves** page is opened. This page is filtered by the number of open waves that contain wave lines from released BOM and formula lines that meet the criteria for the tile. 

### Manually maintain production waves
From the **All production waves** page you can manually *Process* and *Release* the wave and via the **Maintain productions** option you can inquire and maintain the **Prod BOM pool** data which is used to handle the waving process.
