...
The warehouse management workload is the first distributed workload for scale units to be released for general availability. It enables your warehouse operations to scale and run in a resilient environment using isolated maintenance windows. The warehouse management workload supports most enterprise hub warehouse management processes. For more information, see [Warehouse management workloads for cloud and edge scale units](cloud-edge-workload-warehousing.md).
