...
In the following the warehouse management executions within an edge scale unit defined warehouse is called as a **Warehouse execution system (WES)**.

## Prerequisites
You must have a fully deployed cloud and edge scale unit setup. You can read more about the architecture and deployment process [here](cloud_edge-landingpage.md). 
