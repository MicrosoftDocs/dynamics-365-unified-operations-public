...
| Production type | <!-- KFM: Confirm these descriptions. --> This setting only appears when you have enabled [formula change management](manage-formula-changes.md) on your system. Select the type of production this release policy applies to. Select one of the following:<ul><li>**Co-product** – Use this release policy to manage co-products. Co-products are produced during process manufacturing and aren't versioned or engineering products. </li><li>**By-product** – Use this release policy to manage by-products. By-products are produced during process manufacturing and aren't versioned or engineering products. <!-- KFM: Clarify and add the following, also for co-products (previous bullet): "Release policies for by-products can help make sure that important **settings** such as storage and tracking dimensions are set up with a released product **template** before **they** are released to a company." --></li><li>**None** – Use this policy to manage standard products that are not versioned or engineering products, nor co- or by-products.</li><li>**Planning item** – Use this release policy to manage planning items produced using process manufacturing. Planning items use formulas and are similar to formula items, but are only used to produce co- and by-products, not finished products.</li><li>**BOM** – Use this release policy to manage engineering products, which do not use formulas and typically (but not necessarily) include bills of materials (BOM). </li><li>**Formula** – Use this release policy to manage finished items produced using process manufacturing. These items will have a formula, but not a BOM.</li></ul>. |
