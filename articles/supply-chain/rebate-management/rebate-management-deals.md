...
| Claim per | Specify how often rebate monies can be claimed for the deal line. Enter an integer here and then specify a unit in the **Claim by** field. <!-- KFM: Royalties only? --> |
| Claim by | Specify the unit that applies to the **Claim per** setting. Set this to *Lifetime* to allow claims just once over the entire lifetime of the deal. <!-- KFM: meaning, just once for the FROM and TO range specified for this date line? --> Select *Customized period* to choose a period defined in the general ledger, in which case you must also make a selection for the **Period type** field. <!-- KFM: Royalties only? --> |
| Claim period type | The claim period type is only available for selection if the **Claim by** field is set to *Customized period*. The values available here come from the period types defined in the general ledger. <!-- KFM: Royalties only? --> |
...
| Guarantee paid | This setting only applies to royalty deals. It works in conjunction with the **Guarantee per** field to determine the frequency of the guarantee calculation. Choose one of the following:<ul><li>*Beginning of period* - The guarantee is paid up front, at the beginning of the  agreement period, as defined for the date line. The full guarantee is processed first. Only the value of the royalties over the guaranteed amount are posted as a royalty.<br><br>For example:<!-- KFM: I don't understand this example. Also, what is A - C?? --><br>Guarantee minimum: $10,000 over 2 months<br>Month 1: $10,000 would be posted and $0 in royalties posted.<br>Month 2: $2,000 would be posted to royalties and $0 in guarantee.<br><br>Working calculation:<br>A – C = -$2,000, a royalties payment of $2,000 is required, therefore a journal is created for $2,000<br><br>**Note**: The guarantee should be calculated and posted along with the deductions provision for the first period.<br><br></li><li>*End of period* - The guarantee is not paid until the end of the deductions agreement as defined for the date line.<br><br>For example:<!-- KFM: I don't understand this example either. Also, what is A + B? --><br>Guarantee minimum: $10,000 over 2 months<br>Month 1: $5000 posted as royalty and journal created<br>Month 2: $7000 posted as royalty and journal created<br><br>Working calculation:<br>A + B = As the royalties exceed the guarantee amount, $0 will be posted to the guarantee.<br><br>**Note**: The guarantee should only be calculated and posted along with the deductions and rebates transaction for the final period. |
