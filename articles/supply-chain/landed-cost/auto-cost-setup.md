...
| Setting | Description |
| --- | --- |
| **Account Code** | Select one of the following values:<ul><li>**Table** - The cost rule applies only to the specified vendors.</li><li>**Group** - The system will look for the vendor cost group associated with the vendor record to apply the cost rule to.<!--KFM: Add a link for more info on vendor cost groups. --></li><li>**All** - The cost rule applies to all vendors. |
...
| **Item code** | Select one of the following values:<ul><li>**Table** - The cost rule applies only to the specified items.</li><li>**Group** - The system will look for the item cost group associated with the item record to apply the cost rule to.<!--KFM: Add as link for more info on item cost groups. --></li><li>**All** - The cost rule applies to all items.|
...
| **Mode of delivery** | Select the mode of delivery (such as air or sea) where this cost applies. |
...
On the **Lines** FastTab, add a row for each currency that could be used when applying a cost to a purchase order line on a voyage. 

For items and purchase orders, the system will match the currency of each purchase order line against the currencies specified here on the **Lines** FastTab, and will only apply the cost value set for the matching line or item. If there is no line set up for the currency of the line or item, that line or item will not have the auto cost applied to it.

For other types of cost areas, all lines on the **Lines** FastTab will apply for each voyage, shipping container, folio, or transfer order line that matches the values established in the header.  
...
| **Broken by quantity** | <p>Select this check box to enable the **Quantity breaks** button on the **Lines** toolbar. Quantity breaks allow the cost to be broken down and have different costs depending on the quantity on the purchase order line of the voyage. This is often used when the mode of delivery is air. To use this option, the **Category** for the line must be set to *Rate*.</p><p>The quantity pertains to the option selected for the **Apportionment method**. The cost value will be up to the quantity entered in the **Cost value** field. For example:</p><ul><li>Quantities of 45-100kg result in a charge of $6.00 per measurement (such as kg/m³)</li><li>Quantities of over 100kg result in a charge of $5.50 per measurement (such as kg/m³)</li></ul> |
