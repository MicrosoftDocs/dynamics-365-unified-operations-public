...
| Field | Description |
|---|---|
| **Account code** | <p>Select one of the following values:</p><ul><li>**Table** – The cost rule applies only to a specific vendor.</li><li>**Group** – The cost rule applies to a specific vendor group. The system will look for the vendor cost group that is associated with the vendor record.<!--KFM: Add a link for more info on vendor cost groups. --></li><li>**All** – The cost rule applies to all vendors. |
| **Shipping company** or **Customs broker** | Select the vendor or vendor group that the cost rule applies to. This field is available only if you select *Table* or *Group* in the **Account code** field. |
| **Item code** | <p>Select one of the following values:</p><ul><li>**Table** – The cost rule applies only to a specific item.</li><li>**Group** – The cost rule applies to a specific item group. The system will look for the item cost group that is associated with the item record.<!--KFM: Add as link for more info on item cost groups. --></li><li>**All** – The cost rule applies to all items.|
...
| **Mode of delivery** | Select the mode of delivery (such as air or sea) that the cost applies to. |
