...
| <p>**Feature name:**<br>*(Preview) Match vendor invoice journal with voyage cost in different currency.*</p><p>**Version required:**<br>10.0.36 or later</p> | This feature for the Landed cost module lets users specify a currency code on the vendor invoice journal and match it with voyage cost in another currency. |
| <p>**Feature name:**<br>*(Preview) Enable Quality Control for Goods In-Transit Order.*</p><p>**Version required:**<br>10.0.39 or later</p> | With this feature, Goods in transit orders seamlessly integrate into the quality order reference types. Customers gain the capability to initiate the quality management process, ensuring a heightened level of product quality throughout the Goods in transit order process. This is private preivew feature. |
