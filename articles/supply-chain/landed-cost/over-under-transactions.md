...
> [!NOTE]
> The system will first verify if the received PO total amount falls within the Amount tolerance. If it does, then system will proceed to check the percentage tolerance to manage over/under delivery scenarios.
