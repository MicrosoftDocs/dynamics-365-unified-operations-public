...
1. Follow one of these steps:
    ...
    > [!NOTE]
    > For improved performance of the **Voyage Editor** page, it is recommended to select a narrow date range and specify either the purchase or transfer order ID as filters.
