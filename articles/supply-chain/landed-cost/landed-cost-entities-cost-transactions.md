...
In the case where no value exists in either the mapping table or the record submitted to the entity, the creation will fail.

### Apportionment mapping entity (ITMApportionmentMapping)

A data entity for the creation of apportionment mapping relationships is available so that users can create or update records.
...
This entity creates voyage cost transactions that are applied at the voyage level. During the import process, the system uses the **category** and **apportionment method** values included in the entity to determine how the **value** of the cost is apportioned across the contents of the voyage.
...
This entity creates shipping container costs that are applied at the shipping container level. During the import process, the system uses the **category** and **apportionment method** values included in the entity to determine how the **value** of the cost is apportioned across the contents of the shipping container.

The fields **aggregate**, **leg** and **linked leg** are specific to the **cost area** of *shipping container* and so are not present in data entity for other cost areas.
...
The folio cost entity creates cost transaction records that apply to the Folio level. During the import process, the system uses the **category** and **apportionment method** values included in the entity to determine how the **value** of the cost is apportioned across the contents of each folio.
...
The purchase order cost entity creates cost transactions that apply to the purchaser order header. During the import process, the system uses the **category** and **apportionment method** values included in the entity to determine how the **value** of the cost is apportioned across the contents of each folio.
...
The item cost Cost entity creates cost transactions that apply to the item level, this is specific to items on purchase order lines. The **value** of the cost is applied in full to the line.
...
The transfer line cost entity creates cost transactions that apply to the transfer order line level. The **value** of these costs will be applied in full to the transfer order line.
