...
- [Advanced load building during a wave](/dynamics365-release-plan/2019wave2/dynamics365-supply-chain-management/advanced-load-building-during-wave)<br> - Learn more in [Advanced load building during wave](../warehousing/advanced-load-building-during-wave.md).

- [Auto-release shipment for cross dock](/dynamics365-release-plan/2019wave2/dynamics365-supply-chain-management/auto-release-shipment-cross-dock)<br> - Learn more in [Auto-release shipment for cross-docking](../warehousing/auto-release-shipment-for-cross-docking.md).
...
- [Flexible warehouse-level dimension reservation](/dynamics365-release-plan/2019wave2/dynamics365-supply-chain-management/flexible-warehouse-level-dimension-reservation)<br> - Learn more in [Flexible warehouse-level dimension reservation policy](../warehousing/flexible-warehouse-level-dimension-reservation.md).

- [Improved job card device](/dynamics365-release-plan/2020wave1/dynamics365-supply-chain-management/improved-job-card-device)<br> - Learn more in [Report progress on a mobile job device](../production-control/tasks/report-progress-mobile-job-device.md) and [Report as finished from the job card device](../production-control/report-finished-job-device.md).
...
- [Outbound sorting](/dynamics365-release-plan/2019wave2/dynamics365-supply-chain-management/outbound-sorting)<br> - Learn more in [Outbound sorting](../warehousing/outbound-sorting.md).
...
- [Visual scheduling for work orders in Asset Management](/dynamics365-release-plan/2020wave1/dynamics365-supply-chain-management/visual-scheduling-work-orders-asset-management)<br> - Learn more in [Work with scheduled work orders using a gantt chart](../asset-management/work-order-scheduling/schedule-work-orders.md#gantt).

- [Warehouse slotting](/dynamics365-release-plan/2019wave2/dynamics365-supply-chain-management/warehouse-slotting)<br> - Learn more in [Warehouse slotting](../warehousing/warehouse-slotting.md).
...
- [Wave step code](/dynamics365-release-plan/2019wave2/dynamics365-supply-chain-management/wave-step-code)<br> - Learn more in [Wave step codes](../warehousing/wave-step-codes.md).

## Related information

### Platform update 33

Microsoft Dynamics 365 Supply Chain Management 10.0.9 includes Platform update 33. Learn more in [Preview features in Platform update 33](../../fin-ops-core/fin-ops/get-started/whats-new-platform-update-33.md).
