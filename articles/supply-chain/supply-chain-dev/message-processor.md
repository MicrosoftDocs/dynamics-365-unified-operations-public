...
- **Message queue** – The name of the queue that the message will be processed in. The following queues are provided:
    ...
    - *Warehouse*  – This queue holds messages that are created for warehouse management, such as to post a sales packing slip when closing the last shipment container as part of a [manual packing process](../warehousing/packing-containers.md) (this message has a **Message type** of *Run packing slip for container*).
