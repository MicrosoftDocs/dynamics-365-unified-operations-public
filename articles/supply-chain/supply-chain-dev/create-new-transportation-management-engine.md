...
1. On the next page, select **Create new package**.

   :::image type="content" source="../transportation/media/021.png" alt-text="Creating a new package." lightbox="../transportation/media/021.png":::

1. On the next page, select the **ApplicationSuite** model to reference. (The *ApplicationPlatform* model is preselected.)

   :::image type="content" source="../transportation/media/032.png" alt-text="Selecting the model to reference." lightbox="../transportation/media/032.png":::

1. On the next page, select **Finish** to confirm the creation of a new model.
...
This section explains how to set up Supply Chain Management to use a TMS engine, and shows how the new engine that you created is used in rate shopping. The example in this section uses the USMF demo data company.
...
1. On the **Rate route workbench** page, select **Rate shop**. You should see a rate of 100.00 from SampleCarrier, as shown in the following screenshot. In this example, you're rate shopping for a route from warehouse 24 to customer US-004. However, but because the rate is hard-coded, you always see a rate of 100.00.
