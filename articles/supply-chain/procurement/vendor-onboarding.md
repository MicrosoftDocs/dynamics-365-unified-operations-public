...
> [!TIP] If a prospective vendor sees following error message, then assign the *System external user* and *Vendor prospective (external)* security roles their user account:
>
