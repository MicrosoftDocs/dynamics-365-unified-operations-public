...
> [!TIP]
> If a prospective vendor sees following error message when trying to sign in, then assign them the *System external user* and *Vendor prospective (external)* security roles:
>
> *Access Denied: You do not have sufficient permissions to open the menu item VendProspectiveVendorRegistrationWizard. Please contact your system administrator.*
