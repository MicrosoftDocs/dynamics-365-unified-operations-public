...
- *Purchase order* – Purchase orders can't be created for the vendor but meanwhile it's possible to proceed with any open invoices or payments to vendor. This option is available only when *Put vendor on hold for purchase orders* feature is enabled. For more information, see [Feature management overview](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).
