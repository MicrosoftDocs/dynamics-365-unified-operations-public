...
Learn how to set up and use Icertis for Microsoft Dynamics 365 Supply Chain Management on [Microsoft AppSource](https://appsource.microsoft.com/product/dynamics-365-for-operations/icertiscontractmanagement.icertis-dynamics-supply-chain-operations)).
