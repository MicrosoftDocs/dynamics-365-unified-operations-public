...
2.  Click on the tile “vendor bidding”

3.  In the list of New bid invitations find the RFQ that was just sent

4.  Select the RFQ, and you can see what have been requested.

5.  Click RFQ attachments to see any attachments added
...
3.  Select the reply you want to score.

4.  Click Header to go to the scoring of the bid.
...
11. Repeat the process for all bids
