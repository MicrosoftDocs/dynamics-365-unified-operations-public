...
- Evaluating if supplier proposals for expediting, new dates and/or quantities solve the impact. This can be alternatives that come out of follow-up converstaions with the supplier for changes with impact.
