...
1. Enter the following information into the dialog:
    ...
    - **Message** – Enter or paste the body of the email. You could copy this content from the body of an existing email that you want to try or just enter a fictional message.
