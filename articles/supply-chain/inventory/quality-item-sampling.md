...
1. Make the following settings in the header of your new record:
    ...
    - **Use acceptance sampling charts** – Choose whether to use acceptance sampling with this record. Learn more in [Acceptance sampling](quality-acceptance-sampling.md).
1. If you're using acceptance sampling, then fill out the settings provided on the **Acceptance sampling** FastTab. Learn more about how to use these settings in [Acceptance sampling](quality-acceptance-sampling.md).
1. If you're using sample management, then fill out the settings provided on the **Sample management** FastTab to set up inline or continuous sampling. Learn more about how to use these settings in [Enable and configure sample management](quality-sample-management-admin.md).
