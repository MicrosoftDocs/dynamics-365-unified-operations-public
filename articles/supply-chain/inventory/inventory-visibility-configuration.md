...
| *onHandIndexQueryPreloadBackgroundService* | This feature provides capability to preload Inventory Visibility onhand query to assemble onhand list with pre-selected dimensions. The default synchronization frequency is once every 15 minutes. For more information, see [Inventory summary](inventory-visibility-power-platform.md#preload-the-inventory-visibility-onhand-query). |
