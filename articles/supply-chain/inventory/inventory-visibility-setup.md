...
1. In the list, find the row where **Name** is *Dynamics 365 Inventory Visibility*. Check the value in the **Status** column for this row
    - If the **Status** is *Installed*, then you are already running the latest version so you can skip the rest of this procedure.
...
1. A pop-up window opens asking you to confirm the action. To proceed, enter the name of the environment and then select **Update**.
