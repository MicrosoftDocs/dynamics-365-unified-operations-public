...
If you're running Supply Chain Management version no older than 10.0.18, you can skip this deployment session and jump to [set up Inventory Visibility integration](#setup-inventory-visibility-integration).
