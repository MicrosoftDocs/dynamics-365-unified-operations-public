...
Compared to regular items:
 ...
 - You may experience empty rows (row 2 below) which inform that there is no on-hand and reservations and orders on this dimension right now, but there had been.
