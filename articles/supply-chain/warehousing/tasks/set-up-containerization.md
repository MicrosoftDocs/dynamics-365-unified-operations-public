...
8. In the **Wave step code** field, type a value.
...
1. In the navigation pane, go to **Modules > Warehouse management > Setup > Containers > Container types**.
...
7. Select **Save**.
8. Select **Containier mixing constraints**.
