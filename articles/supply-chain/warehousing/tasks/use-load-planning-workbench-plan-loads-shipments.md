...
1. Select account *US-004*.
1. Select **OK**.
1. In the **Item number** field, select the drop-down button to open the lookup.
1. Select item *A0001*. *A0001* is enabled for transportation management.  
1. In the **Site** field, select the drop-down button to open the lookup, and then select an item.
1. In the **Quantity** field, enter a number.
1. In the **Warehouse** field, type *24* for this example. This warehouse is enabled for transportation management and warehouse management processes (WMS).  
1. Select **Save**.
1. Close the page.
