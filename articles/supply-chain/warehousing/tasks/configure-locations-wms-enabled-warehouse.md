...
1. In the list, find and select the desired record.
1. In the list, select the link in the selected row.
1. Select or clear the **Allow mixed inventory statuses** check box. Enable this option if you want to allow mixed inventory status values in the locations greouped by this location profile.
...
1. Go to **Warehouse management** > **Setup** > **Warehouse** > **Warehouse zone groups**. Wwarehouse zones can be filters for options to control the different warehouse management processes. You need to create a zone group before you can define a zone.
1. Select **New**.
...
2. In the **Warehouse** field, select the dropdown to open the lookup.
3. In the list, find and select the desired record.
1. In the list, select the link in the selected row.
5. In the **Zone ID** field, select the dropdown to open the lookup.
1. In the list, find and select the desired record.
1. In the list, select the link in the selected row.
8. In the **Location profile ID** field, select the dropdown to open the lookup.
1. In the list, find and select the desired record.
1. In the list, select the link in the selected row.
