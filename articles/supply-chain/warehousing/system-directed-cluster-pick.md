...
Cluster profiles control how each cluster will be created by the system. If different clusters are needed, different cluster profiles should be created, one for each mobile device menu item.
