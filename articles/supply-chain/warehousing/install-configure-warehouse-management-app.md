...
1. It requires a unique Azure AD user for each worker. **These AD users should have as few permissions as possible in AAD and F&O and be limited to warehouse mobile app worker activities.**
