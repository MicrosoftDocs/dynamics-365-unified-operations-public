...
1. To use the device code flow for user authentication, configure two additional settings in your app registration.
...
## User authentication by the device code.
