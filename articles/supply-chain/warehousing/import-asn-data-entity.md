...
> [!NOTE]
> If you are importing an inbound shipment order (`MODULE="InboundShipmentOrder"`), the `ORDERNUMBER` value must correspond to an external (source system) order number.
