...
description: This article explains how to configure it to connect with user-based authentication to your Microsoft Dynamics 365 Supply Chain Management environment.
author: pavlodatsiuk
...
1. Complete the following steps to use the [device code flow](#authenticate-devicecode) to authenticate devices, follow the steps to set it up, and grant the required API permissions.
