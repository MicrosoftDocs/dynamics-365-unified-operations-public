...
<!-- KFM: I assumed all code examples in this topic were JSON. Please confirm (search) -->
...
> - When creating label layouts using variables, use the full path and file name of the label (as seen in the **Path** field in **File Properties**) for the `LabelFile` system variable.  <!-- KFM: Where are these field names found? What are we looking at here? Maybe these aren't field names? I'm not sure what a system variable is or how to find it. -->
...
> [!NOTE]
>
> - When creating label printers, use the name of the printer installed on the computer(s) running the NiceLabel Automation Service. <!-- KFM: Not sure what we mean by "creating label printers"-->
> - When creating label layouts using variables, use the full path and file name of the label (as seen in the **Path** field in **File Properties**) or the label file's URL (also seen in the **File Properties**) for the LabelFile system variable. <!-- KFM: Where are these field names found? What are we looking at here? Maybe these aren't field names? -->
