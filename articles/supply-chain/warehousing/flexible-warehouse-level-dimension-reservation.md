...
|    Full button - split work line due to overflow on user location.     |    Allow splitting of work option (on the mobile device menu item) is enabled.  |    n/a     |    Click **Full** menu item on the WMA when processing a pick work. Enter partial quantity of the required pick in the **Pick Qty** field to indicate the full capacity. |    <ul><li>On the current work, quantity is updated to the remaining to pick.</li><li>New work for the picked quantity is created and closed.</li></ul>  |    n/a   |
