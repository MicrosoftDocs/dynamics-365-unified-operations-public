...
- **Delete if not updated for this many days** - Use this field to reduce the risk of deleting on-hand entries that are still in use. Enter a value of "0" (or leave blank) to allow cleaning up as often as possible.
