...
The Warehousing app for Microsoft Dynamics 365 Finance and Operations has been tested with a selection of Android powered devices for barcode scanning, but the tests only cover a sample of the devices that are available on the market.
