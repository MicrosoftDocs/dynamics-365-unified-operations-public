# Connect the warehousing app to your Supply Chain Management environment
...
1. Make sure that the Active Directory instance is the one that is used by Supply Chain Management.
