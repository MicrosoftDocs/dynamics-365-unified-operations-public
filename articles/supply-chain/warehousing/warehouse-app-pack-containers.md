...
|New container                                                | (Yes)     | Via **Container creation** mobile device menu item incl. container type capturing, but it is only possible to use a number sequence as part of a auto creation setup process when closing a container |
