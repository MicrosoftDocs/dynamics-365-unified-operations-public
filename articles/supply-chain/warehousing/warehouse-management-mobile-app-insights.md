...
- The feature that is named *Context-aware worker summary screen in WMA* must be turned on in [feature management](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md). (On by default as of Supply Chain Management version 10.0.39.)
