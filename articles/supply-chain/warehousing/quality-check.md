...
1. The next screen is **Purchase orders: Put**. Details of Put work are displayed:
    - **LOC** - System determined
        - This will be the designated put away location for purchase order receiving.
...
1. The **Qty** field is now available, enter *1* and confirm.
1. Next the **Quality check** screen is displayed.
    - For this receipt, the pallet will be accepted for quality and the pallet will be put into a bulk put away location.
