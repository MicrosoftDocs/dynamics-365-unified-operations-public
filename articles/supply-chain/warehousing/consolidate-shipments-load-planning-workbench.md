...
Go to **Accounts receivable > Orders > All sales orders** and create the collection of sales orders with the settings described in the following subsections.
...
1. Find and select all of sales order lines from one of the order sets you created for this scenario.
