...
1. Set up the ER Framework: Configure the ER parameters in D365 to enable label printing. Follow intrsuctions [Design a new ER solution to print ZPL labels](../../fin-ops-core/dev-itpro/analytics/er-design-zpl-labels).
