...
1. On each new line, set the fields as described in the following table.
    ...
    | From quantity | Enter the starting range of the quantity of the items that work should be performed for. Specify the quantity in the unit of measure that is selected in the **Unit** field. |
    | To quantity | Enter the ending range of the quantity of the items that work should be performed for. Specify the quantity in the unit of measure that is selected in the **Unit** field. |
