...
1. On the **General** FastTab, make the following settings:
    ...
    - **Unit** – . <!-- KFM: What does this unit apply to? The container dimension values? What about volume and weight? --> If you will configure your system to use this container type for calculating [location stocking limits](#stocking-limits)), you must specify a unit here. The system is able to convert between units used by different container types when calculating location stocking limits.
