...
- Simplified authentication set up by providing an option that doesn't require you to register or maintain your own Microsoft Azure Entra ID application.
