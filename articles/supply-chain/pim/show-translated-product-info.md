...
- You're running Microsoft Dynamics 365 Supply Chain Management version 10.0.31 or later.
- The feature named *Display product info in user's language* is turned on in [feature management](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).

## Turn the feature on or off in your system

Before you can use this feature, you must turn it on in your system. Admins can use the [feature management](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) settings to check the status of the feature and turn it on. In the **Feature management** workspace, the feature is listed in the following way:
...
1. On the **General** tab, in the **Product identification** section, set the **Display product info in user's language** option to one of the following values:
    ...
    - *No* – Always show product names and descriptions in the system language in the UI, regardless of each user's preferred language setting. Translated product names and descriptions are still used in printed documents.
...
Follow these steps to select your preferred language. This language is used for all UI elements and might also be used for product names and descriptions (if they're entered and enabled as described earlier in this article).
