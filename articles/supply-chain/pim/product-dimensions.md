...
The following areas don't support the version dimension (you can still use these areas but you won't be able to add versioned products (products where the version dimension is used)). For example, you can't add a versioned item to a vendor catalog. This is because the introduction of this version dimension would cause breaking changes.
