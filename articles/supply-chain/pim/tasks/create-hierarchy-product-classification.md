...
1. In the **Name** field, type a value.
1. In the **Code** field, type a value.
1. In the **Friendly name** field, type a value.
1. Select **New** category node.
1. In the **Name** field, type a value.
1. In the **Code** field, type a value.
1. In the **Friendly name** field, type a value.
...
1. On the Action Pane, select **Category hierarchy**.
1. Select **Associate hierarchy type**.
1. Select **New**.
1. In the **Category hierarchy type** field, select an option. Select the **Commodity code category hierarchy type for product classification**.  
1. In the **Category hierarchy** field, select the drop-down button to open the lookup.
1. In the list, find and select the desired record.
