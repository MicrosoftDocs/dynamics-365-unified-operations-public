...
| Product number sequence | Item number sequence | Mapping of the item number | Mapping of the product number | Result of entity import | Result of manual creation | Conclusion |
|--------------------------------|-----------------------------|----------------------------|-------------------------------|-------------------------|----------------------------|-----------|
