...
![LIFO Date without the Include physical value option.](./media/LIFODateWithoutIncludePhysicalValueV2.gif) 
...
![LIFO Date with the Include physical value option.](./media/LIFODateWithIncludePhysicalValueV2.gif) 
...
The following illustration shows the effects of the LIFO Date inventory model when marking between issues and receipts is used. ![LIFO Date with Marking.](./media/LIFODateWithMarkingV2.gif) 
