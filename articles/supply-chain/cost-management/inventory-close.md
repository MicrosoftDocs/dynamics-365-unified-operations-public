...
> [!NOTE] 
> - Inventory close is a required step in the month-end closing procedure for all inventory models except moving average. You will be warned to close the financial period without performing the inventory close as of the period end date.
