...
:::image type="content" source="media/module-sidebar.png" alt-text="Screenshot of the Rebate management module sidebar view." lightbox="media/module-sidebar.png":::
...
:::image type="content" source="media/new-attribute-based-form.png" alt-text="Screenshot of the updated UI for creating new rebate management deals." lightbox="media/new-attribute-based-form.png":::
...
:::image type="content" source="media/attribute-customer-rebate.png" alt-text="Screenshot of attribute-based customer rebates." lightbox="media/attribute-customer-rebate.png":::

:::image type="content" source="media/non-attribute-customer-rebate.png" alt-text="Screenshot of non-attribute based customer rebates." lightbox="media/non-attribute-customer-rebate.png":::
...
:::image type="content" source="media/non-attribute-customer-royalty.png" alt-text="Screenshot of non-attribute based customer royalties." lightbox="media/non-attribute-customer-royalty.png":::

All vendor rebate deals are non-attribute based. You can access them by using the **Vendor rebate deals** page.

:::image type="content" source="media/vendor-deals.png" alt-text="Screenshot of vendor rebate deals." lightbox="media/vendor-deals.png":::
...
:::image type="content" source="media/periodic-tasks.png" alt-text="Screenshot of periodic tasks for rebate management deals." lightbox="media/periodic-tasks.png":::
