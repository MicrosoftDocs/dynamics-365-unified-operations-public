...
|---|---|---|
| Unit price | The price calculated for each unit in a sales order. It's calculated by using the following formula: *Unit price* = *Base price* &plusmn; *Margin component price adjustments*. | |
...
:::image type="content" source="media/base-price-determination-chart.png" alt-text="Screenshot of flow chart for sales order base price determination rules." lightbox="media/base-price-determination-chart.png#lightbox":::
