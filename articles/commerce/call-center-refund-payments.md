...
description: Learn how to generate payment refunds via call centers when returns are created or when orders or order lines are cancelled in Microsoft Dynamics 365 Commerce.
author: hhainesms
ms.date: 09/09/2025
ms.topic: how-to
...
This article explains how to generate payment refunds via call centers when returns are created or when orders or order lines are cancelled in Microsoft Dynamics 365 Commerce.
