...
> [!NOTE]
> Transaction IDs are meant for internal system use only, so they are not required to be sequential. However, many countries/regions require receipt IDs to be sequential.
