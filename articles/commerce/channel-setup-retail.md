...
Because transaction IDs are generated in both offline and online modes, there have been instances of duplicate transaction IDs being created. Eliminating duplicate transaction IDs requires a lot of manual data fixing. 

To prevent duplicate transaction IDs, a new transaction ID format has been introduced that uses a 13-digit number generated by calculating the time in milliseconds since 1970. This makes transaction IDs non-sequential and ensures that they are always unique.
