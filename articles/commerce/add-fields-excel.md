...
description: Learn how to add fields to a Microsoft Excel workbook so that you can edit retail transactions in Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 01/14/2026
ms.topic: how-to
ms.reviewer: mirao
...
When you generate an Excel file so that you can edit retail transactions, the file is filled with some default fields. If a field that you must update isn't visible by default in the generated Excel file, you can add it.
...
1. Select **Design**.
1. Select the pencil symbol for the desired table. In the list of available fields, find and select the field that you want to add.
...
The new field and data for it are now available for editing in Excel.
