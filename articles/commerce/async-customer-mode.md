...
| Ability to audit synchronization of customer management operations | 10.0.31 and later | <p>Enables users to audit the synchronization of customer management operations in headquarters. Also allows users to make changes (if needed), and synchronize the data.</p> |
