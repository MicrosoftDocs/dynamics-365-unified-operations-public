...
The **Order fulfillment** screens of POS will also leverage the channel side calculation to show on-hand inventory for items when an order fulfillment line is selected on this form and a user looks at the **Details** panel to view on-hand inventory for the selected item.
