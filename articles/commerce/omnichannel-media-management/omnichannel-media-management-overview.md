...
Starting with version Commerce version 10.0.35, **site builder** adds a capability to host and manage omnichannel media and product-related media assignments through a dedicated **Omnichannel content** workspace.  This workspace has many similarities to the authoring experience for individual websites within site builder, with the primary difference being that content is organized by Commerce channels rather than website domains. The **Omnichannel content** CMS functionality can be deployed for e-Commerce and non e-Commerce scenarios implementations alike. Besides assigning media to products, the **Omnichannel content** workspace also functions as the central media library for merchandising media.  The **Media library** in the **Omnichannel content** workspace is nearly idendtical to the **Media library** for individual websites in **site builder**, with a few important distinctions: [TODO]
