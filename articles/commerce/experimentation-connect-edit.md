...
1. To launch the **Connect experiment** wizard, select the **Experiments** tab, and then select **Connect**. Alternatively, the wizard can be accessed from a page or fragment editor. In edit mode, select **Connect experiment** in the command bar.
