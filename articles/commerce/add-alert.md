...
|Text alignment| **Right**, **Left**, or **Center**| This property is available as a theme extension in Adventure Works theme and allows a user to set the text alignment within the promo banner. |
