...
3. Set the **Publish groups** toggle key to the **On** setting.
...
2. In the top command bar, click **New**.
3. In the **Create Publish Group** dialog box, enter a descriptive name under **Publish Group Name**, then click **OK**.
