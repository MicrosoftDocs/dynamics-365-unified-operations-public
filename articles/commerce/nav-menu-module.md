...
| Enable multilevel navigation menu | **True** or **False** | When enabled, the navigation menu can show multiple levels of the navigation heirarchy. This feature is available in Dynamics 365 Commerce 10.0.15 release |
| Number of levels| integer | This property shows the numbers of levels to be displayed if *Enable multilevel navigation menu* is true.|
...
| Show root menu | **True** or **False** | When enabled the navigation menu can be defined under a custom root E.g. "Shop now". This feature is available in Dynamics 365 Commerce 10.0.15 release|
| Root menu| string| A custom root text can be defined if *Show root menu* is true|
