...
| Show promotions | **True** or **False**    | When enabled, this property allows promotions to be configured using images, links, and text. Added in Commerce version 10.0.17 release. |
