...
1. Enter values for the connector merchant properties.
    ...
    | Cloud API Key          | Enter the Adyen cloud API key. You can obtain this key by following the instructions in [Generate an API key]([https://docs.adyen.com/developers/user-management/how-to-get-the-api-key](https://docs.adyen.com/development-resources/api-credentials#generate-api-key)). | Yes | No | abcdefg |
