...
description: This topic explains how to consume custom headless Commerce APIs and entities in POS using Proxy.
author: mugunthanm
ms.date: 04/13/2021
ms.topic: article
audience: Developer
...
This topic explains how to consume custom headless Commerce APIs and entities in POS using Proxy. It applies to the Retail SDK version 10.0.18 and later.
...
3. Build your POS extension project to generate the TypeScript for your headless Commerce extensions. The build generates two TypeScript files in a folder named **DataService** in your project root.
