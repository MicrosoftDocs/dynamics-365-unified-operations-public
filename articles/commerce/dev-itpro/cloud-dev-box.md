...
9. Edit the ..\RetailSDK\POS\Web\Pos.Web.csproj and change the defalut **IISURL** node value to your Cloud POS URL.
```    
    Ex:  <IISUrl>https://YourCPOSURL.com</IISUrl>
```
10. Right-click the Pos.Web project and click **Properties**.
11. In the **Properties** window, click the **Web** tab. Select the **Start URL radio** option and set the start URL as your Cloud POS URL. For example, `https://usnconeboxax1pos.cloud.onebox.dynamics.com`.
12. Save the changes.
