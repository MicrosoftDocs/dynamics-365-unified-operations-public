...
7. Open the **ProductAvailabilityPanel.html** file, and paste the following code into it.
    ...
    <html lang="en" xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
            ...
            <script id="Microsoft\_Pos\_Extensibility\_Samples\_ProductAvailabilityPanel" type="text/html">
                <h2 class="marginTop8 marginBottom8" data-bind="text: title"></h2>
                <div class="width400 grow col">
                    <div id="Microsoft\_Pos\_Extensibility\_Samples\_ProductAvailabilityPanel\_DataList" data-bind="msPosDataList: dataList"></div>
                </div>
            </script>
        </body>
    </html>
