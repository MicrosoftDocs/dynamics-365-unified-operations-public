...
4.  The CRT framework code itself will check the success/failure state and throw the error message based on the values returned form the CDX methods, extension code can catch this and do additional logic if required.  
