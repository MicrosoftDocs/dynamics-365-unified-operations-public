...
| Headless commerce | The Extensible Omni-channel API framework can be used to customize and add business logic. APIs that have request handlers, and pre-trigger and post-trigger extension patterns. | [CSU](retail-server-customer-consumer-api.md) | [Tech talk](https://community.dynamics.com/blogs/post/?postid=aaaabbbb-0000-cccc-1111-dddd2222eeee) |
| Commerce SDK | The Commerce SDK includes the code, code samples, templates, and tools that are required to extend or customize Dynamics 365 Commerce functionality. The SDK is published in different repositories (repos) in GitHub, depending on the extension components. | [SDK](retail-sdk/sdk-github.md) | [Tech talk](https://community.dynamics.com/blogs/post/?postid=aaaabbbb-0000-cccc-1111-dddd2222eeee) |
| Point of sale | Store Commerce app can be extended independently by using the POS extension feature of the Commerce SDK. The framework supports customization of the user experience (UX), workflows, and business logic. | [POS](pos-extension/pos-extension-overview.md) | [Tech talk](https://community.dynamics.com/blogs/post/?postid=aaaabbbb-0000-cccc-1111-dddd2222eeee) |
