...
It is common for those on Commerce to pause updates and then leapfrog to the current version. Please read this so that you land safely. There are significant changes and updates to the development and build tools.
...
If you are a technical role (developer, administrator, or manager) and work with Dynamics 365 Commerce, then please continue reading. There have been substantial improvements and changes, and there is a wealth of information and documentation about what has changed and what is coming. The goal of this topic is to consolidate all of that information into a single spot so that you have better clarity on specific changes that will be required in terms of updating your development environments or adjusting your ALM processes.  
...
- [What's new or changed in Finance and Operations apps home page](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/fin-ops/get-started/whats-new-changed?toc=/dynamics365/commerce/toc.json)
- [What's new or changed in Dynamics 365 Commerce](../whats-new-home-page)
- [What's new and changed in Platform updates](../../fin-ops-core/dev-itpro/get-started/whats-new-home-page)
...
- The Retail SDK has been updated to Visual Studio 2017. The templates for pre-configured virtual machines for developers have Visual Studio 2015 installed. You need Visual Studio 2017 installed to build the Retail SDK. So you will need to [update Visual Studio manually](https://docs.microsoft.com/en-us/dynamics365/commerce/dev-itpro/retail-sdk/migrate-sdk#migrate-to-the-sdk-for-visual-studio-2017). 
  ...
  - Install the Visual Studio tools by installing the Visual Studio extension. To download the extension, follow these steps:
    ...
    2. It is a .zip file. Open it and find the **DevToolsService\\Scripts** folder. 
  ...
  - Rebuild the Retail SDK.
    ...
    3. Open Visual Studio 2017 as an administrator, and then open each standard solution file in the SDK folder. You will likely encounter a message like the one below. Click **Continue**.
...
- Retail SDK file size: An unmodified retail deployable package is now around 340 MB. With customizations, this might increase to 350 MB. If you try to deploy this to your Commerce Scale Unit (cloud) (formerly Retail Cloud Scale Unit, RCSU), you will get an error message informing you that [packages larger than 300 megabytes](retail-sdk/retail-sdk-packaging#deploy-the-deployable-packages.md) cannot be deployed.

    1. Follow the instructions in [Deploy the deployable packages](retail-sdk/retail-sdk-packaging#deploy-the-deployable-packages.md), and manually remove the self-service installer files.  
...
3. Check the [Retail SDK FAQ](retail-sdk/sdk-faq.md). It is updated as common issues are identified.
