---
title: Create a Commerce Scale Unit extension API (Commerce SDK version TODO:10.0.11 and later)
description: This article explains how to create a new Commerce Scale Unit extension API with Commerce SDK version TODO:10.0.11 and later.
author: aneesmsft
ms.date: 04/02/2023
ms.topic: article
ms.prod: 
...
ms.author: aneesa
ms.search.validFrom: 2023-04-2023
ms.dyn365.ops.version: AX 10.0.11
ms.custom: 28021
ms.assetid: 
---

# Create a Commerce Scale Unit extension API (Commerce SDK version TODO:10.0.11 and later)

[!include [banner](../includes/banner.md)]

This article explains how to create a new Commerce Scale Unit extension application programming interface (API), and how to expose it so that point of sale (POS) or other clients can consume it. Modification of the existing Commerce Scale Unit APIs isn't supported.

This article applies to Commerce software development kit (SDK) version TODO:10.0.11 and later.

The Commerce SDK includes a few samples of end-to-end Commerce Scale Unit extensions that include the Commerce runtime (CRT). You can use these samples as templates to start your extensions. You can find the sample extensions in the **[Dynamics 365 Commerce Scale Unit repository](https://github.com/microsoft/Dynamics365Commerce.ScaleUnit)**.
