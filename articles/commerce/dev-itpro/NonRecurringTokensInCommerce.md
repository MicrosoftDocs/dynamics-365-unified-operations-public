---
title: Non-Recurring payment tokens in Commerce
description: This article provides a summary to support payment processing in Commerce without the need for payment card tokens.
author: BrianShook
ms.date: 04/10/2024
ms.topic: article
ms.prod: 
...
## Non-recurring payment token usage in Commerce
...
See additional: [Limit payment token usage](../limit-token-usage.md).
