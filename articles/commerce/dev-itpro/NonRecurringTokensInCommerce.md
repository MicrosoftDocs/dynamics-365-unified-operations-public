...
When using nonrecurring tokens in Commerce, the following scenarios still require a recurring detail payment token in order to obtain an authorization:
