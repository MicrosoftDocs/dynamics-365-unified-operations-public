...
> [!NOTE]
> This article describes offline mode for the Store Commerce app for **Windows**. Offline mode is also available for **iOS, Android, and macOS** through custom apps built with the Store Commerce SDK. For more information, see [Store Commerce app for mobile platforms](store-commerce-mobile.md#offline-capabilities-in-ios-android-and-macos) and [Store Commerce Hardware station extensibility for Android, iOS, and macOS devices](store-comm-android-ios-ext.md).
...
:::image type="content" source="../media/status.png" alt-text="Screenshot of connection status." lightbox="../media/status.png":::
...
:::image type="content" source="../media/details-1024x537.png" alt-text="Screenshot of the Disconnect button in the Store Commerce app." lightbox="../media/details-1024x537.png":::
...
:::image type="content" source="../media/offline-sync-1024x521.png" alt-text="Screenshot of offline synchronization." lightbox="../media/offline-sync-1024x521.png":::
