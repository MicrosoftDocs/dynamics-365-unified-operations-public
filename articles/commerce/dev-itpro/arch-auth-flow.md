...
| Employee | Dynamics 365 POS authentication flows\* | Microsoft Entra credentials | In Commerce headquarters, configure a worker that is mapped to Microsoft Entra credentials. | [Enable Microsoft Entra authentication for POS sign-in](../aad-pos-logon.md) |
