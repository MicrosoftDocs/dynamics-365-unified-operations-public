...
This section describes configurations that should be considered as implementation planning begins. The features showcased here are related to data management and data configuration. It is highly valuable to additionally read [Commerce Data Exchange best practices](CDX-Best-Practices.md) prior to following the guidance showcased here.
