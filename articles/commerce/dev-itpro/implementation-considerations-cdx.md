...
To learn more about the versions of SQL and how to use them, review the [Commerce offline implementation considerations and troubleshooting](implementation-considerations-offline.md) document.
