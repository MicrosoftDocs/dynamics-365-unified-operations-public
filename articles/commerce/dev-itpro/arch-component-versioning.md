...
The following illustration shows an overview of Dynamics 365 Commerce components and their versioning requirements and dependencies.

:::image type="content" source="./media/CommerceComponentVersioning_Sep_2024.png" alt-text="Diagram of Dynamics 365 Commerce Component Versioning Requirements and Dependencies.":::

## Component dependencies

### Service updates

To ensure compatibility between all Commerce components that you service and deploy, follow several versioning dependencies during servicing updates. The following list describes all these dependencies.
...
During quality updates, Commerce components follow the versioning requirements for service updates.
...
To be supported, the following in-store components need to run serviceable release versions:
...
For more information about how to service individual components described in this article, see the following articles:
