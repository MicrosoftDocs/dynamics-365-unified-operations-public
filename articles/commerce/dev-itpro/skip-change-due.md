...
## Configure property to skip **Change due** 
...
1. After the changes are synchronized, sign out of the POS and sign back in. Make a transaction that has no change due to the customer to verify that the **Change due** dialog box isn't displayed.  
