...
description: Learn how to create user flow policies in the Microsoft Azure portal.
author: BrianShook
ms.date: 02/13/2026
ms.topic: how-to
...
You can choose to use the default user flows provided by Microsoft Entra ID, which display a page hosted by Microsoft Entra ID B2C. Alternately, you can create an HTML page to control the look and feel of these user flow experiences. 

To customize the user policy pages by using pages built in Dynamics 365 Commerce, see [Set up custom pages for user logins](../custom-pages-user-logins.md). For more information, see [Customize the interface of user experiences in Microsoft Entra ID B2C](/azure/active-directory-b2c/tutorial-customize-ui).
...
1. Under **Name**, enter a policy name. The portal assigns a prefix to the name, such as "B2C_1_."
...
:::image type="content" source="../media/B2CImage_11.png" alt-text="Screenshot of the Microsoft Entra B2C sign-up and sign-in user flow policy settings.":::
...
1. Under **Name**, enter the profile editing user flow. The portal assigns a prefix to this name, such as "B2C_1_," and displays it.
...
:::image type="content" source="../media/B2CImage_12.png" alt-text="Screenshot of the Microsoft Entra B2C profile editing user flow settings.":::
...
:::image type="content" source="../media/B2CImage_13.png" alt-text="Screenshot of the Reset Password using mail address setting in the Microsoft Entra B2C password reset user flow.":::
