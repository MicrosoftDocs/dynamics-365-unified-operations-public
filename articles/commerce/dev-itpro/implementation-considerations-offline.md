...
Use a SQL Server version that is currently under mainstream support. Microsoft doesn't support use of SQL Server versions that aren't under mainstream support with Microsoft Dynamics 365 Commerce. You can find mainstream support dates for SQL Server versions (and other products) in [Search Product and Services Lifecycle Information](/lifecycle/products/).
