...
The [Store Commerce app for Windows](store-commerce.md) and [mobile platforms](store-commerce-mobile.md) are the next generation of point of sale applications for Dynamics 365 Commerce. As such, MPOS and the Retail hybrid app will be deprecated in October of 2023. We recommend that you use Store Commerce or CPOS for all new deployments. Existing customers should plan to migrate MPOS and Retail hybrid app to Store Commerce. 
