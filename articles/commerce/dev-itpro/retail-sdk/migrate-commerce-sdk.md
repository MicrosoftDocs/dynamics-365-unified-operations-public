...
- Improved developer experience. CSU extensions can be developed using Visual Studio Code. with Git for source code management and Azure DevOps for build automation.

## Comparison between old and new SDKs

| Components | New Commerce SDK | Legacy Retail SDK |
| ------ | ------ |-----------------------|
...
1. Setup your [local development environment](https://github.com/microsoft/Dynamics365Commerce.ScaleUnit/blob/release/9.33/src/ScaleUnitSample/Readme.md) or configure the [LCS development environment](../../../fin-ops-core/dev-itpro/dev-tools/access-instances.md).
