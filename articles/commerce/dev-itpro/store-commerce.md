...
- .NET Framework version 4.8 or later is required for embedded Hardware Station components. For more information, see [Install the .NET Framework](https://dotnet.microsoft.com/download/dotnet-framework).  
