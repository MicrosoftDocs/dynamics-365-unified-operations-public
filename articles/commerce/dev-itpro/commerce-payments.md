...
The following illustration shows an order created in the call center. Notice that the **Payments** button is available when you select the row for this order.  

:::image type="content" source="../dev-itpro/media/COP_CC_PAY.png" alt-text="Screenshot of a call center order with the Payments button available." lightbox="../dev-itpro/media/COP_CC_PAY.png":::

The following illustration shows an order created at the POS. Notice that the **Payments** button is unavailable when you select the row for this order.

:::image type="content" source="../dev-itpro/media/COP_NONCC_PAY.png" alt-text="Screenshot of a POS order with the Payments button unavailable." lightbox="../dev-itpro/media/COP_NONCC_PAY.png":::

In Commerce version 10.0.13 and later, you can access the **Payments** page for orders that you create in e-commerce and the POS. Also, when you turn on the omnichannel Commerce order payments feature, you can edit the orders by using the order completion function that was previously available only for call center orders.
...
:::image type="content" source="../dev-itpro/media/COP_ORDERCOMPLETION.png" alt-text="Screenshot of the Sales order summary dialog with the Payments button available for a POS or e-commerce order." lightbox="../dev-itpro/media/COP_ORDERCOMPLETION.png":::

> [!NOTE]
> If you take payments from POS and e-commerce, enable the **Omnichannel Commerce order payments** feature as most of the new payment capabilities depend on this feature. This feature will be mandatory in future.

## Key terms

| Term | Description |
| ---- | ----------- |
| Commerce payment | A payment that's associated with a customer order that the point of sale (POS) or the e-commerce storefront generates. |
...
If you try to turn on the omnichannel Commerce order payments feature but any of the prerequisites are missing, you receive a message that states that you can't continue until the prerequisite features and configurations are in place.

:::image type="content" source="../dev-itpro/media/COP_PRE.png" alt-text="Screenshot of the message about prerequisite features and configurations." lightbox="../dev-itpro/media/COP_PRE.png":::
...
| Duplicate payment protection on invoicing | This feature enables duplicate payment protection for invoicing scenarios. Commerce payments functionality might affect customizations in invoicing scenarios. If your organization has invoicing customizations, make sure that you refactor them before you turn on Commerce payments functionality in production environments. |
...
:::image type="content" source="../dev-itpro/media/COP_OPERATION.png" alt-text="Screenshot of a payment method mapped to an operation in the call center." lightbox="../dev-itpro/media/COP_OPERATION.png":::
...
1. In the **Feature management** workspace, select the **All** tab to view the list of all features, and then search for **Omnichannel Commerce order payments**.
    ...
    :::image type="content" source="../dev-itpro/media/COP_ENABLE.png" alt-text="Screenshot of the Omnichannel Commerce order payments feature in the Feature management workspace." lightbox="../dev-itpro/media/COP_ENABLE.png":::
...
:::image type="content" source="../dev-itpro/media/COP_HEADERCOM.png" alt-text="Screenshot of an order where the Payments type field is set to Commerce." lightbox="../dev-itpro/media/COP_HEADERCOM.png":::
...
:::image type="content" source="../dev-itpro/media/COP_VOUCH.png" alt-text="Screenshot of the payment voucher assignment on the Commerce parameters page." lightbox="../dev-itpro/media/COP_VOUCH.png":::
