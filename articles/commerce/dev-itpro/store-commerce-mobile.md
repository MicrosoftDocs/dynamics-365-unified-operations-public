...
Also, ensure that the shell app on the device is updated to 10.0.40, CSU updated to 9.50(10.0.40) and HQ updated to 10.0.40 for it all to work as expected.
