...
3. On the **Payment service account** tab, enter the following information.
    ...
    | Optional Domain | The optional domain is required for Live environments and should be obtained by contacting Adyen. This is the unique identifier for your Live environment in the form **[random]-[company name]** and is present as the prefix inside the API URLs under **Account -> API URLs** in your company's Live account on the Adyen Customer Area portal. Please refer for additional details to https://docs.adyen.com/development-resources/live-endpoints | Live only | No | Contact Adyen |
