...
3. From that page, select **Log in to the Developer Dashboard**.
4. If prompted to log in, select **Sign up**.
...
8. Once you agree to the terms, specify your business type and select **Continue**.
...
12. Note your **Client ID**, and **Secret** for your Sandbox account. These will be used to set up the connector in Dynamics 365 Commerce.
...
2. Select **New**.
3. Specify a **Payment method ID**, **Payment method name** such as **Wallet**, set the **Default function** to **Wallet**, and then select **Save**.
4. Go to **Retail and Commerce \> Channel Setup \> Payment methods \> Card types**.
5. Select **New**.
6. Specify an **ID** such as **PayPal**, an **Electronic payment name** such as **PayPal**, set **Type** to **Wallet** and specify a name for the **Issuer** such as **PayPal**, then select **Save**.
7. Select the entry previously created and click **Processor mapping**.
8. On the **Processor payment method mapping** page, select the previously created **Paypal** card type, then in the middle column select the **Dynamics 365 Payment Connector for PayPal** and select **Add**. 
