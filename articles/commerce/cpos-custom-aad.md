...
The following steps only apply to Self-hosted CSU's that use the Retail SDK.  If you are using a sealed CSU installer this process is done automatically as part of the installation process. Open the Store Commerce for web config.json file, and make the following updates in it.
