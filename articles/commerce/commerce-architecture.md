...
#### Business and transactional analytical reports in POS and HQ

Dynamics 365 Commerce's prepackaged, set of business and transactional analytical reports, provides retailers with intelligent insights across all points of the Commerce ecosystem by embedding high-charts and SSRS-based reports in Store commerce POS systems and Commerce headquarters. The commerce analytics solution provides a comprehensive set of out-of-box business and transactional reports, enabling retailers to dvantage of insights across all channels.

The high-charts based reports on POS systems are real-time, enabling store associates to analyze their channel's transactional and other POS activities at conclusion of the transaction inr real-time. Whereas, out-of-box reports in Commerce headquarters, upon syncing of data, enables retailers to view the analytical reports for the transactional activity across all channels, designed specifically for channel managers who focus on sales performance to predict trends and uncover insights, allowing them to drill-down reports about organization-wide sales performance across global geography by employee, category, product, terminal, channel, and more. 
...
[Azure cognitive search](https://azure.microsoft.com/en-us/products/search/#overview) is integrated into Dynamics 365 Commerce to provide consistent product discovery and search experiences across all commerce channels that use the Commerce Scale Unit. Consistent product discoverability helps guarantee that customers can quickly and easily find products by browsing categories, searching, and filtering. In this way, retailers can turn shopper frustration and site abandonment into active carts and converted sales. Along with improved capabilities to help retailers increase customer retentions and conversion rates with better product discoverability, it also provides scalability and performance that are required for e-commerce traffic. For more information, see [Cloud powered search overview](./cloud-powered-search-overview.md).
