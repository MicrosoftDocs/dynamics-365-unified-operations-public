...
| `Cate-Ru-002` | Channel navigation hierarchy | Checks if the category display order isn't specified. | Warning | If the category display order isn't specified, the categories will be sorted in a default manner (for example, alphabetically).|
