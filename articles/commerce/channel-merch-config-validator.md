...
| Channel-Ru-002 (Since 10.0.37) | Cloud search configuration | This rule checks whether the cloud search configuration is enabled for online channels. | Error | Cloud search is mandatory for online channels, if it's not enabled, the product discovery experience will be blocked on the e-commerce site. |
