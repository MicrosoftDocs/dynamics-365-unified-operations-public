...
| Hierarchy-Ru-001 | Channel navigation hierarchy | This rule checks whether the category hierarchy translation is missing. | Warning | Missing category hierarchy translation values affect headquarters users who have their preferences set to use a language other than the default system language. |
...
| Prod-Ru-005 | Product assortments | This rule checks whether the product isn't active in any assortments. | Warning | If products are associated with categories in the channel navigation hierarchies, but they aren't part of any assortments that are associated with the channel, they don't show up in Commerce channels. |
