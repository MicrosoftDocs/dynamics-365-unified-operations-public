...
| `d365gi`                                       | Stores geographical location data when a third-party geolocation service is used.      | One day |
| `_msdyn365___can_`                            | Stores customer account number when on behalf of (OBO) business-to-business (B2B) functionality is being used.      | Session |
