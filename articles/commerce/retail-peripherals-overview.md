...
> [!NOTE]
> When keyboard wedge scanners are used in the point of sale, they must be programmed to send a carriage return, or **Enter** event after the last scanned character. If this configuration is not done, keyboard wedge scanners will not function properly. Consult documentation provided by your device manufacturer for details on how to append the carriage return event.  
