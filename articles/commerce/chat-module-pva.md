...
After you configure the chatbot, you must follow the procedures below to copy the bot ID and tenant ID chatbot parameter values to configure the Commerce chat experience. 
