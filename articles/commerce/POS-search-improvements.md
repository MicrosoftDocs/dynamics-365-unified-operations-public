...
1. Run the **1010_CustomerSearch** job. This job publishes the date to the Azure search index. Once publishing of the index is completed, the status of the job will be set to **Applied**.
1. Once the **1010_CustomerSearch** job status is set to **Applied**, run the **1110 - Global configuration** job to update the POS channels of the newly-enabled feature in **Feature management**.
