...
Task management is a productivity feature in Dynamics 365 Commerce that lets managers and workers create task lists, manage assignment criteria, track task status, and integrate these operations between Commerce headquarters and point of sale (POS).
...
:::image type="content" source="media/Tasks-management-conceptual-architecture.png" alt-text="Screenshot of the task management conceptual architecture.":::
