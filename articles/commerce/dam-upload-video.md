---
title: Upload videos
description: Learn how to upload videos in Microsoft Dynamics 365 Commerce site builder.
author: josaw1
ms.date: 01/21/2026
ms.topic: how-to
...
The Commerce site builder Media Library allows you to upload videos. Always upload the version of a video with the highest bitrate and resolution. The system automatically converts your video to be suitable for different viewports and their breakpoints.

### Video information specified during upload

When you upload a video, specify the following information.
...
- **Thumbnail**: Specifies the thumbnail for the video. If not specified, it's generated automatically.
...
1. In the File Explorer window, go to and select one or more video files to upload, and then select **Open**.
...
If you're uploading multiple types of assets at the same time (for example, images and videos), in the **Upload Media Item** dialog box you can only specify keywords, whether the files should be published immediately after upload, and whether closed captions should be automatically generated for video files. All the assets share the same keywords.
