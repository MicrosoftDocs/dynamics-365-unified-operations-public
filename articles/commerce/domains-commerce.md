...
> [!NOTE]
> Starting on May 6th, 2022, all environments created in Dynamics 365 Commerce will provision with the `.dynamics365commerce.ms` domain, replacing the legacy pattern of `.commerce.dynamics.com`.
