...
description: Learn about carousel modules and how to add them to site pages in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 01/14/2026
ms.topic: how-to
...
- Use a carousel that has multiple promotional modules inside it on a home page.
- Use a carousel that has multiple promotional modules inside it on a product details page.
- Use a carousel on any marketing page to promote multiple promotions or products.
...
:::image type="content" source="./media/Hero.PNG" alt-text="Screenshot of a carousel module.":::

## Carousel module properties

| Property name             | Value                 | Description |
|---------------------------|-----------------------|-------------|
| Autoplay                  | **True** or **False** | If you set the value to **True**, the transition between items inside the carousel occurs automatically. If you set the value to **False**, no transition occurs unless the customer uses the keyboard or mouse to move from one item to the next item. |
...
| Hide carousel flipper     | **True** or **False** | If you set the value to **True**, the carousel flipper and sequence indicator are hidden. |
| Allow carousel dismiss    | **True** or **False** | If you set the value to **True**, users can dismiss the carousel. |
...
1. Use the carousel template that you just created to create a page that you name **Carousel page**.
...
1. Select **Save**, and then select **Preview** to preview the page. The page shows a carousel that has two modules inside it (a hero module and a feature module). You can change additional properties for the carousel, hero, and feature modules to achieve the desired effect.
