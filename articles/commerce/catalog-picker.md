...
description: Learn about catalog picker modules and how to add them to Microsoft Dynamics 365 Commerce business-to-business (B2B) e-commerce sites.
author: ashishmsft
ms.date: 01/16/2026
ms.topic: how-to
...
A catalog picker module is a special container that lists all the product catalogs that are available to B2B site users for shopping. Multiple catalogs are currently supported only for B2B sites.

The following illustration shows an example of a catalog picker module.

:::image type="content" source="./media/Catalog-picker-sample.png" alt-text="Screenshot of a catalog picker module that lists three product catalogs.":::
...
1. Under **Page URL**, enter a URL for the page, and then select **Next**.
    ...
    :::image type="content" source="./media/Create-catalog-picker-page.png" alt-text="Screenshot of the Create a new page dialog box.":::
...
1. Under **Catalog picker**, select **Main slot**, select the ellipsis (**...**), and then select **Add module**.
    ...
    :::image type="content" source="./media/Author-web-page-catalog-picker-1.png" alt-text="Screenshot of adding a module to the Main slot under Catalog picker.":::
...
1. Under **Rich text**, enter text that appears at the top of the catalog picker page.
...
:::image type="content" source="./media/my-accounts.png" alt-text="Screenshot of the My accounts page with link to catalog.":::
...
:::image type="content" source="./media/catalog-in-header.png" alt-text="Screenshot of an ecommerce website header with dropdown link to catalog.":::
