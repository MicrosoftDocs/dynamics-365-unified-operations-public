...
1. Configure **Product ratings sync job** as a batch job to synchronize product ratings from **Ratings and Reviews service**.
1. Verify that the batch job for product rating synchronization was successful.
1. Make product ratings available at the POS.

## Configure a Commerce batch job to synchronize product ratings
...
1. Go to **Commerce \> Headquarters setup \> Commerce scheduler \> Initialize commerce scheduler**. Alternatively, search for "Initialize commerce scheduler."
...
1. Go to **Commerce \> Headquarters setup \> Commerce scheduler \> Scheduler subjobs**. Alternatively, search for "Scheduler subjobs."
...
>
> 1. Go to **Commerce \> Headquarters setup \> Commerce scheduler \> Channel database**. Alternatively, search for "Channel database."
...
1. Go to **Commerce \> Headquarters setup \> Commerce scheduler \> Sync product ratings job**. Alternatively, search for "Sync product ratings job."
...
1. Go to **Commerce \> System administrator \> Inquiries \> Batch jobs** or, if you're using a Commerce-only stock keeping unit (SKU), **Commerce \> Inquiries and reports \> Batch jobs** instead. Alternatively, search for "Batch jobs."
...
1. Go to **Commerce \> Commerce setup \> Parameters \> Commerce parameters**. Alternatively, search for "Commerce parameters."
...
1. Select **Save**.
1. Go to **Commerce \> Commerce IT \> Distribution schedule**. Alternatively, search for "Distribution schedule."
