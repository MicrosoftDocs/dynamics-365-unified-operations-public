...
> [!NOTE]
> You cannot create purchase orders from POS if purchase order [change management workflow](/dynamics365/supply-chain/procurement/purchase-order-approval-confirmation) is enabled in headquarters. In that case, the purchase orders can only be created in HQ and must go through approval workflow.
