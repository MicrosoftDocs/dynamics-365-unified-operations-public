...
| Point of Sale (POS) offline   |   Modern POS offline monitoring dashboard and seamless offline resiliency and reliability enhancements   |   This feature set is additionally being backported to the 10.0.20 release as an overall release update.  For more details, view the [Commerce offline database implementation considerations](../dev-itpro/implementation-considerations-offline.md) document.   |
