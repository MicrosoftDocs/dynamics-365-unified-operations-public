...
|---|---|---|---|
| Point of sale | Framework support | For 10.0.42 and beyond, install .NET Framework version 4.8 and .NET Desktop 8 for UI rendering.| Admins|
...
| Payments  | Check out faster with optimized payment flows  | Adding to the payment methods released with 10.0.40 that support the new user interface, more payment methods now support the new optimized and unified payment experience. These payment methods include, Gift cards (internal and external), Payment voucher, Customer account, and Currency. | Admins  |
