...
|   Globalization |  [(India) GST in e-commerce](/dynamics365-release-plan/2021wave2/commerce/dynamics365-commerce/gst-e-commerce-india)    |  This features enables Dynamics 365 Commerce customers in India to implement e-commerce capabilities by ensuring the Goods and Services Tax (GST) is calculated on e-commerce orders.   |  Feature management  |
