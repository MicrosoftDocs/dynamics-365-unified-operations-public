...
|----------------|----------------------------------------------------------|-----------------------------------------------------------|-------------------------|
|B2B   | Enable customer-specific catalogs    |   [Create Commerce catalogs for B2B sites](catalogs-b2b-sites.md)    | Feature management<p>*Enable use of multiple catalogs on retail channels*   |
