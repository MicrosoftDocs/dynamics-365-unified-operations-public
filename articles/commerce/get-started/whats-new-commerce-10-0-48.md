...
| Store Commerce | Distance units display (KM or miles) for store locator and inventory lookup based on the legal entity's country/region | This feature is on by default. Distances are automatically displayed in kilometers for metric-region legal entities and miles for others. | Feature management |
