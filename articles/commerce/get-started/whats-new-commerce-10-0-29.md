...
| Offline | [POS offline database compression](../dev-itpro/implementation-considerations-offline.md#important-offline-features) | The new feature focuses on reducing offline database sizes by enabling automated index compression outside of a Channel (Store) [Store hours](store-hours.md). | Feature management<p>*POS offline database compression* |
