...
| Offline | [POS offline database compression]<> | The new feature vblar bdlhjagklasdfljsaelfj art4se blar. | Feature management<p>*POS offline database compression* |
