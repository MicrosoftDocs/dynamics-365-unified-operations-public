...
| Offline | [POS offline database compression](../dev-itpro/implementation-considerations-offline.md#important-offline-features) | This new feature reduces offline database sizes by enabling automated index compression outside of channel [store hours](store-hours.md). | Feature management<p>*POS offline database compression* |
