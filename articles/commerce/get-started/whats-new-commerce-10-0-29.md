...
| Offline | [POS offline database compression](../dev-itpro/implementation-considerations-offline.md#important-offline-features) | The new feature vblar bdlhjagklasdfljsaelfj art4se blar. | Feature management<p>*POS offline database compression* |
