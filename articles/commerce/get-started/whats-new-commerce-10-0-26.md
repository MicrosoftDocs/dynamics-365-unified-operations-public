...
| Store Commerce |  [The Store Commerce supports Dual display to show cart related information](../retail-peripherals-overview.md) | Dual display shows cart related information to the end customer facing display and [dual display can be extended to show custom information](../dev-itpro/pos-dual-display-extension.md)| Opt-in |
