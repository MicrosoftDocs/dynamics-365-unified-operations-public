...
| 311 | Remove system discounts from transactions | Remove all the system applied discounts, including coupon based discounts, from the transaction. This does not removes the manual discounts. | Yes | Yes | Yes | Yes | No |
| 312 | Reapply system discounts | Reapply the system discounts on the transaction if they were removed using the "Remove system discounts from transaction" operation. | Yes | Yes | Yes | Yes | No |
