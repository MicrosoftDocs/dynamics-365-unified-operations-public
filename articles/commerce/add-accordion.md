...
description: Learn about accordion modules and how to add them to site pages in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 01/14/2026
ms.topic: how-to
...
1. Select **Save**, and then select **Preview** to preview the page. The page shows an accordion module that has the content that you added.
