...
You can "stop" released products for the sales process by turning on a setting in the **Default order** settings. Assortments respect this setting, which is most often used when a product is at the end of its life and shouldn't be sold via any channel. If a product is stopped in all legal entities that it's released to, it won't be assorted, regardless of the assortment configuration.
