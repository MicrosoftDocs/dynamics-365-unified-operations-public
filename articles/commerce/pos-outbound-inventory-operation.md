...
For instructions on how to complete configure an asynchronous document framework, see [Commerce asynchronous document framework](asynchronous-document-framework.md). You can skip this step if you have already configured an asynchronous document framework for other operations.
