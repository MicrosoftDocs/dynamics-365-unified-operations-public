...
description: Learn how to enable shop similar description product recommendations in Microsoft Dynamics 365 Commerce.
author: bebeale
ms.date: 01/29/2026
ms.topic: how-to
...
Product recommendations support only Commerce users who migrated their storage to Azure Data Lake Storage Gen2.

### Prerequisites

Before you can show shop similar description recommendations to customers, complete the following prerequisites:
...
1. In the **Feature management** workspace, search for and select **Shop similar description** in the list of available features.
...
1. Select **Save**.
1. Select **Finish editing** to check in the page, and then select **Publish** to publish it. After the page is published, the PDP includes a **Shop similar description** button.
...
:::image type="content" source="./media/ter_site_builder_buybox_button.png" alt-text="Screenshot of the Enable shop similar description Link checkbox and Shop similar description button on a PDP in site builder.":::
