...
| Default Note Title | Text string | The default title for Notes created and attached to order headers. This property must be populated if **Enable cart note** is set to **True**. This feature is available as of the Commerce version 10.0.40 release. |
