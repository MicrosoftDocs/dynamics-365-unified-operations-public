...
The email notification profile can activated by associating it with a channel, for example a brick and mortal store, online channel, or call center channel. To associate the email notification profile with a channel, in headquarters, go to the channel form and select the desired email notification profile. 
...
1. In the lower-right corner, select **Enable now**. After the feature has been turned on, it will appear in the list on the **All** tab with a status of **Enabled**.
