...
The search results module supports the [Quick view module](quick-view-module.md), which allows users to view product information and add items to the cart from the search results page.
