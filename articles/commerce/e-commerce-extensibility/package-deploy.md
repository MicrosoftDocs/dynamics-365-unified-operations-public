...
1. Scroll right to see more options.
    ...
    ![LCS options when scrolling right.](media/lcs-deploy-4.png)
...
After the deployment is completed, you should see your changes in the authoring tools or on pages that are rendered. For example, new modules or themes are available to page authors, or changes are rendered and appear in the online environment.
