...
Version 16.x is the current supported version for online SDK release 10.0.27 and later.  If you are using online SDK version 10.0.26 or earlier, you will need to install Node 12.x. You can find the installer on the [Node.js website](https://nodejs.org).
