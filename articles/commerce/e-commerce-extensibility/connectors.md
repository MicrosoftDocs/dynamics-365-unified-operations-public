...
> [!NOTE]
> By default, Geolocation provider information is not resolved on the initial page request but rather during a subsequent callback for performance reasons. This behavior can be overridden to occur on first request by filing a [Support ticket] (https://support.microsoft.com).
