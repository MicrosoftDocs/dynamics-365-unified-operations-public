...
## Image component
The online SDK includes an **Image** component that should be used when rendering images inside of a module.  The component is responsible for rendering the image and defining the default behavior for the image.  The image component supports setting an image, a placeholder image and thumbnails that can be used as an intermediate image while the main image is loading.
