...
For information on tools that can help measure page load times and identify problem areas with CSS and JavaScript, see [Tools for performance analysis](#tools-for-performance-analysis) below.
...
Modules can be excluded by adding the module name to the **excludeModules** property in the SDK's "/src/settings/platform.settings.json" file, as shown in the example below.
