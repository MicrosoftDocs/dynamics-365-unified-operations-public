...
This file is an auto generated typescript file that should not be manually touched.  Adding new configuration values to your module definition file and module data files will automatically rebuild this file with appropriate interfaces.

Below is the default autogenerated file for a new module:
