...
### Calling a Retail Proxy API directly in module code
The below code snippit shows how to call the getCategories Retail API with the Retail proxy wrapper API **getCategoriesAsync**.  This API call will return a list of all categories.
