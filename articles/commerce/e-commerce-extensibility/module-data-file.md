...
The software development kit (SDK) includes a set of core data actions that can get data from Commerce ratings and reviews or the recommendations service. You can find the list of data actions under the SDK's \\node\_modules\\@msdyn365-commerce-modules\\retail-actions\\dist\\lib directory.
