...
description: Learn about interactive feature modules and how to add them to site pages in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 01/23/2026
ms.topic: how-to
...
Interactive feature modules are mosaic-like modules that you can use to market multiple product categories or product brands by using a combination of images and text. For example, a retailer can add an interactive feature module to the home page of an e-commerce site to promote top-selling categories. The interactive feature module resembles the tile list module, but it has a different layout and different interaction functionality.

Each interactive feature module is a collection of interactive feature item modules. Each feature item module uses data from the content management system (CMS). It doesn't depend on any other modules or data from Commerce headquarters. You can add the interactive feature module to any site page where a retailer wants to market or promote something, such as products, categories, or brands.
...
:::image type="content" source="./media/Feature.PNG" alt-text="Screenshot of an interactive feature module on the Adventure Works home page.":::
