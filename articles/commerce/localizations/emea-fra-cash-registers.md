...
| Versioning strategy | The documentation that describes the versioning approach and the version management procedure for the software product | [Dynamics 365 Commerce component versioning requirements](../arch-component-versioning.md) |
