...
>[!WARNING]
> You must follow the guidelines in this article only if you are using the Commerce version 10.0.28 or earlier. Starting with the Commerce version 10.0.29, the fiscal printer integration sample for Italy is available in the Commerce SDK. For more information, see [Configure channel components](./emea-deu-fi-sample.md#configure-channel-components))
