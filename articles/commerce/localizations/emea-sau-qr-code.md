...
```
You also need to change the HintPath with the localtion of **Microsoft.Dynamics.Commerce.Runtime.ElectronicReporting.dll** to reference it the same dll under the Internet Information Services (IIS) Retail Server site location.
