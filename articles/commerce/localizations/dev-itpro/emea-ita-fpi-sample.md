...
- Sales scenarios:
    ...
    - Print the [customer information](../italy/emea-ita-customer-information.md) that is specified for a sales transaction on a fiscal receipt. An example of this information is the customer's lottery code. 
...
1. [Set up the functionality for management of customer information in POS](../italy/emea-ita-customer-information.md#setup).
