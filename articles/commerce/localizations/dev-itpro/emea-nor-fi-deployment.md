...
Next, on the **Key Vault parameters** page, specify the parameters for accessing the Key Vault:

- **Name** and **Description** – The name and description of the Key Vault.
