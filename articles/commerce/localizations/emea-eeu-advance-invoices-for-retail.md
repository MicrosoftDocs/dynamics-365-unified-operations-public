...
> [!IMPORTANT]
> If you are using Commerce version 10.0.35 or earlier, you must follow [Deployment guidelines for Advance Invoice report printing](./emea-eeu-deployment.md) to configure extensions for channel components.
