...
> [!NOTE]
> It is not possible to specify a lottery code for a customer in POS when **Create customer in async mode** is enabled in the POS functionality profile. Support for the Async customer creation mode may be added in future updates.
