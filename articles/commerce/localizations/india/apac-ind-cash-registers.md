...
description: This article provides an overview of the cash register functionality that's available for India. It also provides guidelines for setting up the functionality.
...
You must also enable the India-specific functionality on the Commerce channel side:
...
:::image type="content" source="../media/apac-ind-gst-language-text.png" alt-text="Screenshot of language text setup." lightbox="../media/apac-ind-gst-language-text.png":::
...
:::image type="content" source="../media/apac-ind-gst-custom-fields.png" alt-text="Screenshot of custom fields setup." lightbox="../media/apac-ind-gst-custom-fields.png":::
...
:::image type="content" source="../media/apac-ind-gst-receipt-format.png" alt-text="Screenshot of receipt format design." lightbox="../media/apac-ind-gst-receipt-format.png":::
...
:::image type="content" source="../media/apac-ind-gst-pos-functionality-profile.png" alt-text="Screenshot of a POS functionality profile." lightbox="../media/apac-ind-gst-pos-functionality-profile.png":::
...
1. Enter the items, and then select **Enter**.
    ...
    :::image type="content" source="../media/apac-ind-gst-pos-customer-order.png" alt-text="Screenshot of the POS customer order screen with Actions selected." lightbox="../media/apac-ind-gst-pos-customer-order.png":::

1. Validate the GST calculations. Consider the rate that's defined in the tax setup.
...
1. Select **OK**.
    ...
    :::image type="content" source="../media/apac-ind-gst-pos-customer-order2.png" alt-text="Screenshot of the POS customer order screen with Orders selected." lightbox="../media/apac-ind-gst-pos-customer-order2.png":::
...
1. Validate the receipt:
    ...
    :::image type="content" source="../media/apac-ind-gst-s1-receipt1.png" alt-text="Screenshot of scenario 1 first validation receipt example." lightbox="../media/apac-ind-gst-s1-receipt1.png":::
...
1. Validate the sales order and tax document in Headquarters:
    ...
    :::image type="content" source="../media/apac-ind-gst-tax-document.png" alt-text="Screenshot of the Tax document page." lightbox="../media/apac-ind-gst-tax-document.png":::
...
1. Recall and process the customer order:
    ...
    :::image type="content" source="../media/apac-ind-gst-process-customer-order.png" alt-text="Screenshot of processing a customer order." lightbox="../media/apac-ind-gst-process-customer-order.png":::

1. Select **Exact** to process the payment.
1. Validate the receipt.

    :::image type="content" source="../media/apac-ind-gst-s1-receipt2.png" alt-text="Screenshot of scenario 1 second validation receipt example." lightbox="../media/apac-ind-gst-s1-receipt2.png":::
...
1. Validate the voucher transactions:
    ...
    1. Select **Voucher**.
        ...
        | Ledger account name  | Debit amount (Rupees) | Credit amount (Rupees) |
        | -------------------- | --------------------- | ---------------------- |
    ...
    1. Verify that the receipt number is updated as the transaction ID.
        ...
        :::image type="content" source="../media/apac-ind-gst-tax-document2.png" alt-text="Screenshot of the Tax document page with the Transaction ID field selected." lightbox="../media/apac-ind-gst-tax-document2.png":::
...
1. Select **Add customer**, and select the customer account.
    ...
    :::image type="content" source="../media/apac-ind-gst-example-trx.png" alt-text="Screenshot of an example transaction." lightbox="../media/apac-ind-gst-example-trx.png":::
...
1. Validate the receipt:
    ...
    :::image type="content" source="../media/apac-ind-gst-receipt-validation.png" alt-text="Screenshot of receipt validation." lightbox="../media/apac-ind-gst-receipt-validation.png":::
...
1. Validate the voucher transactions:
    ...
    1. On the appropriate tabs, verify the location (store address) and the customer address.
        ...
        :::image type="content" source="../media/apac-ind-gst-tax-info.png" alt-text="Screenshot of tax information." lightbox="../media/apac-ind-gst-tax-info.png":::
...
1. Enter a transaction:
    ...
    :::image type="content" source="../media/apac-ind-gst-trx-example.png" alt-text="Screenshot of a transaction example." lightbox="../media/apac-ind-gst-trx-example.png":::

1. Select **Exact** to process the payment.
1. Validate the receipt.

    :::image type="content" source="../media/apac-ind-gst-s3-receipt4.png" alt-text="Screenshot of scenario 3 receipt example." lightbox="../media/apac-ind-gst-s3-receipt4.png":::
...
1. Validate the voucher transactions:
    ...
    1. Verify that the transaction ID is updated according to the GST number sequence that you defined in the GST reference number sequence group.
        ...
        :::image type="content" source="../media/apac-ind-gst-tax-doc-trx-id.png" alt-text="Screenshot of a tax document transaction ID." lightbox="../media/apac-ind-gst-tax-doc-trx-id.png":::
...
1. Enter an exempt item.
    ...
    :::image type="content" source="../media/apac-ind-gst-exempted-item-trx.png" alt-text="Screenshot of an exempted item transaction." lightbox="../media/apac-ind-gst-exempted-item-trx.png":::

1. Select **Exact** to process the payment.
1. Validate the receipt.

    :::image type="content" source="../media/apac-ind-gst-receipt-4.png" alt-text="Screenshot of scenario 4 receipt example." lightbox="../media/apac-ind-gst-receipt-4.png":::
...
1. Verify that the GST calculation is correct, based on the selected original transactions that you must return.
    ...
    :::image type="content" source="../media/apac-ind-gst-return-trx.png" alt-text="Screenshot of a POS return transaction." lightbox="../media/apac-ind-gst-return-trx.png":::

1. Select **Exact**.
1. Validate the receipt.

    :::image type="content" source="../media/apac-ind-gst-receipt-5.png" alt-text="Screenshot of scenario 5 receipt example." lightbox="../media/apac-ind-gst-receipt-5.png":::
