...
> [!IMPORTANT]
> This step is required only if you're using Commerce version 10.0.35 or later. If you're using Commerce version 10.0.34 or earlier, make sure you upgrade to a supported version.
