...
> [!NOTE]
> >If you need some devices for non-fiscal operations, such as Product catalogue search, Customer lookup, you can select these registers as registers with fiscal process restrictions see [Setup registers with fiscal registration restrictions](setting-up-fiscal-integration-for-retail-channel.md#setup-registers-with-fiscal-registration-restrictions).
