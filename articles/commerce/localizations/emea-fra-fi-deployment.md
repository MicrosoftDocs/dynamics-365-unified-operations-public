...
> [!WARNING]
> You must implement the steps that are described in this article only if you are using the Commerce version 10.0.28 release or earlier. Starting with version 10.0.29, all required Commerce channel components for France are enabled out-of-the-box. If you are using the Commerce version 10.0.28 release or earlier and are migrating to the version 10.0.29 or later, you must follow the steps in [Migrate to version 10.0.29 or later](#migrate-to-commerce-version-10029-or-later).
