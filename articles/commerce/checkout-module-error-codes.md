...
Depending on the error encountered, the table below will:
...
Use the following table to reference error code references provided by customers or experienced on the online store for additional details of the code.
