...
description: This article describes how does POS inventory lookup work with channel-side inventory calculation.
author: hhainesms
ms.date: 09/01/2021
ms.topic: article
ms.prod: 
...
To configure the POS **Inventory lookup** operation in Commerce headquarters to use the channel-side calculation logic and turn off real-time service call, you must first [configure channel-side calculation](commerce-how-to-use-channel-side-calculation.md), and then follow these steps.
