...
description: Learn how to sell and return products that aren't part of a store's assortment in Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 01/29/2026
ms.topic: how-to
...
A common scenario for any retailer is to sell products to their customers or accept returns from their customers even if they don't carry the specific products in their store (in other words, the products aren't assorted to the store).
...
- A retailer has many stores in and around a specific city or zip code and doesn't want to force the customers to return products to the same store they purchased in. Instead, customers can return products to any store.

Those common scenarios are available for retailers using Commerce. By using Commerce, you can:
