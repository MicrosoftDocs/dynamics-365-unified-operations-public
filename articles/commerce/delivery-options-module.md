...
|Enable request for a delivery date| **True** or **False** | When this optional property is set to **True**, users can provide a date on which they want to receive their delivery. This configuration has a dependency on the **"Enable multiple delivery options for an order"** configuration that must be enabled before enabling this configuration. This property is supported as of the Commerce version 10.0.40 release. |
