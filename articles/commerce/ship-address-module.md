...
| Enable auto suggestion| **True** or **False** | If this optional property is set to **True**, address suggestions powered by Bing Maps will be provided. For information on how to set up Bing Maps integration for your site, see [Store selector module](store-selector.md). This feature is available as of the Commerce version 10.0.15 release.|
|Auto suggest options| Number| If auto-suggestions are enabled, you can specify additional options such as the maximum number of auto-suggestion results.|
