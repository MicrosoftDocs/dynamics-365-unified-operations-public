...
a. **Create Customer record of the Organization type** —
...
b. **Create contact under Customer record** —
...
c. **Create customer hierarchy and link to Customer record** — A customer hierarchy is created and linked to the Customer 
record. 
     - The hierarchy is configured as a B2B buyer hierarchy.
     - The organization name is used as the hierarchy name.
        
d. **Link initial contact to customer hierarchy as admin** —
...
Before starting manual onboarding, ensure that:
  ...
  3. You understand whether the hierarchy should be created as a B2B buyer or B2B seller hierarchy.
...
The 1010 Customers job synchronizes:
  ...
  2. Contact records
  3. Customer hierarchy relationships
...
This job synchronizes:
  ...
  4. Customer hierarchy relationships
...
After a contact is selected, an organization selection column is displayed.
  ...
  1. **Multiple organizations selected** — Orders placed by the contact across all selected organizations are shown.
  2. **Single organization selected** — Customer information is displayed.
  3. **No single organization selected** — Customer information remains hidden.
...
All pricing, catalog and shopping cart/checkout configurations which would impact an organization's options when searching, filtering or purchasing products are available for contact based users. Multi-outlet users have the same benefit for any organizations they access within a single signed in session. 
