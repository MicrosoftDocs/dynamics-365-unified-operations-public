...
- **Published** - The experiment is ready to go live in Commerce and hasn't been started in the third-party service.
- **Unpublished** - The experiment is live but isn't visible to website users, even if it's running in the third-party service.
...
The following image shows both sets of statuses and how they relate to each other.
