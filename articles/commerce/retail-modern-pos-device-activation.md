...
This topic describes how to configure, download, and install Modern POS on various platforms. This topic is based on the legacy self-service installer. For more information about the new, sealed self-service installers, read the [Mass deployment of sealed Commerce self-service components](dev-itpro/Enhanced-Mass-Deployment.md) topic. It then describes how to activate Modern POS through device activation.
