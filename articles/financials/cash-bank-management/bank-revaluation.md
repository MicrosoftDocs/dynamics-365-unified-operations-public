...
You must turn on the feature for every legal entity that will use foreign currency revaluation. If you are assigned to the system admistrator role or feature manager role, you can eliminate this step by enabling the new feature "Enable bank revaluation without a parameter" in **Feature management.**
