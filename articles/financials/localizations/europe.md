...
This topic includes information and links to resources that can help you set up Dynamics 365 Finance for legal entities with a primary address in Europe. 
...
- [Payment reference generation tool (Eastern Europe)](tasks/ee-00015-payment-reference-generation-tool.md)
...
- Value Added Tax (VAT)
  ...
  - [Register a vendor VAT ID](tasks/eur-00015-registration-vendor-vat-id.md)
