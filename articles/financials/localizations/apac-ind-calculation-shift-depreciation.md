...
title: Calculate shift depreciation | Microsoft Docs
description: 
...
You can calculate shift depreciation for a value model with a Current status **selected in the** Posting layer field and a straight line percentage method or reducing balance depreciation method selected in the Depreciation profile field in the **Value models** page, per the Companies Act, 1956.
