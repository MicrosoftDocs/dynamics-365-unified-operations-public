...
This topic includes information and links to resources that can help you set up Dynamics 365 Finance for legal entities with a primary address in Brazil. 
...
- [Taxes](latam-bra-calculate-taxes.md)
  ...
  - [Withholding taxes](tasks/br-00009-brazilian-withholding-taxes.md)
    - [Withholding taxes on customer payments](tasks/br-00042-withholding-taxes-customers-payments.md)
    - [Withholding taxes on vendor payments](tasks/br-00061-withholding-taxes-vendors-payments.md)
- Tasks for Brazil
  ...
  - [Cancel a purchase complementary fiscal document](tasks/br-00026-2-cancel-purchase-complementary-fiscal-document.md)
  - [Issue fiscal documents for vendors](tasks/br-00033-issuing-fiscal-document-non-taxable-vendors.md)
  - [Issue customer fiscal documents](tasks/br-00038-issuing-customer-fiscal-document.md)
  - [Delivery slips](tasks/br-00041-delivery-slip.md)
  - [Miscellaneous charges on free text invoices](tasks/br-00050-miscellaneous-charge-free-text-invoice.md)
  ...
  - [Service electronic fiscal document using text files](tasks/br00059-service-electronic-fiscal-document-text-files.md)
  ...
  - [Electronic payment management for vendor payments](tasks/br-00067-electronic-payment-management-vendor-payments.md)
  - [Project debit notes](tasks/br-00076-project-debit-notes.md)
  - [Manage fiscal document text in procurement documents](tasks/br-00080-manage-fiscal-document-texts-procurement-documents.md)
  - [Receive vendor fiscal documents (fixed assets - ICMS long term recoverable)](tasks/br-00082-receiving-vendor-fiscal-document-fixed-assets-icms-long-term-recoverable.md)
  ...
  - [Non-fiscal operations](tasks/br-10016-non-fiscal-operations.md)
  - [Enter a CIAP transaction](tasks/br-10020-1-enter-ciap-transaction.md)
