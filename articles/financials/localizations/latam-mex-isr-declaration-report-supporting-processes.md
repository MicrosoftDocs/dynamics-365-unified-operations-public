...
## Prerequisites
Before you generate the ISR report, you can use Microsoft Dynamics 365 for Finance and Operations to configure the concept category and define the ISR rates that should be applied in the report. The ISR report is based on general journal transactions.
