...
|                  | Independent configuration for ICMS base reduction and tax substitution                                                                                                                                                                                                                                                                                                                                                                                                                                                             |       Yes| Yes       | Yes               |
...
| Sales return                                                            | Customer returns with your organization’s fiscal document                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |       |        |                 |
|                                                                         | Customer returns with a fiscal document issued by the customer                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |       |        |                 |
|                                                                         | Electronic fiscal document access key                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |       |        |                 |
| Inventory                                                               | Issue and receive fiscal documents for transfers/returns of inventory items between fiscal establishments                                                                                                                                                                                                                                                                                                                                                                                                                          |       |        |                 |
|                                                                         | Issue and receive fiscal documents for remittance/returns of inventory items from a third party                                                                                                                                                                                                                                                                                                                                                                                                                                    |       |        |                 |
| Production                                                              | Indirect and direct cost absorption                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |       |        |                 |
| NF-e (Federal)                                                          | Support to NF-e layout 2.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |       |        |                 |
|                                                                         | Support to NF-e layout 3.10                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |       |        |                 |
|                                                                         | Support to NF-e layout 4.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |       |        |                 |
...
| NFS-e Services (São Paulo city)                                         | Service electronic fiscal document using .txt files                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |       |        |                 |
|                                                                         | Recibo Provisório de Serviços (RPS) for São Paulo city                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |       |        |                 |
| Financial and treasury                                                  | Withholding IRRF, PIS, COFINS, CSLL, ISS, and INSS taxes on payments and receiving                                                                                                                                                                                                                                                                                                                                                                                                                                                 |       |        |                 |
...
| General ledger                                                          | Accounting consolidation with transaction detailed transfers                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
|                                                                         | Fiscal document for ICMS tax credit transfer between fiscal establishments                                                                                                                                                                                                                                                                                                                                                                                                                                                         |       |        |                 |
|                                                                         | Fiscal document for 1/48 ICMS tax credits                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |       |        |                 |
|                                                                         | Legal reports:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |       |        |                 |
| Retail Enterprise POS                                                   | Customer CPF/CNPJ on fiscal receipts                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |       |        |                 |
|                                                                         | File generation for *Nota Fiscal Paulista*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |       |        |                 |
|                                                                         | Tax calculation according to AX 2012 configuration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |       |        |                 |
...
|                                                                         | POS legal requirements according to PAF-ECF law “ATO COTEPE/ICMS N°9” of 2013, except for any businesses identified as out of scope in the [Out of scope](#out-of-scope) section                                                                                                                                                                                                                                                                                                                                                   |       |        |                 |
...
|                                                                         | EFT integration with third-party software SiTef, version 4.0.111.6, commercialized by Software Express Informática Ltda.                                                                                                                                                                                                                                                                                                                                                                                                           |       |        |                 |
|                                                                         | Presales according to PAF-ECF law “ATO COTEPE/ICMS N°46” of 2014                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |       |        |                 |
|                                                                         | Issuing of return NF-e in EPOS for sales return                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |       |        |                 |
|                                                                         | Issuing of NF-e linked to fiscal receipt in EPOS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |       |        |                 |
|                                                                         | Configurable AOS for NF-e/NFC-e messaging with SEFAZ                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |       |        |                 |
|                                                                         | **Note:** The EFT service must be contracted directly from the third-party provider and is not included in any Microsoft software license. **Note:** Not all Enterprise POS operations are permitted in Brazil due to conflicts with the PAF-ECF legislation. For further details, see the white paper Retail and Enterprise POS Localization for Brazil.                                                                                                                                                                          |       |        |                 |
| NFC-e (*Nota Fiscal ao Consumidor Eletrônica*) in Retail Enterprise POS | Support to layout NFC-e 3.10                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
|                                                                         | Support to layout NFC-e 4.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |       |        |                 |
|                                                                         | Contingency mode: off-line                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |       |        |                 |
|                                                                         | Contigency mode for SP: SAT (model 59)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |       |        |                 |
|                                                                         | Sales presence type: in-person                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |       |        |                 |
| Retail                                                                  | Retail item management:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |       |        |                 |
|                                                                         | SAT(model59) for São Paulo state layout 0.07                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
|                                                                         | Support to only one SAT hardware per EPOS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |       |        |                 |
|                                                                         | Support for SAT DLL selection, for multiples brand compatibility                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |       |        |                 |
|                                                                         | Fiscal receipt reference                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |       |        |                 |
|                                                                         | Fiscal printer auto-configuration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |       |        |                 |
| Project accounting (PSA)                                                | Credit notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
| TMS                                                                     | Issuing outbound fiscal documents and electronic fiscal documents from loads for sales order invoices                                                                                                                                                                                                                                                                                                                                                                                                                              |       |        |                 |
|                                                                         | Issuing outbound fiscal documents and electronic fiscal documents from loads from transfer oders and fiscal document slips                                                                                                                                                                                                                                                                                                                                                                                                         |       |        |                 |
|                                                                         | **Note:** For information about other source documents handled in loads, see the [Microsoft Dynamics Localization Portal](https://mbs.microsoft.com/partnersource/deployment/resources/productreleases/gfmlocalizationportalmc.htm?printpage=false&sid=xdtafwuk1xh2l5jdjhhv0joy&stext=gfm%20localization%20portal).                                                                                                                                                                                                                |       |        |                 |
| Call center                                                             | Support to Brazilian tax registration ID (CNPJ/CPF) at the customer data management                                                                                                                                                                                                                                                                                                                                                                                                                                                |       |        |                 |
| Fiscal books                                                            | Fiscal books reports:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |       |        |                 |
|                                                                         | Tax assessments                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |       |        |                 |
|                                                                         | Generation of tax assessment and payment of following taxes:                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
|                                                                         | Generation of tax assessment and payment of following taxes:                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
|                                                                         | Generation of tax assessment and payment of following taxes: PIS and COFINS regime Cumulative                                                                                                                                                                                                                                                                                                                                                                                                                                      |       |        |                 |
|                                                                         | Generation of tax assessment and payment of following taxes: PIS and COFINS regime Non Cumulative                                                                                                                                                                                                                                                                                                                                                                                                                                  |       |        |                 |
|                                                                         | Integration with the AX 2012 General ledger module:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |       |        |                 |
|                                                                         | Integration with Microsoft Dynamics AX 2009                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |       |        |                 |
|                                                                         | Fiscal books integration between Microsoft Dynamics AX 2009 SP1 RU8 and AX 2012 R3 Fiscal books to let users generate SPED Fiscal and SPED Contributions blocks A and C only. For detailed information, see <http://www.microsoft.com/en-us/download/details.aspx?id=39271>                                                                                                                                                                                                                                                        |       |        |                 |
| SPED Fiscal                                                             | Generation of a text file and support for companies deined as Profile A. Available layout versions:                                                                                                                                                                                                                                                                                                                                                                                                                                |       |        |                 |
| (IPI and ICMS)                                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |        |         |                  |
|                                                                         | Layout Code 11 – Version 1.10 From 01.01.2017 to 12.31.2017                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |       |        |                 |
|                                                                         | Layout Code 12 – Version 1.11 From 01.01.2018 to 12.31.2018                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |       |        |                 |
...
|                                                                         | Block C C114                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
|                                                                         | Block K and related: 0210- K001-K100-K200-K220-K230-K235                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |       |        |                 |
|                                                                         | **Out of scope:** SPED Fiscal with specific requirements from the state/region, as described in the [Brazilian localization strategy](#brazilian-localization-strategy) section; and companies categorized as Profile B and Profile C                                                                                                                                                                                                                                                                                              |       |        |                 |
| SPED Contributions                                                      | Generation of a text file in accordance with Practical Guide 1.25                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |       |        |                 |
| (PIS and COFINS)                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |        |         |                  |
|                                                                         | Support for tax assessment regime **Cumulative**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |       |        |                 |
|                                                                         | Support for company type **Sociedade empresaria em geral**                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |       |        |                 |
|                                                                         | Support for booking criterio **Regime de Competência – Escrituracao detalhada** only                                                                                                                                                                                                                                                                                                                                                                                                                                               |       |        |                 |
|                                                                         | Support for the following records:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |       |        |                 |
|                                                                         | Block 0 0111                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
|                                                                         | **Out of scope:** The tax assessment process and generation of related blocks (M) for regime **Non cumulative** and **Both**.                                                                                                                                                                                                                                                                                                                                                                                                      |       |        |                 |
| SPED ECF                                                                | Generation of a text file using “Management Reporter” Layout 001, 002, 003 and 004 Support for the following blocks and records:                                                                                                                                                                                                                                                                                                                                                                                                   |       |        |                 |
| SPED Reinf                                                              | Generation of events R-1000, R-1070, R-2010, R-2020, R-2060, R-2098, R-2099. Layout version 1.3.02                                                                                                                                                                                                                                                                                                                                                                                                                                 |       |        |                 |
| SINTEGRA                                                                | Generation of text files in accordance with Version 3 - ICMS-76/03, which is available from <http://www.sintegra.gov.br/>                                                                                                                                                                                                                                                                                                                                                                                                          |       |        |                 |
| GIA-SP                                                                  | Generation of GIA Sao Paulo state text files in accordance with version 08.00 (01/02/2013), which is available from <http://www.fazenda.sp.gov.br/download/download_gia.shtm>                                                                                                                                                                                                                                                                                                                                                      |       |        |                 |
| GIA-ST Nacional                                                         | Generation of GIA-ST text files in accordance with version 3.1 which is available from <http://www.fazenda.sp.gov.br/download/downloadgiast.shtm>                                                                                                                                                                                                                                                                                                                                                                                  |       |        |                 |
| SPED Accounting                                                         | Generation of SPED Contábil text files Layout version supported: 2.0, 3.0, 4.0, 5.0 and 6.0                                                                                                                                                                                                                                                                                                                                                                                                                                        |       |        |                 |
|                                                                         | Support for bookkeeping type G (Day Book - Livro Diario) and the generation of following blocks and records:                                                                                                                                                                                                                                                                                                                                                                                                                       |       |        |                 |
| Tax statement extensibility                                             | The Tax Statement Framework aims to provide a unified experience for tax statement developers (for example, partners and independent software vendors [ISVs]), so that they can make their tax statements available to users in the AX 2012 Fiscal books module. The framework consists of a set of base artifacts and object-oriented design guidelines that should be followed by tax statement providers. Microsoft, being a tax statement developer itself, also develops its own tax statements by leveraging this framework. |       |        |                 |
