...
-   If the **Print corrective invoice on a sales memo** option is set to **Yes**, the label "Rechnungskorrekturâ€ will be printed on credit memos from sales orders, free text invoices, and project invoices.
