...
4. To add full name and short name for a language, click **New** and complete the following fields.
   ...
   |       <strong>Conjunction 'and' between units and parts</strong>       |                                     Select to print the conjunction â€œandâ€ between the currency units and unit parts. For example, on invoices or reports, the amount for LTL 100.20 will be displayed as 100 Litas and 20 Centas.                                      |
