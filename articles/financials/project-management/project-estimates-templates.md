...
### Forecast model ID
To update the default forecast model ID in the template, click on the **Map** arrow to open the mapping. Select to open the Advanced Query and Filtering.
...
The Project expense estimates (PSA to Fin and Ops) template has a default filter to only include expense lines in the integration. If you create your own template, you must add this filter. Select the Transaction relationships task and click on the **Map** arrow. Select **Advanced Query and filtering**. Filter the **msdyn_transactiontype1** column to include only **msdyn_estimateline**.

### Forecast model ID
To update the default forecast model ID in the template, for the Expense estimates task, click on the **Map** arrow to open the mapping. Select to open the Advanced Query and Filtering.
