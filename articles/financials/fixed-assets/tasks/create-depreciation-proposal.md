...
4. In the To date field, enter a date.
    ...
    * For example, if the To date value is March 31, 2015, the following description is generated: â€œDepreciation since January 31, 2015.â€ The Date field on the proposed journal lines is then set to March 31, 2015.  
