...
| Dynamics 365 Finance                                                                              | An environment that has Microsoft Dynamics 365 for Operations version 1611 and Platform update 3 for Dynamics for Operations (November 2016)                   |
| Install hotfix KB 3204341.                                                                              | Task recorder can erroneously record two Close commands for dropdown dialogs; this is included in Platform update 3 for Dynamics 365 for Operations (November 2016 update). |
| Install hotfix KB 3207800.                                                                              | This hotfix enables attachments to be viewed on the mobile client this is included in Platform update 3 for Dynamics 365 for Operations (November 2016 update).           |
