...
1. Select **Accounts receivable \> Vendors**.
...
4. Select the **View settlements** tab on the action pane.
    ...
    The **View settlements** dialog box shows the selected transaction and all documents that are settled against it. This dialog box resembles the settlement history view, but it includes all related documents.
