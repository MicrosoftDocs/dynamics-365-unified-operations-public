...
description: This topic explains how to use cash control to define transaction limits when there is no cash balance, or when a transaction will cause the cash balance to fall below a predefined amount.
author: velofog
manager: AnnBe
ms.date: 07/23/2019
ms.topic: article
