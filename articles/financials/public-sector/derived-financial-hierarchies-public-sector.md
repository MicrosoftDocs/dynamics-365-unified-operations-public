...
-   **Set up the category hierarchies and the derived financial hierarchies:** Create a category hierarchy named â€œEmployee programsâ€ with a parent node named â€œProgramsâ€ and two child nodes named â€œEmployee wellnessâ€ and â€œEmployee education.â€ Assign the **Derived financial hierarchy** category type to the â€œEmployee programsâ€ category hierarchy. Associate the â€œEmployee programsâ€ derived financial hierarchy with the legal entity.
-   **Set up filter rules:** Use the **Derived financial hierarchies** page to create filter rules for the main accounts and financial dimension values associated with the â€œEmployee wellnessâ€ and â€œEmployee educationâ€ nodes in the â€œEmployee programsâ€ derived financial hierarchy. **Tip:** To enter more than one dimension value in a filter, use a comma without spaces as a separator. For example, enter 100,110 or Benefits,Insurance.
