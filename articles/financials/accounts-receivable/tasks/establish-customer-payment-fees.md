...
6. In the **Charge** field, select whether the fee will be charged to the Customer or a Ledger account.
...
7. In the **Journal type** field, select the type of journal that can use this payment fee.
...
10. In the **Groupings** field, select either Table, Group or All to define which bank accounts will be assessed this fee.
...
11. In the **Bank relation** field, select either a bank group or a bank account.
...
13. In the **Mehtod of payment** field, select the Method of payment for which this fee will be assessed.
...
15. If relevant, in the **Payment currency** field, enter a payment currency.
...
17. In the **Percentage/Amount field**, enter either percentage or amount of the fee.
