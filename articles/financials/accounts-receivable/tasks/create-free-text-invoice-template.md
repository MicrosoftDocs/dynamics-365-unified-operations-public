...
title: Create free text invoice template
...
ms.search.form: CustInvoiceTemplate, TaxGroupLookup, CustInvoiceDistributionTemplate   
...
---
# Create free text invoice template
