...
Users who aren't linked to a call center channel use the standard order entry features of Microsoft Dynamics 365 for Finance and Operations. Orders that these users enter are not identified as Retail orders. Additionally, they aren't subject to any of the order processing rules, retail pricing logic, or other order validations that can be defined in the call center channel configuration or call center system parameters.
