...
Finance and Operations already provides the basic requirements for device management. As you plan your implementation, you must make sure that you take all the appropriate considerations, to help minimize pain and maximize benefit.
...
Unfortunately, things sometimes go wrong. It's important that you consider worst-case scenarios and put mitigation plans in place (per the disaster plan that you created during the planning phase) to help resolve issues that arise. In Finance and Operations, the **Devices** page can at least help with device management.
