...
Inline-style: 
![alt text](media/emea-ita-fpi-solution.png "Logo Title Text 1")

## Setting up Retail for Italy
### Enabling extensions
##### The CRT extension components
The CRT extension components are included in Retail SDK. To complete the following procedures, open the CRT solution, CommerceRuntimeSamples.sln, under RetailSdk\SampleExtensions\CommerceRuntime.

1. Find the Runtime.Extensions.DocumentProvider.EpsonFP90IIISample project, and built it.
...
##### The Hardware station extension components
