...
1. Set up the following parameters for value-added tax (VAT) per Swedish requirements:
    ...
    For more information about how to set up and use sales tax in Finance and Operations, see [Sales tax overview](../../financials/general-ledger/indirect-taxes-overview.md).
