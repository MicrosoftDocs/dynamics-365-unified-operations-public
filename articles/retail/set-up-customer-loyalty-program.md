...
> [!NOTE]
> Unlike other periodic discounts such as quantity, simple, mix and match, and threshold discounts, the shipping discount does not create discount lines, instead you need to edit the shipping charge directly.
