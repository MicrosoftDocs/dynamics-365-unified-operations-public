...
1. In the **Navigation pane**, go to **Modules > Retail and commerce > Pricing and discounts management > Price groups > All price groups**.
...
34. In the **Details** fastTab, check or uncheck the **Find next** checkbox.
