...
description: You can monitor sales and margin performance in real time using Dynamics 365 Retail.
author: ashishmsft
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
You can monitor sales and margin performance in real time using Dynamics 365 Retail.
