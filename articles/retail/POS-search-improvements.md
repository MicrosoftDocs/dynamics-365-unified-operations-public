...
To set search criteria as shortcuts, the admin must open the **Retail parameters** page in Finance and Operations, and then, on the **POS search criteria** tab, select all the criteria that should be shown as shortcuts.
