...
| TaxService                 | This service calculates the sales tax for the current order. You can use sales tax information from Dynamics, or from a third-party sales tax service. |
