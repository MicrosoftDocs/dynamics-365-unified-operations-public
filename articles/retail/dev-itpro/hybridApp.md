...
For more details on Xamarin, refer [Xamarin Documentation](https://docs.microsoft.com/en-us/xamarin/)
...
3.  Using the [Visual Studio's Emulator for Android](https://visualstudio.microsoft.com/vs/msft-android-emulator/ "Visual Studio Emulator for Android") or using any other Emulator for Android, launch the POS hybrid app and enter the Retail Server URL and save.
...
For more detailed steps on installing Xamarin on iOS refer [Xamarin.iOS Installation](https://docs.microsoft.com/en-us/xamarin/ios/get-started/installation/)
