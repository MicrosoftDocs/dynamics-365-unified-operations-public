...
<td>Contains all the payment relelated assemblies. It has belwo three subfolders to include different payment files:
...
IPaymentDevice Assemblies – This folder contains the assembly that implements the IPaymentDevice interface/payment request handlers, and its dependent assemblies. These assemblies are used in Retail Hardware station and Retail Modern Point of Sale (Modern POS) to communicate with payment terminal devices.
All payment connector related extensions should also go this folder before creating the deployment packages.
</td>
</tr>    
<tr class="odd">
<td>Payments</td>
