...
Note: The folder structure and description is applicable only for 7.2. In 7.3 we sealed the Retail proxy and Hardware station projects, in 7.3 instead you will see only samples for both Hardware station and retail proxy. Proxy can be generated by following the new extensibility pattern.
