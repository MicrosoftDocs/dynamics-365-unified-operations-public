...
| 137 | Add affiliation to customer | Add an affiliation to a customer from the customer details page. | No | No | No | Yes | No |
| 138 | Remove affiliation from customer | Remove an affiliation from the customer details page. | No | No | No | Yes | No |
