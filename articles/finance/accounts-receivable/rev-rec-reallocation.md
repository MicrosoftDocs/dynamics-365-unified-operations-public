...
o	The credit document will reuse the original invoice number, but with a “-1” appended to the invoice number. 
o	The credit document is automatically settled against the original invoice. If the original invoice was already settled to another credit document/payment, the settlement will be reversed automatically.
o	The credit document will post to general ledger to reverse the accounting entry of the original invoice. It will reverse the accounting entry posted on the original invoice with the exception of the Inventory and COGS transaction entries.  
•	A new invoice is created in the Accounts receivable module based on the new reallocated price amounts. 
o	The new invoice will reuse the original invoice number, but with a “-2” appended to the invoice number. 
o	The new invoice will automatically be settled to any credit document or payments that were previously settled with the original invoice.  
o	The new invoice will post to the general ledger using the new reallocation revenue price amounts. It will not post to Inventory and COGS again, since that is maintained on the original invoice’s accounting entry. 
...
•	A new accounting entry is posted to only general ledger based on the new reallocation revenue prices.  It will not post to Inventory and COGS accounts again because those entries are maintained on the original invoice’s accounting entry. 
...
o	If none of the sales order lines have been invoiced, the Process button will simply update the revenue price amounts on any sales orders selected for the reallocation. 
o	If one or more sales order line has been invoiced, the Process button will post correcting accounting entries and correct the revenue schedule details created for the invoiced sales order line (if they exist).
...
[![General ledger parameter setting](./media/06_RevRecScenarios.png)](./media/06_RevRecScenarios.png)
...
[![New sales order lines](./media/07_RevRecScenarios.png)](./media/07_RevRecScenarios.png)
...
[![Revenue price allocation](./media/08_RevRecScenarios.png)](./media/08_RevRecScenarios.png)
...
[![Sales order lines with additional sale](./media/09_RevRecScenarios.png)](./media/09_RevRecScenarios.png)
...
[![Reallocate price with new order lines](./media/10_RevRecScenarios.png)](./media/10_RevRecScenarios.png)
...
[![Revenue price allocations lines](./media/11_RevRecScenarios.png)](./media/11_RevRecScenarios.png)
...
[![Post invoice corrections to Accounts receivable set to No](./media/12_RevRecScenarios.png)](./media/12_RevRecScenarios.png)
...
[![Revenue price allocation with sustained engineering lines](./media/14_RevRecScenarios.png)](./media/14_RevRecScenarios.png)
The sales order is fully invoiced.  The following accounting entry is posted.

[![Voucher transactions grid](./media/15_RevRecScenarios.png)](./media/15_RevRecScenarios.png)
The Revenue recognition schedule is also created but none of the revenue is recognized yet. 

[![Revenue recognition schedule](./media/16_RevRecScenarios.png)](./media/16_RevRecScenarios.png)
A few days later the customer selects the laptop, and a second sales order is entered for the customer.

[![Sales order details with second addition](./media/17_RevRecScenarios.png)](./media/17_RevRecScenarios.png)
...
[![Reallocate price with new order lines](./media/18_RevRecScenarios.png)](./media/18_RevRecScenarios.png)
...
[![Expected voucher](./media/19_RevRecScenarios.png)](./media/19_RevRecScenarios.png)
...
[![Revenue price allocation](./media/20_RevRecScenarios.png)](./media/20_RevRecScenarios.png)
...
[![Revenue recognition schedule](./media/21_RevRecScenarios.png)](./media/21_RevRecScenarios.png)
The same is true for item S0001, which originally had 2 schedule lines and now there are 6 schedule lines.

[![Revenue recognition schedule – second example](./media/22_RevRecScenarios.png)](./media/22_RevRecScenarios.png)
...
[![Revenue recognition schedule – second example](./media/23_RevRecScenarios.png)](./media/23_RevRecScenarios.png)
...
[![Voucher transactions](./media/24_RevRecScenarios.png)](./media/24_RevRecScenarios.png)
...
### Scenario 3
Thisscenario walks through a reallocation scenario where a new line is added to an existing, invoiced sales order.  When adding a new item to a contract, the new item can be added to a new sales order, as shown in Scenario 2, or added to the existing sales order. This scenario also walks through what happens when Accounts receivable is updated as a result of the reallocation. 
The General ledger parameter, **Post invoice corrections to Accounts receivable**, should be set to Yes.
 
[![General ledger parameters for third scenario](./media/25_RevRecScenarios.png)](./media/25_RevRecScenarios.png)
...
[![Sales order lines for third scenario](./media/26_RevRecScenarios.png)](./media/26_RevRecScenarios.png)
...
[![Revenue price allocation for third scenario](./media/27_RevRecScenarios.png)](./media/27_RevRecScenarios.png)
The sales order is fully invoiced. The following accounting entry is posted for the invoice.

[![Voucher transactions  for third scenario](./media/28_RevRecScenarios.png)](./media/28_RevRecScenarios.png)
...
[![Revenue recognition schedule for third scenario](./media/29_RevRecScenarios.png)](./media/29_RevRecScenarios.png)
...
[![Sales order lines for third scenario](./media/30_RevRecScenarios.png)](./media/30_RevRecScenarios.png)
...
[![Reallocate price with new order lines for third scenario](./media/31_RevRecScenarios.png)](./media/31_RevRecScenarios.png)
...
[![Expected voucher lines for third scenario](./media/32_RevRecScenarios.png)](./media/32_RevRecScenarios.png)
...
[![Revenue price allocation for third scenario](./media/33_RevRecScenarios.png)](./media/33_RevRecScenarios.png)
The revenue recognition schedule was also updated based on the new revenue reallocation price.  From the sales order, open the **Revenue recognition schedule** page.  Previously there were 13 lines for item S0008 which was assigned a 12M schedule. Now there are 39 lines: 13 original schedule lines, 13 reversal schedule lines, and 13 lines based on the new revenue price.  

[![Revenue recognition schedule for third scenario](./media/34_RevRecScenarios.png)](./media/34_RevRecScenarios.png)
...
[![Original and reversing transactions for third scenario](./media/35_RevRecScenarios.png)](./media/35_RevRecScenarios.png)
...
[![Voucher transactions for third scenario](./media/36_RevRecScenarios.png)](./media/36_RevRecScenarios.png)
...
[![General ledger parameters setting for fourth scenario](./media/37_RevRecScenarios.png)](./media/37_RevRecScenarios.png)
...
[![Sales order lines for fourth scenario](./media/38_RevRecScenarios.png)](./media/38_RevRecScenarios.png)
...
[![Revenue price allocation for fourth scenario](./media/39_RevRecScenarios.png)](./media/39_RevRecScenarios.png)
...
[![Voucher transactions for fourth scenario](./media/40_RevRecScenarios.png)](./media/40_RevRecScenarios.png)
...
[![Revenue recognition schedule for fourth scenario](./media/41_RevRecScenarios.png)](./media/41_RevRecScenarios.png)
...
[![Sales order lines for fourth scenario](./media/42_RevRecScenarios.png)](./media/42_RevRecScenarios.png)
...
[![Reallocated price with new order lines for fourth scenario](./media/43_RevRecScenarios.png)](./media/43_RevRecScenarios.png)
Next select Expected voucher to see the accounting entries.  
 
[![Expected voucher lines for fourth scenario](./media/44_RevRecScenarios.png)](./media/44_RevRecScenarios.png)
...
[![Revenue price allocation for fourth scenario](./media/45_RevRecScenarios.png)](./media/45_RevRecScenarios.png)
The revenue recognition schedule was also updated based on the new revenue reallocation price.  From the sales order, open the **Revenue recognition schedule** page.  Previously there were 13 lines for item S0008 which was assigned a 12-month schedule. Now there are 39 lines: 13 original schedule lines, 13 reversal schedule lines, and 13 lines based on the new revenue price.  

[![Revenue recognition schedule for fourth scenario](./media/46_RevRecScenarios.png)](./media/46_RevRecScenarios.png)
...
[![Accounting entries on All customers page for fourth scenario](./media/47_RevRecScenarios.png)](./media/47_RevRecScenarios.png)
