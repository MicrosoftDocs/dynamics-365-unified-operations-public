...
1. On the **Revenue allocation** tab at the top of the page, select **Revenue allocation**.
1. In the **Multiple element arrangement type** field, select the type of multiple element arrangement (MEA).
1. In the **Multiple element arrangement number** field, specify the MEA number. Then, in the **Deferred contract revenue account** field, specify the deferred contract revenue account.
    ...
    You can assign an MEA number only to two or more items. A single line can't have its own MEA number.
...
1. On the **Invoice** tab, under **Revenue allocation**, select **Revenue allocation**.
1. In the **Multiple element arrangement type** field, select the MEA type.
1. In the **Multiple element arrangement number** field, specify the MEA number.
1. If the **Multiple element arrangement type** field is set to **Multiple**, select the lines that you want, and then select **Apply to selected**.
1. Select **Save**.
