...
On the **Accounts receivable parameters** page, enter the default posting profiles for bills of exchange on the **Ledger and sales tax** tab. Define number sequences on the **Number sequences** tab.
...
On the journal voucher page for each bill of exchange journal, enter information about the bill of exchange on the **Bill of exchange** tab. After you post the bill of exchange journal lines, you can view them on the **Bill of exchange journal inquiry** page and the **Bills of exchange statistics** page.
...
## Troubleshoot bills of exchange

### Symptoms

1. The Generate remittance process doesn't create a remittance number for transactions in the Remittance Journal.

### Troubleshooting steps

1. Go to **Accounts receivable** > **Setup** > **Payments setup** > **Method of payment**.
1. Select the **Method of payment**.
1. In the action pane, select **Payment specification**.
1. In the **Payment specification parameter** field, enter **Remittance**.
