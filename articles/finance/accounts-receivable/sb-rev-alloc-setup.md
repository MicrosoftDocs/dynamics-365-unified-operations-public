...
Multiple element revenue allocation allows you to setup different templates to calculate and allocate revenue across multiple items. This can help you meet ASC 606 and/or IFRS 15 compliance.
...
1. Select the **Standlone selling price origin**.
   a. If **Standalone selling price origin** is **Percent of item**, specify the **Percent**.
   b. If **Standalone selling price origin** is **Amount**, specify the **Standalone selling price**. 
2. For each item you want to add in the **List**, do the following: 
   a. Select **Add**. 
   b. Select the **Item code** and **Item relation**. For items where the **Revenue split** check box is cleared, the item code-item relation combination that you select must be unique. 
   c. If needed, change the **Standalone selling price origin**, **Standalone selling price**, or **Percent** from the default values. 
3. For each parent item you want to add in the **List**, do the following: 
   1. Select **Add**. 
   1. Select the **Item code** and **Item relation**
   1. Select the **Revenue split** check box. 
   1. Select the **Item relation**.  
 The list is updated with the parent item and all child items. 
   1. If needed for the child items, change the **Standalong selling price origin**, **Percent of parent standard price**, **Percent of parent invoice price**,  or **Allocate residual amount** from the default values. 
1. To add several items in a single action, do the following: 
   1. Select **Add items**. 
   1. In the  dialog page that opens, modify the query to specify the range of items that you want to add. 
   1. Select **OK**.
1. Review the list of items that you added, and select **OK**.   
...
Modules > Multiple element revenue allocation > Setup > MEA templates

 Use this page to create and edit multiple element arrangement (MEA) template ID’s. These IDs are used on the **Revenue allocation** page to group items together.

### Create Template

Set up an MEA template: 
1. Select **New**. 
1. Specify a unique **MEA template ID** and **Description**. 
