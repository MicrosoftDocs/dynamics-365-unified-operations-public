...
1. Set the **Termination date**, **Termination type**, and **Reason code** fields.
1. Set the **Credit option** field to **Issue credit**.
1. Select **Terminate**.
...
1. Select a billing schedule or a billing schedule line, and then select **Terminate**.
1. Set the **Termination date**, **Termination type**, **Reason code**, and **Credit option** fields.
1. Select **Terminate with refund**. The **Mass termination processing** page appears and is filtered so that it shows the billing schedule.
1. Select **View preview** to view the billing schedules lines, and then select **Process**.
...
If you use the unbilled revenue feature, the **Unbilled revenue journal entry audit** page is updated with the termination entry.
...
1. Select a billing schedule or a billing schedule line, and then select **Terminate**.
1. Set the **Termination date** field.
1. Set the **Termination type** field to **No adjustment**. The **Credit option** field is automatically set to **No credit**.
1. Set the **Reason code** field.
1. In the **Termination notes** field, enter any notes that are required.
1. Select **Terminate**.

When the termination is processed, all billing detail lines after the termination date are removed. These lines include the line that contains the termination date. You can't create invoices for the terminated lines. If you remove the termination, all terminated lines are added back to the **View billing details** page and become available for invoicing.
