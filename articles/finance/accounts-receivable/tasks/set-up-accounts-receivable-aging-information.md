...
description: Learn how to set up an aging period definition, age customer balances, and view balances in the Aged balance list and the Collections page.
author: twheeloc
ms.author: twheeloc
ms.topic: how-to
ms.date: 08/04/2025
...
2. In the **Aging period definition** field, select the aging period definition that you created.
    ...
    + Select an "as of" date for aging. The default is today but, if you change this field to **Selected date**, you can pick the date that you want. For batch processing, use **Today's date**.  
