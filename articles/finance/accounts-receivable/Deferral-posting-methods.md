...
On the **Revenue and expense deferral parameters** page, the options for deferral posting methods are **Balance sheet** and **Profit and loss**. The example in this article helps explain the differences between the two methods and the reasons why you might use one method or the other.

The **Balance sheet** method uses only two accounts, so it involves less setup. The **Profit and loss** method has two additional accounts, **Initial recognition** and **Recognition offset**, for revenue, discounts, and costs, depending on the transaction type. Set up these accounts on the **Deferral defaults** page (**Subscription billing** > **Revenue and expense deferrals** > **Setup**). Although the example focuses on deferred revenue, you can apply the same concept to deferred discounts and deferred costs.
...
When you use the **Balance sheet** method, it isn't as easy to see the gross revenue for a period. Some of the revenue is posted to the **Deferred revenue** account. Keep in mind that as revenue is recognized each period, there are multiple debits and credits in the **Deferred revenue** account. Gross revenue for a given period mixes with the ins and outs of revenue recognition.
...
All revenue goes to the profit and loss **Revenue** account. Then the deferred revenue moves from the profit and loss statement to the balance sheet. You can easily see the gross revenue, because everything is posted to the **Revenue** account. However, some of that gross revenue is deferred. Therefore, it's moved to the **Deferred revenue** account and recognized later.
