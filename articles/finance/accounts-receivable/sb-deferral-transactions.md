...
|**Initial recognition account**|**Account number**<br />Select the account for the initial revenue recognition. The default value is from the **Deferral defaults** page.<br />Available only when **Deferral posting method** is **Profit and loss** on the **[Advanced Revenue & Expense Deferrals Parameters](../setup/Parameter.md)** page. <br />**Account name**<br />Displays the account name. Read-only.
...
|**Deferral account**|**Account number**<br />Specify the discount deferral account number. The default value is from the **Deferral defaults** page. <br />Available when **Discount deferral option** is set to **Separate schedule for discount** on the **[Advanced Revenue & Expense Deferrals Parameters](../setup/Parameter.md)** page and when a discount is applied to the line. <br />**Account name**<br />Displays the account name. Read-only.|
|**Recognition account**|**Account number**<br />Specify the discount recognition account number. The default value is from the **Deferral defaults** page. <br />Available when **Discount deferral option** is set to **Separate schedule for discount** on the **[Advanced Revenue & Expense Deferrals Parameters](../setup/Parameter.md)** page and when a discount is applied to the line. <br />**Account name**<br />Displays the account name. Read-only.|
|**Initial recognition account**|**Account number**<br />Select the account for the initial discount recognition. The default value is from the **Deferral defaults** page.<br />Available only when **Deferral posting method** is **Profit and loss** on the **[Advanced Revenue & Expense Deferrals Parameters](../setup/Parameter.md)** page and when a discount is applied to the line. <br />**Account name**<br />Displays the account name. Read-only.|
...
|**Override start date**|Select whether to override the start date:<br />* **Yes**: Override the start date with the date that you enter in the **Start date** field. <br />* **No**: The start date is the **Default deferral start date** rule that is applied to the invoice date specified on the **Posting invoice** page.  This rule can be set on the  **[Advanced Revenue &Expense Deferrals Parameters](../setup/Parameter.md)** page.|
