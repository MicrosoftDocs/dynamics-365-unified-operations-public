...
Subscription billing enables organizations to manage subscription revenue opportunities and recurring billing through billing schedules. You can easily manage complex pricing and billing models and revenue allocation. The system bills and recognizes revenue at the line level. Multi-element revenue allocation enables allocation of revenue to comply with International Accounting Standards (International Financial Reporting Standard 15 \[IFRS 15\]) and Generally Accepted Accounting Principles (US GAAP) standards (Accounting Standards Codification Topic 606 \[ASC 606\]).

The solution has three modules that you can use independently. Alternatively, you can use all three modules together.
...
>[!NOTE]
> Enable subscription billing through **Feature management**. However, you can't use it with the **Revenue recognition** feature. You must disable that feature before you enable subscription billing.
...
1. Select the **Revenue recognition** feature, and then select **Disable**.
1. In **Feature name** filter, enter **Subscription billing**, and then select the module filter.
1. Select the **Subscription billing** feature, and then select **Enable**.
1. Select one of the three modules from the previous list, and then select **Enable**. Repeat this step for each of the other two modules.

    > [!IMPORTANT]
    > You must enable the **Subscription billing** feature before you can enable any of the three modules.
