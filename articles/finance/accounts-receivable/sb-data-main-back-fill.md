...
Starting in Microsoft Dynamics 365 Finance version 10.0.45, you can run a data maintenance job to backfill deferral schedule line fields. This data maintenance job is designed to
backfill essential fields (Voucher, JournalNum, and TransDate) in the SubBillDeferralScheduleLine table. The values come from the corresponding data in the LedgerJournalTrans table.
