...
### Set up collection process automation parameters
...
> [!Note]
> For more information on Customer predictions and Finance insights see [!Customer payment predictions](payment-insights-overview.md).
