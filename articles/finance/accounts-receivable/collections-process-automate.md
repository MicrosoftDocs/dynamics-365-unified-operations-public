...
|     Collections   process setup; Process automation    	|     Hierarchy                 	|     Defines the   priority of process automation to assign a customer if they belong in multiple pools.                                                                                               	|
|     Collections   process setup; Process automation    	|     Pool ID                   	|     Queries that   define a group of customer records.                                                                                                                                                     	|
|     Collections   process setup; Process automation    	|     Quiet days                	|     Limit how frequently a process step can be completed. For example, if two quiet days are set the next process step will not   occur for at least two days if the leading invoice changes.    	|
