...
The **Collections** page provides a centralized view where you can manage accounts receivable collections information. Collections managers use this centralized view to manage collections. Collections agents can begin the collections process either from customer lists that are generated by using predefined collection criteria or from the **Customers** page.
