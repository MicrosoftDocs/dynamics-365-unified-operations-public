...
> [!NOTE]
> To better show the concepts, the illustrations in this article hide or add columns to grids. Therefore, the pages and data in the illustrations might differ from what you see in the product.

## Enter a sales order

The following sales order is entered and includes three items that are set up for revenue recognition.

:::image type="content" source="./media/revenue-recognition-so-basic-sales-order-header.png" alt-text="Screenshot of a sales order header with three items entered for revenue recognition." lightbox="./media/revenue-recognition-so-basic-sales-order-header.png":::

Two concepts apply to revenue recognition:

- **Determine the revenue price.** Calculate the revenue price based on the setup of the released products. The revenue price never shows to the customer and is used only for the accounting of the sales order invoice. The sales order lines and the documents that are printed as part of the sale continue to show the unit or list price.
- **Determine when revenue recognition should occur.** Use a revenue schedule to determine when revenue should be recognized.

    In this example, assign the first item, S0001, to a **1O** (one-occurrence) revenue schedule. This line represents a milestone-type scenario, where the revenue is recognized after the installation occurs in the future. Therefore, defer revenue until the installation is completed.
    ...
    :::image type="content" source="./media/revenue-recognition-so-basic-revenue-schedules.png" alt-text="Screenshot of the revenue schedules page showing the 12M revenue schedule setup." lightbox="./media/revenue-recognition-so-basic-revenue-schedules.png":::
...
To view more details about the revenue price and revenue schedule, use the buttons in the **Revenue recognition** group on the **Manage** tab on the Action Pane of the sales order. Because the sales order isn't confirmed at this point, the buttons for revenue recognition are unavailable. These buttons become available or unavailable as the sales order progresses through the stages that lead to fulfillment.

:::image type="content" source="./media/revenue-recognition-so-basic-sales-order-header-02.png" alt-text="Screenshot of the sales order header showing revenue recognition buttons on the Manage tab." lightbox="./media/revenue-recognition-so-basic-sales-order-header-02.png":::

The first three buttons provide details about the revenue price for the items on the sales order that are set up for revenue recognition.
...
In the following example, revenue price allocation occurred when the sales order was confirmed. Even though the revenue prices are allocated differently, the total amount in the **Revenue to recognize** field must still equal the sum of the sales order lines that are invoiced to the customer. For example, the sum of the sales order lines, excluding tax, is $,1499. Therefore, the sum of the **Revenue to recognize** values must also be $,1499.

:::image type="content" source="./media/revenue-recognition-so-basic-revenue-price-allocation.png" alt-text="Screenshot of the revenue price allocation page showing allocated revenue prices for sales order lines." lightbox="./media/revenue-recognition-so-basic-revenue-price-allocation.png":::
...
:::image type="content" source="./media/revenue-recognition-so-basic-expected-rev-rec-schedule.png" alt-text="Screenshot of the expected revenue recognition schedule for deferred items." lightbox="./media/revenue-recognition-so-basic-expected-rev-rec-schedule.png":::

## Create the packing slip

Next, the packing slip can be created for the sales order. No revenue is recognized when the packing slip is posted. If the sales order wasn't confirmed, posting of the packing slip doesn't trigger revenue price calculation. It also doesn't trigger creation of the expected or final revenue recognition schedule. If the item model group is set up to defer revenue on the packing slip, it continues to post by using the current posting profile ledger accounts, not the new deferred revenue accounts that are used on the invoice posting.

## Create the invoice

The final step is to invoice the sales order. If you look at the invoice's voucher, you see that the revenue for items S0001 and S0008 is deferred ($321.21 + 160.61 = 481.82), and the remaining amount for item S0012 is posted to revenue (1,017.18). These values add up to $1,499, which matches the sum of the sales order lines.

:::image type="content" source="./media/revenue-recognition-so-voucher-transactions.png" alt-text="Screenshot of the voucher transactions for the posted invoice showing deferred and recognized revenue." lightbox="./media/revenue-recognition-so-voucher-transactions.png":::

After you create the invoice, the **Revenue price allocation**, **Reallocate price with new order lines**, and **Revenue recognition schedule** buttons for revenue recognition become available, but the **Update revenue price allocation** and **Expected revenue recognition schedule** buttons are unavailable.

:::image type="content" source="./media/revenue-recognition-so-basic-after-invoice-buttons.png" alt-text="Screenshot of available revenue recognition buttons after the sales order is invoiced." lightbox="./media/revenue-recognition-so-basic-after-invoice-buttons.png":::
...
:::image type="content" source="./media/revenue-recognition-so-revenue-recognition-schedule.png" alt-text="Screenshot of the final revenue recognition schedule after invoicing." lightbox="./media/revenue-recognition-so-revenue-recognition-schedule.png":::
