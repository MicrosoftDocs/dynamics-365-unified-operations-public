...
|     _      |         _               | Statutory Book | Statutory Book | Statutory Book |       _                 |   | Reversal Book | IFRS 16 Book | IFRS 16 Book | IFRS 16 Book | IFRS 16 Book |                   -                     |
|------------|--------------------------|----------------|----------------|----------------|-------------------------|---|---------------|--------------|--------------|--------|
|       -    |           -              | Current Layer  | Current Layer  | Current Layer  |        _                | _ | Custom layer  | Custom layer | Custom layer | Custom layer | Custom layer |        _                                |
|     _      |                          | JE\-100        | JE\-110        | JE\-120        |          _              | _ | JE\-130       | JE\-140      | JE\-150      | JE\-160   _  | JE\-170      |          _                              |
...
|------------|--------------------------|----------------|----------------|----------------|-------------------------|---|---------------|--------------|--------------|--------------|--------------|-----------------------------------------|
| 1          | Lease expense            | 1,000\.00      |       _        |      _         | 1,000\.00               |   | \-1,000       |      _       |     _        |     _        |     _        | 0\.00                                   |  
| 2          | Bank fee                 |       _        | 3\.00          |      _         | 3\.00                   |   |      _        |     _        |     _        |     _        |       _      | 3\.00                                   |
| 3         | VAT expense              |       _        | 5\.00          |      _         | 5\.00                   |   |      _        |     _        |     _        |     _        |       _      | 5\.00                                   |
| 4          | Clearing account         | \-1,000\.00    | 1,000\.00      |      _         | 0\.00                   |   | 1,000         |     _        | \-1,000      |    _         |      _       | 0\.00                                   |
| 5          | Accounts payable         |       _        | \-1,008\.00    | 1,008\.00      | 0\.00                   |   |      _        |     _        |      _       |     _        |       _      | 0\.00                                   |
| 6          | ROU asset                |     _          |      _         |       _        | 0\.00                   |   |      _        | 22,794       |      _       |     _        |       _      | 22,793\.90                              |
| 7          | Finance lease obligation |     _          |       _        |      _         | 0\.00                   |   |      _        | \-22,794     | 1,000        | \-94\.97     |      _       | \-21,888\.87                            |
| 8          | Interest expense         |       _        |       _        |      _         | 0\.00                   |   |      _        |      _       |     _        | 94\.97       |      _       | 94\.97                                  |
| 9          | Cash                     |       _        |       _        | \-1,008\.00    | \-1,008\.00             |   |      _        |      _       |     _        |     _        |      _       | \-1,008\.00                             |
| 10         | Depreciation expense     |       _        |      _         |     _          | 0\.00                   |   |      _        |      _       |     _        |     _        | 949\.75      | 949\.75                                 |
| 11         | Accumulated depreciation |       _        |      _         |     _          | 0\.00                   |   |      _        |      _       |     _        |     _        | \-949\.75    | \-949\.75                               |

#### Alternative to the preceding table
