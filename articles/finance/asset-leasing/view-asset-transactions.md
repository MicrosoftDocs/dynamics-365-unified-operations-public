...
To view the lease liability transactions, select a lease on the **Lease summary** page, and then select **Books** to open the books that are attached to the lease record. After you post an initial recognition, an invoice, or an interest journal, select **Liability transactions**.
...
The **Expense transactions** page shows all the expenses that you post against the lease, such as interest expenses, depreciation expenses, and any executory costs.
