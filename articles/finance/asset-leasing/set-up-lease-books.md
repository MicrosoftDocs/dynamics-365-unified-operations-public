...
3. Set the following fields.
    ...
    | Leasing convention                       | Select the convention for the commencement date of the lease. If None, the Lease start date of the lease will be the Commencement Date. If Full Month, the system will default the Commencement Date to the first day of the month of the Lease start date. By selecting None, there is a risk that the liability amortization and asset depreciation schedules would accrue and post expenses in the middle of the month rather than month end. The Full month convention will ensure that the system begins accounting for the lease as of the first of the month and the entire month’s expense is accrued and posted on the final day of the month. [!NOTE] The leasing convention feature is enabled through the Feature Management workspace. Please navigate to the Feature Management workspace and enable the Leasing convention for asset leasing feature. |
