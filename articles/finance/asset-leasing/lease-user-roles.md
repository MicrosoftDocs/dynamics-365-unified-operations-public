...
description: Learn about the security roles that are used in Asset leasing, including a table that defines various roles and a step-by-step process for assigning roles to users.
author: moaamer
ms.author: moaamer
ms.topic: article
ms.date: 04/12/2021
