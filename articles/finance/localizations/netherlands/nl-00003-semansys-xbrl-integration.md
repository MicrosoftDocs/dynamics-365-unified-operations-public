...
The high-level process is a system-to-human-to-system process. The first system involved is Microsoft Dynamics 365 Finance. This system is responsible for creating all the necessary entries, chart of accounts, and mappings. After you complete these tasks, export the data into the Semansys DataBridge format. You can then upload this exported data into the XBRLOne portal to convert to XBRL, and then validate and deliver to the correct Dutch regulatory body.

You need the following prerequisites for this process:
