...
5. Create chronological number sequence groups. For the period (Q3), there are five lines (records): two for customer 1, two for customer 2, and one for the remaining number intervals.
    ...
    | ID\_Cust1\_Q3 | Customer 1 Q3, 2021 from 10 to 20         | ID\_Cust1Q3     |
    | ID\_Cust2     | Customer 2                                | Not applicable  |
    | ID\_Cust2\_Q3 | Customer 2 Q3, 2021 from 30 to 40         | ID\_Cust2Q3     |
    | ID\_21Q3\_1   | Q3 2021, First interval. (from 1 to 9)    | ID\_21Q3\_1     |
    | ID\_21Q3\_2   | Q3 2021, Second interval. (from 21 to 29) | ID\_21Q3\_2     |
...
## Add the application URL in connected aplications
...
5. Enter values in the **Description** and **Company** fields.
