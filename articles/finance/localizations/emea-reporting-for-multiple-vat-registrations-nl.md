---
title: Support for multiple VAT registration numbers in reporting of Netherlands
description: This article explains how to support multiple value-added tax (VAT) registration numbers in reporting of Netherlands.
author: liza-golub
ms.date: 7/4/2023
ms.topic: article
ms.prod: 
...
# Support for multiple VAT registration numbers in the reporting of Netherlands

[!include [banner](../includes/banner.md)]

This article provides information about the regulatory reports in Netherlands available for legal entities using multiple value-added tax (VAT) registration numbers functionality. 
...
When your legal entity is configured for reporting for multiple VAT registrations, the following reports are available to report in Netherlands:
