...
5. In the **Electronic report parameters** dialog box, in the **Requested language in the user interface** field, specify **en**. In **Requested security level** lookup field select one of the available values according to your preference of the security level of your autorization in ID-porten. The following values of **Requested security level** lookup field are available that can be used as `acr_values` parameter of autorization request to ID-porten:
