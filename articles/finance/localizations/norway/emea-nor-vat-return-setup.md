...
> [!IMPORTANT]
> When you import version **112.71** of **VAT Declaration XML (NO)** and version **112.71.59** of **VAT Declaration Excel (NO)** to your Finance environment, you need to export the application-specific parameters from the previously used version of the formats by using the **Export** button on the Action Pane of the **Application specific parameters** page. Next, you need to import the parameters to version **112.71** of **VAT Declaration XML (NO)** and version **112.71.59** of **VAT Declaration Excel (NO)**. This export/import is required because of the change in the structure of the application-specific parameters in version **112.71** of **VAT Declaration XML (NO)** and version **112.71.59** of **VAT Declaration Excel (NO)**. While the application-specific parameters configuration is imported, the system automatically updates the structure to the new version and you can see the additional **Item sales tax group** and **Sales tax group** columns for **StandardTaxCodes_Lookup**. The new structure introduces an additional level of setup flexibility and improves the user experience in certain scenarios. You have the flexibility to keep the new columns empty if they don't align with your company's specific setup and requirements. 
