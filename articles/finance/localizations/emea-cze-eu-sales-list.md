...
3. In the **Authority identification** field, enter the code of the tax authority (this value will be reported in `c_ufo` tag of `VetaP` section of the report).
...
4. In the **EU sales list reporting** dialog box, on the **Parameters** FastTab, set the following fields.
    ...
    | Tax authority code to file the report | Enter the Tax authority code that will be reported in `c_pracufo` of `VetaP` section of the report. |
...
4. Select **OK**, and review the report in XML format that is generated. The following tables show the values on the example report.
    ...
    **EU sales list header**
    ...
    | c_ufo          | 451    | Code related to the tax authority ID.   |
