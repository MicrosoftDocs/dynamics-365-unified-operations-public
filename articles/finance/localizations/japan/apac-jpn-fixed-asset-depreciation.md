...
description: Access answers some frequently asked questions about fixed asset depreciation for Japan, including answers about special depreciation.
author: EricWangChen
ms.author: wangchen
ms.topic: faq
ms.date: 12/08/2025
...
A fixed asset depreciates over the course of its useful life. Therefore, the acquisition value of the asset decreases. To regulate the depreciation of a fixed asset, you must assign one of the following depreciation methods to the asset, based on the date when the asset is put into service:

- **Old straight line** – Depreciate assets that are put into service before April 1, 2007.
- **New straight line** – Depreciate assets that are put into service on or after April 1, 2007.
- **Old declining balance** – Depreciate assets that are put into service before April 1, 2007.
- **250% new declining balance** – Depreciate assets that are put into service before April 1, 2012.
- **200% new declining balance** – Depreciate assets that are put into service on or after April 1, 2012.

## What are special depreciation and additional depreciation?

Special depreciation and additional depreciation are depreciation types that you apply to the following special types of fixed assets:

- Fixed assets that you use in accordance with specific industrial policies that promote the supply and development of green energy or new energy, such as wave energy.
- Fixed assets that you purchase for the purpose of safety and sustainability.
- Fixed assets that you use to help an employee who has a disability.
- Fixed assets that you build to help people who are elderly or sick.

When you use special depreciation, calculate the extra depreciation amount by multiplying the acquisition cost and the special depreciation rate. When you use additional depreciation, calculate the extra depreciation amount by multiplying the ordinary depreciation and the additional depreciation rate.

> [!NOTE]
> If a fixed asset is eligible for both special depreciation and additional depreciation, you can apply only one of them to the asset for a given depreciation period.

## What is the allowable limit for depreciation?

The allowable limit for depreciation is the maximum amount of total depreciation expense that you can deduct per tax book for each depreciation period. The allowable limit for depreciation for a fixed asset corresponds to the depreciation types that you use to depreciate your company's fixed assets.
...
You calculate the allowable limit for depreciation per period for your company's fixed assets by using the following formula: Allowable limit for depreciation = Allowable limit for ordinary depreciation + Allowable limit for accelerated depreciation + Allowable limit for special depreciation or Allowable limit for additional depreciation.

## What is the allowable limit for accumulated depreciation?

The allowable limit for accumulated depreciation is the maximum amount of accumulated depreciation that you can deduct from the acquisition value of a fixed asset for its useful life. You choose the value of the allowable limit for accumulated depreciation. Your choice depends on the depreciation method that you apply to the fixed asset, and whether the fixed asset is tangible or intangible. There are two kinds of allowable limit for accumulated depreciation:

- **95% allowable limit for accumulated depreciation** – This limit applies only to tangible assets that you depreciate by using the old straight line method or the old declining balance method. This limit is restricted to 95 percent of the acquisition cost of the fixed asset.
- **Maximum allowable limit for accumulated depreciation** – This limit applies to both tangible assets and intangible assets that you depreciate by using a deprecation method other than the old straight line method or the old declining balance method. For a tangible asset, the maximum allowable limit for accumulated depreciation is the acquisition cost of the asset. The maximum allowable limit for accumulated depreciation of an intangible asset is the acquisition cost of the asset minus 1 Japanese yen (JPY).
...
Calculate the depreciation expense for each month and post it in the next month. Use the following factors to calculate the monthly depreciation expense:

- The total depreciation expense that you incur since the beginning of the year: Annual depreciation expense × (Position of the current month in the fiscal year ÷ 12) = 100,000 JPY.
- The total depreciation expense that you post from the beginning period of the fiscal year through the current month.
- The depreciation expense that you post for the current month: Total depreciation expense that you incur since the beginning of the year.
- The total depreciation expense that you post from the beginning period of the fiscal year through the current month = 100,000 JPY.

Use the following formula to calculate the monthly depreciation: Annual depreciation expense × (Position of the current month in the fiscal year ÷ Total number of months in the calendar year) – Total depreciation expense that you post from January through the current month. This calculation method helps guarantee that the total monthly depreciation expense equals the annual depreciation expense of the asset.

## Can I change the depreciation profile of a fixed asset after the depreciation for the asset has been posted?

Yes. You can change the depreciation profile of a fixed asset even after you post the depreciation for the asset. The following table shows the depreciation method changes that are allowed.

| Starting depreciation method | Allowed depreciation method change |
|------------------------------|-------------------------------------|
| Old straight line | Old declining balance |
| Old declining balance | Old straight line |
| New straight line | <ul><li>250% declining balance</li><li>200% declining balance</li></ul> |
| 250% declining balance | <ul><li>200% declining balance</li><li>New straight line</li></ul> |
| 200% declining balance | <ul><li>250% declining balance</li><li>New straight line</li></ul> |
