...
In Japan, vendors usually use consolidated invoices for transactions.
...
1. Specify a consolidation day for the vendor. To update this field, you might need to select **Edit** first.  
