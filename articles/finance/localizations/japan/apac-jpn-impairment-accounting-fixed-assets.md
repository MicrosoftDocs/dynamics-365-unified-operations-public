...
To set up and calculate fixed asset impairments, you can perform the following tasks:
...
Yes, you can select which assets to test for impairment. To specify the criteria, select **Query** on the **Impairment recognition test** page.
