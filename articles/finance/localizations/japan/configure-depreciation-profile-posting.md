...
In Japan, special depreciation is permitted under certain conditions. The system treats it as extraordinary depreciation.
...
1. In the **Accounting method** field, select an option. Select **Reserve** for the reserve method, or select **Direct-off** for the direct-off method for journalization. The reserve method usually appears on a financial statement.  
