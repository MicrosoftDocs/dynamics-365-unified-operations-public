...
For Japan, report transactions and amounts of ARO separately from the underlying fixed assets.
...
To view ARO transactions, in Dynamics 365 Finance, go to **Fixed assets \> Asset retirement obligations \> Asset retirement obligation transaction inquiry**. The system categorizes ARO-related transactions into types for summarization.  
