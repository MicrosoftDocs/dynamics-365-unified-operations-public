...
1. On the **Sales tax** tab, on the **Japanese tax reporting** FastTab, set the **Consumption tax reports** option to **Yes**.

## Enter Japan reporting information for a legal entity

1. Go to **Organization administration** \> **Organizations** \> **Legal entities**.
1. On the **Registration numbers** FastTab, select **Edit**.
...
| 9012           | Taxable purchases credit notes related to specified taxable purchases - reverse charge | <ul><li>Taxable sales credit note</li><li>Taxable import credit note</li></ul> |
| 7012           | Consumption tax on taxable purchases credit notes related to specified taxable purchases - reverse charge | <ul><li>Sales tax on sales credit note</li><li>Sales tax on import credit note</li></ul> |
...
| 9203           | Credit note on nontaxable export | <ul><li>Tax exempt sales credit note</li></ul> |
| **206**        | **Non-taxable sales** | <ul><li>Tax-free sale</li></ul> |
| 9206           | Nontaxable sales credit note | <ul><li>Tax exempt sales credit note</li></ul> |
...
| **209**        | **Taxable purchases subject to the transitional measures** | <ul><li>Taxable purchases</li></ul> |
| 8209           | Consumption tax amount of taxable purchases subject to the transitional measures | <ul><li>Sales tax receivable</li></ul> |
| 9209           | Taxable purchase credit note subject to the transitional measures | <ul><li>Taxable purchase credit note</li></ul> |
| 7209           | Consumption tax amount of taxable purchase credit note subject to the transitional measures | <ul><li>Sales tax on purchase credit note</li></ul> |
...
| 8014           | Amount of adjustment (addition) to the amount of consumption tax in case you don't receive exemption from tax liability | <ul><li>Sales tax receivable</li></ul> |
...
Set up ledger accounts for bad debt and collected bad debt that you use to select the transactions to report.

1. Go to **Tax** \> **Setup** \> **Sales tax** \> **Tax reporting accounts**.
1. Select **Edit**.
1. In the **Bad debt** field, specify the ledger account. For example, in the **JPMF** legal entity, select **84720**.
1. In the **Collected bad debt** field, specify the ledger account. For example, in the **JPMF** legal entity, select **84710**.

## Generate the Japan consumption tax report

1. Go to **Tax** \> **Declarations** \> **Sales tax** \> **Japanese sales tax report**.
1. In **Consumption tax working sheet** dialog box, set the following fields.
...
1. Select **OK** to calculate amounts on the **Consumption tax calculation sheet** page.
1. On the **Consumption tax calculation sheet** page, on the **Appendix 1** and **Appendix 2** tabs, review the values in the **Item** fields. These values represent the amounts that you enter in the rows of **Table 1** and **Table 2**.
...
1. On the **Header** tab, review the header information.
...
1. On the **Tax calculation** tab, review the tax amounts in the **Items** fields. The values represent the amounts that you enter in the rows of **Table 1**.
    ...
    | Item10 | Intermediate tax payment | You can fill in this field manually. |
    ...
    | Item13 | Previously declared tax (If this declaration is an amended declaration) | You can fill in this field manually. |
    | Item14 | Tax due (If this declaration is an amended declaration) | You can fill in this field manually. |
    ...
    | Item21 | Interim tax payment (local) | You can fill in this field manually. |
    ...
    | Item24 | Previously declared tax (if this declaration is an amended declaration) | You can fill in this field manually. |
    | Item25 | Netted tax payment amount (if this declaration is an amended declaration) | You can fill in this field manually. |
...
1. On the **Breakdown of taxable base amount** tab, review the tax amounts in the **Items** fields. The values represent the amounts that you enter in the rows of **Table 2**.
...
1. On the **Consumption tax report** page, on the **Additional information** tab, set the following fields.
...
1. Select **Finalize** to finalize tax amounts.
1. After you finalize tax amounts, select **Consumption tax report** \> **Print** to print the **Consumption tax calculation sheet** and **Consumption tax report** reports.
