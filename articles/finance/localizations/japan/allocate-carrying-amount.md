...
description: Learn about allocating the carrying amount of shared asset and goodwill to each of the cash generating units, including a step-by-step process.
author: kfend
ms.author: kfend
ms.topic: how-to
ms.date: 08/29/2018
