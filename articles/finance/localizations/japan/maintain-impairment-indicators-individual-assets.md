...
Before you complete the procedures, set up the impairment accounting common parameters. For more information, see [Set up impairment accounting common parameters and posting profile](impairment-accounting.md).
...
1. Select **Update impairment indicators**.
1. In the list, select the record with fixed asset number **TOOLM-000007**.  
1. In the **Modify date** field, enter a date.
1. In the **Description** field, enter a value.
