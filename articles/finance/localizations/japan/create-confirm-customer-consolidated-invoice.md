...
1. Select **OK**.
    ...
    - One consolidated invoice contains only one customer account. When there are multiple customer accounts to consolidate, multiple consolidated invoices are generated.  
