...
In Japan, you depreciate the following three types of fixed assets with equal amounts in each year of service life:
...
1. Select **Save**.
1. Select **Books**.
1. Expand the **Depreciation** section and confirm that the method is equally divided.  
