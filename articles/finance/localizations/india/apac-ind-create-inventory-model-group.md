...
To create an inventory model group for capital items (India), follow these steps:

1. Go to Inventory management > Setup > Inventory > Item model groups.
1. Select **New**.
1. In the **Item model group** field, type a value.
1. In the **Name** field, type a value.
1. In the **Inventory model** field, select an option.
1. Select **Save**.
