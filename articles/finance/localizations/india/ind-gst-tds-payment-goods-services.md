...
1. Go to **Tax** > **Tax configuration** > **Setup** > **GST** > **GST TDS Tax component**, and set up the posting accounts.
    ...
    :::image type="content" source="../media/gst-tds-payment-01.png" alt-text="Screenshot of the posting account setup, Accounting tab.":::
  
1. Go to **Accounts payable** > **Vendors** and open the vendor record that you're updating.
1. Verify each contract individually. For each contract where the value exceeds INR 2,50,000, you must identify a vendor for deduction of GST TDS. On the **Tax information** FastTab, set the **Apply GST TDS** option to **Yes**. You can update this setting at any time.

    :::image type="content" source="../media/gst-tds-payment-02.png" alt-text="Screenshot of the Vendors page, Tax information FastTab.":::

1. To record the GST TDS deduction that was made by the customer, go to **Accounts receivable** > **Customers**, and mark the customer as **Govt Company**.

    :::image type="content" source="../media/gst-tds-payment-03.png" alt-text="Screenshot of the Customers page, Tax information FastTab.":::

1. When you're ready to post the journal, go to **Accounts receivable** > **Payment** > **Customer payment journal**, and select the appropriate journal.
1. In the **Tax information** dialog box, set the **Apply GST TDS** option to **Yesv.

    :::image type="content" source="../media/gst-tds-payment-04.png" alt-text="Screenshot of the Tax information dialog box, Apply GST TDS option set to Yes.":::

## Scenario: GST TDS on payment to a vendor transaction

1. Go to **Accounts payable** > **Vendor payment journal**, and select **New**.
1. In the **Account type** field, select **Vendor**, and then, in the **Account** field, select **INMF-000001**.
1. In the **Credit** field, enter **1200.00**.
1. In the **Offset account type** field, select **Bank**, and then, in the **Offset account** field, select **Bank-IND OPER**.
1. Select **Tax Information**.

    :::image type="content" source="../media/gst-tds-payment-05.png" alt-text="Screenshot of the Tax information dialog box.":::

    Notice that GST TDS is calculated based on the defined percentage (10.0).

    :::image type="content" source="../media/gst-tds-payment-06.png" alt-text="Screenshot of the Tax details FastTab showing GST TDS calculation based on defined percentage.":::

    Additionally, notice that the GST that is calculated on the invoice amount is excluded from the GST TDS calculation.

    :::image type="content" source="../media/gst-tds-payment-07.png" alt-text="Screenshot of the Vendor payments page.":::

    When the journal voucher is posted, it's shown on the Voucher transactions page.

    :::image type="content" source="../media/gst-tds-payment-08.png" alt-text="Screenshot of the Voucher transactions page.":::
