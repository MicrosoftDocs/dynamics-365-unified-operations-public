...
1. On the **Overview** tab, select **Alt+N** to create a TDS ledger account, and enter the required details.
1. On the **Setup** tab, in the **Posting type** field, select **Withholding tax**.		
