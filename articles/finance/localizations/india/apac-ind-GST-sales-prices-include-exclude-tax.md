...
1. Create a sales order for taxable goods, and add two sales order lines:
...
1. Select **OK**.
1. Repeat steps 4 through 7 for order line 2.
...
:::image type="content" source="../media/Annotation-2019-05-20-153808.png" alt-text="Screenshot of the voucher example.":::
