...
> [!NOTE]
> Enabling the ability to choose Azure Synapse Data Lake Storage in India for finance and operations apps environments that are deployed outside of India is a work in progress. Availability is planned for June 2024. However, the availability plan is subject to change.
