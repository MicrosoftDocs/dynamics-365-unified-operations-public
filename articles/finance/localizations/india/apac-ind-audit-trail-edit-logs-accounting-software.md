...
> [!NOTE]
> Enabling the ability to choose legal entities in finance and operations apps, data for which must be replicated to Azure Synapse Data Lake Storage in India is a work in progress. When you choose finance and operations tables for data replication to Data Lake Storage, all the data from these tables regardless of their affiliation with legal entities in your finance and operations apps will be replicated.
