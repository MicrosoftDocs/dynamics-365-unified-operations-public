...
- On the **Tax setup** page, select **Setup**, and on the **Setup** page specify the **Interim transit for stock transfer** account for all GST components that you can create for GST on stock transfer. For more information, see [Define main accounts](apac-ind-GST-map-configuration-tax-types.md#define-main-accounts-1).
...
1. On the **Transfer order lines** tab, create a new line. In the **Item number** field, select the item to transfer.
1. In the **Transfer quantity** field, enter the quantity of the items to transfer. In the **Unit** field, change the default unit of measurement, if required.
...
1. Select **Tax information** to review the tax configuration for the transfer order.
...
1. Select **Ship** > **Ship transfer order**. Then, on the **Shipment** page, post the transfer order shipment:

    1. Select the **Explode lines** checkbox, and then, in the **Update** field, select **All**.
    1. Select **Setup** > **Tax document**, and review the tax settings and amounts. Make any adjustments that are required.
    1. Close the **Tax document** page, and then select **OK** on the **Ship** page to post the operation.

1. Select **Receive** > **Receive**. Then, on the **Receive** page, post the transfer order receipt:

    1. Select the **Explode lines** checkbox, and then, in the **Update** field, select **All**.
    1. Select **Setup** > **Tax document**, and review the tax settings and amounts. Make any adjustments that are required.
    1. Close the **Tax document** page, and then select **OK** on the **Receive** page to post the operation.
