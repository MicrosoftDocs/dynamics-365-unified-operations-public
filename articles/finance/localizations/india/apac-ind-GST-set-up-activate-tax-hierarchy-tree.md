...
1. In the **Structure** field, select **GTE hierarchy**.
    ...
    :::image type="content" source="../media/Annotation-2019-05-15-145825.png" alt-text="Screenshot of the Create a sales tax hierarchy dialog box.":::
...
1. Select **View**.
    ...
    :::image type="content" source="../media/Annotation-2019-05-15-150106.png" alt-text="Screenshot of the Versions FastTab.":::

    The **Sales tax hierarchy designer** page shows the tax type and tax components, based on the configuration.

    :::image type="content" source="../media/Annotation-2019-05-15-150259.png" alt-text="Screenshot of the Sales tax hierarchy designer page.":::

1. Select **Setoff rules for sales tax hierarchy**, and then select **New**.
1. In the **Name** field, enter a value, and then save the record.
1. On the **Recoverable** and **Payable** FastTabs, select the tax components, and adjust the priority values.
1. Define the setoff rules according to the legal requirement.

    :::image type="content" source="../media/Annotation-2019-05-15-150432.png" alt-text="Screenshot of the Setoff rules for sales tax hierarchies page.":::

1. Select **Save**, and then select **Close**.
1. Close the **Sales tax hierarchy designer** page.
1. Select **Activate**, and then select **Close**.
...
1. In the **Hierarchy** field, select a value.
    ...
    :::image type="content" source="../media/Annotation-2019-05-15-150613.png" alt-text="Screenshot of the Create a setoff hierarchy profile dialog box.":::

1. Select **OK**, and then select **Activate**.
1. Select **Yes**.
1. Close the message that you receive, and then close the page.
...
:::image type="content" source="../media/TaxHierarchyVersionAddBatch.png" alt-text="Screenshot of adding a tax hierarchy version in batch mode.":::
...
:::image type="content" source="../media/TaxHierarchyVersionSyncBatch.png" alt-text="Screenshot of syncing a tax hierarchy in batch mode.":::
...
:::image type="content" source="../media/Annotation-2019-05-15-151254.png" alt-text="Screenshot of the GST minor code page.":::
