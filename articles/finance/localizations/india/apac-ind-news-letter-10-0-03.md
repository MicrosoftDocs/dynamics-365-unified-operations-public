...
This article summarizes the new features and critical bug fixes released in Dynamics 365 Finance version 10.0.03 for India GST localization.

## New features and updates

### GST solution document is updated

Updates are made to the following article, [India Goods and Services Tax (GST) overview](apac-ind-gst.md).

### GSTR report performance improvement

The **GSTR** report generation time is 30% faster because the solution replaces line-by-line data fetch with dataset operation.
...
:::image type="content" source="../media/GST-tax-based-accounting-currency-2-10-0-03.png" alt-text="Screenshot of Tax setup parameters showing currency type configuration.":::
...
- When you create an export order, the system includes Basic Custom Duty (BCD) and Social Welfare Surcharge (SWS). When you post the export order, the system posts only BCD. To resolve this issue, apply the following configurations:

  - Taxable Document .version.81.xml
  - Taxable Document (India) .version.81.138.xml
  - Tax (India GST) .version.81.138.248.xml

- GST-related accounts post without financial dimensions in the project invoice proposal.
...
- Adjust project transactions doesn't work properly.
...
- The delivery address doesn't populate on the **Tax information** page for the sales order lines.
