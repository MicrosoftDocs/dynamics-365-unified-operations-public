...
The dialog box for the executable class includes the **Report in accounting currency** parameter. By default, the amounts in the report are represented in the sales tax code currency. Use this parameter to report amounts in JPK-V7M in the accounting currency. The **Report in accounting currency** parameter is available as of Finance version 10.0.29.
