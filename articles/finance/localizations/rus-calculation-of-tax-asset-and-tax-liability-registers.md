...
7.  [Set up tax difference registers](#set-up-tax-differences-registers).
...
2.  Create and set up a sales tax code for profit tax. For more information, see [Set up sales tax codes](https://docs.microsoft.com/en-us/dynamics365/finance/general-ledger/tasks/set-up-sales-tax-codes).
