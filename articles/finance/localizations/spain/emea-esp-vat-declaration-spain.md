...
This article describes how to set up and generate a value-added tax (VAT) declaration model 303 for Spain in the official TXT format. It also describes how to preview the VAT declaration in Microsoft Excel.
...
2. Set the following fields.
   ...
   | **Result - Refunds agreed by the Tax Agency**   | Enter the amount that should be exported to box 109, "Result - Refunds agreed by the Tax Agency as a consequence of the processing of previous self-assessments corresponding to the year and period subject to the self-assessment." |
