...
- Business data from Dynamics 365 Finance and Dynamics 365 Supply Chain Management, or from other connected applications in the unified structure (JavaScript Object Notation \[JSON\] format)
