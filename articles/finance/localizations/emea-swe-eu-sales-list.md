...
\[NOTE\] The company's tax registration number will be used in the .xlsx file for the EU sales list report.
...
\[NOTE\] If the **VAT exempt number export** field in the **Intrastat** section on the **Foreign trade and logistics** FastTab is set (that is, it isn't blank), that value will be used, instead of the VAT ID that you created, in the .txt file of the EU sales list report.
