...
When you complete all the procedures in this article, you can print invoices that follow Egyptian legal requirements. You can create invoices based on sales orders, free text invoices, and project invoices.
