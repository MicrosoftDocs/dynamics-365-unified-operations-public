...
2. Make sure that the **Electronic invoicing integration** feature disabled in the [Feature management](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) workspace.
