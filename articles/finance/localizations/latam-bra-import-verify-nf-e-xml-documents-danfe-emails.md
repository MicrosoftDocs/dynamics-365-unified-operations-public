...
-   Post electronic fiscal documents that have access keys that aren't validated by SEFAZ. Alternatively, you can set up Dynamics 365 Finance to post only electronic fiscal documents that have access keys that are validated by SEFAZ.
