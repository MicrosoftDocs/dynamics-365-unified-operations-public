...
> [!NOTE]
> This feature is the same as the out-of-box feature for European Union (EU) countries/region. For more information, see [Invoice issue deadline](emea-invoice-issue-deadline.md).
