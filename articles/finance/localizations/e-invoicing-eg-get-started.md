...
Some of the parameters from the **Egyptian electronic invoice (EG) Electronic invoicing feature** are published with default values. Review and, if necessary, update the values to better fit your business operation needs before you deploy the Electronic invoicing feature to the Service environment.
...
10. To deploy the Electronic invoicing feature to the Service environment, see [Get started with the Electronic invoicing add-in](e-invoicing-get-started.md).
...
14. To deploy the Application setup to the Finance or Supply Chain Management Connected application, see [Get started with the Electronic invoicing add-in](e-invoicing-get-started.md).
