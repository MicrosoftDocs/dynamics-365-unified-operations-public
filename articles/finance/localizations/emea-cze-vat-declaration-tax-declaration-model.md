...
| General ledger parameters (**General ledger \> Setup \> Ledger setup \> General ledger parameters**) | <p><li>On the **Sales tax** tab, on the **Tax options** FastTab, in the **VAT statement format mapping** field, select **VAT declaration Excel (CZ)**. This format will be printed when you run the **Report sales tax for settlement period** report. It will also be printed when you select **Print** on the **Sales tax payments** page.</li></p><p><li>If you must report the corrections, on the **Special report** section, set the **Inclide corrections** option is set to **Yes**.</li></p>|
