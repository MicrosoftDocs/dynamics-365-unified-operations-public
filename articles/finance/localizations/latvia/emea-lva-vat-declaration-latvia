...
| Operation description | Tax Base<br>(sum without VAT) | VAT amount | Lookup result<br>(ReportFieldLookup) | Lookup result description label EN | Lookup result description label LV |
|---|---|---|---|---|---|
|  |  |  |  |  |  |
