...
The **P_54_Powód** additional field is available as of version 98.194 of the **JPK-V7M XML format (PL)** ER configuration and version 98.194.50 of the **JPK-V7M Excel format (PL)** ER configuration. It can be imported with the **PL JPK_V7M EM setup v.5 KB4614816.zip** file (version 5 or later of the package of data entities that includes a predefined electronic message setup).
