...
The following table shows the general ledger (GL) transactions and user
...
>   *Note:* When the **Prepayment journal voucher** is set to **Yes**, the
...
9.  Set the **Include in book** option to **Yes** if factures that are processed
