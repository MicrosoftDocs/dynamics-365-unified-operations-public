...
-   The confirmation period expired during previous periods.
...
3.  In the **From date** field, specify the date when the export confirmation
    period begins.
...
3.  In the **Outgoing VAT processing – select data for period** dialog box, on
