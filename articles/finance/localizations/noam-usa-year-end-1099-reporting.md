...
You can update the value in the **1099 box** on vendor records and update transactions with the 1099 box information for multiple vendors in a single step. This process does not support 1099-G or 1099-S box types. If your organization is in the public sector, you can update 1099-G or 1099-S records one vendor at a time by using the **Accounts payable > Vendors > All vendors > Vendor tab > Update 1099** navigation. 

To update 1099 information for multiple vendors, on the **Feature management** page, turn on the **Update tax 1099 information for multiple vendors** parameter. You can use the **Update 1099 information for multiple vendors** page to update the **1099 box** on a vendor record and to update transactions with the 1099 box information. You can open this page from the **Accounts payable > Periodic task > Tax 1099** navigation. Security privilege **Update 1099 box and transactions for multiple vendors** is required to access the page.

Specific parameters are used to update 1099 information for multiple vendors in a single step. The following parameters are available:
- **Update vendor’s 1099 box** – If you set this option to **Yes**, the **1099 box** information for the selected vendors will be updated to the value specified in the **New 1099 box value** parameter. To be updated, the selected vendor records must have the **Report 1099** parameter enabled on the **All vendors** page. Vendors that have the **Report 1099** parameter disabled will not be updated when the process runs. If this option is set to **No**, the vendor **1099 box** will not be changed. 

- **New 1099 box value** – Select the 1099 field value that will be used to update the vendor’s 1099 box information. The **New 1099 box value** option is available only if the **Update vendor’s 1099 box** option is selected. 1099-S and 1099 G 1099 box values are not included for processing.

- **Update 1099 transactions** – If you set this option to **Yes**, the 1099 transactions will be updated with the **1099 box** information specified on the **All vendors** page. The process will run for selected vendors that have the **Report 1099** parameter enabled and have a value specified for the **1099 box** on the **All vendors** page. If you enable both the **Update vendor’s 1099 box** parameter and the **Update 1099 transactions** parameters, the system will first update the selected Vendor’s **1099 box** value and then will update the existing 1099 transactions with the newly updated **1099 box** information.
