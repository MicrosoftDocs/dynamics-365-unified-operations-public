...
This article describes the updates to the XML layout and validation rules that technical note NT2020.005 introduced for generating electronic fiscal document model 55 (NF-e).
...
The scope of the new technical note now includes the following updates and additions:

- New options for the **&lt;tpViaTransp&gt;** tag.
- An updated structure for the &lt;adi&gt; node.
- New tags for the &lt;ICMS10&gt;, &lt;ICMS70&gt;, and &lt;ICMS90&gt; nodes:

  - &lt;vICMSSTDeson&gt;
  - &lt;motDesICMSST&gt;

- New tags for the &lt;ICMS51&gt; node:

  - &lt;pFCPDif&gt;
  - &lt;vFCPDif&gt;
  - &lt;vFCPEfet&gt;

- Updated validation rules NA15-20 and NA17-10 for posting fiscal documents.
