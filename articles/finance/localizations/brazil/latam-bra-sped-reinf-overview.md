...
The statement consists of a set of events. You must deliver these events in specific layouts through the public digital bookkeeping system (SPED), and use a valid digital certificate for delivery. The certificate must be issued by an entity that the Brazilian Public Key Infrastructure (ICP-Brasil) accredits.

The statement is valid after receipt is confirmed and the contents of the files are validated.
...
> [!NOTE]
> Events R-2010 and R-2020 support National Registry of Legal Entities (CNPJ) third parties. Use event R-5011 to inquire about the status of closing event R-2099.
> Events R-9005 and R-9015 are totalizers. The Federal Revenue delivers these events as the return of the bases to the taxpayers. Taxpayers don't deliver these events.

Only taxpayers that comply with SPED-ECD are supported.

- Public departments aren't supported as taxpayers.
...
1. [Set up fiscal books](latam-bra-sped-reinf-setup-fiscal-books.md).
1. [Process and submit the events](latam-bra-sped-reinf.md).
