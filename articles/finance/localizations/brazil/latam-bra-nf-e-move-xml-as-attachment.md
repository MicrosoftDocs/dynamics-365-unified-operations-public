...
For a specific date range and fiscal establishment, this feature moves the NF-e XML files from your Finance or Supply Chain Management database
...
1. On the **All** tab, search for and select the **NF-e XML move as attachment** feature.
1. Select **Enable now**.
...
1. In the **From date** and **To date** fields, select the start and end dates.
1. In the **Fiscal establishment ID** field, select a value.
1. Select **OK**.
