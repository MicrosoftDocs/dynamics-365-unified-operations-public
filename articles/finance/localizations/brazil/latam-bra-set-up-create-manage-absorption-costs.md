...
You can calculate and post the direct and indirect costs that production orders incur during a fiscal period. The final manufacturing costs are registered in the ledger at the end of the fiscal period. You calculate absorption costs by allocating the total manufacturing costs to the products that you manufacture during a fiscal period.
...
Use the **Cost center** page to set up cost centers for absorption costs. 
...
To set up journal names for absorption costs, use the following steps:
...
1. In the **Month/Year to close** field, select the month and year that you want to post the costs for.
...
You can't cancel absorbed costs after the monthly closing is completed.

To cancel absorbed costs that aren't posted to the ledger for a specific month and year, follow these steps:

1. In Dynamics 365 Finance, go to **Production control** > **Periodic** > **Absorption costs** > **Absorbed costs cancellation**.
1. In the **Month/Year to cancel** field, select the month and year for which you want to cancel the absorbed costs.
