...
description: Learn how you can create a tax assessment for the IPI tax for a given booking period, including a step-by-step process using the BRMF demo company.
author: AdamTrukawka
ms.author: atrukawk
ms.topic: how-to
ms.custom: 
