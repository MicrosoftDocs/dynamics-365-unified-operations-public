...
description: In the Sistema Publico de Escrituração Digital (SPED) fiscal text file, record C197 includes information about adjustments on fiscal documents.
author: AdamTrukawka
ms.author: atrukawk
ms.topic: how-to
ms.custom: 
