...
2. In the **Invoice account** field, enter or select a value.
3. In the **Operation type** field, enter or select a value.
1. Select **Save**.
1. Expand the **Lines** section.
1. In the **Main account** field, enter or select a value.
2. In the **Quantity** field, enter or select a value.
3. In the **Unit price** field, enter or select a value.
