...
- [Fiscal books](latam-bra-fiscal-books.md)
 ...
 - [NF-e process](latam-bra-nf-e-process.md)
   ...
   - [Generate emails for approved NF-e and attach DANFE PDF files and NF-e XML files to the emails](br-00053-3-generate-emails-approved-nf-e-attach-danfe-pdf-files-nf-e-xml-files-emails.md)
   ...
   - [Set up NF-e federal parameters](br-00053-1-set-up-nf-e-federal-parameters.md)
   - [Set up NF-e parameters for a fiscal establishment](br-00053-2-set-up-nf-e-parameters-fiscal-establishment.md)
...
- [Taxes](latam-bra-calculate-taxes.md)
  - [Calculate tax on purchase quotations](br-00031-tax-calculation-purchase-quotation.md)
  - [Create a tax assessment - ICMS](br-10001-4-create-tax-assessment-icms.md)
  - [Create a tax assessment - IPI tax](br-10004-2-create-tax-assessment-ipi-tax.md)
  - [Create a tax assessment - PIS and COFINS tax](br-10006-4-create-tax-assessment-pis-cofins-tax.md)
  - [Enter and post tax adjustment transactions](br-10001-3-enter-post-tax-adjustment-transactions.md)
  - [Enter PIS and COFINS tax adjustment transactions](br-10006-3-enter-pis-cofins-tax-adjustment-transactions.md)
  - [Fiscal establishment tax attributes](br-00002-fiscal-establishment-tax-attributes.md)
  - [Issue ICMS tax credit fiscal documents](br-00072-issuing-icms-tax-credit-fiscal-document.md)
  - [Issue ICMS tax credit transfer fiscal documents](br-00071-issuing-icms-tax-credit-transfer-fiscal-document.md)
  - [Set up adjustment codes for ICMS tax](br-10001-1-set-up-adjustment-codes-icms-tax.md)
  - [Set up adjustment codes for ICMS taxes on fiscal documents](br-10001-2-set-up-adjustment-codes-icms-taxes-fiscal-documents.md)
  - [Set up adjustment codes for IPI taxes](br-10004-1-set-up-adjustment-codes-ipi-taxes.md)
  - [Set up adjustment codes for PIS and COFINS taxes](br-10006-2-set-up-adjustment-codes-pis-cofins-taxes.md)
  - [Set up PIS and COFINS tables](br-10006-1-set-up-pis-cofins-tables.md)
  - [Tax assessment for ISS tax](br-10005-tax-assessment-iss-tax.md)
  - [Tax attributes](latam-bra-tax-attributes.md)
  - [Tax payments](latam-bra-tax-payments.md)
  - [Tax in sales quotations](br-00057-brazilian-taxes-sales-quotation.md)
  - [Withholding taxes](br-00009-brazilian-withholding-taxes.md)
    - [Withholding taxes on customer payments](br-00042-withholding-taxes-customers-payments.md)
    - [Withholding taxes on vendor payments](br-00061-withholding-taxes-vendors-payments.md)
- Tasks for Brazil
  - [Set up legal entity parameters](br-00001-1-set-up-brazil-legal-entity-parameters.md)
  - [Set up fiscal document source text](br-00001-2-set-up-fiscal-document-source-text.md)
  - [Set up bank account numbers for Brazil](latam-bra-bank-account-number-setup-brazil-localization.md)
  - [Receive vendor fiscal documents (fixed assets - PIS and COFINS long term recoverable)](br-00014-receiving-vendor-fiscal-document-fixed-assets-pis-cofins-long-term-recoverable.md)
  - [Receive vendor fiscal documents (products)](br-00024-receiving-vendor-fiscal-document-products.md)
  - [Create and post a purchase complementary fiscal document](br-00026-1-create-post-purchase-complementary-fiscal-document.md)
  - [Cancel a purchase complementary fiscal document](br-00026-2-cancel-purchase-complementary-fiscal-document.md)
  - [Issue fiscal documents for vendors](br-00033-issuing-fiscal-document-non-taxable-vendors.md)
  - [Issue customer fiscal documents](br-00038-issuing-customer-fiscal-document.md)
  - [Delivery slips](br-00041-delivery-slip.md)
  ...
  - [Electronic payment management for vendor payments](br-00067-electronic-payment-management-vendor-payments.md)
  - [Project debit notes](br-00076-project-debit-notes.md)
  - [Manage fiscal document text in procurement documents](br-00080-manage-fiscal-document-texts-procurement-documents.md)
  - [Receive vendor fiscal documents (fixed assets - ICMS long term recoverable)](br-00082-receiving-vendor-fiscal-document-fixed-assets-icms-long-term-recoverable.md)
  ...
  - [Non-fiscal operations](br-10016-non-fiscal-operations.md)
  - [Enter a CIAP transaction](br-10020-1-enter-ciap-transaction.md)
  - [Calculate CIAP credit amount](br-10020-2-calculate-ciap-credit-amount.md)
