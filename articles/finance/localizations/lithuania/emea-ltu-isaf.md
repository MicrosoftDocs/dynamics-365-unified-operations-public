...
| PVM58                 | Services supplied in the territory of the country (Article 19(3) of the VAT Law) Rate 12%. |
| PVM59                 | Cases where services are consumed for the private needs of a VAT payer (Article 8 of the VAT Law) Rate 12%. |
| PVM60                 | Cases where VAT on services supplied in the territory of the country by a foreign taxable person not established in that territory is calculated and paid by the purchaser (Article 95(5) of the VAT Law) Rate 12%. |
| PVM100                | Other cases |
