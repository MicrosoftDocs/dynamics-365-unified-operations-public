...
5. On the **Sales tax** tab, on the **Tax options** FastTab, in the **VAT statement format mapping** field, select the **VAT declaration Excel (LT)** ER format.
...
FR0600 form of VAT declaration in Lithuania includes the following fields to identify the reporting company.
...
- PVM mokėtojo kodas - VAT payer’s number. The VAT identification number is entered without the prefix "LT".
...
5. In the **Registration number** field, enter the tax number. This value will be reported in "PVM mokėtojo kodas" field of VAT declaration.
...
8. In the **Registration number** field, enter the tax number. This value will be reported in "Mokesčių mokėtojo identifikacinis numeris (kodas)" field of VAT declaration.
...
| **Declaration period type** | Select **Initial** to prepare file for initial submission in the reporting period or **Corrected** to prepare a file to submit a corrected VAT declaration. |
| **Contact person** | Select a contact person from the lookup list. |
| **Main economic activity code** | Specify the main economic activity code for your company. |
| **Pro rata coefficient** | Specify pro rata coefficient for the reporting period. |
