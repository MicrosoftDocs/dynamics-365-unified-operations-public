...
This article provides information about the regulatory reports for Lithuania that are available to legal entities that use the functionality for multiple value-added tax (VAT) registration numbers. For more information about this functionality, the prerequisites, and the required setup, see [Multiple VAT registration numbers](../global/emea-multiple-vat-registration-numbers.md).
...
When you configure your legal entity for reporting for multiple VAT registrations, you get the following reports for reporting for Lithuania.
