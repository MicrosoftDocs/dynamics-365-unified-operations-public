...
1. Set the **Use transportation document information on packing slip** option to **Yes** to show the transportation delivery details on the packing slip when it's posted.
1. Close the page to save your changes.
1. Select **Accounts receivable** &gt; **Setup** &gt; **Forms** &gt; **Form setup**.
1. On the **Packing slip** tab, select the **Shipping details** check box to print shipping information on the packing slip. The shipping information includes the carrier details.
1. Select the **Transportation document** check box to print the transportation document information on the packing slip.
...
1. Select an open sales order, and then, on the Action Pane, on the **Pick and pack** tab, select **Packing slip** to open the **Packing slip posting** dialog box.
1. On the **Parameters** FastTab, in the **Quantity** field, select **All**.
1. Set the **Posting** option to **Yes** to post the packing slip.
1. Set the **Print packing slip** option to **Yes** to print the packing slip when it's posted.
1. In the **Carrier name** field, select the name of the carrier.
1. In the **Compiler** field, apply the filter to sort the compiler names, and then select the name of the person who created the packing slip.
1. In the **Contractor**, **Loader**, and **Owner** fields, select the type of party to filter the transportation party, and then select the name of each party.
1. In the **Additional declarations**, **Additional notes**, and **Additional instructions** fields, enter any additional information that should be printed on the packing slip.
1. Select **OK** to post and print a packing slip that includes the transportation document information.
1. Close the page to save your changes.
