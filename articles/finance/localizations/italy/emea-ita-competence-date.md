...
1. On the **General ledger parameters** page, on the **Ledger** tab, set the **Transaction date reference to competence date** option to **Yes**.

    After you turn on the competence date functionality, you can specify **Transaction date** as an acknowledgment date for each journal that you can use to post the adjustment and closing transactions for the fiscal year:
...
1. On the **General journal** page, in the **Date** field, specify December 31.
1. In the **Transaction date** field, specify April 15.
1. Post the transaction.

    :::image type="content" source="../media/ITA-Competence-date-for-transactions-2-general-journal.png" alt-text="Screenshot of the Journal voucher page.":::
...
1. Verify that the **Date** field is set to December 31, and the **Transaction date** field is set to April 15.
