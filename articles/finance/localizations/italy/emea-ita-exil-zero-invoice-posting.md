...
The Posting invoices with zero amount feature applies to invoices that you create in the **Accounts receivable** and **Accounts payable** modules.

When you post invoices that have an amount of 0 (zero), the system creates customer or vendor transactions and voucher transactions.
