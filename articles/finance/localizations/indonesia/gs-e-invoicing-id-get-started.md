---
title: Get started with electronic invoicing for Indonesia (preview)
description: This article explains how to configure and process electronic invoice for Indonesia (preview).
...
# Get started with electronic invoicing for Indonesia (preview)
...
2. On the **Electronic invoicing features** page, verify that the **Indonesian electronic invoice (ID)** Electronic invoicing feature is selected.
3. On the **Versions** tab, verify that the **Draft** version is selected.
4. Import the Electronic Invoicing feature to process invoice exports and importing vendor invoices.
5. Review the format configurations that are required to generate and export sales invoices.
...
Make sure that the following Electronic reporting (ER) format configuration is imported.
 - Invoices issued (ID)
...
2. On the **Configurations** page, select **Invoices issued (ID)** format configuration.
...
### Change the version status and deploy feature
...
3. Click on **Deploy** \> in the **Effective from** field, select the date when the environment should become effective.
4. Click **OK**.
