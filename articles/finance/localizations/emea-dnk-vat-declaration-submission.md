...
20. If you need request the receipt informaion again, you can use **Update status** button to change the electronic message status back to **DK VAT return approved** and then cliack again **Send report** button to repeat **DK VAT receipt request** action (see steps 18 and 19).
