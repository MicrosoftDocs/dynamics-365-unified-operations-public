...
The [Petty cash for Eastern Europe and Russia](https://docs.microsoft.com/dynamics365/finance/localizations/emea-petty-cash) topic provides information about the following reports:
...
5. On the Action Pane, select **Print \> Cash due announcement** to generate and print the report. The report is generated as a Microsoft Excel document that uses the template for form **0402001**.
    ...
    ![](media/1%20Объявление%20на%20взнос%20наличными.png)
...
![](media/2%20Cash%20counting%20statement%20(INV-15).png)

4. Select **OK** to generate the cash counting act.

    ![](media/3%20Акт%20инвентаризации%20наличных%20денежных%20средств.png)
