...
|-------------------------|-------------------------|
| M-15 | <ul></br><li>Invoice (M-15) (system ID)</li></br><li>Invoice (M-15)</li></br><li>Corrective invoice (M-15) (system ID)</li></br><li>Corrective invoice (M-15)</li></br></ul> |
| TORG-12 | <ul></br><li>Customer invoice</li></br><li>Customer invoice voucher</li></br></ul> |
...
| Reporting form | Number sequence reference types |
|-------------------------|-------------------------|
| TORG-1 | <ul></br><li>Receipt items statement voucher</li></br></ul> |
| TORG-2 | <ul></br><li>Receipts list voucher</li></br><li>Receipt items statement voucher</li></br></ul> |
| TORG-3 | <ul></br><li>Receipts list voucher</li></br><li>Receipt items statement voucher</li></br></ul> |
| M-4 | <ul></br><li>Reimbursement slip voucher</li></br></ul> |
| M-7 | <ul></br><li>Receipts list voucher</li></br></ul> |
