...
7. Set the following options according to the characteristics of the tax ID type.
    ...
    | Foreign document type | Set this option to **Yes** to specify that the tax ID type can be selected in the countries/regions' address configurations for all foreign countries/region. |
