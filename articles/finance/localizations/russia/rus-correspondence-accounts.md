...
description: Learn how to work with correspondence of accounts for Russia in Microsoft Dynamics 365 Finance.
author: evgenypopov
...
1. In the **Show only vouchers** field, select which vouchers should be listed:
...
1. Select a voucher, and then, on the **Overview** FastTab, view the voucher transactions.
1. On the **Offset** FastTab, follow one of these steps:
