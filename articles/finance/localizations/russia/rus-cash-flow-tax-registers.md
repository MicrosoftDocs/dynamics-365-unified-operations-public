...
1. In the **Interval group** field, enter a name for the new account interval group. For this example, enter **Bank**.
1. On the **Account intervals** FastTab, select **Add**.
1. In the **Account (Interval: From)** field, select a ledger account. For this example, select **51.000**.
1. In the **Account (Interval: To)** field, select a ledger account. For this example, select **51.999**.
1. Repeat steps 2 through 6 to create a second account interval group that is named **Cash**, for ledger accounts **50.000** through **50.999**, and a third account interval group that is named **Transfers in transit**, for ledger accounts **57.000** through **57.999**.
...
1. On the **Exceptions** FastTab, create the following exceptions to specify that the tax register won't reflect the cash flow between cash accounts and bank accounts, or the cash flow for transfer accounts:
...
:::image type="content" source="../media/ruExceptions.png" alt-text="Screenshot of the Exceptions FastTab configuration.":::
...
:::image type="content" source="../media/ruCash_payment_receipt.png" alt-text="Screenshot of the Cash payment receipt tax register.":::
...
:::image type="content" source="../media/ruCash_payment_issue.png" alt-text="Screenshot of the Cash payment issue tax register.":::
