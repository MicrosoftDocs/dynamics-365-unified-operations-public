...
description: Learn how to work with expense and income codes available for Russia in Microsoft Dynamics 365 Finance.
author: evgenypopov
...
1. In the **Name** field, enter a detailed description of the expense or income code.
...
1. On the **Set up** FastTab, you can select the registers that will be used to calculate the amounts and totals for expense or income codes.
...
1. On the Action Pane, select **Ledger account setup** to select the ledger accounts that transactions will be assigned to for the income or expense code.
