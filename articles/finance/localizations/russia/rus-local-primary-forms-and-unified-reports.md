...
description: Learn how to work with cash transaction reports that are available for companies with Russian context in Microsoft Dynamics 365 Finance.
author: kailiang
ms.author: kailiang
ms.topic: how-to
ms.custom: 
...
1. Create a line for sending petty cash to the bank. Select a bank account in either the **Account** field or the **Offset account** field.
1. On the **Payment** tab, in the **Bank transaction type** field, select the transaction type that you selected the **Allow cash due announcement** checkbox for earlier in this article.
1. On the Action Pane, select **Print \> Cash due announcement** to generate and print the report. The report is generated as a Microsoft Excel document that uses the template for form **0402001**.

    :::image type="content" source="../media/cash-primary-01.png" alt-text="Screenshot of the Cash due announcement report.":::
    
    On the line that you created, the **Cash due announcement** field is set and can't edited.

1. On the Action Pane, select **Functions \> Cancel cash due announcement** to cancel the document that was generated for the line. The field that contains a link to the document is cleared, and the line becomes editable.
...
1. To print the **Cash due announcement** report, use the same steps that you used to print the report from the **General journals** page.
...
1. The lower part of the page shows the lines where calculated data about cash is available. You can also manually create lines. This part of the page includes the following fields:
...
:::image type="content" source="../media/cash-primary-02.png" alt-text="Screenshot of the Cash counting statement.":::

1. Select **OK** to generate the cash counting act.

    :::image type="content" source="../media/cash-primary-03.png" alt-text="Screenshot of the Cash counting act report.":::
