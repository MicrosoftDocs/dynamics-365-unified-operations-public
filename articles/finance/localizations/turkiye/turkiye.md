...
> [!NOTE]
> Out-of-box localization of Microsoft Dynamics 365 Commerce doesn't include Türkiye.

## Set up a legal entity for Türkiye

This section explains how to configure a legal entity for companies operating in Türkiye by using Microsoft Dynamics 365 Finance. 
...
This section provides guidance and a reference link on setting up and managing serial numbering for financial and legal documents within Finance in Türkiye.
...
This section provides guidance and a reference link about how Finance distributes the remaining depreciation amount evenly across all 12 months in the final year when you use the Türkiye-specific depreciation methods.

The system automatically allocates the final year depreciation amount, helping you keep monthly depreciation consistent without manual adjustments.

- [Use final year depreciation allocation across months for fixed assets](../../localizations/turkiye/emea-turkiye-final-year-depreciation.md)

## Use prorated depreciation on fixed assets

This section explains how Finance starts depreciation from the month an asset is placed in service when you enable prorated depreciation.

The system calculates depreciation only for the months in use during the first year and adds the remaining amount to the final year.
