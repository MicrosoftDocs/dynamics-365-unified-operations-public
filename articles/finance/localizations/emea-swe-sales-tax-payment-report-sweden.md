...
| Currency rate on reporting date | Set this option to **Yes** to specify that the currency rate on the reporting date should be used for all transactions on the report.                                                                                                                      |
