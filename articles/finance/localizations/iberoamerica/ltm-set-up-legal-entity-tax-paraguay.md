...
1. In the address setup, set up the address format for Paraguay by using **State** as **Departamento** and **County** as **Municipio**.
...
1. Select **New**, and then, in the **Overview** section, in the **Tax ID type** field, enter **RUC** (tax identification), which is one of the tax ID types for Paraguay.
