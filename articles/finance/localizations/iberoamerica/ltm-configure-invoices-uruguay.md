...
1. Create the **document classes** that are required for the commercial activity of the company according to the requirements of the Uruguayan fiscal authorities.
...
1. Configure the document mask as required by the Uruguayan normative. Use the required number of characters for the sales point and the document number.
