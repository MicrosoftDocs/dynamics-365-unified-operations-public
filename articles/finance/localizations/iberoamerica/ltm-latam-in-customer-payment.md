...
1. In the **Name** field, select a customer payment journal.
1. On the Action Pane, select **Lines**.
1. In the **Account** field, select a customer account.
1. On the **LATAM** tab, in the **Document class Id** field, select **REC** as the document class ID for a receipt document.
1. Select **Settle transactions**, and then select the invoices that you want to collect from the customer.
...
1. Go to **Accounts receivable** \> **Payments** \> **Customer payment journal**.
1. On Action Pane, select **LATAM** \> **Payment methods**.
...
1. In the **Document number** field, enter a value.
1. Close the page, and review the information in the customer payment journal before you post.
...
1. On the **Payment method** page, select **New**.
1. In the **Document class id.** field, select a document class ID that represents customer checks. For more information, see [Document classes for Latin America](ltm-core-document-class.md).
1. In the **Document Number** field, enter the customer's check number.
...
1. In the **Bank group** field, select the bank group of the received check.
1. In the **Check source** field, select a value to specify the source of the check that the customer uses for the payment:
