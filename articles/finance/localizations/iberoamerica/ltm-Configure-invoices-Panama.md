...
| Form | Description |
| ------------- | ------------- |
| Document class letter | Countries that have different invoice types, and you can distinguish them by the letter. In Panama you can configure it as WL “without letter” |
