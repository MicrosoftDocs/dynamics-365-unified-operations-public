...
1. In the address setup, set up the address format for Nicaragua by using **State** as **Departamento** and **County** as **Municipio**.
...
1. Select **New**, and then, in the **Overview** section, in the **Tax ID type** field, enter **RUC** (Unique Taxpayer Registry), which is one of the tax ID types for Nicaragua.
1. In the **Format** field, enter **XXXXXXXXXXXXXX**. For more information, see [Tax ID types for Latin America](ltm-core-tax-id-type.md).
