...
description: This topic explains how to configure sales and purchase invoices for a company in Paraguay.
author: Cpicon85
ms.date: 12/07/2023
ms.topic: Article
ms.reviewer: kfend
...
3. Create the **document classes** that are required for the commercial activity of the company according to the requirements of the Paraguayan fiscal authorities.
...
5. Configure the document mask as required by the Paraguayan normative. Use the required number of characters for the sales point and the document number.
