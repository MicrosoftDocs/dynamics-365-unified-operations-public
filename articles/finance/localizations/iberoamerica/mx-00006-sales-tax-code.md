...
1. Select **New**.
1. In the **Tax report category code** field, enter a unique value. Use this code to classify the VAT report generation.
...
1. In the **Ledger posting group** field, select the drop-down button to open the lookup. In the list, find and select the link in the selected row.
...
1. In the list, find and select the desired record and select the link in the selected row.
1. Select the tax category report you created.
1. Select **Save**, and then close the page.
