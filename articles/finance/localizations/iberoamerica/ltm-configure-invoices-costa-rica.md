...
1. Create the **document classes** that are required for the commercial activity of the company according to the Costa Rican fiscal requirements.
...
1. Configure the document mask as required by the Costa Rican normative. Use the required number of characters for the sales point and the document number.
