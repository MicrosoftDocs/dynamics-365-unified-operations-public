...
- [Advance holders overview](emea-advance-holders.md)
 ...
 - [Advance payment to employee](tasks/advance-payment-employee.md)
...
- [Intrastat overview](emea-intrastat.md)
  ...
  - [Specifying a lading address for an intra-community transaction](tasks/eur-00002-specify-lading-address-intra-community.md)
...
- [Receive an EU entry certificate](tasks/eur-00012-receive-eu-entry-certificate.md)
- [Registration IDs](emea-registration-ids.md)
- [Reverse charges VAT](emea-reverse-charge.md)
...
- Value Added Tax (VAT)
  - [Set up VAT ID](tasks/eur-00015-vat-id.md)
  - [Registration of vendor VAT ID](tasks/eur-00015-registration-vendor-vat-id.md)
  - [VAT exchange rate overview](emea-vat-exchange-rate.md)
  - [VAT reconciliation report](tasks/eur-00018-vat-reconciliation-report.md)
