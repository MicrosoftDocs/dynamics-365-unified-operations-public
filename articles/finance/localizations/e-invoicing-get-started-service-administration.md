...
6. In the **AAD tenant ID** field, enter the tenant ID of your Azure subscription account. The AAD tenant you specify should be the same one that is used for RCS.
...
4. Verify that the **Application ID** field is set to **0cdb527f-a8d1-4bf8-9436-b352c68682b2**. This is a fixed value.
...
### Enable Flighting keys for Finance or Supply Chain Management versions 10.0.17
