...
| Certified e-mail address (PEC) for private or professional company | PEC | For example: Customer, Certified e-mail address | CustTable (Customers) | Account receivable > Customers > All customers, Customer tab, Properties, Electronic document properties button.
