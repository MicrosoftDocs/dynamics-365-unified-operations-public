...
3. Select **OK**, and then, in the next dialog box, set the following fields.
    ...
    | Summarize purchases per partner | Select this checkbox to report information in Sales annexes grouped by partner. If this checkbox is selected, the invoice number and date aren't mandatory fields in part B, and amounts are summarized per partner. |
