...
All companies must gather data about employees, customers, and vendors, and also other personal data. When you gather data about persons, most of the information is considered personal data, and you must handle it correctly according to Estonian legislation. All information that comes from logging changes or inquiries on tables that are related to personal data is presented in three defined reports: **Personal chart**, **Access log**, and **Permission changes**.

The following tables are in scope for logging changes or inquiries that are related to personal data:
...
To enable logging changes or inquiries that are related to personal data in the mentioned tables, go to **Organization administration** > **Organizations** > **Legal entities**. For your legal entity with primary address in Estonia, expand the **Database read log** FastTab and select the **Enable** checkbox.

## Reports that are available

- **Access log** – This report shows the fields and tables that are related to an employee's personal information, and that the employee accessed within a specified period. To generate the report, go to **Human resources** > **Workers** > **Inquiries and reports** > **Access log**.
