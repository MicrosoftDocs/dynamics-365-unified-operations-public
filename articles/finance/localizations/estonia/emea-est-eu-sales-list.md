...
For information about how to create a general setup, create postings, and transfer transactions by using the **DEMF** legal entity for Estonia, see [Example for generic EU Sales list](../europe/emea-eu-sales-list-example.md). Additionally, for this example, use **EE123456789** as the company's enterprise ID, instead of the VAT ID.
