...
3. <a id="ImportChannel"></a>On the **Import channel** tab, in the **Parameters** section, select the **Data channel** parameter. Then, in the **Value** field, define the name of the data channel. Alternatively, leave the default value unchanged. Default channel name for the OIOUBL format is **EdiOIOUBL** and **EdiPEPPOL** for the PEPPOL format. In both cases, make a note of the value, because you'll use it in later configuration steps.
...
11. If import in the PEPPOL format is also required then repeat steps 2 till 10 for the **Incoming PEPPOL** feature setup.
...
16. If import in the PEPPOL format is also required then create another import channel and repeat steps 3 till 15 for this channel. Use the **Vendor invoice import** configuration on the step 15.
