...
By using Dynamics 365 Finance, the company agrees that Microsoft can store its recorded transactions and receipts for 5 years from the end of the financial year such material concerns. This applies even if the company changes their bookkeeping system, goes bankrupt, or is liquidated. The data will be stored in a Microsoft-managed storage, either in the same location as the primary computer equipment or in the European Union. During this period, the company cannot access or modify any of its data in this storage. Microsoft will protect this data with the same security measures used for other customer data. After the 5-year retention period, Microsoft will delete this data and is not liable for its deletion.  
