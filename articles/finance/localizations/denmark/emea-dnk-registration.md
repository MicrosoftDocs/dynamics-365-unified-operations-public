...
description: Learn how Dynamics 365 Finance supports requirements to digital standard bookkeeping system registered in Denmark.
author: liza-golub
ms.author: egolub
ms.topic: how-to
ms.date: 03/05/2026
...
This article explains how Dynamics 365 Finance supports requirements to digital standard bookkeeping system registered in Denmark.
...
1. Meet recognized standards for IT security, including user and access management, and ensure automatic backup of records and receipts.
1. Support the automation of administrative processes, including automatic distribution and receipt of e-invoices and the option of accounting in accordance with a public standard chart of accounts in registered bookkeeping systems.
...
:::image type="content" source="../media/emea-dnk-attachment.png" alt-text="Screenshot of the attachment storage settings showing Azure Blob storage as the default option.":::
...
:::image type="content" source="../media/emea-dnk-attachment-example.png" alt-text="Screenshot of the Attachments page displaying all attachments linked to the relevant data source.":::
