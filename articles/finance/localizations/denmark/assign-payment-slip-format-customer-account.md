...
description: Learn how to set up the payment slip attachment format for customers in Denmark with Microsoft Dynamics 365 Finance. 
...
The following procedure walks you through how to set up the payment slip attachment format for a selected customer. The procedure uses the demo data company DEMF.
