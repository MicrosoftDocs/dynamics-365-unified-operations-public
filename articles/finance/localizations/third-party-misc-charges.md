...
15.	To view the information about the allocation of debt, on the Invoice journal page, select Charges > Misc. charges allocation history. Then, in the Allocation mode field, select Redraw debt.
