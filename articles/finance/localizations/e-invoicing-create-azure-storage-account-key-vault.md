...
9. Go to **Settings \> Shared access tokens**, and set the fields. In the **Permissions** field, you should select the following permissions: Read, Add, Creat, Write, Delete, List. 
10. Click **Generate SAS token and URL**.
11. Copy and store the value in the **Blob SAS URL** field. This value will be used in the next procedure and will be referred to as the *shared access signature URI*.
