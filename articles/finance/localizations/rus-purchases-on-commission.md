...
6. Create a purchase order and a facture as described in the topic, [Create a purchase order and update the facture on goods that are purchased for a principal](rus-transactions-through-intermediary.md#create-a-purchase).
7. Create a sales order and an invoice as described in the topic, [Create a sales order and generate a sales invoice for goods that are purchased for a principal](rus-transactions-through-intermediary.md#create-a-sales).
8. Create a report for the principal, and update the lines on shipments, as described in the topic, [Create and print a report for a principal, and reissue the seller's factures to the principal](rus-transactions-through-intermediary.md#create-report-for-1).
...
11. On the **Report for principal** page, approve lines on the **Overview** tab and vouchers on the **Prepayments** tab, as described in the topic, [Create and print a report for a principal, and reissue the seller's factures to the principal](rus-transactions-through-intermediary.md#create-report-for-1).
12. You can create a facture, and view the principal's invoice (or facture) or the original invoice (or facture), as described in the topic, [Create and print a report for a principal, and reissue the seller's factures to the principal](rus-transactions-through-intermediary.md#create-report-for-1).

### Print a report for the principal

Print a report for the principal as described in the topic, [Create and a print a report for a principal, and reissue the seller's factures to the principal](rus-transactions-through-intermediary.md#create-report-for-1). The report for the principal has two sections: one for shipments and one for prepayments.
...
The facture accounting journal shows approved lines. You can print a facture accounting journal as described in the topic, [Print a facture accounting journal](rus-transactions-through-intermediary.md#print-a-facture).
