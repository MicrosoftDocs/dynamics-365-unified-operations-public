...
3. Depending on the scenarios that you want to support, enter the following information in the grid, and then save your changes.
    ...
    | CzCustAdvanceInvoiceTable | <p>**Mapping name:** Advance invoice context</p><p>**Configuration:** Advance invoice context model</p> | <p>**Mapping name:** Advance invoice</p><p>**Configuration:** Advance invoice model mapping</p> | Polish electronic invoice (PL) |
