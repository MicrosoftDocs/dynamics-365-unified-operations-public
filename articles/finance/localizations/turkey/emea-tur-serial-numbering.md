...
- If the **Account type** is **Vendor** and vendor account has a credit amount, the **Serial prefix** cannot be selected. The invoice number must be provided by the vendor and must be filled in the **Invoice** field. 
