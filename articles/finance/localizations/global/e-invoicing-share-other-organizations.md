...
1. In the **Globalization feature** workspace, in the **Features** section, select the **Electronic invoicing** tile.
1. On the **Electronic invoicing features** page, select the feature and version to share. You can't share feature versions that have a status of **Draft**.
1. On the **Organizations** tab, select **Share with**. In the drop-down dialog box, enter the domain name of the organization that you want to share the feature with.
1. Select **Share**.
