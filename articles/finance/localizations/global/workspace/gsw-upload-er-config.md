...
You can also export and import specific versions as a file by using the export and import buttons on the page (existing functionality).
...
1. Export the .xml files of any ER configurations and the .json files of any Globalization features to the new folder.
    ...
    > [!IMPORTANT]
    > Don't include Microsoft configurations.
...
> [!NOTE]
> Check the size of the generated .zip file. If it exceeds 90 megabytes (MB), you must split your source files into multiple Dataverse solutions.
