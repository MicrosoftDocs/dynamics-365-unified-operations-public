...
Before you begin the procedures in this article, create an Azure storage account. To learn more, see [Configure an Azure storage account in the Azure portal](../global/gs-e-invoicing-create-azure-storage-account-azure-portal.md).
...
1. On the service menu, under **Data storage**, select **File shares**.
    ...
    :::image type="content" source="../media/create-file-share.png" alt-text="Screenshot of File shares on the service menu.":::
...
1. Under **key1**, copy the value in the **Connection string** field.
    ...
    :::image type="content" source="../media/azure-file-share-connection-string.png" alt-text="Screenshot of Azure file share connection strings.":::

1. Store the **Connection string** value in a Key Vault secret. To learn how to set up Key Vault, see [Configure an Azure Key Vault in the Azure portal](../global/gs-e-invoicing-create-azure-key-vault-azure-portal.md).
1. Refer to the Key Vault secret in Key Vault parameters. To learn more, see [Configure Electronic invoicing parameters](../global/gs-e-invoicing-set-up-parameters.md).
