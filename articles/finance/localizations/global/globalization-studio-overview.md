...
:::image type="content" source="../media/globalization-studio-breakdown.png" alt-text="Screenshot of Globalization Studio breakdown.":::

The Globalization Studio consists of the following tools and services:

- [Regulatory Configuration Service (RCS)](rcs-overview.md) is a standalone designer and lifecycle management service for no-code and low-code globalization functionality.
- [Electronic Reporting (ER)](/dynamics365/unified-operations/dev-itpro/analytics/general-electronic-reporting) is a configurable tool that helps create and maintain regulatory electronic reporting, payment formats, and other features in a no-code or low-code format.
...
- [Out-of-the-box multi-country/region localizations](../../../fin-ops-core/fin-ops/lcs/globalization-resources.md) and [regulatory updates](regulatory-updates.md) are provided by Microsoft and updated per legislation changes in the supported countries and regions.
- Partner localization solutions that partners publish on [Microsoft Marketplace](https://marketplace.microsoft.com/) or provide directly.
