...
| Belgium | Generation of electronic invoices for sales and project invoices and credit notes in the **PEPPOL** format. | <ul><li>Available</li><li>B2B end-to-end communication is planned for 2025 release wave 1</li></ul> |
...
| Denmark | <p>Generation and submission to NemHandel or to the Peppol network of electronic invoices for sales and project invoices and credit notes in the **OIOUBL** or **PEPPOL** formats. Import of vendor electronic invoices.</p><p>Learn more: [Use electronic invoicing for Denmark](../denmark/gs-e-invoicing-dk-get-started.md)</p> | <ul><li>Available</li><li>**OIOUBL** format update to version 3.0 planned for 2025 release wave 1</li></ul> |
