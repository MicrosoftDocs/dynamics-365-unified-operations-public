...
| Chile | <p>Generation of electronic tax documents (DTE) in country-specific format for invoices, debit notes, credit notes, export invoices, export debit notes, export credit notes​, and packing slips.</p><p>Learn more: [Chilean electronic invoicing](../iberoamerica/ltm-chile-elec-invo-conncection.md)</p> | <ul><li>Available</li><li>Vendor invoices import (inbound flow) planned for 2024 release wave 1</li></ul> |
