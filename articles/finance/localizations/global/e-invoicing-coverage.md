...
| Brazil | <p>Generation and direct submission of NF-e fiscal documents to the authorities.<br>Generation of national and São Paulo NFS-e service fiscal document formats, without submission.<br>Import of incoming documents issued by the authorities into Dynamics 365 Finance.</p><p>**2026 Tax Changes in Electronic Invoicing for Brazil**<br>The update includes the revision of the NF-e format and its transition to Electronic Reporting to ensure compliance with updated tax rules and classifications. It also introduces the new national NFS-e and São Paulo city NFS-e formats for service invoices. All formats are generated using the Electronic Reporting framework. NF-e continues to be submitted to SEFAZ in the same way as currently (in the code in F&O). _**NFS-e and São Paulo NFS-e aren't submitted out of the box**_; customization or integration with a third-party solution is required to submit service fiscal documents. </p><p>Learn more: [NF-e process overview](../brazil/latam-bra-nf-e-process.md)</p> | <p>Available</p> <p>**New ER-formats for Tax Reform**: <br>Available in Public preview (except NFS-e).<br>General availability is planned for 2025 release wave 2 (December 1, 2025). </p>|
