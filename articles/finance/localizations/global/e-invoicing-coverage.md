...
| Guatemala | Generation of electronic invoices in a file structured in the country-specific XML format. Submission to the Guatemalan Tax Authority (SAT) via a third-party "last mile" connection to Edicom. | Planned for 2025 release wave 2 or later |
...
| Paraguay | <p>Generation of electronic documents and electronic tax documents in the standardized country-specific XML format. Submission to the Paraguayan Tax Authority (SET) via a third-party "last mile" connection to Edicom.</p><p>Learn more: [Electronic invoicing for Paraguay](../iberoamerica/ltm-paraguay-electronic-invoice-configuration.md)</p> | Available |
