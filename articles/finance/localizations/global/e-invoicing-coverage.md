...
| Uruguay | Generation of electronic fiscal receipts (CFE) based on the XML standard, with a syntax defined and maintained by the DGI. Submission to the Uruguayan Tax Authority (DGI) via a third-party "last mile" connection to Edicom. | Planned for 2025 release wave 1 |
