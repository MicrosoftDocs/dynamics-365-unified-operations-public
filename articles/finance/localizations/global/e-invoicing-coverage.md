...
| Brazil | <p>**2026 Tax Changes in Electronic Invoicing for Brazil**<br>The update includes the revision of the NF-e format and its transition to Electronic Reporting to ensure compliance with updated tax rules and classifications. It also introduces the new national NFS-e and São Paulo city NFS-e formats for service invoices. All formats are generated using the Electronic Reporting framework. NF-e continues to be submitted to SEFAZ in the same way as previously (in the code in F&O).</p><p>_**NFS-e and São Paulo NFS-e aren't submitted out of the box**_; additionally, the XML is no digital signed. Customization or integration with a third-party solution is required to submit and sign service fiscal documents.</p><p>Learn more: [NF-e process overview](../brazil/latam-bra-nf-e-process.md)</p> | Available |
