...
With the merge of the Regulatory Configuration Service (RCS) experience, we are moving away from the notion of service environments. Because RCS standalone was configured at the tenant level, service environments were used to logically separate Globalization feature setups. Therefore, they could, in a way, mimic different Finance environments. This experience goes away after the RCS merge into Finance.

After the **Globalization Studio** and **E-invoicing service workspace designer** features are enabled, the field for the service environment name on the **Electronic Invoicing** tab of the **Electronic document parameters** page becomes unavailable. Therefore, for existing setups, we recommend that you finalize the name of the relevant service environment before you enable the new Globalization Studio experience.
