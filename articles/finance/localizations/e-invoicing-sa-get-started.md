...
10. In Key Vault, create certificates and secret for Cryptographic Stamp Identifiers (CSIDs). For more information, see [Customer certificates and secrets](e-invoicing-customer-certificates-secrets.md).
...
18. In the **Processing pipeline** section, select **(Preview) Integrate with Saudi Arabia Zatca service**, and then follow these steps:
    ...
    8. In the **Value** field, select **CCSIDSecret** or **PCSIDSecret**, depending on your place in onboarding process. 
