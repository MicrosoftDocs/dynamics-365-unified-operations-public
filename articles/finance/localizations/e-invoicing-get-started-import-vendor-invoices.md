...
5. In the **Data sources** tree, expand the **$Context\_Channel** container. In the **Value** field, select **Edit**, then select **Edit formula** and enter the data channel name. This is the name of the channel given in the configuration of the data channel for the Electronic invoicing feature in RCS. 
