...
description: Learn how to set up VAT ID registration prerequisites such as setting up a registration type and assigning it to a registration category in Microsoft Dynamics 365 Finance.
author: epodkolzina
...
The procedure is intended for system administrators, and the information here applies to all European countries/regions. The procedure uses the demo data company DEMF with Germany as the legal entity primary address. 
...
1. In the **Description** field, enter "VAT number".
