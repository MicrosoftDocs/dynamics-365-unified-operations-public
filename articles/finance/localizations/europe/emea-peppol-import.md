...
9. File attachments are supported during the import. All attached files specified in the **Invoice\\cac:AdditionalDocumentReference** element of PEPPOL import files should have extensions. If an attached file has no extension then the system will raise a warning and this attachment will be skipped during the import.    
