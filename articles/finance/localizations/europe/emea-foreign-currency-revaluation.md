...
1. In the **General** tab, in the **Exchange difference type** field, select **FIFO** or **LIFO**.
...
To configure the parameters for bank foreign currency revaluation, follow these steps:
...
1. Go to **Cash and bank management** > **Periodic tasks** > **Foreign currency revaluation**.
...
1. Go to **Records to include** > **Filter** to find the bank account, and then select **OK**.
