...
1. Select and double-click a record to open the bank account details.
1. Select **Edit**.
1. In the **Additional identification** section, enter a value in the **IBAN** field.
1. In the **SWIFT code** field, enter a value. A SWIFT\BIC isn't required for many payment formats, but register it for a bank account.  
1. Select **Save**.
...
1. In the **Bank account information** section, in the **Bank account** field, enter or select a value.
1. Select **Save**.
