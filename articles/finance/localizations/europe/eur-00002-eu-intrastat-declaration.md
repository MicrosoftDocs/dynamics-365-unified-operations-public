...
1. Apply a filter on the **Configuration name** field by using the **begins with** filter operator with a value of `Intrastat (DE)`. Select the configuration name that's applicable for the country/region of your legal entity.
1. Select **Import**, and then select **Yes**.
1. Open the **Configuration name** column filter.
1. Apply a filter on the **Configuration name** field by using the **begins with** filter operator with a value of `intrastat report`.
1. Select **Import**, and then select **Yes**.  
...
1. In the **Electronic reporting** section, enter or select a value in the **File format mapping** field.
1. Enter or select a value in the **Report format mapping** field.
1. In the **Rounding rules** section, enter a number in the **Rounding rule** field.  
1. Enter a number in the **Number of decimals for amount** field.
1. Select an option in the **Rounding below 1 kg** field.
1. Enter a number in the **Rounding rule** field.
1. In the **Minimum limit** section, enter a number in the **Weight** field. 
1. Enter a number in the **Amount** field.
1. Enter or select a value in the **Commodity** field.
...
1. Select **Validate**. The validation process uses the **Check setup** field on the **Foreign trade parameters** page.  
1. Select **OK**.
...
1. Select **Update** > **Compress**. The compression process uses the **Compression of intrastate** settings.  
1. In the **Start date** field, enter a date.
1. In the **End date** field, enter a date, and then select **OK**.
