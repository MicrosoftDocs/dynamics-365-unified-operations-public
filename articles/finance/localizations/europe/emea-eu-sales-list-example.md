...
description: Learn how to set up and transfer a European Union (EU) sales list, including outlines on setting up country/region parameters and company information.
author: liza-golub
ms.author: egolub
ms.topic: how-to
ms.custom: 
...
1. On the **Tax registration** FastTab, in the **Tax registration number** field, enter "203/118/12345".
    ...
    > [!NOTE]
    > Depending on the specific country or region, you can use the value of the **Tax registration number** field in EU sales list report files.
...
1. On the Action Pane, select **New**.
1. In the **Enter registration type details** dialog, enter "VAT ID" in the **Name** field.
1. Select **DEU** in the **Country/region** field.
1. Select **Create**.
...
To match the registration type with a registration category, use the following steps:
...
1. Close the page.
    ...
    > [!NOTE]
    > Depending on the company localization, if the **VAT exempt number export** field in the **Intrastat** section of the **Foreign trade and logistics** FastTab is set (not blank), you can use this value instead of the VAT ID that you created.
...
1. On the action pane, select **Save**.
1. Close the page.
1. On the **Invoice and delivery** FastTab, in the **Sales tax** section, select **SE100200300400** in the **Tax exempt number** field.

### Import electronic reporting configurations

To import electronic reporting configurations, use the following steps:
