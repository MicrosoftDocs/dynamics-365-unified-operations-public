...
The following procedures show how inventory accountants can create transfer documents for goods movement inside a company. The procedures are only available for legal entities with a primary address in Lithuania. The procedures use the demo data company DEMF with a primary address in Lithuania. 

Before you can complete the procedures, you must complete the procedures in [Set up transfer documents for goods movement inside a company](set-up-transfer-documents-goods-movement-inside-company.md).
...
To view the packing slip for the posted transfer order, use the following steps:
