...
description: Learn how to create and submit a VAT report to the German authority with Microsoft Dynamics 365 Finance.
author: mrolecki
...
The following procedure walks you through creating and submitting the VAT report to the German authority. This functionality is available for legal entities whose primary address is in Germany. The procedure uses the demo data company DEMF.
