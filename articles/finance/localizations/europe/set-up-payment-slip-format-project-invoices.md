...
The following procedures use the DEMF demo company. This functionality is available for legal entities whose primary address is in Denmark.
...
1. In the **Associated payment attachment on customer invoice** field, select one of the following options.
    - **None**: Don't print a payment slip. Select this option if the payment amount is in a currency other than Danish kroner (DKK).
