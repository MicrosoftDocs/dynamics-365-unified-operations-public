...
The following procedure shows how to generate the tax reconciliation report for Icelandic and Norwegian legal entities. The procedure uses the demo data company DEMF with the country/region of legal entity primary address updated to be Norway.

To generate the tax reconciliation report for Icelandic and Norwegian legal entities, follow these steps:
