...
Before you complete the procedure, export format configurations and set up payment accounts.

This procedure uses the DEMF demo data company.

To set up a vendor method of payment for an ISO 20022 credit transfer, follow these steps:
