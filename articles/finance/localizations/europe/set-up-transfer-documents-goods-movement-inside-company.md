...
The following procedures, intended for inventory accountants, show how to create transfer documents for goods movement inside a company. These procedures are only available for legal entities with a primary address in Lithuania. You can use these procedures with the demo data company DEMF, which has a primary address in Lithuania. Before you can complete this procedure, you must first complete the procedures in [Set up transfer documents for goods movement inside a company](set-up-transfer-documents-goods-movement-inside-company.md).
