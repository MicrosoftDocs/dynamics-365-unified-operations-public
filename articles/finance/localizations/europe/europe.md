...
- [Create payments for a customer who have direct debit mandates](create-payments-customers-who-have-direct-debit-mandates.md)
...
- [Generate a transfer document for an internal inventory transfer](transfer-document-internal-inventory-transfer.md)
- ISO20022 files
  ...
  - [Setup method of payment for ISO20022 direct debit](setup-method-payment-iso20022-direct-debit.md)
...
- [Intrastat overview](emea-intrastat.md)
  - [Transfer transactions to the Intrastat](transfer-transactions-intrastat.md)
  - [Specifying a lading address for an intra-community transaction](eur-00002-specify-lading-address-intra-community.md)
  - [Generate an EU Intrastat declaration](eur-00002-eu-intrastat-declaration.md)
...
- [Issue an EU entry certificate](eur-00012-issue-eu-entry-certificate.md)
...
- [Original invoice reference (Eastern Europe)](../estonia/ee-00004-original-invoice-reference.md)
- [Party search using VAT ID](eur-00015-party-search-vat-id.md)
- [Payment reference generation tool](../estonia/ee-00015-payment-reference-generation-tool.md)
- [Payment slip report](emea-eur-payment-slip-report-giro.md)
- [Petty cash for Eastern Europe and Russia](emea-petty-cash.md)
...
- [Reverse charges VAT](../global/emea-reverse-charge.md)
...
- [Set up payment slip format for project invoices](set-up-payment-slip-format-project-invoices.md)
...
- Value Added Tax (VAT)
  - [Set up VAT ID](eur-00015-vat-id.md)
  - [Registration of vendor VAT ID](eur-00015-registration-vendor-vat-id.md)
  - [VAT exchange rate overview](emea-vat-exchange-rate.md)
  - [VAT reconciliation report](eur-00018-vat-reconciliation-report.md)
  - [VAT register transactions for Eastern Europe](emea-vat-register-transactions.md)
  - [VAT reporting](emea-vat-reporting.md)
  - [Create and submit VAT report](create-submit-vat-report.md)
  - [View transactions on settlement for Eastern Europe](emea-transactions-settlement-form.md)
  - [Tax point date (Date of VAT register)](../united-kingdom/emea-tax-point-date.md)
