...
description: Learn how to set up and register transactions for an advance holder, including processes on creating a new cash account and creating new journals.
author: kfend
ms.author: kfend
ms.topic: how-to
ms.date: 08/29/2018
