...
- **TD28** – For vendors that are located in the San-Marino and sale tax amount is greater then zero (available from version 273.47 of **Vendor Invoice (IT)** format).
