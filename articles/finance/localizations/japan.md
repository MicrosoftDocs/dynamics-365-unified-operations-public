...
-  [Adjustment of the asset retirement obligation estimate](tasks/adjustment-asset-retirement-obligation-estimate.md)
...
-  [Create and confirm recognition test](tasks/create-confirm-recognition-test.md)
...
-  [Depreciation of fixed assets with reduction entry posted](tasks/depreciation-fixed-assets-reduction-entry-posted.md)
...
-  [Fixed asset allocation rules](apac-jpn-allocation-rules-fixed-assets.md)
...
-  [Generate Japan consumption tax report](tasks/japan-consumption-tax-report.md)
-  [Impairment accounting for fixed assets](apac-jpn-impairment-accounting-fixed-assets.md)
-  [Inquiries of the asset retirement obligation related transactions](tasks/inquiries-asset-retirement-obligation.md)
...
-  [Use assemble list of a fixed asset](tasks/use-assemble-list-fixed-asset.md)
...
-  [Setup vendor master and purchase order to be target of consolidated invoice](tasks/vendor-master-po.md)
...
-  [Generate EFT payment file with JBA format](tasks/eft-payment-file-jba-format.md)
-  [Import customer payment with JBA file format](tasks/import-customer-payment-jba-file-format.md)
-  [Inquiries of payment fee on journal](tasks/inquiries-payment-fee-journal.md)
...
-  [Setup payment fee for Japan](tasks/setup-payment-fee-japan.md)
...
-  [Qualified Invoice System - Setting up Sales tax for JCT](apac-jpn-qualified-invoice-system.md#setting-up-sales-tax-for-jct)
