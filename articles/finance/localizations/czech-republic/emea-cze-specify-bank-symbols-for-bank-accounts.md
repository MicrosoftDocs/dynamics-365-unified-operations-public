...
When you set up a constant symbol for a bank account, it's copied to sales orders, customer and vendor invoices, and free-text invoices.
...
> [!NOTE]
> When you set up or add a **specific** symbol for a bank account, both the **constant symbol** and **specific symbol** show on the vendor invoice printout.
