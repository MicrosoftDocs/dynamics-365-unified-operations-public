...
| 10.0.19     | NL          | VAT Declaration XML (NL).version.85.14</br>VAT Declaration Excel (NL).version.85.14.17| [VAT declaration (Netherlands)](https://docs.microsoft.com/dynamics365/finance/localizations/emea-nl-vat-declaration-netherlands)|
| 10.0.20     | FR          | VAT Declaration Excel (FR).version.85.15| [VAT declaration (France)](https://docs.microsoft.com/dynamics365/finance/localizations/emea-fra-vat-declaration-preview-france) |
| 10.0.21     | UK          | MTD VAT importing model mapping (UK).version.31.36</br>Tax declaration model mapping.version.95.158</br>VAT Declaration Excel (UK).version.32.30.16</br>VAT Declaration JSON (UK).version.32.31 | [Prepare for integration with MRD for VAT](https://docs.microsoft.com/dynamics365/finance/localizations/emea-gbr-mtd-vat-integration)   |
| 10.0.21     | SE          | VAT Declaration XML (SE).version.95.11</br>VAT Declaration Excel (SE).version.95.11.13| [VAT declaration (Sweden)](https://docs.microsoft.com/dynamics365/finance/localizations/emea-swe-vat-declaration-sweden)   |
| 10.0.21     | CH          | Tax declaration model.version.96</br>Tax declaration model mapping.version.96.164</br>VAT Declaration XML (CH).version.96.16</br>VAT Declaration Excel (CH).version.96.16.9 | [VAT declaration (Switzerland)](https://docs.microsoft.com/dynamics365/finance/localizations/emea-che-vat-declaration-switzerland) |
