...
| Declaration type | This field contains information about the direction of the Intrastat report and the format of the declaration.</br><ul></br><li>For a full Intrastat report about arrivals, "Ievedums-1B" is printed.</li></br><li>For a full Intrastat report about dispatches, "Izvedums-2B" is printed.</li></br><li>For a simplified Intrastat report about arrivals, "Ievedums-1A" is printed.</li></br><li>For a simplified Intrastat report about dispatches, "Izvedums-2A" is printed.</li></br></ul> |
