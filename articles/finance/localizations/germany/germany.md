...
description: This article provides an overview of Dynamics 365 Finance functionality that is specific to Germany with links to resources about audit files, depreciation, and VAT declarations.
author: AdamTrukawka
ms.author: atrukawk
ms.topic: overview
ms.custom: 
...
This article provides an overview of Dynamics 365 Finance functionality that is specific to Germany with links to resources about audit files, depreciation, and VAT declarations.
