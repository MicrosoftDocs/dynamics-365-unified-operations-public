...
13. Select **Configuration version**. You should see the configuration version that you imported in step 8.
    ...
    Microsoft provides a default tax configuration that covers most of the requirements and will be updated based on market feedback. If you must extend the configuration to meet specific requirements, see [How to build extension in Tax Calculation ](https://go.microsoft.com/fwlink/?linkid=2138483) for information about how to generate and select your own tax configuration.
