...
2. Enable "Globalization features" in "Feature management" workspace.
...
10. Return to the **Globalization features (Preview)** workspace, select **Features**, select the **Tax Calculation** tile, and then select **Add**.
