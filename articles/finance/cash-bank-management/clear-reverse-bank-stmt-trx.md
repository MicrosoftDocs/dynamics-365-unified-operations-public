...
In some cases, you don't record bank statement transaction reversals on the company side. You can clear reversal bank statement transactions in advanced bank reconciliation without matching them to any company transaction.
...
1. On the **Unmatched transactions** tab, select the bank statement transactions to match. The total amount of the selected company transactions must be 0.
1. Select **Match**.
...
1. On the **Step 1: Find reversal statement lines** FastTab, define the criteria.
    ...
    > [!NOTE]
    > For this step, set the **Reversal** field on the bank statement line to **Yes**.

1. On the **Step 2: Find original statement lines** FastTab, define the criteria. You can use the **Document number** and **Payment reference** fields. The value of these fields must be the same on the reversal and original statement lines.
