...
1. Enter information in the **Bank statement date** and **Bank statement** fields. In the **Ending balance** field, enter the bank account balance as it appears on the bank statement.

1. Select **Transactions** to open the **Account reconciliation** page.
...
>[!NOTE]
>Don't select the **Cleared** checkbox for transactions that aren't on the bank statement. These transactions continue to be displayed in on this page until they're reconciled with a future bank statement.
...
1. If the amount for a bank account transaction doesn't correspond to the amount for the transaction on the bank statement, enter the amount of the correction in the **Correction amount** field.
...
1. Create transactions for entries, such as fees and interest, that are on the bank statement but that aren't in Finance. Enter the **Bank transaction type** and appropriate financial dimensions.
...
1. On **Cancel bank reconciliation**, enter the **Reason code**, **Reason comment**, and **Cancellation date**.
1. Select **OK**.
