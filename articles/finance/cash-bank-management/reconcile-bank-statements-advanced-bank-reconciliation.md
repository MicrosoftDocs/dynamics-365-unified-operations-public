...
When validation finishes, the status of the bank statement updates to **Validated**. You must validate a bank statement before you can reconcile it.
...
1. On the **Bank statement** or **Bank reconciliation worksheet** page, select the required bank statement lines.
