...
Depreciation is a periodic transaction that typically reduces the value of the fixed asset on the balance sheet. You charge it as an expenditure to a profit and loss account. Therefore, you typically use a main account to credit the periodic depreciation on the balance sheet. An offset account is an account in the profit and loss part of the chart of accounts.

## Depreciation adjustment

Usually, you post a depreciation adjustment to correct a posted depreciation transaction. Therefore, set up both the main account and the offset account just like the accounts for depreciation. A depreciation adjustment can be either a positive amount or a negative amount, but the functionality of the main account (as a balance sheet account) and the functionality of the offset account (usually as a profit and loss account) remain the same.

## Extraordinary depreciation

Extraordinary depreciation works like basic depreciation. Therefore, you use a main account to credit the depreciation amount to the balance sheet and reduce the value of the fixed asset. An offset account is a profit and loss account, where you charge the depreciation that you calculate for the fiscal period as an expenditure.
...
You can create an unlimited number of special depreciation allowance records. After you assign those records to an asset group book, they apply to the asset book.
...
>[!Note]
> This feature is only supported by using the Straight Line – Service Life depreciation method. It's not available for localized versions.
