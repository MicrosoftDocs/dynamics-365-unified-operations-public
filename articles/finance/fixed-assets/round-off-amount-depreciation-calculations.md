...
description: Learn about the Round-off depreciation field that is found on the Book setup pages, including an example that shows depreciation amounts for rounding methods.
author: moaamer
ms.author: moaamer
ms.topic: article
ms.date: 05/27/2026
