...
description: Learn about fixed asset mass updates. If you use books, you can change the depreciation conventions for groups of assets that are part of the same book.
author: moaamer
ms.author: moaamer
ms.topic: article
ms.date: 06/24/2026
...
For example, if you're in the United States and you put more than 40 percent of your assets in service during the fourth quarter of the year, you must use the mid-quarter depreciation convention. Use the process for a mass update to change all assets that require the new depreciation convention.
...
To update the depreciation convention for assets that you already disposed of, you must first delete the existing disposal transactions. You must also delete all transactions that the disposal process generated.
