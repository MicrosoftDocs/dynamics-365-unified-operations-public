...
NOTE: If "Summarize depreciation" parameter is turned on then the value filled in "Number of books per journal - Depreciation proposal" has no effect as the internally defined limit is 6000 in this case.
