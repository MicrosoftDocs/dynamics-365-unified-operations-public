...
|         Half year         |  Deduct a half-year of depreciation for both the first year and the last year that you depreciate the property. Deduct a full year of depreciation for every other year during the recovery period. The half-year convention process will calculate half of the depreciation for half of the first and last year of the service life of the asset. This has the effect of adding six months to the service life of the asset.  |
