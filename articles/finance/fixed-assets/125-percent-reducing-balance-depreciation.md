...
If you select **Fiscal** in the **Depreciation year** field, the system calculates 125% reducing depreciation based on the fiscal year for the fiscal calendar that you specify for the book or select on the **Ledger** page. Set up fiscal calendars on the **Fiscal calendars** page.
...
The 125% reducing balance method divides 125 percent by the service life years. That percentage is multiplied by the net book value of the asset to determine the depreciation amount for the year.
...
> [!NOTE]
> Typically, when the amount that is calculated by using the 125% reducing balance depreciation method becomes less than the amount that would be calculated by using the straight line method, there's a conversion to the straight line method for the remaining life.
