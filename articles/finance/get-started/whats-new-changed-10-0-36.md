...
| Data Management | Job history cleanup | By default, job history entries and related staging table data that are older than 90 days are automatically deleted.[More details.](../../fin-ops-core/dev-itpro/sysadmin/cleanuproutines)| 
