...
|--------------|---------|------------------|------------|
|Cash and bank management|Modern bank reconciliation|This feature redesigns advanced bank reconciliation including usability improvements, feature enhancements and performance improvements. Several new capabilities are available on bank reconciliation worksheet including clearing reversal company transactions, generating vouchers, generating payment journals, and settling open customer invoices. Bank reconciliation matching rules are also enhanced to run these capabilities automatically through user defined criteria. This feature is a preview feature and is available in sandbox environments in Dynamics 365 Finance version 10.0.39.|Feature management|
|Cash and bank management|Petty cash|Petty cash is extended from a localization feature to a global feature for all countries in 10.0.39. You can use the petty cash functionality to automate operations for receipts and expenditures of cash, the creation of primary documents, and the printing of related reports.|Feature management|
