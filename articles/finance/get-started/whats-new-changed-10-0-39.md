...
| Regulatory reporting | Italian Sales tax payment report and sales tax books | New ER design introduced for [Italian Sales tax payment report and sales tax books](../localizations/italy/emea-ita-vat-statements-details.md) with support of reporting for [multiple value-added tax (VAT) registrations](../localizations/global/emea-multiple-vat-registration-numbers).  |
