...
|--------------|---------|------------------|------------|
|Cash and bank management|Modern bank reconciliation|This feature redesigns advanced bank reconciliation including usability improvements, feature enhancements and performance improvements. Several new capabilities are available on bank reconciliation worksheet including clearing reversal company transactions, generating vouchers, generating payment journal and settling open customer invoices. Bank reconciliation matching rules are also enhanced to run these capabilities automatically through user defined criteria. This feature is a preview feature and is available in sandbox environments in Dynamics 365 Finance version 10.0.39.|Feature management|
