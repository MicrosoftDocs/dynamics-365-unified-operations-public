...
| Cash and bank management | Enable batch mode for bank statement and bank statement line posting in advanced bank reconciliation | This feature enables batch processing option for bank statement posting and bank statement line posting in bank reconciliation worksheet. For posting bank statement line in bank reconciliation worksheet, the feature "Enable posting of new transactions in bank reconciliation" has to be enabled. | Feature management |
