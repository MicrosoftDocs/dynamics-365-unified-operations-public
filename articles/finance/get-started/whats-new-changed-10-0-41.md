...
| Tax | Adjust sales tax amount per vendor charged sales tax | The **Accrue sales tax type - adjustment** feature in the vendor master and the vendor invoice header. The vendor charged sales tax amount can be entered on the vendor invoice header. That amount overrides the sales tax result that was calculated by using sales tax adjustment. | Feature management |
