...
|Electronic Invoicing |E-Invoicing for Chile: Vendor electronic invoice import|This feature enhances the last-mile integration with the Panamanian Tax Authorities via the Certification Authorization Provider Edicom. It provides the required end-to-end process of the **inbound flow** of e-invoices import. For more information, see: [Vendor electronic invoice import in Chile](../localizations/iberoamerica/ltm-chl-vend-e-invoice.md).|  |
