...
| General ledger| Correct ledger settlement records with mismatched partial ledger settlement records | Detects and corrects transactions that have ledger settlement records but are not marked as settled. | Data maintenance|
