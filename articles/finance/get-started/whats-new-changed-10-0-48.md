...
| Globalization studio | Electronic invoicing for France | The feature provides Dynamics 365 Finance compliance with French regulatory requirements for electronic invoicing.<p></p><ul><li>Supports the generation of electronic invoices XML files in the French extension of the UBL‑based format for domestic business‑to‑business (B2B) invoices and credit notes generated from sales orders, free text invoices, and project invoices</li><li>Transmits generated electronic invoices to counterparties and to the French tax authorities through EDICOM that act as an Accredited Service Provider</li><li>Enables the receipt of vendor electronic invoices in the UBL‑based format through EDICOM</li><li>Supports mandatory invoice lifecycle statuses as defined by French legislation</li><p></p><p>Learn more: [**Electronic invoicing for France**](../../finance/localizations/france/emea-fra-einv-ereport.md)</p>| Feature management |
