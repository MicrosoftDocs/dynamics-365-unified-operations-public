...
| General ledger | Account structure activation performance enhancement | This feature will allow you to save time by updatin multiple transaction groups faster by running them simultaneously during account structure change. You can track your activation status by clicking on ‘View activation status’ for detailed results. |
