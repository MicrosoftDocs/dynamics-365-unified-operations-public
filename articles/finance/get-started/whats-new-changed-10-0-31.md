...
| Additional languages available | Four additional languages are available | Users can choose additional four new languages from the preferred language list. This option can be selected by going to **User options > Preferences > Language and country/region preference**. Additional languages that are available: Korean, Portuguese (Portugal), Vietnamese, Chinese (Traditional).| Localized preferences |
