...
|Cash and bank management|Generate NACHA payment file by Electronic Reporting|This feature enables Eletronic Reporting for NACHA payment file generation. Users can import Electronic Reporting configurations under "Standard NACHA (US) - customers" and "Standard NACHA (US) - vendors" to use this feature. ||
