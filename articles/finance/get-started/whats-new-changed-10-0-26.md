...
| Globalization | (ER) Keep rows of a single section together on the same Excel page | This functionality allows you to tune an Excel template of your ER format to improve the look and readability of a generated report by keeping all the content for a single section on the same page. For more information, see [Row handling](../../fin-ops-core/dev-itpro/analytics/er-fillable-excel.md#row-handling). | Parameter |
