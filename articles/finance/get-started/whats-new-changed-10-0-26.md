...
| Globalization | (ER) Support ZPL printing | This functionality enhances the direct printing option of the Electronic reporting (ER) framework. In addition to the option of printing outbound documents in Microsoft Office formats, ER allows you to configure various labels by using the Zebra Programming Language (ZPL II) and directly send generated labels to a selected network printer. For more information, see [ZPL printing](../../fin-ops-core/dev-itpro/analytics/er-destination-type-print.md#zpl-printing). | Parameter |
| Globalization | (ER) Keep rows of a single section together on the same Excel page | This functionality allows you to update a Microsoft Excel template of your ER format to improve the look and readability of a generated report by keeping all the content for a single section on the same page. For more information, see [Row handling](../../fin-ops-core/dev-itpro/analytics/er-fillable-excel.md#row-handling). | Parameter |
...
| Globalization | (ER) Built-in functions | This feature offers you on the [Formula editor](../../fin-ops-core/dev-itpro/analytics/er-advanced-formula-editor.md) page an individual hyperlink for every ER built-in function. This hyperlink navigates you to a relevant help page that describes this function, provides examples of its usage, and gives all necessary details to help you efficiently use it in your ER expressions. |
