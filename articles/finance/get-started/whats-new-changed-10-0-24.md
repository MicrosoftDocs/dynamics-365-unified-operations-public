...
| Tax Calculation | Tax Calculation Service | This feature supports a legal entity's primary address in Mexico. For more information, see the **Supported countries/regions** section in [Tax Calculation overview](../localizations/global-tax-calculation-service-overview.md). |
