...
|Document management  |	Export attachments in Document management |	The **Export attachments** feature is available in **Document management**. Use this feature to export files and metadata that are attached to records of tables in finance and operations apps.  |	 |
