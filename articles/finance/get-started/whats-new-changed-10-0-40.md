...
| General ledger | Reverse related journals | This feature reverses all related journals in a single step. As part of the automatic split of large journals, multiple journals can be created from one large journal. Users can now reverse all those journals at the same time. For more information, see [Reverse journal posting](/general-ledger/reverse-journal-posting.md#reverse-related-journals-with-journals-that-were-automatically-split). | |
