...
|Electronic Invoicing |E-Invoicing for Chile: ISV last-mile connector with Edicom|This is the feature of the last-mile integration with the Chilean Tax Authorities via the Certification Authorization Provider Edicom. It covers the required end-to-end process of the outbound flow of e-invoices submission. The documentation article is published here: [Get started with Electronic invoicing for Chile](../finance/localizations/iberoamerica/ltm-chile-elec-invo-conncection.md)|Globalization studio|
