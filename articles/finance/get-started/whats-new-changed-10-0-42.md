...
|Accounts receivable | Archive customer invoice with long term retention | Sales order invoices and free text invoices can be archived using the **Archive with Dataverse long term retention** workspace. In Feature management, enable **(Preview) Archive Customer invoice with long term retention** to see this on the workspace. For more information, see [Archive Dynamics 365 Finance customer invoices](../../fin-ops-core/dev-itpro/sysadmin/archive-gl.md).| Feature management | 
