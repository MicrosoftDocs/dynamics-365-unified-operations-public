...
title: Preview features in Dynamics 365 Finance version 10.0.8 (March 2020)
...
---
# Preview features in Dynamics 365 Finance version 10.0.8 (March 2020)

[!include [banner](../includes/banner.md)]
[!include [preview banner](../includes/preview-banner.md)]

This topic describes preview features that are new or changed for Platform update 31 for Microsoft Dynamics 365 Finance, version 10.0.8. This version has a build number of 8.0.xxxx and is available as follows:

- Preview release is in October 2019.
- General availability (self-update) is in January 2019.
- Auto-update is in March 2020.
...
Microsoft Dynamics 365 Supply Chain Management 10.0.8 includes Platform update xx. To learn more about Platform update xx, see [Preview features in Platform update 31](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-xx.md).
