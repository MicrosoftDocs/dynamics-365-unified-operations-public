...
| Globalization | (ER) Use labels of the parent data model in the derived format | You can use labels of the parent [Electronic reporting (ER)](../../fin-ops-core/dev-itpro/analytics/general-electronic-reporting.md) data model in the format that you derived from this model. When you enable the **Enhanced access to labels of the ascendent ER data model** feature, you can also access labels of the ascendent ER data model when you derive your format from another format and select during this process the alternative data model. For more information, see [Lifecycle](../../fin-ops-core/dev-itpro/analytics/er-design-multilingual-reports.md#lifecycle). | Feature management |
