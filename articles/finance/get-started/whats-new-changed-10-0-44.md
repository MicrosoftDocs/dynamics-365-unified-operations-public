...
| Regulatory reporting | Performance improvement for Norwegian SAF-T report | Enables new version of Norwegian SAF-T report with the latest performance improvements. Learn more in [Set up SAF-T for Norway](../localizations/norway/emea-nor-standard-audit-file-for-tax.md#features) | Feature management |
