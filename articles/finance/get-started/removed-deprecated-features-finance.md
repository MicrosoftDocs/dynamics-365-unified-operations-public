...
| &nbsp;  | &nbsp;  |
|---|---|
| **Reason for deprecation/removal** | Replaced existing 22 fields starting with SystemGenerated* with three new fields in the DimensionAttributeValueCombination table and DimensionAttributeValueSet table |
