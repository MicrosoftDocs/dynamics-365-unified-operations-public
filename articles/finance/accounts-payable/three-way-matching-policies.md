...
1. Sammy, a worker in the receiving department at Fabrikam, receives the total quantity of machines that Contoso ships. Sammy enters a quantity of 5 on a product receipt. Because the purchase order is fully received, the status of the purchase order changes to **Received**.
...
Because this line passes the invoice matching process, you can post the invoice.
...
1. The items arrive. Sammy, a worker in the receiving department of the Malaysia division of Fabrikam, is interrupted and doesn't post the product receipt immediately.
2. April, the accounts payable coordinator at Fabrikam, enters, and verifies the invoice that is submitted by Contoso, and verifies the following information:
