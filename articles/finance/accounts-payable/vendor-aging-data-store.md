...
description: Learn about the process of using external storage for vendor aging data, including outlines on enabling and running Vendor aging data storage.
author: sunfzam
