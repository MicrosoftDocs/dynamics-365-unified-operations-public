...
> [!NOTE]
>In Dynamics 365 Finance versions 10.0.45 and 10.0.46, the override actual tax with imported tax functionality is controlled by a feature in feature management and not a toggle on the **Account payable parameters** page.
...
> In Dynamics 365 Finance version 10.0.47 and later, the feature is available by default, and users must configure the feature in Account payable parameters as listed above. However, if the feature was previously enabled in Dynamics 365 Finance versions 10.0.45 and 10.46, these toggles are automatically enabled.  
