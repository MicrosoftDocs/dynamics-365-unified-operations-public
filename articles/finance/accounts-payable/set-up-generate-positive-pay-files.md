...
>[!NOTE:]
> This functionality will be deprecated September 2022, new users should use electronic reporting. For more information, see [Set up positive pay files by using Electronic reporting](set-up-positive-pay-er).
