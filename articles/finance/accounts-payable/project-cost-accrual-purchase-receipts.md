...
:::image type="content" source="./media/accruals1-1024x409.png" alt-text="Screenshot of the Accounts payable parameters page with the Post product receipts to ledger option." lightbox="./media/accruals1.png":::
...
:::image type="content" source="./media/accruals2-1024x569.png" alt-text="Screenshot of the Category policy rule page showing purchasing policies." lightbox="./media/accruals2.png":::
...
:::image type="content" source="./media/accruals4-1024x497.png" alt-text="Screenshot of creating a new purchase order for the project." lightbox="./media/accruals4.png":::

When the purchase order is confirmed, transactions for the committed cost are created for the project.
:::image type="content" source="./media/accruals5-1024x219.png" alt-text="Screenshot of the transactions created for the committed cost." lightbox="./media/accruals5.png":::
...
:::image type="content" source="./media/accruals6-1024x214.png" alt-text="Screenshot of the voucher transactions posted to the ledger." lightbox="./media/accruals6.png":::
...
:::image type="content" source="./media/accruals7-1024x390.png" alt-text="Screenshot of the Procurement category page where categories are mapped." lightbox="./media/accruals7.png":::
...
:::image type="content" source="./media/accruals8-1024x225.png" alt-text="Screenshot of the pending project transactions generated by the draft vendor invoice." lightbox="./media/accruals8.png":::
...
:::image type="content" source="./media/accruals9-1024x200.png" alt-text="Screenshot of the Committed cost page showing records from the pending vendor invoice." lightbox="./media/accruals9.png":::
