...
The Dynamics 365 ERP Analytics MCP server enables AI agents to access and analyze [Business Performance Analytics (BPA)](business-performance-analytics-home-page.md) data through natural language. This article provides guidance and best practices for building an agent with the ERP Analytics MCP server in [Microsoft Copilot Studio](../microsoft-copilot/microsoft-copilot-studio).
...
4. **Validate security**: Test with users having different Business performance analytics permissions.
