...
Business performance analytics is currently supported in regions: AU, CA, US, UK, EU and JP. Before you can use business performance analytics, you must complete configuration steps. For more information, see [Set up business performance analytics](configure-BPA.md).
