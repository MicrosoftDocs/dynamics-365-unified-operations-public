...
1. Turn on maintenance mode by using Lifecycle Services. This allows you to make system changes that might affect system functionality, such as enabling or disabling configuration keys.
