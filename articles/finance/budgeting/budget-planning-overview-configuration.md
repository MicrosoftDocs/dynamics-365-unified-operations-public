...
An organization can configure budget planning, and then set up budget planning processes to meet its policies, procedures, and requirements for budget preparation. Understanding the concepts and terminology used in Dynamics 365 Finance, should make it easier to implement budget planning effectively in your organization.
