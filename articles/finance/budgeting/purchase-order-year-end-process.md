...
### Enable the encumbrance process (for Public Sector customers)
...
### Set up posting definitions (for Public Sector customers)
...
### Assign posting definitions to transaction posting types (for Public Sector customers)
