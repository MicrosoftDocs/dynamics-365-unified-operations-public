...
4.1. In **Budgeting** > **Setup** > **Budget planning** > **Budget planning configuration**, open the **Columns** page. Click **Office** button on the top right corner of the form, and pick Columns (unfiltered). 
