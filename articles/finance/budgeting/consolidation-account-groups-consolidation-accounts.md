...
description: Learn about consolidation account groups, additional consolidation accounts, and how they're used, including outlines on various types of accounts.
...
Consolidation account groups let you create groups of the accounts that you want to use to consolidate data. Typically, a consolidation account group represents a government-mandated chart of accounts. A consolidation account group can also map accounts to a group that the company's headquarters defines. You can find consolidation account groups in the **Setup** area of the **Consolidations** module. When you add a new group, enter a unique identifier for the account group, as well as a name.

## Additional consolidation accounts

Use additional consolidation accounts to assign an account from an existing chart of accounts to a consolidation account group. Then, specify a consolidation account value and name.

You can find additional consolidation accounts in the **Setup** area of the **Consolidations** module. When you create a new consolidation account, specify the following information:

- **Main account** – This field is a lookup that shows all the main accounts that are based on the chart of accounts that you selected on the page. When you select an account, the name automatically enters in the **Main account name** field.
...
When you finish creating your consolidation account groups and additional consolidation accounts, select the group in the Consolidate online process.
