...
The **Trial balance with transactional detail** report uses electronic reporting (ER). Therefore, an organization can either use the version of the report that's included in the Global repository or create their own version of the report.

## ER setup

If you didn't configure the Global repository, you must configure it for the updated version of the **Trial balance with transactional detail** report.
...
1. Select **Repositories** for the **Microsoft** provider.
1. Select **Open**.
1. Scroll down, or add a filter for the configuration name that begins with **Trial**.
1. Select **Trial balance with transactional detail (excel)**, and then select **Import**.

You can now run the updated report, and the results are available in Microsoft Excel.
...
The information that appears in the **Document** and **Description** columns varies, depending on the type of transaction. The following table provides some examples of information that appears in those columns.
