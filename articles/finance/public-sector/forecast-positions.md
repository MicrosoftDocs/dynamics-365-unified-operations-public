...
description: Learn about the position budgeting functionality that's available for the public sector and validate whether the dimensions for a forecast position are correct.
author: velofog
ms.author: twheeloc
ms.topic: article
ms.date: 06/15/2026
