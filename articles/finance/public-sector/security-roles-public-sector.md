...
All users must be assigned to at least one security role to access Dynamics 365 Finance. Security roles determine which duties users can perform and which parts of the user interface they can view.
...
After you add users to the system, set up two roles for public sector organizations:
...
After you create the users, assign them to roles on the **Assign users to roles** page.
