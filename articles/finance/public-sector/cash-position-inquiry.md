...
1. In the **Cash position parameters** page, in the **Column one** section:

- In the **Column name** field, type a label to use as the header for the inquiry’s first column, such as "Beginning balance".
- In the **Opening balance main accounts** field, select the accounts that you want to reference for inquiring on the opening balance.

1. In the **Column two** section:

- Specify a label for the second column in the inquiry, such as "Cash receipts".
- In the **Debit and credit main accounts** list, select the main accounts to use only the sum of all debit and credit transaction amounts for the inquiry's data.

> [!NOTE]
> The inquiry adds the net of the debit and credit accounts plus the debit amount and credit amounts from the main accounts in the other fields in the group.

- In the **Debit-only main accounts** list, select the main accounts to use only the sum of all debit transaction amounts for the inquiry's data.
- In the **Credit-only main accounts** list, select the main accounts to use only the sum of all credit transaction amounts for the inquiry's data.

1. In the **Column three** and **Column four** sections:
...
1. In the **Column five** group section, specify a label for the fifth column, such as "Ending balance".
...
1. In the **Column six** and **Column seven** sections:
...
1. In the **Column eight** section, specify a column label, such as "Unencumbered balance".
