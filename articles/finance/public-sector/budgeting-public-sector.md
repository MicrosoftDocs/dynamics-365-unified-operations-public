...
## What are the prerequisites for setting up Budgeting in the public sector?
...
You might need to set up the following Budgeting features:
...
**Note** This information also applies to General ledger, Accounts payable, and Accounts receivable.
