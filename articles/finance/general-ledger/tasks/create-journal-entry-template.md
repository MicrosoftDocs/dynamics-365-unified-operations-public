...
20. This procedure assumes a **Percent Template** type. Click **OK**.
    ...
    - **Amount** - The actual amounts are stored and applied.  
...
29. In the **Amount** field, enter the amount to be applied to the voucher. The **Amount** field is only displayed if the voucher template is **Percent** type.  
30. Click **OK**.
