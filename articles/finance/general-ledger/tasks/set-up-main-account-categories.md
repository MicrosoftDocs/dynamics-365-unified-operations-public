...
NOTE: The Main account type serves as a way to determine the general classification of an account, such as Balance Sheet, Profit & Loss, Asset, or Liability. In contrast, the Main Account Category offers a more detailed grouping for accounts within these classifications.
