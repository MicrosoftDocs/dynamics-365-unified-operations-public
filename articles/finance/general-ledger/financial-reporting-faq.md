...
Financial Reporter uses the following 16 tasks to copy data from Dynamics 365 Finance into the Financial reporter database. Below are these 16 tasks, as well as the intervals that specify how often they run. The intervals can't be changed.
