...
order or transfer order receipt.                                                 |
...
status may be **Ordered** or **Purchased**.                                                            |
| Issue (status)   | For inventory transactions that are issues, this field indicates the status of the issue. For example, a sales order is an issue, and the status
...
order return this when the product receipt is posted.                                                                      |
