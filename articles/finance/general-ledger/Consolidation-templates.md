...
On the **Financial dimensions** FastTab, you define the dimensions that the consolidation company includes.

Set the **Specification** field to **Dimension** to select a dimension. Then use the **Segment order** field to define the order of the dimension in the consolidation company.

Regardless of the order that you define, **Main account** is always the first segment.

## Legal entities

On the **Legal entities** FastTab, you define the companies that the consolidation company includes. You also define the ownership percentage of those companies. If you specify less than 100-percent ownership, the specified percentage rolls up to the consolidation company.

For any translation differences, use the **Account type for conversion differences** field to select the main account from the setup on the **Accounts for automatic transactions** page.
...
On the **Currency translation** FastTab, you define the legal entity, the account, the exchange rate type, and the rate. If the consolidation company uses different main accounts than the source company, you must enter the consolidation company's main accounts in the **From account** and **To account** fields, not the source company's main accounts. Even though the account lookup shows the source company accounts, you must enter the consolidation company's main accounts.

- **Select consolidation amount from**

  - Select **Accounting currency** to use the accounting currency amounts from the source companies to update the accounting currency amounts in the consolidation company. When you select this value, use the **Consolidate accounting currency** field to define how the accounting currencies in the consolidation company are calculated.
...
- **Transaction date** – The date of each transaction is used to select an exchange rate. This option is most often used for fixed assets and is often referred to as a historical rate. You can't see a preview of the rate, because there are many rates for the various transactions in the account range.
