...
[![Illustration of year-end close history](./media/run-yr-end-close.png)](./media/run-yr-end-close.png)

If the year-end close is rerun, you will see one or multiple records for each legal entity/fiscal year depending on the General ledger parameters that were selected:

- If the General ledger parameter **Delete existing year-end entries when re-closing the year** is set to **Yes**, the voucher for the previous year-end close will be deleted.  The record will be marked as Reversed, stamped with the date and time it was reversed, and the link to the voucher number will be removed. A new record will be created for the new voucher created when the year-end close is complete.
...
A year-end close can be reversed from the **Year-end close** page. Select the record for the legal entity and fiscal year that needs to be reversed, and then click the **Reverse year-end close** button. The reversal process will delete all opening and closing vouchers created for the fiscal year. The record will be marked as **Reversed**, and stamped with the date and time that the reversal was done. Also, the link to the voucher number will be removed. The reversal of the year-end close will also run using batch processing. 
...
[![Illustration of year-end close reversal](./media/rvrs-yr-end-close.png)](./media/rvrs-yr-end-close.png)
