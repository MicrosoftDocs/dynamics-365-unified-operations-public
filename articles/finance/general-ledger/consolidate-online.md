...
- **Consolidation period** – Use the fields in this section to define the consolidation period.
    ...
    - **Select consolidation amount from** – Use this parameter to define whether to use the accounting currency or the reporting currency amounts from the source companies to update the accounting currency amounts of the consolidation company. Select **Accounting currency** to use the accounting currency amounts from the source companies to update the accounting currency amounts in the consolidation company. When **Accounting currency** is selected, use the **Consolidate accounting currency** parameter below to define how the accounting currencies in the consolidation company will be calculated. Select **Reporting currency** to use the reporting currency amounts from the source companies to calculate the accounting currency amounts in the consolidation company. If the reporting currency from the source company is the same as the accounting currency of the consolidation company, then the reporting currency amounts are copied from the source company to the consolidation company. If the reporting currency from the source company is different from the accounting currency of the consolidation company, then the values are translated, using the exchange information defined on the **Currency translation** tab on this page, to calculate the consolidation company values.
    - **Consolidate accounting currency** -This option is available only if the **Select consolidation amount from** option is set to **Accounting currency**. Use this parameter to define whether the accounting currency amounts from the source companies are translated through exchange rates or copied to the consolidation company. Select **Use currency translation** to use the exchange rate information defined on the **Currency translation** tab to calculate the consolidation accounting balances. Select **Use accounting currency amount** to copy the accounting currency amounts from the source companies to the consolidation company. If the accounting currency from the source company is the same as the accounting currency of the consolidation company, then the currency amounts are copied from the source company to the consolidation company. If the accounting currency from the source company is different from the accounting currency of the consolidation company, then the values are translated, using the exchange information defined on the **Currency translation** tab, to calculate the consolidation company values.
...
- **Consolidation date** – The date defined in the **Consolidation period To** field on the consolidation **Criteria** tab will be used to get the exchange rate. This rate is equivalent to the spot or month-end rate. You will see a preview of the rate, but you can't edit it.
