...
- Set ledger periods to **On hold**, so that no further posting occurs. You can also restrict a period to a specific user group while period-end activities are occurring, for better control. Don't set periods to **Permanently closed**, because you can't reopen a period that you closed.

Use the **Financial period close** workspace to organize and track the tasks required for various period end processes.
