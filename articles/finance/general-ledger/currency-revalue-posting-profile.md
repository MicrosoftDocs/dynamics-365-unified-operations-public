...
In different countries (such as Türkiye), the realized gain or loss accounts can be used in the invoicing process to account for differences between the settled invoice and payment transactions. For more information, see [Exchange difference invoicing](../localizations/turkiye/emea-tur-exchange-difference-invoicing.md).
