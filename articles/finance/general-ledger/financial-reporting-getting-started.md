...
1. In Lifecycle Services, confirm that the Power Platform integration is configured and available. For more information, see [Configure Microsoft Power Platform](configure-bpa.md#configure-microsoft-power-platform) 
