...
>[!IMPORTANT]
> Beginning September 11, 2026, Microsoft will be deprecating the Financial dimension service with the release of Dynamics 365 Finance version 10.0.49 and align future investment with Optimized Financial dimensions.
>The Financial dimension service was introduced as an optional performance optimization for specific journal import scenarios, mainly large general journal imports through the Data Management Framework where ledger account values are provided on journal lines. The service applies to a limited set of scenarios and isn't used for Customer, Vendor, Bank account types, or when derived dimensions are configured.
