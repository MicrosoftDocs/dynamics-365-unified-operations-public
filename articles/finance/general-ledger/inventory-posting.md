...
When you use a fixed receipt price, you set a standard cost for a product. This method is an alternative to selecting the **Standard cost** option on the **Item model group** page for an item. The main difference when you use a fixed receipt price is that the system uses the currently configured cost price for the item when you post the receipt into inventory. There's no cost revaluation process for a fixed receipt price. When you post a financial update, the system uses the current cost price at the time of posting. If the cost price that you use at receipt and the invoice differ, the variance is posted to the fixed receipt price profit and loss accounts.
...
If there's a variance in the catch weight, the system posts the differences to the accounts that you specify in the **Catch weight loss** and **Catch weight profit** fields on the **Inventory posting profile** page. Typically, you specify the same main account in both fields.

The following table shows examples of the default posting types, and includes sample main accounts and descriptions.

- The "Debit/Credit?" column indicates whether the transaction typically debits or credits. In some cases, the transaction can post either debits or credits.
...
Use the inventory to fixed asset journal (**Fixed assets** > **Journals** > **Inventory to fixed asset journal**) to move items out of inventory and convert them to fixed assets. For more information, see [Fixed assets integration](../fixed-assets/fixed-asset-integration.md).
...
| Posting type | Main account example | Main account name example | Account type | Debit/Credit? | Clearing account | P/F | Follow | Description |
|---|---|---|---|---|---|---|---|---|
| Fixed asset issue | 180100 | Tangible fixed assets | Asset | Credit | No | Both | Not applicable | Use this account when you post an inventory to fixed asset journal to remove an item from inventory and convert it to a fixed asset. |
...
| Posting type | Main account example | Main account name example | Account type | Debit/Credit? | Clearing account | P/F | Follow | Description |
|---|---|---|---|---|---|---|---|---|
| Price difference for moving average | 510600 | Moving average price difference | Expense | Both | No | Both | Not applicable | Use this account when there's a difference in the cost between the receipt and the invoice. |
| Revaluation for moving average | 510610 | Moving average revaluation | Expense | Both | No | Both | Not applicable | Use this account when you adjust the moving average cost of a product. |
...
| Posting type | Main account example | Main account name example | Account type | Debit/Credit? | Clearing account | P/F | Follow | Description |
|---|---|---|---|---|---|---|---|---|
| Inventory issue | 140100 | Materials inventory | Asset | Credit | No | Both | Inventory receipt | Use this account when an inventory transaction that you post is an issue (negative quantity) and isn't related to sales, purchases, or production. The offset to this account is the Inventory expenditure, loss account. This account typically represents inventory in the balance sheet. |
| Inventory expenditure, loss | 510100 | Inventory profit and loss | Expense | Debit | No | Both | Inventory expenditure, profit | Use this account when an inventory transaction that you post is an issue (negative quantity) and isn't related to sales, purchases, or production. The offset to this account is the Inventory issue account. |
| Inventory receipt | 140100 | Materials inventory | Asset | Debit | No | Both | Inventory issue | Use this account when an inventory transaction that you post is a receipt (positive quantity) and isn't related to sales, purchases, or production. The offset to this account is the Inventory expenditure, profit account. This account typically represents inventory in the balance sheet. |
| Inventory expenditure, profit | 510100 | Inventory profit and loss | Expense | Credit | No | Both | Inventory expenditure, loss | Use this account when an inventory transaction that you post is a receipt (positive quantity) and isn't related to sales, purchases, or production. The offset to this account is the Inventory receipt account. |
| Inter-unit payable | 231500 | Interunit payable | Liability | Debit | No | Both | | Use this account when you transfer inventory between inventory dimensions such as sites, and the cost of an item differs between the sites. |
| Inter-unit receivable | 131500 | Interunit receivable | Asset | Credit | No | Both | | Use this account when you transfer inventory between inventory dimensions such as sites, and the cost of an item differs between the sites. |
