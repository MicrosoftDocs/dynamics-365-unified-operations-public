...
The **Inventory** tab in the **Inventory posting profiles** page is used to control how inventory transactions will post to the general ledger. These transactions are ones that are not created from sales orders, purchase orders, or production orders. Inventory transactions automatically post the physical and financial update to the inventory simultaneously. One exception are transfer orders that separate physical and financial updates when you ship and receive the inventory. 
