...
1. Select **New** to create the legal entity that acts as the consolidated legal entity.
1. Select the **Use for financial consolidation process** check box, and then enter information about the consolidated legal entity. Enter this information exactly as you want it to appear on financial statements for the consolidated legal entity.
1. Close the page.
1. Select the consolidated legal entity in the field in the upper-right corner of the page, and then select **OK**.
1. Go to **General ledger \> Setup \> Ledger**.
1. Select the chart of accounts, the fiscal calendar, the accounting currency, an optional reporting currency, and the default type of exchange rate for the consolidated legal entity.
1. Go to **General ledger \> Setup \> Currency \> Currency exchange rates**.
1. Set up currency exchange rates in relevant periods for the currencies of the subsidiary legal entities.
1. Close the page.
1. If the consolidated legal entity has subsidiaries that use foreign currencies, follow these steps:

    1. Go to **General ledger \> Setup \> Posting \> Accounts for automatic transactions**.
    1. In the **Posting type** field, select an appropriate account:
    ...
    1. In the **Main account** field, select the main accounts that should be used for foreign currency revaluation adjustments.
    1. Close the page.
