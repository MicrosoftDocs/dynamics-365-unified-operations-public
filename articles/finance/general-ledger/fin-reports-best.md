...
- Avoid cross-ledger or cross-company consolidation for ledgers or companies that use different accounting currencies if you don't require that level of consolidation.
- Reduce the number of tree units and columns in the design file by breaking a single large design into several smaller designs that you can generate in parallel.
