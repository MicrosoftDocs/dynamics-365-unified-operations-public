...
For a collection of troubleshooting articles grouped by article, see the following site provided by Microsoft Support:

- [Microsoft Dynamics 365 Finance troubleshooting](/troubleshoot/dynamics-365/finance/welcome-finance)

These articles explain how to determine, diagnose, and fix problems that you might encounter when you use Dynamics 365 Finance. The articles are organized by feature area. Each article focuses on a specific problem and how to solve it.

## Frequently asked questions

Collections of frequently asked questions (FAQs) are integrated into the finance documentation. Each of these articles include multiple FAQs for a specific feature article or area.
...
The following Microsoft support and community resources are also available. You can discuss and solve problems, browse blogs, request features, and more:
...
- [Dynamics 365 support] In <a href="https://lcs.dynamics.com/">LCS</a>, the <strong>Support</strong> tile opens a tool that helps you manage support incidents. To submit problems directly to Microsoft, select the <strong>Support</strong> tile in your LCS project. You can then submit problems in two ways:

<ul>
<li>On the <strong>Active issue</strong> tab, select your problem, and then select <strong>Submit to Microsoft</strong>.</li>
<li>On the <strong>Submitted to Microsoft</strong> tab, select <strong>Submit an incident</strong>, and then follow the on-screen instructions to submit the incident. After you submit an incident, you receive an email message from the Microsoft Support engineer who is assigned to your case.</li>
