...
2. The environment must be a high-availability (HA) environment in Sandbox. (This type of environment is also known as a Tier-2 environment.) For more information, see [Environment planning](../fin-ops-core/dev-itpro/organization-administration/environment-planning.md). 
