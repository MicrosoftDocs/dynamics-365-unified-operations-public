...
> [!NOTE]
> Following Finance insights setup is valid for Dynamics 365 Finance versions 10.0.20 and beyond. To setup Finance insights on versions up to 10.0.19, see [Configuration for Finance Insights (preview) - Version 10.0.20+](configure-for-fin-insites-PublicPreview.md).
