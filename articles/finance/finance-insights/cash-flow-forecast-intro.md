...
For additional details regarding cash flow forecasting configuration and calculation, please see [Cash flow forecasting](../../finance/cash-bank-management/cash-flow-forecasting.md).
