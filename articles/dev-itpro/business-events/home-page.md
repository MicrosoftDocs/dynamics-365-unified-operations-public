...
Business events provide a mechanism that lets external systems receive notifications. In this way, the systems can perform business actions in response to the business events.
