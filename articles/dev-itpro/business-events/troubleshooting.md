...
|---------------|---------------------|
| Unable to find navigation to business events in the system parameters form | The navigation to business events is from *System administration > Set up > Business events*. This change was made when business events was made generally available starting PU26.|
