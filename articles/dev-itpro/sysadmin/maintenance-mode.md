...
1. Go to the environment details page and on the **Maintain** menu and click **Enable Maintenance Mode**. 
...
## Turn maintenance mode on and off in DevTest/Demo environments hosted in Microsofts' subscription
