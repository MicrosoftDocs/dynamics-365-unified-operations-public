...
An email notification will contain details about the environment that is being updated, the amount of downtime, and the time when the update will be applied. For more details, see [Planned maintenance FAQ](../lifecycle-services/planned-maintenance-window-faq.md).
