...
> [!NOTE]
> You do not need to follow the instructions in this article if you are upgrading your platform (also known as the Dynamics 365 Unified Operations platform) to Platform update 4 or newer. It is an automatic step that is part of the platform upgrade process.
