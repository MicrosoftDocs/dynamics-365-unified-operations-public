...
> [!NOTE]
> You do not need to follow the instructions in this article if you are upgrading your Finance and Operations platform (aka Dynamics 365 Unified Operations platform) to platform update 4 or newer. It is an automatic step that is part of the platform upgrade process.
