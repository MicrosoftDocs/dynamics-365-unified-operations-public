...
+ Consider to add additional element type information in case you create class extension for elements, that can't be declared in the code(like Forms, DataSources, FormControls etc..). For example **CustTableFormWHS\_Extension** - extension for the **CustTable** form.
