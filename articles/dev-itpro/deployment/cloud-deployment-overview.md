...
> - Creating new user accounts in the VMs is NOT permitted. Microsoft reserves the right to, and will delete the newly created user accounts without providing notice.
