...
Use the on-premises agent certificate that you acquired from a certificate authority (CA) or the self-signed certificate that you generated by using scripts.
