...
# Validate an application for AppSource for Dynamics 365 for Finance and Operations
...
| 2     | 3    | Create a project                       | Create an LCS project by using the solution package.                                                                                                           | Successfully create an LCS Package project. Correctly deploy package artifacts, such as the methodology and BPM.                                                                                                                                                                                                                        |
...
| Methodology                  | The methodology should incorporate an overview of the product. Guided experience to Conference Room Pilot 1 (CRP1) and any implementation methodology specifically tailored for the partner's LCS solution are optional. |
