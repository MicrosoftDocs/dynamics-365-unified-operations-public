...
| Methodology                  | The methodology should incorporate a solution package overview that includes relevant documentation. A guided experience to Conference Room Pilot 1 (CRP1) and any implementation methodology specifically tailored for the partner's LCS solution are optional. |
