...
title: Process and consume data packages in a Dynamics 365 for Finance and Operations solution
description: A Microsoft Dynamics 365 for Finance and Operations data package can consist of one to many data entities. A typical data package consists of a group of entities for a particular task, process, or function.
author: kfend
manager: AnnBe
ms.date: 04/13/2018
ms.topic: article
...
# Process and consume data packages in a Dynamics 365 for Finance and Operations solution
...
Before you create your data package, make a plan for what it should include to ensure that the correct entities, entity sequence, and fields are included. You create a data package by using the **Data management** workspace in Finance and Operations. Follow these steps to create a data package.
