...
> 
> The **Cost management** Power BI content pack, published to the AppSource site has been deprecated. For more information about that deprecation, see [Power BI content packs published to AppSource](../migration-upgrade/deprecated-features.md#power-bi-content-packs-published-to-appsource).
