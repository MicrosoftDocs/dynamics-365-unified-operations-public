...
<td>If you enter <strong>SPLIT(&quot;abc&quot; , 1)</strong> as a data source (DS), the expression <strong>STRINGJOIN (DS, DS.Value, &quot;:&quot;)</strong> returns <strong>&quot;a<span class="emoji" shortCode="b">🅱️</span>c&quot;</strong>.</td>
</tr>
<tr class="odd">
