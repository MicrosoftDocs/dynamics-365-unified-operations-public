...
> [!Note]
> For Power BI report development, customers must use a development environment running in their own subscription or on local machines. You can’t develop Power BI reports in Microsoft-provided, Tier-1 environments. You need administrator rights to install Power BI Desktop.
