...
If you're using Microsoft Dynamics 365 for Finance and Operations, Enterprise edition 7.2.0, the **Practice manager** Power BI content is shown in the **Project management** workspace.
...
Be sure to download the **Practice manager** content that applies to the version of Finance and Operations that you're using.
