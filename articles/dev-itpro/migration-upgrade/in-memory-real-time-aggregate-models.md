...
description: This topic explains how in-memory, real-time aggregate models are used for analytics, instead of SQL Server Analysis Services (SSAS) cubes.
author: MilindaV2
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
This topic explains how in-memory, real-time aggregate models are used for analytics, instead of SQL Server Analysis Services (SSAS) cubes.
