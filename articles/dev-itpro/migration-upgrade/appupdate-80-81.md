...
title: Update environments from version 8.0 to 8.1.X
...
# Update environments from version 8.0 to 8.1.X

[!include [banner](../includes/banner.md)]

This topic explains the steps required to update existing Dynamics 365 for Finance and Operations 8.0 environments to the 8.1.X application release.
...
The high-level process to update from version 8.0 to 8.1.X includes the following:
