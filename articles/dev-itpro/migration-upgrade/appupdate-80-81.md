...
> [!NOTE]
> The 8.1 binary update package will be available during second half of October, 2018. This package impacts steps 5-7, which means that steps 1-4 can be started after October 1, 2018.
