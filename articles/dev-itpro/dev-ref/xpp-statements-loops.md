...
| [TransientSqlConnectionError](sql-connection-x++.md)       | An error occured when during the query execution. The transaction will be aborted. This exception can't be caught within a transaction. |
