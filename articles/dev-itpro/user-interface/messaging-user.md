...
-   If the validation logic is defined at the control/field level, then the message will be removed as soon as a valid value is entered in the control. 
-   If the validation logic is defined at the table level, then the message will be removed the next time the users crosses a save boundary.   
