...
Before you run a single-user test with a scenario, you must work with your business team to define your end-to-end scenarios and then use Task recorder to create a recording of the steps in each scenario. For more information about how to create a task recording, see [Task recorder](../user-interface/task-recorder.md). The scenarios that you should test depend on your customer's business requirements. In this topic, you will use the "Create and confirm a sales order" sample scenario.
...
3. When you've finished, select **Save as developer recording** to download the XML file.
    ...
    [![Save as developer recording button in Task recorder](./media/single-user-test-01.png)](./media/single-user-test-01.png)
...
4. On the **Dynamics 365** menu, point to **Addins**, and then select **Create C\# perf test from recording**.
    ...
    [![Create C# perf test from recording command in Visual Studio](./media/single-user-test-07.png)](./media/single-user-test-07.png)
...
5. In the **Import Task Recording** dialog box, enter the following required details:
    ...
    [![Import Task Recording dialog box](./media/single-user-test-08.png)](./media/single-user-test-08.png)
