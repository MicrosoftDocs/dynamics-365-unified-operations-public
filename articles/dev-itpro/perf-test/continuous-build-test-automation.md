...
To use more than one build agents, setup your VSTS account with Azure billing: [Set up billing for your account](https://docs.microsoft.com/en-us/vsts/billing/set-up-billing-for-your-account-vs) 

[![VSTS1](./media/vsts1-300x155.jpg)](./media/vsts1.jpg)

-   After your account is linked with the Azure subscription. Follow the instructions in the Azure management portal to provision more build agents - [Buy load testing](https://docs.microsoft.com/en-us/vsts/billing/buy-load-testing-vs)
