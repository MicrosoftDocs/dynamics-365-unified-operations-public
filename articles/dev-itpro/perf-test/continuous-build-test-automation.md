...
To use more build pipelines than you're currently granted, set up your Azure DevOps account with Azure billing: [Set up billing for your account](/Azure DevOps/billing/set-up-billing-for-your-account-vs) 

[![VSTS1](./media/vsts1-300x155.jpg)](./media/vsts1.jpg)

-   After your account is linked with the Azure subscription, follow the instructions in the Azure management portal to purchase more concurrent pipelines - [Concurrent pipelines in VSTS](/Azure DevOps/build-release/concepts/licensing/concurrent-pipelines-ts) 
