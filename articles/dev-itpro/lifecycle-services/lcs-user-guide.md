...
| [Get updates](../migration-upgrade/download-hotfix-lcs.md)                            | Get updates is a tool that customers can use to access the updates that are available for their environments.                            |
