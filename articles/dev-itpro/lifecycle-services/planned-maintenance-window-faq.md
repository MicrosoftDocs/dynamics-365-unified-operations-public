...
We do not offer an option to reschedule a planned maintenance. You can however exclude from the current months maintenance cycle. 
...
To opt out of the current maintenance cycle, please file a support ticket with Microsoft. Your environment will be excluded for the current months maintenance cycle. It will be updated however with the next months maintenance. 
