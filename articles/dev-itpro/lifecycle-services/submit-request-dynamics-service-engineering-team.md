...
-   **Database refresh** – This includes, for example, the ability to refresh a database from production to sandbox. For more information, see [Upgrade data to latest update](..dev-itpro/migration-upgrade/upgrade-data-to-latest-update#before-you-begin).
 
