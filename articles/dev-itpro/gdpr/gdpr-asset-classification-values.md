...
-  **EUII** (End User Identifiable Information) – A natural value that can be used to identify a user of the service.

-  **EUPI** (End User Pseudonymous Information) – A generated value that can be used to identify the user of the service. 

-  **OII** (Organizational Identifiable Information) – A value that can be used to identify the organization using the service.
