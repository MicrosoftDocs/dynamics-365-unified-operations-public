...
To create a functioning Retail Store Scale Unit, complete the procedures in all sections of this topic through the "Run the Retail Store Scale Unit installer" section.  To complete the configuration and installation, the user must first begin in Dynamics 365 for Retail headquarters and perform the initial configuration.  Then, the user must complete the installation.  Finally, the user must return to headquarters to finish the configuration so that the Retail Store Scale Unit functions properly.
