...
### Before you begin
> [!IMPORTANT]
> This functionality works only in Microsoft Dynamics 365 for Retail, July 2017 version with Application update 3 and later. Note that silent servicing maintains all components that are currently installed.
