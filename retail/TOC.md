...
### [ Create and associate a device](tasks/create-associate-device.md)
...
### [ Manage assortments ](tasks/manage-assortments-2016-11.md)
...
### [ Push products from distribution center to store using buyer's push](tasks/push-products-distribution-center-store-buyers-push.md.md)
...
### [ Set up rules and parameters for cross docking and buyer's push](tasks/set-up-rules-parameters-cross-docking-buyers-push.md.md)
