...
### [Apply country context to solution](localizations\localization-requirements-apply-country-context.md)
...
### [Regulatory watch communication](localizations\localization-requirements-regulatory-watch-communication.md)
...
## [New task guides (get-started\February 2016)](get-started\new-task-guides-available-february-2016.md)
## [New or updated Task guides (get-started\November 2016)](get-started\new-or-updated-task-guides-available-november-2016.md)
## [New or updated task guides (get-started\August 2016)](get-started\new-updated-task-guides-available-august-2016.md)
## [New or updated task guides (get-started\May 2016)](get-started\new-updated-task-guides-available-may-2016.md)
## [What's new or changed in Dynamics AX 7.0 (get-started\February 2016)](get-started\whats-new-changed-7-0-february-2016.md)
## [What's new or changed in Dynamics AX application version 7.0.1 (get-started\May 2016)](get-started\whats-new-changed-application-version-7-0-1-may-2016.md)
...
## [Key performance indicator (analytics-bi-reporting\KPI) report](analytics-bi-reporting\key-performance-indicators-report.md)
...
## [Retain a copy of a Dynamics 365 for Operations database to restore later](database-management\retain-copy-dynamics-365-operations-database.md)
# Migration upgrade
...
## AX 2012
### Deployment
#### [Cloud-hosted environments (lifecycle-services\ax-2012\AX 2012)](lifecycle-services\ax-2012\cloud-hosted-environments-lcs.md)
...
#### [RFP responses (lifecycle-services\ax-2012\AX 2012)](lifecycle-services\ax-2012\rfp-responses-lcs.md)
#### [System diagnostics](lifecycle-services\ax-2012\system-diagnostics-lcs.md)
#### [Install and run System diagnostics (lifecycle-services\ax-2012\AX 2012)](lifecycle-services\ax-2012\install-run-system-diagnostics-lcs.md)
#### [Upgrade analysis](lifecycle-services\ax-2012\upgrade-analysis-lcs.md)
#### [Usage profiler (lifecycle-services\ax-2012\AX 2012)](lifecycle-services\ax-2012\usage-profiler-lcs.md)
...
#### [Test Data Transfer Tool (lifecycle-services\ax-2012\beta)](lifecycle-services\ax-2012\test-data-transfer-tool-beta-2012.md)
#### [Install the Test Data Transfer Tool (lifecycle-services\ax-2012\beta) for Dynamics AX](lifecycle-services\ax-2012\install-test-data-transfer-tool-beta.md)
...
#### [Run the Test Data Transfer Tool (lifecycle-services\ax-2012\beta) for Dynamics AX](lifecycle-services\ax-2012\run-test-data-transfer-tool-beta.md)
...
#### [Define or edit entry point permissions (lifecycle-services\ax-2012\AX 2012)](lifecycle-services\ax-2012\define-edit-entry-point-permissions.md)
#### [Performance Benchmark Software Development Toolkit (lifecycle-services\ax-2012\SDK) for Dynamics AX 2012](lifecycle-services\ax-2012\performance-benchmark-software-development-toolkit-sdk-2012.md)
